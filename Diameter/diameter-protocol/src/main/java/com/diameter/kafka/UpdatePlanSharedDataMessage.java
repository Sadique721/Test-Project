...
public class UpdatePlanSharedDataMessage {
    ...
    @SerializedName(value = "dataRatePackageGroup", alternate = {"data_rate_package_group"})
    private Long dataRatePackageGroup;

    @SerializedName(value = "smsRatePackageGroup", alternate = {"sms_rate_package_group"})
    private Long smsRatePackageGroup;

    @SerializedName(value = "voiceRatePackageGroup", alternate = {"voice_rate_package_group"})
