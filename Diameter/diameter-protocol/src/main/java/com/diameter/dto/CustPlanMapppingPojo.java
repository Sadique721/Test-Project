...
//    }
    ...
    public CustPlanMapppingPojo(Long planId, Long custid, CustomersPojo customer, LocalDateTime startDate, LocalDateTime expiryDate, Long qospolicyId, String uploadqos, String downloadqos, String uploadts, String downloadts, String service, Double offerPrice, Double taxAmount, LocalDateTime endDate, Double validity, Integer planValidityDays, Integer planGroupId, Integer renewalId, String custRefName) {
        this.planId = planId;
        this.custid = custid;
