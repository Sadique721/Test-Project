...
public class PostpaidPlan {
	...
	@DiffIgnore
	@Column(name = "SMSLIMIT", length = 40)
	private Long smsLimit;

	@DiffIgnore
	@Column(name = "VOICELIMIT", length = 40)
...
//    private List<RadiusProfile> radiusprofile;
	...
	@Column(name = "smsresetinterval", length = 40)
	private String smsResetInterval;
	@Column(name = "voiceresetinterval", length = 40)
...
//	private String retail;
    ...
    @Column(name = "sms_rate_package_group", nullable = true)
    private Long smsRatePackageGroup;

    @Column(name = "data_rate_package_group", nullable = true)
    private Long dataRatePackageGroup;

    @Column(name = "voice_rate_package_group", nullable = true)
...
//	private List<PlanQosMappingPojo> planQosMappingEntityList;
	...
	@Transient
	private String planServiceType;
...
//        this.radiusprofile = plan.getRadiusprofile();
		...
		this.allowdiscount = plan.getAllowdiscount();
		...
		this.useQuota = plan.getUseQuota();
		this.chunk = plan.getChunk();
		this.usageQuotaType = plan.getUsageQuotaType();
		this.addonToBase = plan.getAddonToBase();
		this.smsLimit = plan.getSmsLimit();
		this.voiceLimit = plan.getVoiceLimit();
		this.smsResetInterval = plan.getSmsResetInterval();
		this.voiceResetInterval = plan.getVoiceResetInterval();
		this.smstype = plan.getSmstype();
		this.voicetype = plan.getVoicetype();
		this.pulse = plan.getPulse();
		this.maxHoldDurationDays = plan.getMaxHoldDurationDays();
		this.maxHoldAttempts = plan.getMaxHoldAttempts();
		this.currency = plan.getCurrency();
        this.smsRatePackageGroup = plan.getSmsRatePackageGroup();
        this.voiceRatePackageGroup = plan.getVoiceRatePackageGroup();
        this.dataRatePackageGroup = plan.getDataRatePackageGroup();
	}
