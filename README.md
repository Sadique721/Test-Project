...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&amp;weight=600&amp;size=24&amp;duration=3000&amp;pause=500&amp;color=22D3EE&amp;center=true&amp;vCenter=true&amp;width=700&amp;lines=Feature%20Testing;API%20Prototyping;Code%20Sandbox" alt="Typing SVG">
</p>
...
[![Spring Cloud](https://img.shields.io/badge/Spring%20Cloud-Eureka%20%7C%20Zuul%20%7C%20Gateway-6DB33F?style=for-the-badge&logo=spring&logoColor=white)](https://spring.io/projects/spring-cloud)
...
[![Diameter 3GPP](https://img.shields.io/badge/Diameter%20Protocol-Gy%20%7C%20Ro%20%7C%20Gx%20%7C%20Sy-00599C?style=for-the-badge&logo=3gpp&logoColor=white)](https://www.3gpp.org/)
[![FreeRADIUS](https://img.shields.io/badge/RADIUS%20AAA-FreeRADIUS%20%7C%20CoA%20%7C%20PoD-007ACC?style=for-the-badge&logo=network&logoColor=white)](https://freeradius.org/)
[![Angular](https://img.shields.io/badge/Angular-11%2B%20SPA-DD0031?style=for-the-badge&logo=angular&logoColor=white)](https://angular.io/)
[![Flutter](https://img.shields.io/badge/Flutter-Cross--Platform%20Mobile-02569B?style=for-the-badge&logo=flutter&logoColor=white)](https://flutter.dev/)
...
```mermaid
flowchart TB
    subgraph ClientLayer ["Client & Frontend Ecosystem"]
        AdminUI["Admin UI Portal\n(Angular 11/12)"]
        CWSC["Customer Web Self Care\n(Angular 11/12)"]
        CustApp["Customer Mobile App\n(Flutter iOS/Android)"]
        FieldApp["Field Tech Mobile App\n(Flutter iOS/Android)"]
    end

    subgraph NetworkEdge ["Network & Hardware Layer"]
        BNG["BNG / BRAS Router\n(MikroTik, Cisco, Juniper)"]
        OLT["FTTH OLT\n(Huawei, ZTE, Nokia)"]
        UPF["5G Core UPF / PGW"]
    end

    subgraph GatewayMesh ["Edge Gateway & Protocol Adapters"]
        Gateway["common.gateway-dira\n(Spring Cloud Zuul / Port 30080)"]
        RadiusSvc["radius.service\n(FreeRADIUS / Port 30087)"]
        DiameterEngine["Diameter Engine\n(Gy / Ro / Gx / Port 3868)"]
    end

    subgraph ServiceRegistry ["Service Discovery & Registry"]
        Eureka["service.registry-dira\n(Netflix Eureka / Port 8761)"]
    end

    subgraph CoreServices ["Core Business Microservices"]
        CPM["cpm.service\n(Online Charging & Policy\nPort 30085)"]
        Revenue["revenue.service\n(Billing & Invoicing\nPort 30088)"]
        SalesCRM["salescrm.service\n(Subscriber Lifecycle\nPort 30089)"]
        Inventory["inventory.service\n(IPAM & Stock\nPort 30083)"]
        TaskMgmt["task.management-dira\n(Field Operations\nPort 30090)"]
        Ticket["ticket.service\n(Helpdesk & Faults\nPort 30091)"]
        Partner["partner.service\n(LCO & Commission\nPort 30086)"]
        Integration["integration.service\n(Payment & SMS APIs\nPort 30082)"]
        Notification["nofitication.service\n(Event Alerts\nPort 30084)"]
        Captive["captiveportal.service\n(Wi-Fi Hotspot\nPort 30081)"]
        Migration["dira.migrationutility\n(ETL & Batch Import\nPort 30092)"]
    end

    subgraph EventStream ["Event Streaming & Messaging"]
        Kafka["Apache Kafka Cluster\n(Broker Port 29092 / 30084)"]
        Zookeeper["Apache ZooKeeper\n(Port 2181 / 12181)"]
    end

    subgraph DataStore ["Database & Persistence Tier"]
        DB_Gateway[(commongateway DB)]
        DB_CPM[(savbillcpm DB)]
        DB_Revenue[(savbillrevenue DB)]
        DB_CRM[(savbillcrm DB)]
        DB_Radius[(radius DB)]
        DB_Other[(Domain Specific DBs)]
    end

    AdminUI & CWSC & CustApp & FieldApp -->|HTTPS / REST| Gateway
    BNG & OLT -->|RADIUS Auth/Acct| RadiusSvc
    UPF & BNG -->|Diameter CCR/CCA| DiameterEngine

    Gateway <-->|Service Lookup| Eureka
    CoreServices <-->|Heartbeat Register| Eureka

    Gateway -->|Feign / HTTP| CPM & Revenue & SalesCRM & Inventory & TaskMgmt & Ticket & Partner & Integration & Captive
    DiameterEngine <-->|Inter-Process / REST| CPM
    RadiusSvc <-->|Quota Validation| CPM

    CPM & Revenue & SalesCRM & RadiusSvc -->|Publish Events| Kafka
    Kafka -->|Consume Events| Notification & Revenue & TaskMgmt
    Kafka <--> Zookeeper
    ...
    SalesCRM --> DB_CRM
    RadiusSvc --> DB_Radius
    Inventory & Ticket & Partner & TaskMgmt --> DB_Other
```
