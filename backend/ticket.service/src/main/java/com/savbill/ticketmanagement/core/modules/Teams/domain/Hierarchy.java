package com.savbill.ticketmanagement.core.modules.Teams.domain;
...
public class Hierarchy extends Auditable implements IBaseData<Long> {
...
//    @Column(name = "hierarchy_id")
    ...
    @OneToMany(targetEntity = TeamHierarchyMapping.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER)
