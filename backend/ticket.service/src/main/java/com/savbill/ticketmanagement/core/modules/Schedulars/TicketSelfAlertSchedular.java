...
import com.savbill.ticketmanagement.rabbitmq.messages.TicketAlertStaffMessage;
...
//        messageSender.send(ticketAlertStaffMessage , RabbitMqConstants.QUEUE_TICKET_ALERT_TO_STAFF);
        ...
        kafkaMessageSender.send(new KafkaMessageData(ticketAlertStaffMessage, TicketAlertStaffMessage.class.getSimpleName()));
    }
