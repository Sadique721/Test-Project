...
//    }
    ...
    public static final String TICKET_REMARK_TYPE_INTERNAL = "Internal Remark";
    public static final String TICKET_REMARK_TYPE_EXTERNAL = "External Remark";

    public static final String EMAIL_STAFF_BU = "EMAIL_STAFF_BU";
    public static final String EMAIL_TEAM = "EMAIL_TEAM";
