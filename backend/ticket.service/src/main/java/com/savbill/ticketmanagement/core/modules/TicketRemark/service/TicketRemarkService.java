package com.savbill.ticketmanagement.core.modules.TicketRemark.service;
...
import com.savbill.ticketmanagement.core.modules.Customers.dto.CustomerPlanDTO;
import com.savbill.ticketmanagement.core.modules.Customers.dto.CustomerServiceDTO;
...
import com.savbill.ticketmanagement.core.modules.TicketRemark.controller.TicketRemarkController;
import com.savbill.ticketmanagement.core.modules.TicketRemark.domain.QTicketRemark;
import com.savbill.ticketmanagement.core.modules.TicketRemark.domain.TicketRemark;
import com.savbill.ticketmanagement.core.modules.TicketRemark.model.TicketRemarkDTO;
import com.savbill.ticketmanagement.core.modules.TicketRemark.repository.TicketRemarkRepository;
import com.savbill.ticketmanagement.core.modules.tickets.domain.Case;
import com.savbill.ticketmanagement.core.modules.tickets.domain.QCase;
...
public class TicketRemarkService {
    ...
    public TicketRemark DtoToDomain(TicketRemarkDTO ticketRemarkDTO){
        ...
        if(Objects.nonNull(ticketRemarkDTO.getTicketId())){
            ...
            Integer custId = getCustIdFromTicketId(ticketRemarkDTO.getTicketId()).get(0).getCustomers().getId();
