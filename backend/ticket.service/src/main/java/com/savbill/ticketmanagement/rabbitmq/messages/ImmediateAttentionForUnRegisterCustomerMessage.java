...
@AllArgsConstructor
@NoArgsConstructor
public class ImmediateAttentionForUnRegisterCustomerMessage {
    ...
    public ImmediateAttentionForUnRegisterCustomerMessage(String customerEmail, String subject, Integer mvnoId, Long buId) {
        ...
        this.customerData.put("userName",customerEmail);
