package com.savbill.ticketmanagement.core.modules.staffuser.service;
...
import com.savbill.ticketmanagement.rabbitmq.messages.DataShareMessage.SaveStaffUserSharedDataMessage;
import com.savbill.ticketmanagement.rabbitmq.messages.DataShareMessage.UpdateStaffUserSharedDataMessage;
    ...
    public void updateStaffUser(UpdateStaffUserSharedDataMessage message) throws Exception {
        try {
            ...
            if(message.getTeamsList().size()>0){
                ...
                oldteamMapping = teamUserMappingsRepocitory.findAllByStaffId(staffUser.getId().longValue());
