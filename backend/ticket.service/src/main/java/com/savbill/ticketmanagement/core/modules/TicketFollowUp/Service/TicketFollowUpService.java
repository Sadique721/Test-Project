...
import com.savbill.ticketmanagement.core.modules.TicketFollowUp.Mapper.TicketFollowUpMapper;
...
@Service
public class TicketFollowUpService extends ExBaseAbstractService<TicketFollowUpDTO, TicketFollowUp, Long> {
