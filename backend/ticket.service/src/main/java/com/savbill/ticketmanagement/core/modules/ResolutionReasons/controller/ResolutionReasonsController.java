package com.savbill.ticketmanagement.core.modules.ResolutionReasons.controller;


import com.savbill.ticketmanagement.core.constants.DeleteContant;
...
import com.savbill.ticketmanagement.core.modules.ResolutionReasons.mapper.ResolutionReasonsMapper;
import com.savbill.ticketmanagement.core.modules.ResolutionReasons.model.ResolutionReasonsDTO;
import com.savbill.ticketmanagement.core.modules.ResolutionReasons.repository.ResolutionReasonsRepository;
...
import com.savbill.ticketmanagement.core.modules.tickets.repository.ResoSubCategoryMappingRepo;
...
public class ResolutionReasonsController extends ExBaseAbstractController<ResolutionReasonsDTO> {
	...
	@Autowired
	TicketSubCategoryReasonCategoryMappingRepository mappingRepository;
	@Autowired
	...
	private final Logger log = Logger.getLogger(ResolutionReasonsController.class);
...
//	@PreAuthorize("validatePermission(\"" + MenuConstants.rootcause.ROOT_CAUSE_EDIT + "\")")
////    @Override
//	public GenericDataDTO update(@Valid @RequestParam String resolutionReasonsDTO, @RequestPart("fileList") List<MultipartFile> fileList, Authentication authentication, HttpServletRequest req) throws Exception {
//		ResolutionReasonsService resolutionReasonsService = SpringContext.getBean(ResolutionReasonsService.class);
//		GenericDataDTO genericDataDTO = new GenericDataDTO();
////		TraceContext traceContext = tracer.currentSpan().context();
//		MDC.put("type", "Update");
...
////		MDC.put("spanId",traceContext.spanIdString());
//		Integer RESP_CODE = APIConstants.FAIL;
//		ResolutionReasonsDTO entityDTO = new ResolutionReasonsDTO();
//		try{
//			entityDTO= new ObjectMapper().registerModule(new JavaTimeModule())
//					.readValue(resolutionReasonsDTO, new TypeReference<ResolutionReasonsDTO>() {
//					});
//			ResolutionReasonsDTO dtoData = resolutionReasonsService.getEntityForUpdateAndDelete(entityDTO.getIdentityKey());
//
//			boolean flag = resolutionReasonsService.duplicateVerifyAtEdit(entityDTO.getName(), entityDTO.getId());
...
//				ResolutionReasons olddata = resolutionReasonsService.getRepository().getOne(entityDTO.getId());
//				ResolutionReasonsDTO olddatadto = resolutionReasonsMapper.domainToDTO(olddata , new CycleAvoidingMappingContext());
//				genericDataDTO = resolutionReasonsService.update(entityDTO,fileList, authentication, req);if (olddata != null) {
//					log.info("Ticket Root Cause update details: " + UpdateDiffFinder.getUpdatedDiff(olddatadto, entityDTO));
//				}
//
//				//	logger.info("Updating resolution reasone With name "+entityDTO.getName() +"is successfull :  request: { From : {}}; Response : {{}{}}", getModuleNameForLog(),genericDataDTO.getResponseMessage(),genericDataDTO.getResponseCode());
