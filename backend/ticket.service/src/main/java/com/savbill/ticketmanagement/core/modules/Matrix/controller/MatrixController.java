package com.savbill.ticketmanagement.core.modules.Matrix.controller;
...
import com.savbill.ticketmanagement.core.modules.Matrix.service.MatrixService;
import com.savbill.ticketmanagement.core.modules.Pincode.controller.PincodeController;
...
public class MatrixController extends ExBaseAbstractController<MatrixDTO> {
...
//        HashMap<String, Object> response = new HashMap<>();
    ...
    public GenericDataDTO update(@Valid @RequestBody MatrixDTO entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        ...
        try {
            ...
            matrixService.getEntityForUpdateAndDelete(entityDTO.getId());
