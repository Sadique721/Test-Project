...
@AllArgsConstructor
@NoArgsConstructor
public class ImmediateAttentionForUnRegisterCustomerToStaffMessage {
    ...
    public ImmediateAttentionForUnRegisterCustomerToStaffMessage(String customerMobileNumber, String customerEmailId, String message, TemplateNotification template22, String customerName, String staffPersonName, String remark, Integer mvnoId, String ticketNumber, String teamStaff, Long buId) {
        this.setMessage("New Inquiry For Unknown Customer: Immediate Attention Required");
