...
import com.savbill.ticketmanagement.core.service.ExBaseService;
...
public abstract class ExBaseAbstractController<DTO extends IBaseDto> implements IBaseExController<DTO> {
    ...
    public GenericDataDTO save(@RequestBody DTO entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        genericDataDTO.setResponseCode(HttpStatus.OK.value());
        genericDataDTO.setResponseMessage("Success");
        try {
    ...
    public GenericDataDTO update(@RequestBody DTO entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
