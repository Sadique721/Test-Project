package com.savbill.ticketmanagement.core.modules.TicketTatMatrix.Controller;
...
import com.savbill.ticketmanagement.core.modules.TicketTatMatrix.Mapper.TicketTatMatrixMapper;
...
import com.savbill.ticketmanagement.core.modules.TicketTatMatrix.Service.TicketTatMatrixService;
...
public class TicketTatMatrixController extends ExBaseAbstractController<TicketTatMatrixDTO> {
    ...
    private final Logger log = Logger.getLogger(TicketTatMatrixController.class);
...
//                        AclConstants.OPERATION_MATRIX_EDIT, req.getRemoteAddr(), null, tatMatrixDTODTO.getId(), tatMatrixDTODTO.getName());
            ...
            if (ex instanceof DataNotFoundException) {
                ...
                RESP_CODE = HttpStatus.NOT_ACCEPTABLE.value();
                log.error(LogConstants.REQUEST_FROM + req.getHeader("requestFrom") + LogConstants.REQUEST_FOR + "Create tat matrix" + LogConstants.LOG_BY_NAME + entityDTO.getName() + LogConstants.REQUEST_BY + tatMatrixService.getLoggedInUser().getFirstName() + LogConstants.LOG_STATUS + LogConstants.LOG_FAILED + LogConstants.LOG_INFO + "Unable too update tat " + LogConstants.LOG_STATUS_CODE + RESP_CODE);
