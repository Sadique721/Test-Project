...
import com.savbill.ticketmanagement.utils.ApplicationContextProvider;
...
//        try {
//            ProducerRecord<String, Object> record = new ProducerRecord<>(KafkaConstant.KAFKA_TICKET_TOPIC, message);
...
//    }
    ...
    public String send(KafkaMessageData message) {
        try {
            ...
            ProducerRecord<String, KafkaMessageData> record = new ProducerRecord<>(KafkaConstant.KAFKA_TICKET_TOPIC,KafkaConstant.KAFKA_TICKET_TOPIC+1 ,message);
