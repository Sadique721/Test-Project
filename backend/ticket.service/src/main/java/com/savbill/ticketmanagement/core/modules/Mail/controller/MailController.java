...
import com.savbill.ticketmanagement.core.modules.ResolutionReasons.controller.ResolutionReasonsController;
...
public class MailController extends ExBaseAbstractController<MailDTO> {
    ...
    @PreAuthorize("validatePermission(\"" + MenuConstants.TicketConversation.TICKET_CONVERSATION + "\")")
    ...
    @Override
    @PreAuthorize("validatePermission(\"" + MenuConstants.TicketConversation.TICKET_CONVERSATION_DELETE + "\")")
...
//
    ...
    @PreAuthorize("validatePermission(\"" + MenuConstants.TicketConversation.TICKET_CONVERSATION_EDIT + "\")")
