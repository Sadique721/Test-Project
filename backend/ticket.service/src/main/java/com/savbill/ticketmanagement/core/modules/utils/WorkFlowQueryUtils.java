...
import com.savbill.ticketmanagement.core.modules.BranchServiceArea.domain.BranchServiceAreaMapping;
import com.savbill.ticketmanagement.core.modules.BranchServiceArea.repository.BranchServiceAreaMappingRepository;
...
import com.savbill.ticketmanagement.core.modules.CustomerAddress.Service.CustomerAddressService;
...
import com.savbill.ticketmanagement.core.repository.TicketServiceMappingRepo;
...
//                    }
            ...
            try {
                System.out.println(queryInit.toString().toLowerCase());
                result= (Boolean) engine.eval(queryInit.toString().toLowerCase());
                return (Boolean) engine.eval(queryInit.toString().toLowerCase());
            } catch (ScriptException e) {
                e.printStackTrace();
