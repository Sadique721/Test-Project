...
import com.savbill.ticketmanagement.core.modules.Plan.service.CustPlanMappingService;
...
public class KafkaMessageReceiver implements Runnable {
    ...
    public KafkaMessageReceiver() {
        ...
        messageHandler.put("TicketETRAuditMessage:" + KafkaConstant.TICKET_ETR_AUDIT_SUCCESS, this::saveETRTicketHandler);
        messageHandler.put("TicketETRAuditMessage", this::saveETRTicketHandler);
        messageHandler.put("TicketAuditMessage:" + KafkaConstant.TICKET_TAT_AUDIT_SUCCESS, this::saveTATTicketHandler);
        ...
        messageHandler.put("CloseTicketCheckMessage", this::closeTicketMessageHandler);
        messageHandler.put("CloseTicketCheckMessage:" + KafkaConstant.TASK_CLOSE_MESSAGE, this::closeTicketMessageHandler);
        messageHandler.put("SaveStaffAssignmentMessage", this::handleStaffUserServiceAreaMapping);
        messageHandler.put("UpdateCustplanMappingMessage", this::handleUpdateCustPlanMapping);
...
//        }catch (Exception e) {
//            e.printStackTrace();
//            log.error("Ticket Service Receive Kafka Error Message From Common-Micro-Service : "+e.getMessage());
//        }
//    }
    @Async
    private void saveCountryHandler(KafkaMessageData messageData) {
        try {
            ...
            log.info("Ticket Service Receive Kafka Message From Common-Micro-Service" + dataMessage);
        } catch (Exception e) {
            log.error("Ticket Service Receive Kafka Error Message From Common-Micro-Service" + e.getMessage());
        }
    }
    ...
    private void saveHeirarchyHandler(KafkaMessageData messageData) {
        try {
            ...
            log.info("Ticket Service Receive Kafka Message From CMS-Micro-Service" + dataMessage);
        } catch (Exception e) {
            log.error("Ticket Service Receive Kafka Error Message From CMS-Micro-Service" + e.getMessage());
        }
    }
    ...
    private void updateHeirarchyHandler(KafkaMessageData messageData) {
        try {
            ...
            log.info("Ticket Service Receive Kafka Error Message From CMS-Micro-Service" + e.getMessage());
        }
    }
    ...
    private void saveETRTicketHandler(KafkaMessageData messageData) {
        try {
            ...
            log.info("Ticket Service Receive Kafka Error Message From Notification-Micro-Service" + e.getMessage());
        }
    }
    ...
    private void saveStaffUserHandler(KafkaMessageData messageData) {
        try {
            SaveStaffUserSharedDataMessage dataMessage = new Gson().fromJson(new Gson().toJson(messageData.getData()), SaveStaffUserSharedDataMessage.class);
    ...
    private void updateStaffUserHandler(KafkaMessageData messageData) {
        try {
            UpdateStaffUserSharedDataMessage dataMessage = new Gson().fromJson(new Gson().toJson(messageData.getData()), UpdateStaffUserSharedDataMessage.class);
    ...
    private void savePartnerHandler(KafkaMessageData messageData) {
        try {
            ...
            log.info("Ticket Service Receive Kafka Message From Partner-Micro-Service" + dataMessage);
        } catch (Exception e) {
            log.error("Ticket Service Receive Kafka Error Message From Partner-Micro-Service" + e.getMessage());
        }
    }
    ...
    private void getEmailConfigrationHandler(KafkaMessageData messageData) {
        try {
            ...
            log.info("Ticket Service Receive Kafka Message From Notification-Micro-Service" + dataMessage);
        } catch (Exception e) {
            log.error("Ticket Service Receive Kafka Error Message From Notification-Micro-Service" + e.getMessage());
        }
    }
    ...
    @Async
    private void closeTicketMessageHandler(KafkaMessageData message) {
        try {
            ...
            caseService.updateStatusFromTask(dataMessage);
        } catch (Exception e) {
            e.getMessage();
        }
    }
...
//        }catch (Exception e) {
//            e.printStackTrace();
//            log.error("Ticket Service Receive Kafka Error Message From Inventory-Micro-Service : "+e.getMessage());
//        }
//    }
...
//        }catch (Exception e) {
//            e.printStackTrace();
//            log.error("Ticket Service Receive Kafka Error Message From Revenue-Micro-Service : "+e.getMessage());
//        }
//    }
...
//        }catch (Exception e) {
//            e.printStackTrace();
//            log.error("Ticket Service Receive Kafka Error Message From Radius-Micro-Service : " + e.getMessage());
//        }
//    }
