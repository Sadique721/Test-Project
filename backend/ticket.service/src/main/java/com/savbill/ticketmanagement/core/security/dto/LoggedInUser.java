package com.savbill.ticketmanagement.core.security.dto;
 ...
 */
@JsonIgnoreProperties({"password", "username", "authorities", "accountNonExpired", "accountNonLocked", "credentialsNonExpired", "enabled", "lastLoginTime", "fullName" , "teamIds"})
