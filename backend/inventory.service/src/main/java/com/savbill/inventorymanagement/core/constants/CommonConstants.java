...
public class CommonConstants {
    ...
    public static final String CUSTOMER_BIND_NETWORK_BIND = "CustomerBind, NetworkBind";
    public static final String NA_Bind = "NA";
    ...
    public interface WORKFLOW_EVENT_NAME {
        ...
        String CUSTOMER_INVENTORY_ASSIGN_REPLACE = "CUSTOMER_INVENTORY_ASSIGN_REPLACE";
    ...
    public interface  WORKFLOW_AUDIT_STATUS{
        ...
        String INPROGRESS="In Preogress";
...
//    }
    ...
    public static String STAFF_ALLOCATED = "Staff Allocated";
    ...
    public interface PRODUCT_OWNER {
        String PARTNER_OWNERTYPE = "Partner";
        String STAFF_OWNERTYPE = "Staff";
    }

    public interface PRODUCT_CATEGOTY {
        String CARD_DTV_CATEGORY = "Card";
        String STB_DTV_CATEGORY = "STB";
    }

    public interface PRODUCT {
        String SERIALIZED_ITEM = "Serialized Item";
        String NON_SERIALIZED_ITEM = "Non Serialized Item";
    }

    public interface EXTERNALITEM {
        String CUSTOMER_OWNED = "Customer Owned";
        String PARTNER_OWNED = "Partner Owned";
    }

    public interface INVENTORY_MAPPING {
        String PENDING = "Pending";
        String APPROVE = "Approve";
    }

    public interface POP_ASSIGN {
        String POP_DELETE = "Do not delete pop due to inventory assigned to pop";
    }
    public interface REQUEST_INVENTORY_PRODUCT_MAPPING{
        String OPEN = "Open";
        String CLOSE = "Close";
        String PARTIAL_OPEN = "Partial_Open";
        String REJECTED = "Rejected";
    }
    public interface CUSTOMER_INVENTORY_BILL_TO {
        String CUSTOMER = "CUSTOMER";
        String SUBISU = "SUBISU";
        String ORGANIZATION = "ORGANIZATION";
    }

    public interface SERIALISED_ITEM_OWNERTYPE {
        String POP = "Pop";
        String SERVICE_AREA = "Service Area";
        String STAFF = "Staff";
        String CUSTOMER = "Customer";
        String WAREHOUSE = "Warehouse";
        String SERVICEAREA = "ServiceArea";
        String EXTERNALITEM_SERVICEAREA = "ServiceArea";
        String PARTNER = "Partner";
    }

    public interface ITEM_WARRENTY_STATUS {
        String INWARRANTY = "InWarranty";
    }
    public static final String INVEN_ASSET_ORG = "InventoryAssetOrganization";
    public static final Integer OPERATION_ADD_MAC_SERIAL = 4;


    public static final String WARRANTY_REMAINING_DAY="InventoryWarrantyRemainder";

    public interface SERIALIZED_ITEM_OWNERSHIP_TYPE {
        String SUBISU_OWNED = "Subisu Owned";
        String ORGANIZATION_OWNED = "Organization Owned";
        String CUSTOMER_OWNED = "Customer Owned";
        String PARTNER_OWNED = "Partner Owned";
        String SOLD = "Sold";
    ...
    public interface MODULE{
        String MODULE_INVENTORY = "Inventory Management";
    }

    public static final String Smart_Gadget="Smart Gadget";
}
