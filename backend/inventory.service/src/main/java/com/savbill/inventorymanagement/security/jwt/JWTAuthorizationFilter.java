package com.savbill.inventorymanagement.security.jwt;

import com.savbill.inventorymanagement.core.utillity.log.ApplicationLogger;
import com.savbill.inventorymanagement.security.constants.Constants;
...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req,
        ...
        try {
            String header = req.getHeader(Constants.AUTHORIZATION_HEADER_STRING);
