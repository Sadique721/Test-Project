...
public class ItemAssemblyServiceImp extends ExBaseAbstractService<ItemAssemblyDto, ItemAssembly,Long> {
    ...
    public ItemAssemblyDto saveEntity(ItemAssemblyDto groupDto) {
        try {
            ...
            if (flag) {
                if (getMvnoIdFromCurrentStaff() != null) {
                    groupDto.setMvnoId(getMvnoIdFromCurrentStaff());
                }
        ...
        try {
            ...
            booleanExpression = booleanExpression.and(qItemAssembly.isDeleted.eq(true).or(qItemAssembly.isDeleted.eq(false).or(qItemAssembly.status.eq(CommonConstants.APPROVE).or(qItemAssembly.status.eq(CommonConstants.REJECTED).or(qItemAssembly.status.eq(CommonConstants.PENDING))))));
        ...
        try {
            ...
            if (getMvnoIdFromCurrentStaff() != 1) {
                booleanExpression = booleanExpression
                        .and(qItemAssembly.mvnoId.in(getMvnoIdFromCurrentStaff(), 1));
            }
