package com.savbill.inventorymanagement.modules.PartnerServiceAreaMapping;
...
public interface PartnerServiceAreaMappingRepo extends JpaRepository<PartnerServiceAreaMapping, Integer>, QuerydslPredicateExecutor<PartnerServiceAreaMapping> {
    ...
    List<PartnerServiceAreaMapping> findAllByServiceId(Integer serviceId);
    List<PartnerServiceAreaMapping> findAllByServiceIdIn(List<Integer> serviceId);
}
