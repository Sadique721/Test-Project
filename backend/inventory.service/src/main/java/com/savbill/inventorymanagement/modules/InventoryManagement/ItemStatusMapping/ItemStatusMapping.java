package com.savbill.inventorymanagement.modules.InventoryManagement.ItemStatusMapping;
...
public class ItemStatusMapping {
    ...
    public ItemStatusMapping(Long itemId, Long customerId, String itemStatus, String event) {
        this.itemId=itemId;
