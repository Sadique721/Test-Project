...
import com.savbill.inventorymanagement.utils.ApplicationContextProvider;
...
//        try {
//            ProducerRecord<String, Object> record = new ProducerRecord<>(KafkaConstant.KAFKA_INVENTORY_TOPIC, message);
...
//    }
    ...
    public String send(KafkaMessageData message) {
        try {
            ...
            ProducerRecord<String, KafkaMessageData> record = new ProducerRecord<>(KafkaConstant.KAFKA_INVENTORY_TOPIC, KafkaConstant.KAFKA_INVENTORY_TOPIC + 1, message);
