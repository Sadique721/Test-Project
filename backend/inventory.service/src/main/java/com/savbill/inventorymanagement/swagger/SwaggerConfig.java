package com.savbill.inventorymanagement.swagger;
...
public class SwaggerConfig implements WebMvcConfigurer{
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Savbill Inventory Management").description("Savbill Inventory Management").build();
    }
