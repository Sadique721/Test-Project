...
public class SwaggerConfig implements WebMvcConfigurer{
	...
	/*return new Docket(DocumentationType.SWAGGER_2).select()
		.apis(RequestHandlerSelectors.basePackage("com.savbill.radius.controller"))
	...
	return new ApiInfoBuilder().title("Savbill Radius Service").description("Savbill Radius Service").build();
    }
