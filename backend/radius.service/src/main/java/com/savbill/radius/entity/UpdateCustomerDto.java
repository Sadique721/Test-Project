...
public class UpdateCustomerDto {
    ...
    @ApiModelProperty(value = "This is SLiceChunk value", required = false)
    ...
    public UpdateCustomerDto(CustomMessage message) {
        ...
        if (message.getMacAddressMapping() != null && !message.getMacAddressMapping().isEmpty()) {
            this.macAddressMapping = new HashSet<>(message.getMacAddressMapping());
        }
        if (map.get("sliceChunk") != null) {
            this.setSliceChunk(Long.parseLong(map.get("sliceChunk").toString()));
        }
        if (message.getCustomerTimeBasePolicyMappings() != null && !message.getCustomerTimeBasePolicyMappings().isEmpty()) {
            this.customerTimeBasePolicyMappings = message.getCustomerTimeBasePolicyMappings();
        }
        if (message.getCustomerQosPolicyMapping() != null && !message.getCustomerQosPolicyMapping().isEmpty()) {
            this.customerQosPolicyMappings = message.getCustomerQosPolicyMapping();
        }
