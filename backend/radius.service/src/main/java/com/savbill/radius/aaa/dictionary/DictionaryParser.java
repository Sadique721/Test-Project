 ...
 */
package com.savbill.radius.aaa.dictionary;
...
import com.savbill.radius.aaa.attribute.*;
import com.savbill.radius.aaa.attribute.*;
...
public class DictionaryParser {
    ...
    private static Class getAttributeTypeClass(int attributeType, String typeStr) {
		...
		else if (typeStr.equalsIgnoreCase("hwoctets")) //Jira Id: ANG-11045
			type = OctetAttribute.class;
		...
		else if (typeStr.equalsIgnoreCase("ipv4addr"))
			type = IpAttribute.class;
		...
		else if (typeStr.equalsIgnoreCase("eap"))
			type = EAPAttribute.class;
		else
			type = StringAttribute.class;
