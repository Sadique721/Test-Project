...
//    private String port;
    ...
    @Value(value = "${kafka.max.request.size.bytes}")
    private String kafkaMaxRequestSizeInBytes;
    ...
    public KafkaProducer<String , KafkaMessageData> kafkaProducer() {
        ...
        config.put(ProducerConfig.BATCH_SIZE_CONFIG, kafkaBatchSize); //max batch size to be send through kafka
        ...
        config.put(ProducerConfig.MAX_REQUEST_SIZE_CONFIG, kafkaMaxRequestSizeInBytes); // 10MB (10485760 bytes)
