...
public class AccessRequest extends RadiusPacket {
	...
	throws RadiusException {
		...
		if (userPassword != null) {
			...
			//		System.out.println("Passowrd "+userPassword.getAttributeData());
	 ...
	 */
	public byte[] encodePapPassword(final byte[] userPass, byte[] sharedSecret) {
	...
	/**
	 * Radius attribute for EAP-Authentication.
	 */
	public static final int EAP = 79;
