...
public class LiveUser {
    ...
    @Column(name = "sourceipaddress", length = 100)
    ...
    @Column(name = "clientgroupid", length = 250)
    private String clientGroupId;

    @Column(name = "lastsessionquotavolume", length = 250)
    private double lastSessionQuotaVolume;

    @Column(name = "lastsessionquotatime", length = 250)
    private double lastSessionQuotaTime;

    @Column(name = "isthrottlespeed")
    private boolean isThrottleSpeed;


    @Column(name = "cprid", length = 250)
    private Long cprId;
    ...
    public double getLastSessionQuotaVolume() {
        return lastSessionQuotaVolume;
    }

    public void setLastSessionQuotaVolume(double lastSessionQuotaVolume) {
        this.lastSessionQuotaVolume = lastSessionQuotaVolume;
    }

    public double getLastSessionQuotaTime() {
        return lastSessionQuotaTime;
    }

    public void setLastSessionQuotaTime(double lastSessionQuotaTime) {
        this.lastSessionQuotaTime = lastSessionQuotaTime;
    }
    ...
    public LiveUser(Long cdrID, String userName, String userPassword, String chapPassword, String nasIpAddress,
                    ...
                    String digestAttributes, String framedipv6address, Timestamp createdDate, Timestamp lastmodifiedDate, String sourceipaddress) {
        super();
        this.cdrID = cdrID;
        this.userName = userName;
        this.userPassword = userPassword;
