...
import com.savbill.radius.aaa.db.DBDictionaryDriver;
...
extends MemoryDictionary{
	...
	static {
		try {
			...
			DBDictionaryDriver dictionarydata=new DBDictionaryDriver();
			InputStream source = dictionarydata.getDictionary();
