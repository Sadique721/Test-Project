...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    public PriceBookPlanDetail(Long id, Double offerprice, Double partnerofficeprice, String revsharen, String registration, String renewal, Boolean isDeleted, PriceBook1 priceBook, PostpaidPlan postpaidPlan, String revenueSharePercentage, Boolean isTaxIncluded, PlanGroup planGroup, Integer planGroupId, Integer postpaidplanid, Long pricebookid) {
        this.id = id;
