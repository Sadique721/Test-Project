package com.savbill.partnermanagement.nepaliCalendarUtils.service;
...
import com.savbill.partnermanagement.nepaliCalendarUtils.model.EnglishDateDTO;
import com.savbill.partnermanagement.nepaliCalendarUtils.model.NepaliDateDTO;
import com.savbill.partnermanagement.nepaliCalendarUtils.repository.NepaliDateRepository;
...
public class DateConverterService {
    ...
    */
    public NepaliDateDTO getNepaliDateDTO(int eYear, int eMonth, int eDay, String time) {
        ...
        ApplicationLogger.logger.debug("Days between start and end: {}", deltaDays);
        ...
        ApplicationLogger.logger.info("Converted to Nepali date: {}-{}-{} {}", nYear, nMonth, nDay, time);
    ...
    public EnglishDateDTO getEnglishDateDTO(int nYear, int nMonth, int nDay, String time) {
        ...
        ApplicationLogger.logger.debug("Days to add from base English date: {}", deltaDays);
    ...
    public int getDaysInMonth(int year, int month){
    	Optional<NepaliDate> nepalidate = dateRepository.findByYear(String.valueOf(year));
