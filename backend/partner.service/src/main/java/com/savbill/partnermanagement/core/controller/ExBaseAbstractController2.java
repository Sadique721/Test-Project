...
import com.savbill.partnermanagement.core.service.ExBaseService;
...
public abstract class ExBaseAbstractController2<DTO extends IBaseDto2> {
    ...
    public GenericDataDTO save(@Valid @RequestBody DTO entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        genericDataDTO.setResponseCode(HttpStatus.OK.value());
        genericDataDTO.setResponseMessage("Success");
        try {
    ...
    public GenericDataDTO update(@Valid @RequestBody DTO entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
