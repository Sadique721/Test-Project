...
public class PriceBook1 extends Auditable implements IBaseData2<Long> {
    @Id
    @DiffIgnore
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "priceBook")
    ...
    @OneToMany(mappedBy = "priceBook", targetEntity = PriceBookSlabDetails.class, fetch = FetchType.EAGER, cascade = CascadeType.ALL)
