package com.savbill.partnermanagement.core.utillity.fileUtillity;
...
import com.savbill.partnermanagement.core.exceptions.FileNotCreatedException;
...
public class FileUtility {
    ...
    public String saveFileToServer(MultipartFile argFile, String path) throws IOException {
        ...
        int allowedFileSize = clientService.getByName(DocumentConstants.ALLOWED_DOCUMENT_SIZE , clientService.getMvnoIdFromCurrentStaff()) != null ? Integer.parseInt(clientService.getByName(DocumentConstants.ALLOWED_DOCUMENT_SIZE , clientService.getMvnoIdFromCurrentStaff()).getValue()) : 2;
...
//        path="D:\\";
    ...
    public MultipartFile getFileFromArray(String fileName, MultipartFile[] files) {
        ...
        try {
            Integer allowedFileSize = clientService.getByName(DocumentConstants.ALLOWED_DOCUMENT_SIZE , clientService.getMvnoIdFromCurrentStaff()) != null ? Integer.parseInt(clientService.getByName(DocumentConstants.ALLOWED_DOCUMENT_SIZE , clientService.getMvnoIdFromCurrentStaff()).getValue()) : 2;
