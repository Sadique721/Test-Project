package com.savbill.partnermanagement.security.dto;
 ...
 */
@JsonIgnoreProperties({"password", "authorities", "accountNonExpired", "accountNonLocked", "credentialsNonExpired", "enabled", "lastLoginTime", "fullName" , "teamIds"})
