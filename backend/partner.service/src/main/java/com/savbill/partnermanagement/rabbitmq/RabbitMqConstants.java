...
//    public static final String QUEUE_SEND_SERIAL_NUMBER = "bss.apigateway.send.serialnumber";
	...
	// Sample
	public static final String QUEUE_COUNTRY_CREATE_DATA_SHARE_PARTNER_MICROSERVICE = "queue.country.create.data.share.partner.microservice";
	public static final String QUEUE_COUNTRY_UPDATE_DATA_SHARE_PARTNER_MICROSERVICE = "queue.country.update.data.share.partner.microservice";
	...
	public static final String QUEUE_STATE_CREATE_DATA_SHARE_PARTNER ="queue.state.create.data.share.partner.microservice" ;
	public static final String QUEUE_STATE_UPDATE_DATA_SHARE_PARTNER ="queue.state.update.data.share.partner.microservice" ;

	public static final String QUEUE_CITY_UPDATE_DATA_SHARE_PARTNER = "queue.city.update.data.share.partner";
	public static final String QUEUE_CITY_CREATE_DATA_SHARE_PARTNER = "queue.city.create.data.share.partner";

	public static final String QUEUE_PINCODE_CREATE_DATA_SHARE_PARTNER ="queue.pincode.create.data.share.partner";
	public static final String QUEUE_PINCODE_UPDATE_DATA_SHARE_PARTNER ="queue.pincode.update.data.share.partner";
	public static final String QUEUE_AREA_CREATE_DATA_SHARE_PARTNER = "queue.area.create.data.share.partner";
	public static final String QUEUE_AREA_UPDATE_DATA_SHARE_PARTNER = "queue.area.update.data.share.partner";

	public static final String QUEUE_SERVICE_AREA_CREATE_DATA_SHARE_PARTNER = "queue.service.area.create.data.share.partner";
	public static final String QUEUE_SERVICE_AREA_UPDATE_DATA_SHARE_PARTNER = "queue.service.area.update.data.share.partner";
	...
	public static final String QUEUE_BRANCH_CREATE_DATA_SHARE_PARTNER_MICROSERVICE = "queue.branch.create.data.share.partner.microservice";
	public static final String QUEUE_BRANCH_UPDATE_DATA_SHARE_PARTNER_MICROSERVICE = "queue.branch.update.data.share.partner.microservice";

	public static final String QUEUE_REGION_CREATE_DATA_SHARE_PARTNER = "queue.region.create.data.share.partner";

	public static final String QUEUE_REGION_UPDATE_DATA_SHARE_PARTNER = "queue.region.update.data.share.partner";
	public static final String QUEUE_BUSINESS_VERTICALS_CREATE_DATA_SHARE_PARTNER = "queue.business.verticals.create.data.share.partner";
	public static final String QUEUE_BUSINESS_VERTICALS_UPDATE_DATA_SHARE_PARTNER = "queue.business.verticals.update.data.share.partner";
	...
	public static final String QUEUE_INVESTMENT_CODE_CREATE_DATA_SHARE_PARTNER = "queue.investment.code.create.data.share.partner";
	public static final String QUEUE_INVESTMENT_CODE_UPDATE_DATA_SHARE_PARTNER = "queue.investment.code.update.data.share.partner";
	public static final String QUEUE_BUSINESS_VERTICALS_DATA_CREATE_DATA_SHARE_PARTNER = "queue.business.verticals.data.create.data.share.partner";
	...
	public static final String QUEUE_SEND_CREATE_DATA_ROLE_PARTNER = "queue.send.create.data.role.to.partner";
	public static final String QUEUE_SEND_DELETE_DATA_ROLE_PARTNER = "queue.send.delete.data.role.to.partner";

	public static final String QUEUE_SEND_UPDATE_MVNO_COMMON_APIGW_TO_Partner_ISP = "queue.create.mvno.common.apigw.to.partner.isp";
	...
	public static final String QUEUE_MVNO_CREATE_DATA_SHARE_PARTNER = "queue.mvno.create.data.share.partner";

	public static final String QUEUE_MVNO_UPDATE_DATA_SHARE_PARTNER = "queue.mvno.update.data.share.partner";

	public static final String QUEUE_STAFF_CREATE_DATA_SHARE_PARTNER = "queue.staff.create.data.share.partner";

	public static final String QUEUE_STAFF_UPDATE_DATA_SHARE_PARTNER = "queue.staff.update.data.share.partner";
