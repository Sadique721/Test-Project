package com.savbill.partnermanagement.security.service;


import com.savbill.partnermanagement.constants.APIConstants;
import com.savbill.partnermanagement.modules.Mvno.MvnoRepository;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        try {
            ...
            user = new LoggedInUser(username, sfUser.getPassword(), true, true, true, true, authorities,
                    sfUser.getFirstname(), sfUser.getLastname(), sfUser.getLast_login_time(), sfUser.getId(), sfUser.getPartnerid(), roleList.toString(), serviceAreaId, mvnoId, null, sfUser.getId(), null, isLco , null,null,mvnoName,null,null);
