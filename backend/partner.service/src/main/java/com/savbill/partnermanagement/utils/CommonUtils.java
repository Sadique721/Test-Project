...
public class CommonUtils {
    ...
    public static String getBillPath() {
        if (BILL_PATH == null) {
            ...
            ClientService s1 = service.searchByName(CommonConstants.BILL_PATH_PARAM , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
    ...
    public static String getTrialBillPath() {
        if (TRIAL_BILL_PATH == null) {
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.TRIAL_BILL_PATH_PARAM , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
    ...
    public static String getPaymentPath() {
        if (PAYMENT_PATH == null) {
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.PAYMENT_PATH_PARAM , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
    ...
    public static String getPartnerBillPath() {
        if (PARTNER_BILL_PATH == null) {
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.PARTNER_BILL_PATH_PARAM , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
    ...
    public static String getPartnerRoleName() {
            String role = "";
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.PARTNER_TYPE_LCO_ROLE , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
                role = s1.getValue();
            }
            return role;
    ...
    public static Integer getPartnerRoleId() {
        if (PARTNER_ROLE_ID == null) {
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.PARAM_PARTNER_ROLE_ID , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
    ...
    public static Integer getPartnerManagerRoleId() {
        if (PARTNER_MANAGER_ROLE_ID == null) {
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.PARAM_PARTNER_MANAGER_ROLE_ID , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
    ...
    public static Integer getPartnerOperatorRoleId() {
        if (PARTNER_OPERATOR_ROLE_ID == null) {
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.PARAM_PARTNER_OPERATOR_ROLE_ID , service.getMvnoIdFromCurrentStaff());
            if (s1 != null) {
...
//    public static final String PAYMENT_MODE_DIRECTDEPOSIT = "directdeposit";
    ...
    public static String getNewCustomerAccountNo() {
        long timestamp = getUniqueNumber();
        LocalDate local = LocalDate.now();
        return "A" + local.getYear() + local.getMonthValue() + timestamp;
    }
