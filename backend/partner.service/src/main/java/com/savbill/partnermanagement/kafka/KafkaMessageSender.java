...
import com.savbill.partnermanagement.utils.ApplicationContextProvider;
...
//        try {
//            ProducerRecord<String, Object> record = new ProducerRecord<>(KafkaConstant.KAFKA_PMS_TOPIC, message);
...
//    }
    ...
    public String send(KafkaMessageData message) {
        try {
            ...
            ProducerRecord<String, KafkaMessageData> record = new ProducerRecord<>(KafkaConstant.KAFKA_PMS_TOPIC, KafkaConstant.KAFKA_PMS_TOPIC + 1, message);
