$(document).ready(function () {
  ...
  var affectedElement = $(".panel-collapse collapse in");
  ...
  $(".panel .btn-toggle-collapse").clickToggle(
    function (e) {
      ...
      $(this).find("i.fa-minus-circle").removeClass("fa-minus-circle");
    ...
    function (e) {
      ...
      $(this).find("i.fa-plus-circle").removeClass("fa-plus-circle");
  ...
  if ($("#toastr-demo").length > 0) {
    ...
    toastr["info"](
      'Hi there, this is notification demo with HTML support. So, you can add HTML elements like <a href="javascript:void(0)">this link</a>'
    );
