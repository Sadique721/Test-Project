...
import com.savbill.notification.services.impl.LoginServiceImpl;
...
public class RoleAccesses {
    ...
    public boolean hasPermission(String screenName, String actionName,String requestFrom) {
	...
	try {
	    ...
	    if (requestFrom.equalsIgnoreCase("swagger")) {
