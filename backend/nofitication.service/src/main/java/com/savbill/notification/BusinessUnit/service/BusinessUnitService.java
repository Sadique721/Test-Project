package com.savbill.notification.BusinessUnit.service;
...
import com.savbill.notification.rabbitmq.message.SaveBusinessUnitSharedDataMessage;
import com.savbill.notification.rabbitmq.message.UpdateBusinessUnitSharedDataMessage;
...
//
    ...
    public void saveBusineeUnit(SaveBusinessUnitSharedDataMessage message){
        try {
            ...
            autoCreateTemplateForNewBU(businessUnit);
        }catch (Exception e){
    ...
    @Transactional
    public void autoCreateTemplateForNewBU(BusinessUnit businessUnit){
        ...
        for(Template template : defaultTemplateList){
            ...
            autoTemplate.setMvnoId(businessUnit.getMvnoId());
            ...
            autoTemplate.setBuId(businessUnit.getId());
