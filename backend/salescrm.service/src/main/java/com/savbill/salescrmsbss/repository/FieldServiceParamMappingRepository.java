...
@Repository
public interface FieldServiceParamMappingRepository
		extends JpaRepository<FieldServiceParamMapping, Long>, QuerydslPredicateExecutor<FieldServiceParamMapping> {
	...
	List<FieldServiceParamMapping> findAllByServiceParameterIdInAndServiceParameterIdIsNull(
			List<Long> serviceparamIdList);
