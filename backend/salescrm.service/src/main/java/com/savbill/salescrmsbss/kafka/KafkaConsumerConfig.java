...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, KafkaMessageData> kafkaConsumerFactory() {
        ...
        configProps.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, true); // Manual offset commit
        ...
        configProps.put(ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, maxPollInterval); // 5 minutes
        ...
        //configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "INSTANCE");
...
//        factory.setConcurrency(100); // Adjusted concurrency level
