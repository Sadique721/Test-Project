package com.savbill.revenuemanagement.mastermanagement.Area.service;
...
import com.savbill.revenuemanagement.rabbitmq.messages.DataSharedMessages.MasterManagementMessages.SaveAreaSharedDataMessage;
...
@Transactional
    public void updateAreaEntity(SaveAreaSharedDataMessage message){
        try {
