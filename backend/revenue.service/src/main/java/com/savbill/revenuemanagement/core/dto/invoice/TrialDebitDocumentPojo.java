...
import com.savbill.revenuemanagement.core.repository.customer.CustomersPojo;
...
//	}
    ...
    public TrialDebitDocumentPojo(TrialDebitDocument debitDocument) {
    }
    ...
    public boolean isBoosterplan() {
        return isBoosterplan;
    }

    public void setBoosterplan(boolean boosterplan) {
        isBoosterplan = boosterplan;
    }
}
