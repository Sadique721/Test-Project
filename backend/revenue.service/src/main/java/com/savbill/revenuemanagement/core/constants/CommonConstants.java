...
public class CommonConstants {
    ...
    public static final String PAYMENT_STATUS_FULLY_ADJUSTED = "Fully Adjusted";
    ...
    public static final String INSTALLATION_SERVICE = "Installation";
    ...
    public static final String BILL_RUN_URL = "http://{server}:{port}/SavbillBillingEngine/generatebill/{billrundate}";
    public static final String CUST_BILL_RUN_URL = "http://{server}:{port}/SavbillBillingEngine/generatebillcust/{billrundate}/{custid}";
    public static final String CUST_PLANREL_BILL_RUN_URL = "http://{server}:{port}/SavbillBillingEngine/generatebillcust/{billrundate}/{custid}/{custplanrelid}";
    public static final String GERERATE_INVOICE_URL = "http://{server}:{port}/SavbillBillingEngine/generatepdf/{billrunid}";
    ...
    public static final String PAYMENT_RECEIPT_URL = "http://{server}:{port}/SavbillBillingEngine/payment/generatereceipt/{creditdocid}";

    public static final String BILL_CHARGE_RUN_URL = "http://{server}:{port}/SavbillBillingEngine/generatebillcharge/{custid}/{chargemappingid}";
    ...
    public static final String TRANS_REVERSAL_BUSINESS_PROMOTION = "Reverse Promotion";
    ...
    public static final String BALANCE_TRANSFER = "TransferBalance";
    public static final String BALANCE_TRANSFER1 = "BalanceTranfer";
    public static final String COMMISSION_TRANSFER1 = "CommissionTrasnfer";
    public static final String COMMISSION_TRANSFER = "TransferCommission";
    ...
    public static String ADD_1_DAY_INVOICE_CREATION = "Add1DayInvoiceCreation";
    ...
    public static final String BILL_CHARGE_RUN_URL_FOR_INVENTORY = "http://{server}:{port}/SavbillBillingEngine/generateBillForInventory/{custid}/{inventoryMappingId}";
    ...
    public interface PAYMENT_CONDITION {
        ...
        String ONLINE_PAYMENT_PENDING = "Online Payment Pending";
        String ONLINE_PAYMENT_APPROVED = "Online Payment Approved";
    }
    ...
    public interface PLAN_CONDITION {
        ...
        String BRANCH = "BRANCH";
        String REGION = "REGION";
        String BUSINESS_VERTICAL = "REBUSINESS_VERTICALGION";
        String TEAM_ASSIGNED_NEW = "TEAM_ASSIGNED_NEW";
        String PLAN_GROUP = "PLAN_GROUP";
        String CURRENT_TEAM_ASSIGNED = "CURRENT_TEAM_ASSIGNED";
        String PARTNER_NAME = "PARTNER_NAME";
...
//    }
    ...
    public static final String TEAMTYPE = "Finance";
    ...
    public interface DUE_DATE_CONSTANTS {
        String STARTDATE = "StartDate";
        String CREATEDDATE = "CreatedDate";
        String DUEDAYS = "Due_Days";
        String DUEDATETYPE = "duedate_by_StartDate_or_CreatedDate";

    }

    public interface MODULE {
        String MODULE_REVENUE = "Revenue Management";
    }

    public static final String IS_ISP_INVOICE_PAYLOAD_SEND = "IS_ISP_PAYLOAD_SEND";

    public static final String AUTO_RENEW_BEFORE_EXPIRY_DAY = "AUTO_RENEW_BEFORE_EXPIRY_DAY";

    public static final String AUTO_RENEWAL_FUTURE_PLAN_DAYS = "AUTO_RENEWAL_FUTURE_PLAN_DAYS";

    public static final String RENEWAL_PLAN_LIMIT_GLOBAL = "RENEWAL_PLAN_LIMIT_GLOBAL";

    public static final String RENEWAL_MIN_REMAINING_DAYS = "RENEWAL_MIN_REMAINING_DAYS";


    //This Const For Schedulers

    public static final String CRONJOB_Day_Wise_Revenue_Generate = "cronjobtimeforrevenueeverydaymidnight";

    public static final String CRONJOB_EVERY_MONTH_FIRST_DAY = "cronjobtimeforeverymonthfirstday";

    public static final String POSTPAID_INVOICE_DAY_MIDNIGHT = "cronjobforpostpaidinvoicedaymidnight";

    public static final String GENERATE_POSTPAID_INVOICE_NUMBER = "cronjobforgenerateinvoicenumber";

    public static final String AUTOMATE_PAYMENT = "cronJobTimeForAutomatePayment";

    public static final String GENERATE_INVOICE_PDF = "cronjobforgenerateinvoicepdf";

    public static final String SEND_INVOICE_PDF = "cronjobforsendinvoicepdf";

    public static final String PARTNER_COMMISSION_INVOICE = "cronJobTimeForPartnerCommissionInvoice";

    public static final String WRITE_OFF_AMOUNT = "Write off By";

    public static final String WRITE_OFF = "Write off";


    public static String REVENUE_AUTHORITY_NAME = "RevenueAuthorityName";

    public static final String KRA_INVOICE_SYNC = "KRA_INVOICE_SYNC";
    public static final String KRA_CREDIT_NOTE_SYNC = "KRA_CREDIT_NOTE_SYNC";
}
