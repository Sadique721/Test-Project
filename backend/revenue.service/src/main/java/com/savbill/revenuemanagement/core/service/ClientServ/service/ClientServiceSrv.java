package com.savbill.revenuemanagement.core.service.ClientServ.service;
...
import com.savbill.revenuemanagement.core.service.ClientServ.mapper.ClientServiceMapper;
import com.savbill.revenuemanagement.core.service.ClientServ.repository.ClientServiceRepository;
import com.savbill.revenuemanagement.rabbitmq.messages.SaveClientServMessge;
import com.savbill.revenuemanagement.rabbitmq.messages.UpdateClientServMessage;
...
//    }
    ...
    public List<ClientService> saveAllEntity(List<ClientService> list) {
        return this.entityRepository.saveAll(list);
    }
...
//    }
    ...
    public ClientService getByNameAndMvnoId(String name) {
        List<Integer> mvnoIds = new ArrayList<>();
        mvnoIds.add(getMvnoIdFromCurrentStaff());
        return this.entityRepository.getByNameAndMvnoIdIn(name,mvnoIds);
    }
...
//    }
    ...
    public ClientService update(ClientService clientService) {
        ClientService existingClientService = this.entityRepository.findByNameAndMvnoId(clientService.getName() , getMvnoIdFromCurrentStaff());
    ...
    public ClientService getClientSrvByName(String name) {
        List<Integer> mvnoIds = new ArrayList<>();
        mvnoIds.add(getMvnoIdFromCurrentStaff());
        return entityRepository.findByNameAndMvnoId(name,getMvnoIdFromCurrentStaff());
    }
...
//            clientService.setId(entityRepository.findlast()+1);
