...
import com.savbill.revenuemanagement.productmanagement.PlanGroup.dto.PlanGroupMappingDTO;
...
//            planGroupMapping.setService(planGroupMappingDTO.getService());
...
//                ServicesDTO services = servicesService.getEntityById(customerServiceMapping.getServiceId());
//                if (services != null) {
...
//                        PlanGroup newPlangroup = planGroupService.findPlanGroupById(id, getMvnoIdFromCurrentStaff());
