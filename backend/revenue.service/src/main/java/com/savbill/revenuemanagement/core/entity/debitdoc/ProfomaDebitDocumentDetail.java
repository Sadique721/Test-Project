...
@Data
@ToString
@Table(name = "tbltproformadebitdocumentdetail")
public class ProfomaDebitDocumentDetail {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "proformadebitdocaddrid")
    private Integer debitdocdetailid;

    @Column(name = "proformadebitdocumentid")
