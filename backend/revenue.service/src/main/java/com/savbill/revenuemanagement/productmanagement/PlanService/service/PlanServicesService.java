package com.savbill.revenuemanagement.productmanagement.PlanService.service;
...
import com.savbill.revenuemanagement.productmanagement.PlanService.dto.PlanServiceDto;

import com.savbill.revenuemanagement.productmanagement.PlanService.repository.PlanServiceRepository;
import com.savbill.revenuemanagement.rabbitmq.messages.DataSharedMessages.MasterManagementMessages.SaveServicesSharedDataMessage;
...
@Transactional
    public void updatePlanServiceEntity(SaveServicesSharedDataMessage message) throws Exception {
        try {
