package com.savbill.revenuemanagement.core.security.spring;//package com.savbill.ticketmanagement.core.security.spring;//package com.savbill.radius.spring;
//
...
@Configuration
//@ComponentScan(basePackages = "com.savbill.apigw")
//@EnableTransactionManagement
//@EnableAspectJAutoProxy
//@EnableJpaRepositories({"com.savbill.apigw.repository"})
		...
		return new CommitPropertiesProvider() {
			...
			public Map<String, String> provide() {
				...
				if (RequestContextHolder.getRequestAttributes() != null) {
					...
					ipAddress =(String) CommonUtils.getIpAddressFromHeader(request);
					...
					ipAddress = "0.0.0.1";					logger.info("******************** REMOTE ADDRESS START ********************");
					logger.info("IPV4 ADDRESS : "+ipAddress);
					logger.info("******************** REMOTE ADDRESS END ********************");
				}
				if (getLoggedInUser() != null) {
