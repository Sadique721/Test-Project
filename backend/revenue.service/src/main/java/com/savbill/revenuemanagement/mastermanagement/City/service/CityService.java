package com.savbill.revenuemanagement.mastermanagement.City.service;
...
import com.savbill.revenuemanagement.rabbitmq.messages.DataSharedMessages.MasterManagementMessages.CitySharedDataMessage;
...
//    }
    ...
    @Transactional
    public void saveCityEntity(CitySharedDataMessage message){
        try {
            City city = new City();
...
@Transactional
    public void updateCityEntity (CitySharedDataMessage message){
        try {
