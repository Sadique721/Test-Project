package com.savbill.revenuemanagement.core.security.config;

import com.savbill.revenuemanagement.core.security.jwt.JWTAuthenticationFilter;
import com.savbill.revenuemanagement.core.security.jwt.JWTAuthorizationFilter;
import com.savbill.revenuemanagement.core.security.service.CustomUserDetailsService;
...
@EnableWebSecurity
@ComponentScan("com.savbill.revenuemanagement.core.security")
    ...
    public static class WebAuthenticator extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http
                    ...
                    .antMatchers("api/v1/Revenue/process/**").permitAll()
                    .antMatchers(
                            "/v2/api-docs",
                            "-resources/**",
                            "swagger-ui.html",
