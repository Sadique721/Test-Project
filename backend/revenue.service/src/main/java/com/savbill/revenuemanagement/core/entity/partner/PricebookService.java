...
import com.savbill.revenuemanagement.rabbitmq.messages.DataSharedMessages.UpdatePricebookSharedMessage;
import com.savbill.revenuemanagement.rabbitmq.messages.SavePricebookSharedMessage;
...
public class PricebookService {
    ...
    public void update(UpdatePricebookSharedMessage message) {
        ...
        PriceBook priceBook=priceBookRepository.findById(message.getId()).orElse(null);
        if(priceBook!=null) {
            priceBook.setId(message.getId());
            priceBook.setBookname(message.getBookname());
            priceBook.setDescription(message.getDescription());
