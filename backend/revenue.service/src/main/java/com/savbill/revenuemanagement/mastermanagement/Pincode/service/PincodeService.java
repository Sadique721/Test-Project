package com.savbill.revenuemanagement.mastermanagement.Pincode.service;
...
import com.savbill.revenuemanagement.rabbitmq.messages.DataSharedMessages.MasterManagementMessages.SavePincodeSharedDataMessage;
...
//
    ...
    @Transactional
    public void updatePincode(SavePincodeSharedDataMessage message){
        try {
