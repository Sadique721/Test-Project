...
@Data
public class CreateSharedCustomersMessage {
...
//    private String pincode;
    ...
    public CreateSharedCustomersMessage(Customers customers) {
        this.id = customers.getId();
        this.createdById=customers.getCreatedById();
...
//        this.plangroupid = customers.getPlangroup().getPlanGroupId();
        ...
        this.flatAmount = customers.getOutstanding();
