package com.savbill.revenuemanagement.mastermanagement.BusinessUnit.service;
...
import com.savbill.revenuemanagement.mastermanagement.BusinessUnit.mapper.BusinessUnitMapper;
...
import com.savbill.revenuemanagement.rabbitmq.messages.DataSharedMessages.MasterManagementMessages.SaveBusinessUnitSharedDataMessage;
...
@Transactional
    ...
    @Transactional
    public void updateBusinessUnit(SaveBusinessUnitSharedDataMessage message) {
        try {
