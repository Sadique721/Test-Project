package com.savbill.revenuemanagement.mastermanagement.Branch.service;
...
import com.savbill.revenuemanagement.mastermanagement.Branch.mapper.BranchMapper;
...
import com.savbill.revenuemanagement.rabbitmq.messages.DataSharedMessages.MasterManagementMessages.SaveBranchSharedDataMessage;
...
@Transactional
    public void updateBranch(SaveBranchSharedDataMessage message){
    try {
        Branch branch = new Branch();
