...
public class PartnerLedgerDetails implements IBaseData<Long> {
    ...
    @Column(name = "total_shared_commission")
    Double totalSharedCommission = 0d;

    @Column(name = "parent_shared_commission")
    Double parentSharedCommission = 0d;

    @Column(name = "child_shared_commission")
    Double childSharedCommission = 0d;

    @Column(name = "operator_commission")
    Double operatorCommission = 0d;
