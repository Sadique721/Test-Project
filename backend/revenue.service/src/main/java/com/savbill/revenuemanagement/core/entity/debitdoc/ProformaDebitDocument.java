...
@Data
@ToString
@Table(name = "tblproformadebitdocument")
public class ProformaDebitDocument {

    @Id
    @DiffIgnore
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "proformadebitdocumentid", nullable = false, length = 40)
    private Integer id;

    @Column(name = "proformadebitdocumentnumber", nullable = false, length = 40)
    ...
    @OneToMany(fetch = FetchType.LAZY,targetEntity = ProfomaDebitDocumentDetail.class)
    @JoinColumn(name = "proformadebitdocaddrid")
    private List<ProfomaDebitDocumentDetail> profomaDebitDocumentDetails;
