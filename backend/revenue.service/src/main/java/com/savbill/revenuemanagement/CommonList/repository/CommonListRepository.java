package com.savbill.revenuemanagement.CommonList.repository;
...
public interface CommonListRepository extends JpaRepository<CommonList, Long> , QuerydslPredicateExecutor<CommonList> {
    ...
    CommonList findByValueAndType(String value, String mode);
   ...
   // List<CommonList> findByValueAndTypeIn(List<String> reasonIdStrings, String deactivateReasonEzBill);
    ...
    @Query("SELECT c.text FROM CommonList c WHERE c.value = :value AND c.type = :type")
    String findTextByValueAndType(@Param("value") String value, @Param("type") String type);
