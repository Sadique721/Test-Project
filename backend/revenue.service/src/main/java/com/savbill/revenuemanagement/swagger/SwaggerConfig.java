package com.savbill.revenuemanagement.swagger;
...
public class SwaggerConfig implements WebMvcConfigurer{
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Savbill SavbillRevenueManagement BSS API Gateway").description("Savbill SavbillRevenueManagement BSS API Gateway").build();
    }
