package com.savbill.revenuemanagement.productmanagement.Plan.domain;
...
//import com.savbill.revenuemanagement.productmanagement.PlanQosMapping.PlanQosMappingEntity;
...
//    private List<PlanQosMappingEntity> planQosMappingEntities;
    ...
    @Column(name = "qospolicy_name")
    private String qospolicy_name;

    public PostpaidPlan(Integer id,String name, String category , Double newOfferPrice){
        this.id = id;
        this.name = name;
        this.category = category;
        this.newOfferPrice = newOfferPrice;
    }
    public PostpaidPlan(Integer id, String name, String category, Double offerprice, Double validity, String unitsOfValidity) {
        this.id = id;
        this.name = name;
        this.category = category;
