...
--
-- Host: localhost    Database: savbillcpm    Table: tblmpostpaidplan
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmpostpaidplan` (
  ...
  `mode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'NORMAL',
  ...
  `max_hold_duration_days` bigint DEFAULT '0',
  `max_hold_attempts` bigint DEFAULT '0',
  `SMSLIMIT` decimal(40,0) DEFAULT NULL,
  `VOICELIMIT` decimal(40,0) DEFAULT NULL,
  `smstype` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `voicetype` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SMSRESETINTERVAL` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `VOICERESETINTERVAL` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pulse` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `PLANAVAILABILITYSCOPE` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`POSTPAIDPLANID`),
  UNIQUE KEY `mpostpaidplan_id_unq` (`POSTPAIDPLANID`),
  KEY `tblmpostpaidplan_ibfk_2` (`TAXID`),
  KEY `tblmpostpaidplan_ibfk_1` (`MVNOID`),
  KEY `businessunit_postpaidplan_fk` (`BUID`),
  CONSTRAINT `businessunit_postpaidplan_fk` FOREIGN KEY (`BUID`) REFERENCES `tblmbusinessunit` (`businessunitid`),
  CONSTRAINT `tblmpostpaidplan_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`),
  CONSTRAINT `tblmpostpaidplan_ibfk_2` FOREIGN KEY (`TAXID`) REFERENCES `tblmtax` (`TAXID`)
