...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmcharges
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmcharges` (
  ...
  KEY `charges_mvno_id_fk` (`MVNOID`),
  CONSTRAINT `charges_mvno_id_fk` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
