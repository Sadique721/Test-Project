...
--
-- Host: localhost    Database: savbillcpm    Table: tbltcustledgerdetails
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltcustledgerdetails` (
  ...
  KEY `tbltcustledgerdetails_ibfk_1` (`CREDITDOCID`),
  KEY `tbltcustledgerdetails_ibfk_2` (`DEBITDOCID`),
  KEY `tbltcustledgerdetails_ibfk_3` (`CUSTID`),
  CONSTRAINT `tbltcustledgerdetails_ibfk_2` FOREIGN KEY (`DEBITDOCID`) REFERENCES `tbltdebitdocument` (`debitdocumentid`),
  CONSTRAINT `tbltcustledgerdetails_ibfk_3` FOREIGN KEY (`CUSTID`) REFERENCES `tblcustomers` (`custid`)
