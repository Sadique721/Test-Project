...
--
-- Host: localhost    Database: savbillpartnermanagement    Table: tblminvestmentcode
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblminvestmentcode`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblminvestmentcode` (
  `investmentcode_id` bigint NOT NULL,
