...
--
-- Host: localhost    Database: savbillticketmanagement    Table: tblserviceareapincoderel
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=18437 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
