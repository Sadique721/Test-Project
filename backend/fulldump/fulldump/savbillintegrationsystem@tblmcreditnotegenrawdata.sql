...
--
-- Host: localhost    Database: savbillintegrationsystem    Table: tblmcreditnotegenrawdata
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmcreditnotegenrawdata`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmcreditnotegenrawdata` (
  ...
  `serial_number_credit_note_final` bigint DEFAULT NULL,
  `pushable_ledger_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`sr_no`),
  UNIQUE KEY `tblmcreditnotegenrawdata_sr_no` (`sr_no`),
  KEY `fk_tblmcreditnotegenrawdata_serial_number_bill_gen_final_id` (`serial_number_credit_note_final`),
  CONSTRAINT `fk_tblmcreditnotegenrawdata_serial_number_bill_gen_final_id` FOREIGN KEY (`serial_number_credit_note_final`) REFERENCES `tblmcreditnotefinaldata` (`sr_no`)
