...
--
-- Host: localhost    Database: savbillintegrationsystem    Table: tblmbillgenrawdata
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmbillgenrawdata`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmbillgenrawdata` (
  ...
  `serial_number_bill_gen_final` bigint DEFAULT NULL,
  ...
  PRIMARY KEY (`sr_no`),
  UNIQUE KEY `tblmbillgenrawdata_sr_no` (`sr_no`),
  KEY `fk_tblmbillgenrawdata_serial_number_bill_gen_final_id` (`serial_number_bill_gen_final`),
  CONSTRAINT `fk_tblmbillgenrawdata_serial_number_bill_gen_final_id` FOREIGN KEY (`serial_number_bill_gen_final`) REFERENCES `tblmbillgenfinaldata` (`sr_no`)
