...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tblmscheduleraudit
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmscheduleraudit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84777 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
