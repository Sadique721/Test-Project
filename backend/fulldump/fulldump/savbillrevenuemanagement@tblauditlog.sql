...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tblauditlog
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblauditlog` (
  ...
  `invoice_number` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_id` bigint DEFAULT NULL,
  `debit_doc_grace_days` bigint DEFAULT NULL,
