...
--
-- Host: localhost    Database: savbillcpm    Table: tblnotifications
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblnotifications` (
  ...
  KEY `tblnotifications_ibfk_1` (`MVNOID`),
  CONSTRAINT `tblnotifications_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
