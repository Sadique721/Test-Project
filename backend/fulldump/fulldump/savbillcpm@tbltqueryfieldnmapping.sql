...
--
-- Host: localhost    Database: savbillcpm    Table: tbltqueryfieldnmapping
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltqueryfieldnmapping` (
  ...
  `team_hir_mapping_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
