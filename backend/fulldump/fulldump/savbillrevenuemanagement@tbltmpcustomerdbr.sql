...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tbltmpcustomerdbr
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tbltmpcustomerdbr`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tbltmpcustomerdbr` (
  ...
  PRIMARY KEY (`dbr_id`),
  UNIQUE KEY `tbltmpcustomerdbr_id_unq` (`dbr_id`)
