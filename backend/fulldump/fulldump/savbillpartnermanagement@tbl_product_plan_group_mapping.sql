...
--
-- Host: localhost    Database: savbillpartnermanagement    Table: tbl_product_plan_group_mapping
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tbl_product_plan_group_mapping`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tbl_product_plan_group_mapping` (
  `id` bigint NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `tbl_product_plan_group_mapping_id_unq` (`id`)
