...
--
-- Host: localhost    Database: savbillcpm    Table: tbloltslots
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbloltslots` (
  ...
  KEY `tbloltslots_ibfk_1` (`MVNOID`),
  CONSTRAINT `tbloltslots_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
