...
--
-- Host: localhost    Database: savbillcpm    Table: tbltemplatemanagement
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltemplatemanagement` (
  ...
  KEY `tbltemplatemanagement_ibfk_1` (`MVNOID`),
  CONSTRAINT `tbltemplatemanagement_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
