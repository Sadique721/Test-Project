...
--
-- Host: localhost    Database: savbillcpm    Table: tblserviceareapincoderel
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblserviceareapincoderel` (
  ...
  CONSTRAINT `tblserviceareapincoderel_fk1` FOREIGN KEY (`serviceareaid`) REFERENCES `tblservicearea` (`service_area_id`),
