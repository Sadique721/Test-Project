...
--
-- Host: localhost    Database: commongateway    Table: tblmbuildingmapping
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=9660554 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
