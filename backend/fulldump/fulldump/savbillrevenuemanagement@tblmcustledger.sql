...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tblmcustledger
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmcustledger` (
  ...
  KEY `index_custLedger_custid` (`CUSTID`)
) ENGINE=InnoDB AUTO_INCREMENT=56258 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
