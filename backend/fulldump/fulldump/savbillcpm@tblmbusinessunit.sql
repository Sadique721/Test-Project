...
--
-- Host: localhost    Database: savbillcpm    Table: tblmbusinessunit
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmbusinessunit` (
  ...
  UNIQUE KEY `mbusinessunit_businessunitid_unq` (`businessunitid`),
  KEY `tblmbusinessunit_ibfk_1` (`MVNOID`),
  CONSTRAINT `tblmbusinessunit_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
