...
--
-- Host: localhost    Database: savbillcpm    Table: tblcharges
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblcharges` (
  ...
  `isinventorycharge` tinyint(1) DEFAULT '0',
  `inventorychargetype` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `tblcharges_taxid_fk` (`TAXID`),
  KEY `tblcharges_discountid_fk` (`DISCOUNTID`),
  KEY `TBLCHARGES_ibfk_1` (`MVNOID`),
  KEY `businessunit_charge_fk` (`BUID`),
  CONSTRAINT `businessunit_charge_fk` FOREIGN KEY (`BUID`) REFERENCES `tblmbusinessunit` (`businessunitid`),
  CONSTRAINT `tblcharges_discountid_fk` FOREIGN KEY (`DISCOUNTID`) REFERENCES `tblmdiscount` (`DISCOUNTID`),
  CONSTRAINT `TBLCHARGES_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`),
  CONSTRAINT `tblcharges_taxid_fk` FOREIGN KEY (`TAXID`) REFERENCES `tblmtax` (`TAXID`)
