...
--
-- Host: localhost    Database: savbillpartnermanagement    Table: tblmpartnerpayment
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmpartnerpayment` (
  `partnerpaymentid` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `tblmpartnerpayment_ibfk_1` (`partner_id`),
  CONSTRAINT `tblmpartnerpayment_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `tblpartners` (`PARTNERID`)
