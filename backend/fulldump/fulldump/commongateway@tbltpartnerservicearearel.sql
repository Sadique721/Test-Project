...
--
-- Host: localhost    Database: commongateway    Table: tbltpartnerservicearearel
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltpartnerservicearearel` (
  ...
  CONSTRAINT `tblpartnerservicearearel_ibfk_1` FOREIGN KEY (`serviceareaid`) REFERENCES `tblmservicearea` (`service_area_id`)
