...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmbranch
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmbranch` (
  ...
  UNIQUE KEY `tblmbranch_branchid_unq` (`branchid`),
  KEY `branch_mvno_id_fk` (`MVNOID`),
  CONSTRAINT `branch_mvno_id_fk` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
