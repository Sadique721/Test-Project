...
--
-- Host: localhost    Database: savbilltaskmanagement    Table: tbltresosubcategorymapping
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltresosubcategorymapping` (
  ...
  KEY `tbltresosubcategorymapping_fk1` (`case_category_id`),
  CONSTRAINT `tbltresosubcategorymapping_fk1` FOREIGN KEY (`case_category_id`) REFERENCES `tblmticketreasonsubcategory` (`id`),
