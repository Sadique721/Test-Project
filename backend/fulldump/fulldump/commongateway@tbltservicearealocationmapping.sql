...
--
-- Host: localhost    Database: commongateway    Table: tbltservicearealocationmapping
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltservicearealocationmapping` (
  ...
  CONSTRAINT `fk_service_area` FOREIGN KEY (`service_area_id`) REFERENCES `tblmservicearea` (`service_area_id`)
