...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmoutward
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmoutward`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmoutward` (
  ...
  `selecteditems` bigint DEFAULT NULL,
  `description` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`outward_id`),
  UNIQUE KEY `tblmoutward_outward_id_unq` (`outward_id`),
  KEY `outward_mvno_id_fk` (`mvno_id`),
  CONSTRAINT `outward_mvno_id_fk` FOREIGN KEY (`mvno_id`) REFERENCES `tblmmvno` (`MVNOID`)
