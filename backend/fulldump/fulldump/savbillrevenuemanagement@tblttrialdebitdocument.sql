...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tblttrialdebitdocument
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblttrialdebitdocument` (
  ...
  `adjustedamount` decimal(20,6) DEFAULT NULL,
  `paymentStatus` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
