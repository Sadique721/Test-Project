...
--
-- Host: localhost    Database: savbillcpm    Table: tblpartnerdebitdocument
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblpartnerdebitdocument`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblpartnerdebitdocument` (
  `creditdocumentid` bigint NOT NULL AUTO_INCREMENT,
  `creditdocumentnumber` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `partnerbillrunid` bigint DEFAULT NULL,
  ...
  UNIQUE KEY `partnercreditdoc_id_unq` (`creditdocumentid`),
  KEY `tblpartnercreditdoc_ibfk_2` (`partnerbillrunid`),
  KEY `tblpartnerdebitdocument_ibfk_1` (`partnerid`),
  CONSTRAINT `tblpartnercreditdoc_ibfk_1` FOREIGN KEY (`partnerid`) REFERENCES `tblpartners` (`PARTNERID`),
  CONSTRAINT `tblpartnerdebitdocument_ibfk_1` FOREIGN KEY (`partnerid`) REFERENCES `tblpartners` (`PARTNERID`),
  CONSTRAINT `tblpartnerdebitdocument_ibfk_2` FOREIGN KEY (`partnerbillrunid`) REFERENCES `tblmpartnerbillrun` (`partnerbillrunid`)
