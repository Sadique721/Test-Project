...
--
-- Host: localhost    Database: commongateway    Table: tblmbranch
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmbranch` (
  ...
  KEY `tblmbranch_mvnoid_fk` (`MVNOID`),
  CONSTRAINT `tblmbranch_mvnoid_fk` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
