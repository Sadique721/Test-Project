...
--
-- Host: localhost    Database: savbillpartnermanagement    Table: tblmserviceareaplangroupmapping
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmserviceareaplangroupmapping` (
  ...
  CONSTRAINT `tblmserviceareaplangroupmapping_fk1` FOREIGN KEY (`service_area_id`) REFERENCES `tblmservicearea` (`service_area_id`),
