...
--
-- Host: localhost    Database: savbillcpm    Table: tbltqospolicy_gateway_mapping
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltqospolicy_gateway_mapping` (
  ...
  KEY `tbltqospolicy_gateway_mapping_qos_policy_id_fk` (`qos_policy_id`),
  CONSTRAINT `tbltqospolicy_gateway_mapping_qos_policy_id_fk` FOREIGN KEY (`qos_policy_id`) REFERENCES `tbl_qos_policy` (`id`)
