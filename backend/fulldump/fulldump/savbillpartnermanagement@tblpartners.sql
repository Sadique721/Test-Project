...
--
-- Host: localhost    Database: savbillpartnermanagement    Table: tblpartners
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblpartners` (
  `PARTNERID` bigint NOT NULL AUTO_INCREMENT,
  ...
  `credit_consume` double(16,6) DEFAULT '0.000000',
  ...
  `commission_interval` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
