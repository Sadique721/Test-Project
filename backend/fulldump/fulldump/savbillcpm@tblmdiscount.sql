...
--
-- Host: localhost    Database: savbillcpm    Table: tblmdiscount
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmdiscount` (
  ...
  KEY `tblmdiscount_ibfk_1` (`MVNOID`),
  KEY `discount_charge_fk` (`BUID`),
  CONSTRAINT `discount_charge_fk` FOREIGN KEY (`BUID`) REFERENCES `tblmbusinessunit` (`businessunitid`),
  CONSTRAINT `tblmdiscount_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
