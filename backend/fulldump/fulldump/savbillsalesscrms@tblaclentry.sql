...
--
-- Host: localhost    Database: savbillsalesscrms    Table: tblaclentry
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblaclentry` (
  ...
  KEY `tblaclentry_role_id_fk` (`roleid`),
  CONSTRAINT `tblaclentry_role_id_fk` FOREIGN KEY (`roleid`) REFERENCES `tblroles` (`roleid`)
