...
--
-- Host: localhost    Database: savbillintegrationsystem    Table: tbltwarehousemanagement
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltwarehousemanagement` (
  ...
  `warehousetype` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `branch_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
