...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tbltcustomer_inventory_file_mapping
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tbltcustomer_inventory_file_mapping`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tbltcustomer_inventory_file_mapping` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `customer_inventory_mapping_id` bigint NOT NULL,
