...
--
-- Host: localhost    Database: savbillintegrationsystem    Table: tblmbillgenfinaldata
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmbillgenfinaldata`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmbillgenfinaldata` (
  ...
  PRIMARY KEY (`sr_no`),
  UNIQUE KEY `tblmbillgenfinaldata_sr_no` (`sr_no`)
