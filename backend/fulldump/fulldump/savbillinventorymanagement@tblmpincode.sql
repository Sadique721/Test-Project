...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmpincode
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmpincode` (
  ...
  KEY `pincode_mvno_id_fk` (`MVNOID`),
  CONSTRAINT `pincode_mvno_id_fk` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
