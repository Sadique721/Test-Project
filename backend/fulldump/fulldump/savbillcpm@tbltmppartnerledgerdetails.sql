...
--
-- Host: localhost    Database: savbillcpm    Table: tbltmppartnerledgerdetails
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tbltmppartnerledgerdetails`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tbltmppartnerledgerdetails` (
  ...
  `gross_offer_price` double(16,6) DEFAULT NULL,
  `is_payment_done_fran` bigint DEFAULT NULL,
  `staff_id` bigint DEFAULT NULL,
  `planid` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `royalty_base_price` double(20,6) DEFAULT '0.000000',
  PRIMARY KEY (`partnerledgerdtls_id`),
  UNIQUE KEY `tbltmpppartnerledgerdetails_id_unq` (`partnerledgerdtls_id`),
  KEY `tbltmppartnerledgerdetails_ibfk_1` (`partner_id`),
  CONSTRAINT `tbltmppartnerledgerdetails_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `tblpartners` (`PARTNERID`)
