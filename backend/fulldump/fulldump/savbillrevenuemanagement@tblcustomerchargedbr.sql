...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tblcustomerchargedbr
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblcustomerchargedbr`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblcustomerchargedbr` (
  ...
  `cumm_revenue` decimal(20,6) DEFAULT NULL,
  ...
  PRIMARY KEY (`dbr_id`),
  UNIQUE KEY `tblcustomerchargedbr_id_unq` (`dbr_id`),
  KEY `idx_customerchargedbr_invoice_startdate` (`invoiceid`,`start_date`)
) ENGINE=InnoDB AUTO_INCREMENT=1703521 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
