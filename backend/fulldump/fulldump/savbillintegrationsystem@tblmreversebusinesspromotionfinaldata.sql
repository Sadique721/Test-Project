...
--
-- Host: localhost    Database: savbillintegrationsystem    Table: tblmreversebusinesspromotionfinaldata
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmreversebusinesspromotionfinaldata`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmreversebusinesspromotionfinaldata` (
  ...
  PRIMARY KEY (`sr_no`),
  UNIQUE KEY `tblmreversebusinesspromotionfinaldata_sr_no` (`sr_no`)
