...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmservicearea
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmservicearea` (
  ...
  KEY `servicearea_mvno_id_fk` (`MVNOID`),
  CONSTRAINT `servicearea_mvno_id_fk` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
