...
--
-- Host: localhost    Database: savbillcpm    Table: tbltbusinessverticalsmapping
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltbusinessverticalsmapping` (
  ...
  KEY `tbltbusinessverticalsmapping_fk1` (`buverticalsid`),
  KEY `tbltbusinessverticalsmapping_fk2` (`region_id`)
