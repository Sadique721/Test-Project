...
--
-- Host: localhost    Database: commongateway    Table: tblmbuildingmanagement
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmbuildingmanagement` (
  `building_mgmt_id` bigint NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=10567 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
