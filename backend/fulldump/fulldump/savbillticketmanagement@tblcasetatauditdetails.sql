...
--
-- Host: localhost    Database: savbillticketmanagement    Table: tblcasetatauditdetails
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblcasetatauditdetails` (
  ...
  `tat_message` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
