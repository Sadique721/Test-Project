...
--
-- Host: localhost    Database: savbillintegrationsystem    Table: tblstaffuser
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblstaffuser` (
  ...
  `availableAmount` decimal(20,0) DEFAULT NULL,
  `lastmodified_on` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `regDate` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `partnerName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updatedatestring` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `branchId` bigint DEFAULT NULL,
  `branchName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parentstaffname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hrms_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lcoid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`staffid`),
  UNIQUE KEY `tblstaffuser_staffid` (`staffid`)
