...
--
-- Host: localhost    Database: savbillpartnermanagement    Table: tblpartnerdetails
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblpartnerdetails`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblpartnerdetails` (
  ...
  PRIMARY KEY (`doc_id`),
  UNIQUE KEY `tblpartnerdetails_doc_id_unq` (`doc_id`)
