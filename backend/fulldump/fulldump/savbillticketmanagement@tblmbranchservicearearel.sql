...
--
-- Host: localhost    Database: savbillticketmanagement    Table: tblmbranchservicearearel
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=822698 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
