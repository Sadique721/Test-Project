...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tbltdebitdocumenttaxrel
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltdebitdocumenttaxrel` (
  ...
  KEY `tbltdebitdocumenttaxrel_debitdocid` (`debitdocumentid`)
) ENGINE=InnoDB AUTO_INCREMENT=56412 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
