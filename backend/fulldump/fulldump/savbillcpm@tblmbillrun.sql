...
--
-- Host: localhost    Database: savbillcpm    Table: tblmbillrun
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmbillrun` (
  ...
  KEY `TBLMBILLRUN_ibfk_1` (`MVNOID`),
  KEY `businessunit_template_management_fk` (`BUID`),
  CONSTRAINT `businessunit_billrun_fk` FOREIGN KEY (`BUID`) REFERENCES `tblmbusinessunit` (`businessunitid`),
  CONSTRAINT `businessunit_template_management_fk` FOREIGN KEY (`BUID`) REFERENCES `tblmbusinessunit` (`businessunitid`),
  CONSTRAINT `TBLMBILLRUN_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
