...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmworkflowaudit
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmworkflowaudit`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmworkflowaudit` (
