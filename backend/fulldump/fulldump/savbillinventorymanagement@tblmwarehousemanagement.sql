...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmwarehousemanagement
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmwarehousemanagement`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmwarehousemanagement` (
  ...
  UNIQUE KEY `tblmwarehousemanagement_warehouse_id_unq` (`warehouse_id`),
  KEY `warehousemanagement_mvno_id_fk` (`mvno_id`),
  KEY `idx_warehouse_deleted_status_mvno` (`is_deleted`,`status`,`mvno_id`),
  KEY `idx_warehouse_active` (`is_deleted`,`status`,`warehouse_id`,`name`),
  CONSTRAINT `warehousemanagement_mvno_id_fk` FOREIGN KEY (`mvno_id`) REFERENCES `tblmmvno` (`MVNOID`)
