...
--
-- Host: localhost    Database: savbillcpm    Table: tbltdebitdocumenttaxrel
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltdebitdocumenttaxrel` (
  `debitdoctaxid` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `tbltdebitdocumenttaxrel_ibfk_1` (`debitdocumentid`),
  KEY `tbltdebitdocumenttaxrel_ibfk_2` (`taxid`),
  CONSTRAINT `tbltdebitdocumenttaxrel_ibfk_1` FOREIGN KEY (`debitdocumentid`) REFERENCES `tbltdebitdocument` (`debitdocumentid`),
  CONSTRAINT `tbltdebitdocumenttaxrel_ibfk_2` FOREIGN KEY (`taxid`) REFERENCES `tblmtax` (`TAXID`)
