...
--
-- Host: localhost    Database: savbillticketmanagement    Table: tblmtatmatrixdetails
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblmtatmatrixdetails`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblmtatmatrixdetails` (
  ...
  `tat_management_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tblmtatmatrixdetails_id_fk` (`tat_management_id`),
  CONSTRAINT `tblmtatmatrixdetails_id_fk` FOREIGN KEY (`tat_management_id`) REFERENCES `tblmmatrix` (`id`)
