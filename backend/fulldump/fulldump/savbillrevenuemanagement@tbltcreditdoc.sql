...
--
-- Host: localhost    Database: savbillrevenuemanagement    Table: tbltcreditdoc
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tbltcreditdoc` (
  ...
  `withdrawcreditdocid` bigint DEFAULT NULL,
  `trialdebitdocid` bigint DEFAULT NULL,
  ...
  KEY `index_creditdoc_custid_status` (`CUSTID`,`STATUS`),
  KEY `index_tbltcreditdoc_custid_status` (`CUSTID`,`STATUS`)
