...
--
-- Host: localhost    Database: savbillticketmanagement    Table: tblcasedocdetails
-- ------------------------------------------------------
-- Server version	8.0.32

--
-- Table structure for table `tblcasedocdetails`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tblcasedocdetails` (
  ...
  PRIMARY KEY (`doc_id`),
  UNIQUE KEY `casedocdetails_doc_id_unq` (`doc_id`)
