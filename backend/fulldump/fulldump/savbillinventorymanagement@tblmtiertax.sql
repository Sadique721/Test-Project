...
--
-- Host: localhost    Database: savbillinventorymanagement    Table: tblmtiertax
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmtiertax` (
  ...
  UNIQUE KEY `tblmtiertax_tiertaxid_unq` (`tiertaxid`),
  KEY `tblmtiertax_taxidfk_1` (`taxid`),
  CONSTRAINT `tblmtiertax_taxidfk_1` FOREIGN KEY (`taxid`) REFERENCES `tblmtax` (`taxid`)
