...
--
-- Host: localhost    Database: savbillcpm    Table: tblmdiscountfieldmapping
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblmdiscountfieldmapping` (
  ...
  KEY `tblmdiscountfieldmapping_ibfk_1` (`DISCOUNTID`),
  CONSTRAINT `tblmdiscountfieldmapping_ibfk_1` FOREIGN KEY (`DISCOUNTID`) REFERENCES `tblmdiscount` (`DISCOUNTID`)
