...
--
-- Host: localhost    Database: savbillsalesscrms    Table: tblnotificationemplate
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblnotificationemplate` (
  ...
  `appendUrl` varchar(528) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`templateid`),
  KEY `eventid_id_fk` (`eventid`),
  CONSTRAINT `eventid_id_fk` FOREIGN KEY (`eventid`) REFERENCES `tblmnotificationevent` (`eventid`)
