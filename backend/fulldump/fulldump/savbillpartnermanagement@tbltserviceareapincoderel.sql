...
--
-- Host: localhost    Database: savbillpartnermanagement    Table: tbltserviceareapincoderel
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=18446 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
