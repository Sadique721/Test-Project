...
--
-- Host: localhost    Database: savbillcpm    Table: tblauditlog
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblauditlog` (
  ...
  KEY `tblauditlog_ibfk_1` (`MVNOID`),
  CONSTRAINT `tblauditlog_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
) ENGINE=InnoDB AUTO_INCREMENT=80278 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
