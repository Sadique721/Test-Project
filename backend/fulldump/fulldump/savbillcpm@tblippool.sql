...
--
-- Host: localhost    Database: savbillcpm    Table: tblippool
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tblippool` (
  ...
  KEY `tblippool_ibfk_1` (`MVNOID`),
  CONSTRAINT `tblippool_ibfk_1` FOREIGN KEY (`MVNOID`) REFERENCES `tblmmvno` (`MVNOID`)
