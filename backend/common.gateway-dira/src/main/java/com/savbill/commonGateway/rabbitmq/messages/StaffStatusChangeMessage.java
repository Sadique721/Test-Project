...
import com.savbill.commonGateway.moules.Template.domain.TemplateNotification;
...
public class StaffStatusChangeMessage {
    ...
    public StaffStatusChangeMessage(String message, TemplateNotification template, String sourceName, StaffUser staffUser , String newStatus, Long buId) {
