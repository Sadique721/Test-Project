...
@Data
@NoArgsConstructor
public class PartnerPojo extends Auditable implements IBaseDto {
    ...
    public PartnerPojo(
            ...
            String partnerType,
            String email,
            Integer parentpartnerid,  // not int
            Boolean isDelete,         // not boolean
            Integer mvnoId,
            Long buId
    ) {
        this.id = id;
        ...
        this.email = email;
        this.parentpartnerid = (parentpartnerid != null) ? parentpartnerid.longValue() : null;
