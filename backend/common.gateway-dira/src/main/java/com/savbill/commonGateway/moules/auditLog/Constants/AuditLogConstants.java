package com.savbill.commonGateway.moules.auditLog.Constants;
...
public class AuditLogConstants {
    ...
    public static final String AUDIT_FOR_COUNTRY = "country";
    ...
    public static final String AUDIT_ENTITY_NAME = "entityName";
}
