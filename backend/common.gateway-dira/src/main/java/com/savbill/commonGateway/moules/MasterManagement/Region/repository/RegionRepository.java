package com.savbill.commonGateway.moules.MasterManagement.Region.repository;
...
public interface RegionRepository extends JpaRepository<Region, Long> , QuerydslPredicateExecutor<Region> {
    ...
    @Query(value = "select count(*) from tbltbusinessverticalsmapping t where t.region_id =:id and t.is_deleted = false",nativeQuery = true)
