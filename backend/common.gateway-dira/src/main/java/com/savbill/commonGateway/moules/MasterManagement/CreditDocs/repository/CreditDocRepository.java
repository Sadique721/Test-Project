package com.savbill.commonGateway.moules.MasterManagement.CreditDocs.repository;



import com.savbill.commonGateway.moules.MasterManagement.CreditDocs.domain.CreditDocument;
...
@Repository
public interface CreditDocRepository extends JpaRepository<CreditDocument
        , Integer>, QuerydslPredicateExecutor<CreditDocument> {
