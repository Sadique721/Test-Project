...
import com.savbill.commonGateway.moules.SettingsManagement.StaffUserManagement.StaffUserPojo;
...
public class StaffUserMessage {
    ...
    private static final String BUSINESSUNITNAME = "buname";
    ...
    public StaffUserMessage(StaffUserPojo user, List<StaffUserServiceAreaMapping> staffUserServiceAreaMappings, List<ServiceAreaDTO> serviceAreaDTOS, List<BusinessUnitDTO> businessUnitDTOS) {
        ...
        for(BusinessUnitDTO businessUnitDTO : businessUnitDTOS){
            ...
            businessUnit.put(BUSINESSUNITNAME, businessUnitDTO.getBuname());
