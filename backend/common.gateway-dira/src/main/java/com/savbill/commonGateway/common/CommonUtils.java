package com.savbill.commonGateway.common;
...
//
    public static Integer getPartnerRoleId(Integer mvnoId) {
        if (PARTNER_ROLE_ID == null) {
            ClientServiceSrv service = SpringContext.getBean(ClientServiceSrv.class);
            ClientService s1 = service.searchByName(CommonConstants.PARAM_PARTNER_OPERATOR_ROLE_ID,mvnoId);
            if (s1 != null) {
