package com.savbill.commonGateway.moules.Communication.Constants;
...
public class CommunicationConstant {
    ...
    public static String COMM_EMAIL_USERNAME = "notification@savbillnettech.com";
    public static String COMM_EMAIL_PASSWORD = "Nat123";

    //SMS CREDENTIALS
    public static String SOURCE = "SAVBILL";
