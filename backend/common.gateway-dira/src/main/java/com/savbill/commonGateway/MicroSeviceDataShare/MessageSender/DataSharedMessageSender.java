package com.savbill.commonGateway.MicroSeviceDataShare.MessageSender;
...
//Teams
    ...
    //bank management
    public String send(SaveBankManagementSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }

    public String send(UpdateBankManagementSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }
    ...
    public String send(SaveInvestmentCodeSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }

    public String send(UpdateInvestmentCodeSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }
    ...
    public String send(SaveSubBusinessUnitSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }

    public String send(UpdateSubBusinessUnitSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }

    //sub businessverticals

    public String send(SaveSubBusinessVerticalsSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }

    public String send(UpdateSubBusinessVerticalsSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }
    ...
    public String send(SaveDepartmentSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }

    public String send(UpdateDepartmentSharedDataMessage message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }
    ...
    public String send(UpdateMvnoData message, String queueName) {
        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, message);
        log.info("Send msg  " + message);
        return "Message Published";
    }*/
