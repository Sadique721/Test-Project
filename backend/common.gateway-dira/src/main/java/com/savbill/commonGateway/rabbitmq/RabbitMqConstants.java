...
public class RabbitMqConstants
{
	...
	public static final String MOBILE_NUMBERS = "MOBILE_NUMBER";
...
//    public static final String QUEUE_SEND_SERIAL_NUMBER = "bss.apigateway.send.serialnumber";
	...
	public static final String QUEUE_CAF_TO_CUSTOMER_DATA_SHARE_COMMONGATEWAY = "queue.caf.to.customer.data.share.commonapigw";
	public static final String QUEUE_TEAM_HIERARCHY_CREATE_DATA_SHARE_COMMONGATEWAY = "queue.hierarchy.create.data.share.commonapigw";
	public static final String QUEUE_TEAM_HIERARCHY_UPDATE_DATA_SHARE_COMMONGATEWAY = "queue.hierarchy.update.data.share.commonapigw";
	public static final String QUEUE_SEND_CREATE_WAREHOUSE_TEAM_MAPPING_DATA_COMMONGATEWAY = "queue.send.create.data.warehouseteammapping.to.commonapigw";
	public static final String QUEUE_SEND_UPDATE_WAREHOUSE_TEAM_MAPPING_DATA_COMMONGATEWAY = "queue.send.update.data.warehouseteammapping.to.commonapigw";
