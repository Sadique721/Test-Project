package com.savbill.commonGateway.core.constants;
...
public class CommonConstants {
    ...
    public static final String APIKEY_HEADER_STRING = "apikey";
    ...
    public static final String UNDERDEVELOPMENT_STATUS = "UnderDevelopment";
    public static final String IS_USED_UNDERDEVELOPMENT_SERVICEAREA = "IS_USED_UNDERDEVELOPMENT_SERVICEAREA";
    ...
    public static final Integer OPEARTION_MVNO_CREATE = 4;
...
//    }
    ...
    public interface CUSTOMER_STATUS {
        ...
        String NOT_SERVICE_READY = "Not Service Ready";
        String RELOCATED = "Relocated";
        String OFFICE_ACCOUNTS = "Office Accounts";
    }
    ...
    public interface MODULE{
        String MODULE_COMMON = "Common Gateway";
    }


    public interface CLASS_NAME_FOR_SEARCH{
        String COUNTRY = "Country";
        String STATE = "State";
        String CITY = "City";
        String PINCODE = "Pincode";
        String AREA = "Area";
        String SERVICE_AREA = "ServiceArea";
        String INVESTMENT_CODE = "InvestmentCode";
        String BUSINESS_UNIT = "BusinessUnit";
        String SUB_BUSINESS_UNIT = "SubBusinesUnit";
        String BANK_MANAGEMENT = "BankManagement";
        String BRANCH_MANAGEMENT = "BranchManagement";
        String REGION_MANAGEMENT = "RegionManagement";
        String BUSINESS_VERTICLE = "BusinessVerticle";
        String SUB_BUSINESS_VERTICLE = "SubBusinessVerticle";
        String DEPARTMENT = "Department";


    }

    public static final String DEFAULT_OTP_PROFILE = "OTP";
