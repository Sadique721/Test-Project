package com.savbill.commonGateway.moules.MasterManagement.InvestmentCode.repository;
...
public interface InvestmentCodeRepository extends JpaRepository<InvestmentCode,Long>, QuerydslPredicateExecutor<InvestmentCode> {
    ...
    Page<InvestmentCode> findAllByIsDeletedIsFalse(Pageable pageable);
    Page<InvestmentCode> findAllByIsDeletedIsFalseAndMvnoIdIn(List<Integer> mvnoId, Pageable pageable);
}
