...
import com.savbill.integrationsystem.core.dto.*;
import com.savbill.integrationsystem.core.dto.*;
import com.savbill.integrationsystem.core.exceptions.DataNotFoundException;
import com.savbill.integrationsystem.core.service.ExBaseService;
...
//    ClientServiceSrv clientServiceSrv;
    ...
    public GenericDataDTO getEntityById(@PathVariable String id, HttpServletRequest req) throws Exception {
        ...
        try {
            ...
            genericDataDTO.setData(service.getEntityById(new Long(id), getMvnoId(authTokenHeader)));
    ...
    public GenericDataDTO save(@RequestBody DTO entityDTO, BindingResult result, HttpServletRequest request) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        genericDataDTO.setResponseCode(HttpStatus.OK.value());
        genericDataDTO.setResponseMessage("Success");
        try {
...
//               ApplicationLogger.logger.debug("Base Controller Error"+result.getFieldErrors());
            ...
            String authTokenHeader = req.getHeader("Authorization");
            DTO dtoData = service.getEntityForUpdateAndDelete(entityDTO.getIdentityKey(), getMvnoId(authTokenHeader));
...
//        this.MAX_PAGE_SIZE = Integer.parseInt(clientServiceSrv.getClientSrvByName(ClientServiceConstant.MAX_PAGE_SIZE).get(0).getValue());
        try {
            ...
            genericDataDTO = service.search(filter.getFilter(), page, pageSize, sortBy, sortOrder, request);
