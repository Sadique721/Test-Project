...
@AllArgsConstructor
@Table(name = "tblmreversebusinesspromotionfinaldata")
public class ReverseBusinessPromotionFinalData implements IBaseData<Long> {
    ...
    public ReverseBusinessPromotionFinalData(LocalDate addedDate, String businessCode,
                                             String icCode,
                                             String branchCode,
                                             String navLedgerId,
                                             Integer serviceAreaId,
                                             Long totalRecords,
                                             Double totalAmount, String transactionType, String serviceAreaName
    ) {
