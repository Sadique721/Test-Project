...
public class CustomerServiceMapping {
...
//    private Long traiRate;
    ...
    public CustomerServiceMapping (Map message){
        if (message.get("ustomerServiceMapping(id") != null)
            this.id = Integer.parseInt(message.get("ustomerServiceMapping(id").toString());
...
//            this.customer = new Customers((Map)message.get("customer"));
        ...
        if (message.get("serviceId") != null)
            this.serviceId = Long.parseLong(message.get("serviceId").toString());
