...
@Entity
@NoArgsConstructor
@Table(name = "tblmapproveremoveinventoryserializeditem")
public class ApproveRemoveInventoryItem {
    @Id
    private Long id;
    ...
    public ApproveRemoveInventoryItem(Map message) {
        ...
        if(message.get("removeFrom")!=null){
            this.removeFrom = message.get("removeFrom").toString();
        }
    }
}
