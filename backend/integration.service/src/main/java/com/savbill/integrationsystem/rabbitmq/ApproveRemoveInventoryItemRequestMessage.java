...
import com.savbill.integrationsystem.InventoryItem.ApproveRemoveInventoryItem;
...
@AllArgsConstructor
@NoArgsConstructor
public class ApproveRemoveInventoryItemRequestMessage {
    ...
    public ApproveRemoveInventoryItemRequestMessage(ApproveRemoveInventoryItem item, String message) {
