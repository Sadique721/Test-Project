...
VALUES (1, 'com.savbill.cpm.model.postpaid.City', 'City', 1, 1);
INSERT INTO tblaclclass (classid, classname, dispname, disporder, operallid)
VALUES (2, 'com.savbill.cpm.model.postpaid.State', 'State', 2, 6);
INSERT INTO tblaclclass (classid, classname, dispname, disporder, operallid)
VALUES (3, 'com.savbill.cpm.model.postpaid.Country', 'Country', 3, 11);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (4, "com.savbill.cpm.model.postpaid.Partner","Partner",4,16);
INSERT INTO tblaclclass (classid, classname, dispname, disporder, operallid)
VALUES (5, 'com.savbill.cpm.model.common.Customers', 'Subscribers', 5, 21);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (6, "com.savbill.cpm.model.radius.Clients","Clients",6,59);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (7, "com.savbill.cpm.model.radius.ClientGroup","Client Group",7,64);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (8, "com.savbill.cpm.model.radius.AccountingProfile","Accounting Profile",8,69);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (9, "com.savbill.cpm.model.radius.RadiusProfile","Policies",9,74);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (10, "com.savbill.cpm.model.radius.AuthResponse","Audit",10,79);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (11, "com.savbill.cpm.model.radius.DbcdrProcessing","Subscriber CDRs",11,84);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (12, "com.savbill.cpm.model.radius.LiveUser","Connected Subscriber",12,89);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (13, "com.savbill.cpm.model.postpaid.PostpaidPlan","Packages",13,94);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (14, "com.savbill.cpm.model.postpaid.Tax","Tax",14,99);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (15, "com.savbill.cpm.model.postpaid.Charge","Charge",15,104);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (16, "com.savbill.cpm.model.postpaid.Discount","Discount",16,109);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (17, "com.savbill.cpm.model.postpaid.PlanService","Service",17,114);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (18, "com.savbill.cpm.modules.qosPolicy.domain.QOSPolicy","QOS Policy",18,119);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (19, "com.savbill.cpm.modules.PriceGroup.domain.PriceBook","Price Book",19,124);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (20, "com.savbill.cpm.modules.ServiceArea.domain.ServiceArea","Service Area",20,129);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (21, "com.savbill.cpm.modules.NetworkDevices.domain.NetworkDevices","Network Devices",21,134);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (22, "com.savbill.cpm.modules.ippool.domain.IPPool","IP Pool",22,139);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (23, "com.savbill.cpm.modules.tickets.domain.Case","Case",23,144);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (24, "com.savbill.cpm.modules.tickets.domain.CaseReason","Case Reason",24,149);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (25, "com.savbill.cpm.model.common.StaffUser","Staff",25,154);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (26, "com.savbill.cpm.modules.Broadcast.domain.Broadcast","Broadcast",26,159);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (27, "com.savbill.cpm.model.postpaid.XsltManagement","XsltManagement",27,164);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (28, "com.savbill.cpm.modules.role.domain.Role","ACL",28,169);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (29, "com.savbill.cpm.modules.Teams.domain.Teams","Teams",29,187);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (30, "com.savbill.cpm.modules.Notification.domain.Notification","Notification",30,192);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (31, "com.savbill.cpm.modules.NetworkDevices.domain.NetworkDevices","Bulk Upload Network Devices",31, 197);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (32, "com.savbill.cpm.modules.tickets.domain.Case","Bulk Upload Case",32, 198);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (33, "com.savbill.cpm.model.common.StaffUser","Manage Profile",33, 199);
insert into tblaclclass (classid,classname,dispname,disporder,operallid)
values (34, "com.savbill.cpm.model.postpaid.CustomerAddress","CustomerAddress",34, 206);
