...
values (35, "com.savbill.cpm.modules.Pincode", "Pincode", 35, 212);
...
#AREA
insert into tblaclclass (classid, classname, dispname, disporder, operallid)
values (36, "com.savbill.cpm.modules.Area", "Area", 36, 217);
...
insert into tblaclclass (classid, classname, dispname, disporder, operallid)
values (37, 'com.savbill.cpm.modules.reports.recentrenewal.queryscript', 'Recent Renewal Report', 37, 222);

insert into tblacloperations (opid, classid, opname) values (222, 37, 'Recent Renewal Report View');

#Charge Details Report
insert into tblaclclass (classid, classname, dispname, disporder, operallid)
values (38, 'com.savbill.cpm.modules.reports.recentrenewal.queryscripts', 'Charge Details Report', 38, 223);
