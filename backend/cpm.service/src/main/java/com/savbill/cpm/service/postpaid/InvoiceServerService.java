...
import com.savbill.cpm.pojo.api.InvoiceServerPojo;
import com.savbill.cpm.repository.postpaid.InvoiceServerRepository;
...
public class InvoiceServerService extends AbstractService<InvoiceServer, InvoiceServerPojo, Integer> {
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.InvoiceServer', '1')")
    public List<InvoiceServer> getAllActiveEntities() {
        return invoiceServerRepository.findAllByStatus("1");
    }

    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.InvoiceServer', '4')")
    public void deleteInvoiceServer(Integer id) throws Exception {
        invoiceServerRepository.deleteById(id);
    }

    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.InvoiceServer', '2')")
