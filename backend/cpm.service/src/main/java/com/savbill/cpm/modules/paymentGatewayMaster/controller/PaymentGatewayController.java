package com.savbill.cpm.modules.paymentGatewayMaster.controller;
...
import com.savbill.cpm.modules.MtnPayment.model.DebitCompletedRequest;
import com.savbill.cpm.modules.MtnPayment.service.MtnPaymentService;
import com.savbill.cpm.modules.PriceGroup.controller.PriceBookController;
import com.savbill.cpm.pojo.CreditDoc.CreditDocUpdateDTO;
import com.savbill.cpm.pojo.api.*;
import com.savbill.cpm.pojo.api.CreditDocumentSearchPojo;
import com.savbill.cpm.pojo.api.SearchPaymentPojo;
import com.savbill.cpm.repository.postpaid.DebitDocDetailRepository;
import com.savbill.cpm.repository.postpaid.DebitDocumentTAXRelRepository;
import com.savbill.cpm.service.common.BatchPaymentService;
...
//    @PreAuthorize("validatePermission(\"" + MenuConstants.SEARCH_CREDIT_NOTE+ "\",\"" + MenuConstants.search_payment+ "\")")
    ...
    public ResponseEntity<?> searchPaymentWithPagination(@ModelAttribute SearchPaymentPojo entity,@RequestParam(name = "isKraSynced", required = false) Boolean isKraSynced, HttpServletRequest req) throws Exception {
