package com.savbill.cpm.modules.Alert.emailSchedular.controller;
...
public class EmailJobSchedulerController {
    ...
    public GenericDataDTO scheduleEmail(@Valid @RequestBody List<SchedulerDTO> scheduleEmailRequest) {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        genericDataDTO.setResponseCode(HttpStatus.OK.value());
        genericDataDTO.setResponseMessage("Success");
        try {
            List<SchedulerDTO> list = schedulerService.scheduleEmail(scheduleEmailRequest);
