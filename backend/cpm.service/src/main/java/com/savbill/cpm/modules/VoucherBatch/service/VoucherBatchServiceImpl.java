package com.savbill.cpm.modules.VoucherBatch.service;
...
import com.savbill.cpm.modules.LocationMaster.service.LocationMasterService;
import com.savbill.cpm.modules.Reseller.domain.Reseller;
import com.savbill.cpm.modules.Reseller.mapper.PageableResponse;
import com.savbill.cpm.modules.Reseller.mapper.WifiUtils;
import com.savbill.cpm.modules.Reseller.service.ResellerService;
...
import com.savbill.cpm.modules.VoucherBatch.module.UpdateVoucherBatchDto;
import com.savbill.cpm.modules.VoucherBatch.module.VoucherBatchDto;
import com.savbill.cpm.modules.VoucherBatch.module.VoucherBatchInfoDto;
...
import com.savbill.cpm.modules.VoucherConfiguration.repository.VoucherConfigurationRepository;
...
public class VoucherBatchServiceImpl implements VoucherBatchService {
	...
	public void generateBatchAndVouchers(VoucherBatchDto voucherBatchDto, Long mvnoId) {
		try{
			...
			{
				voucherService.generateBatch(voucherBatch.getVoucherBatchId(), voucherBatch.getVoucherProfileId(), mvnoId);
			}} catch (Throwable e) {
			throw new RuntimeException(e.getMessage());
		}
	}
