...
import com.savbill.cpm.constants.MapConstants;
...
import com.savbill.cpm.pojo.LocationDto;
import com.savbill.cpm.pojo.LocationPlace;
 ...
 */
    public HashMap getNearbyDevices(LocationVo locationVo) {
        ...
        try {
            ...
            if(!CollectionUtils.isEmpty(networkDevices) && clientServiceSrv.getMvnoIdFromCurrentStaff() != null) {
                networkDevices = networkDevices.stream().filter(netDev -> Objects.equals(netDev.getMvnoId(), clientServiceSrv.getMvnoIdFromCurrentStaff())).collect(Collectors.toList());
            }
