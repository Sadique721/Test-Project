...
public class SearchPartnerCreditDocs {
	...
	private List<PartnerDebitDocument> debitdoclist;
	...
	public List<PartnerDebitDocument> getDebitdoclist() {
		return debitdoclist;
	}

	public void setDebitdoclist(List<PartnerDebitDocument> debitdoclist) {
