...
import com.savbill.cpm.modules.InventoryManagement.InOutMACMapping.*;
import com.savbill.cpm.modules.InventoryManagement.ItemStatusMapping.ItemStatusMapping;
import com.savbill.cpm.modules.InventoryManagement.ItemStatusMapping.ItemStatusMappingRepo;
import com.savbill.cpm.modules.InventoryManagement.NonSerializedItem.NonSerializedItem;
import com.savbill.cpm.modules.InventoryManagement.NonSerializedItem.NonSerializedItemRepository;
import com.savbill.cpm.modules.InventoryManagement.NonSerializedItem.QNonSerializedItem;
...
import com.savbill.cpm.modules.InventoryManagement.product.*;
import com.savbill.cpm.modules.InventoryManagement.outward.*;
...
import com.savbill.cpm.modules.InventoryManagement.warehouse.WareHouseServiceAreaMapping;
    ...
    public GenericDataDTO findItems(Integer pageNumber, Integer customPageSize, String sortBy, Integer sortOrder, SearchItemsPojo search) throws Exception {
        ...
        try {
            ...
            for (ItemDto itemDto : dto) {
                ...
                if (itemDto.getOwnerType().equalsIgnoreCase(CommonConstants.STAFF))
                    itemDto.setOwnerName(staffService.get(itemDto.getOwnerId().intValue()).getUsername());
                else if (itemDto.getOwnerType().equalsIgnoreCase(CommonConstants.WAREHOUSE))
                    itemDto.setOwnerName(warehouseManagementService.getEntityById(itemDto.getOwnerId().longValue()).getName());
                else if (itemDto.getOwnerType().equalsIgnoreCase(CommonConstants.POP))
                    itemDto.setOwnerName(popManagementService.getEntityById(itemDto.getOwnerId().longValue()).getName());
                    ...
                    itemDto.setOwnerName(customersService.get(itemDto.getOwnerId().intValue()).getUsername());
