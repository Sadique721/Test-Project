package com.savbill.cpm.modules.Teams.repository;
...
//    Long findById(List<Long> ids);
    ...
    List<TeamHierarchyMapping> findByTeamIdAndHierarchyId(Integer teamId, Integer hierarchyId);

    List<TeamHierarchyMapping> findAllByHierarchyId(Integer hierarchy_id);
    @Query(value = "SELECT t.hierarchy_id \n" +
            "FROM tbltteamhierarchymapping t \n" +
            "JOIN tblmhierarchy t2 \n" +
