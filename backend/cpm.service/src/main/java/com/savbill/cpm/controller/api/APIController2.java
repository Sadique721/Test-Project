...
public class APIController2 extends ApiBaseController {
    ...
    public ResponseEntity<?> deleteTax(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            TaxService taxService = SpringContext.getBean(TaxService.class);
            Tax tax = taxService.get(id);
            if (tax != null) {
    ...
    public ResponseEntity<?> createPlanService(@Valid @RequestBody PlanPojo pojo) throws Exception {
        ...
        try {
            ...
            pojo = planserviceService.save(pojo);
    ...
    public ResponseEntity<?> updatePlanService(@Valid @RequestBody PlanPojo pojo, @PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            PlanServiceService planserviceService = SpringContext.getBean(PlanServiceService.class);
    ...
    public ResponseEntity<?> deletePlanService(@PathVariable Integer id) throws Exception {
        ...
        try {
            PlanServiceService planserviceService = SpringContext.getBean(PlanServiceService.class);
            PlanService planservice = planserviceService.get(id);
            if (planservice != null) {
    ...
    public ResponseEntity<?> deleteCharge(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            ChargeService chargeService = SpringContext.getBean(ChargeService.class);
            Charge charge = chargeService.get(id);
            if (charge != null) {
    ...
    public ResponseEntity<?> deletePostpaidPlan(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            PostpaidPlanService postpaidPlanService = SpringContext.getBean(PostpaidPlanService.class);
            PostpaidPlan plan = postpaidPlanService.get(id);
            if (plan != null) {
                ...
                postpaidPlanService.deletePostpaidPlan(id);
...
//    }
    ...
    public ResponseEntity<?> getActiveDiscountList() throws Exception {

        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            DiscountService discountService = SpringContext.getBean(DiscountService.class);
            List<Discount> discountList = discountService.getAllEntities();
...
//	}
    ...
    public ResponseEntity<?> getCustomerAddressList(@PathVariable Integer custid) throws Exception {
        ...
        try {
            ...
            Customers customer = customerService.get(custid);
            if (customer != null) {
    ...
    public ResponseEntity<?> deleteCustomerAddress(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            CustomerAddressService customerAddressService = SpringContext.getBean(CustomerAddressService.class);
    ...
    public ResponseEntity<?> deleteRadiusProfile(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            RadiusProfileService radiusProfileService = SpringContext.getBean(RadiusProfileService.class);
            RadiusProfile radiusProfile = radiusProfileService.get(id);
    ...
    public ResponseEntity<?> deleteRadiusProfileCheckItem(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            RadProfileCheckItemService radProfileCheckItemService = SpringContext.getBean(RadProfileCheckItemService.class);
            RadiusProfileCheckItem radiusProfileCheckItem = radProfileCheckItemService.get(id);
    ...
    public ResponseEntity<?> deleteInvoiceServer(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            InvoiceServerService invoiceServerService = SpringContext.getBean(InvoiceServerService.class);
            InvoiceServer invoiceServer = invoiceServerService.get(id);
...
//    }
    ...
    public ResponseEntity<?> searchPayment(@ModelAttribute SearchPaymentPojo entity) throws Exception {
        ...
        try {
            if (entity != null) {
                ...
                List<CreditDocumentPojo> creditDocumentPojoList = creditDocService.convertResponseModelIntoPojo(creditDocService.serachPayment(entity,null).stream().collect(Collectors.toList()));
    ...
    public ResponseEntity<?> deleteStaffUser(@PathVariable Integer id) throws Exception {
        ...
        try {
            StaffUserService staffUserService = SpringContext.getBean(StaffUserService.class);
            StaffUser staffUser = staffUserService.get(id);
            if (staffUser != null) {
...
//    }
    ...
    public ResponseEntity<?> deleteDunningRule(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            DunningRuleService dunningRuleService = SpringContext.getBean(DunningRuleService.class);
            DunningRule dunningRule = dunningRuleService.get(id);
            if (dunningRule != null) {
                ...
                dunningRuleService.deleteDunningRule(id);
...
*/
    ...
    public ResponseEntity<?> deleteLocation(@PathVariable Integer id) throws Exception {
        Integer RESP_CODE = APIConstants.FAIL;
        HashMap<String, Object> response = new HashMap<>();
        try {
            LocationService locationService = SpringContext.getBean(LocationService.class);
    ...
    public ResponseEntity<?> getTaxTierGroups() throws Exception {
        HashMap<String, Object> response = new HashMap<>();
        response.put("data", CommonUtils.getTaxGroupMap());
        return apiResponse(APIConstants.SUCCESS, response);
    }
    ...
    public ResponseEntity<?> getTaxTypes() throws Exception {
        HashMap<String, Object> response = new HashMap<>();
        response.put("data", CommonUtils.getTaxTypeMap());
        return apiResponse(APIConstants.SUCCESS, response);
    }
