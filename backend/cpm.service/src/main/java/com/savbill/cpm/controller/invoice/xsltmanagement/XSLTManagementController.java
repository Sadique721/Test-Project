package com.savbill.cpm.controller.invoice.xsltmanagement;
...
import com.savbill.cpm.service.postpaid.XsltManagementService;
...
public class XSLTManagementController extends BaseController<XsltManagement>{
    ...
    public String edit(@PathVariable Integer id, Model model) {
        model.addAttribute("entity", xsltManagementService.get(id));
        model.addAttribute("pageuri", MODEL_URI_NAME);
        return RETURN_URI_ADD_EDIT;
    }
