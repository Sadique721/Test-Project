...
public class SubscriberJwtAuthorizationFilter extends BasicAuthenticationFilter {

    public SubscriberJwtAuthorizationFilter(AuthenticationManager authenticationManager) {
