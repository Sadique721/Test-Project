package com.savbill.cpm.modules.Voucher.controller;
...
import com.savbill.cpm.modules.Voucher.module.SNMPCounters;
import com.savbill.cpm.modules.Voucher.service.VoucherService;
...
public class BSSVoucherController {
    ...
    public ResponseEntity<Map<String, Object>> validate(@RequestParam(name = "code", required = true) String code, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        ResponseEntity<Map<String, Object>> responseEntity = null;
        try {
            Integer mvnoId = responseController.getMvnoIdFromCurrentStaff();
    ...
    public ResponseEntity<Map<String, Object>> getAllVouchers(PaginationDTO paginationDTO, @RequestParam(name = "resellerId", required = false) Long resellerId, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
...
//		    log.debug("Request to fetch all vouchers");
    ...
    //  @PreAuthorize("@roleAccesses.hasPermission('voucher','readAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> findVouchersByBatchName(PaginationDTO paginationDTO, @RequestParam(name = "batchId", required = true) Long batchId, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
...
//            return responseController.apiResponse(APIConstants.SUCCESS, response);
    ...
    @PreAuthorize("validatePermission(\"" + MenuConstants.SHOW_MANAGE_VOUCHERS + "\")")
    // @PreAuthorize("@roleAccesses.hasPermission('voucher','readAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> findVouchers(PaginationDTO paginationDTO, @RequestParam(name = "batchName", required = false) String batchName, @RequestParam(name = "status", required = true) String status, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        MDC.put(APIConstants.TYPE, APIConstants.TYPE_FETCH);
        try {
            Integer mvnoId = responseController.getMvnoIdFromCurrentStaff();
...
//		    log.debug("Request to fetch all voucher by batch name: " + batchName + " and status: " + status);
    ...
    //  @PreAuthorize("@roleAccesses.hasPermission('voucher','createUpdateAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> changeStatusToActive(@RequestParam(name = "voucherIdList", required = true) List<Long> voucherIdList, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Update");
        MDC.put("userName", getLoggedInUser().getUsername());
...
//		    }
    ...
    // @PreAuthorize("@roleAccesses.hasPermission('voucher','createUpdateAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> changeStatusToBlock(@RequestParam(name = "voucherIdList", required = true) List<Long> voucherIdList, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Update");
        MDC.put("userName", getLoggedInUser().getUsername());
...
//		    }
    ...
    //   @PreAuthorize("@roleAccesses.hasPermission('voucher','createUpdateAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> changeStatusToUnblock(@RequestParam(name = "voucherIdList", required = true) List<Long> voucherIdList, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Update");
        MDC.put("userName", getLoggedInUser().getUsername());
...
//		    }
    ...
    //  @PreAuthorize("@roleAccesses.hasPermission('voucher','createUpdateAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> changeStatusToScrap(@RequestParam(name = "voucherIdList", required = true) List<Long> voucherIdList, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Update");
        MDC.put("userName", getLoggedInUser().getUsername());
...
//		    }
    ...
    //@PreAuthorize("@roleAccesses.hasPermission('voucher','createUpdateAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> sendSms(@RequestParam(name = "code", required = true) String code, @RequestParam(name = "id", required = true) Long id, @RequestParam(name = "countryCode", required = true) String countryCode, @RequestParam(name = "mobileNo", required = true) String mobileNo, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
    ...
    //  @PreAuthorize("@roleAccesses.hasPermission('voucher','readAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> findVouchers(@RequestParam(name = "batchName", required = false) String batchName, @RequestParam(name = "status", required = true) String status, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        MDC.put(APIConstants.TYPE, APIConstants.TYPE_FETCH);
        try {
            Integer mvnoId = responseController.getMvnoIdFromCurrentStaff();
            List<Map<String, String>> dataToExport = voucherService.dataToExport(batchName, status);
    ...
    @PostMapping("/verify")
    //@PreAuthorize("@roleAccesses.hasPermission('voucher','createUpdateAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> verify(@RequestParam(name = "code", required = true) String code, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        ResponseEntity<Map<String, Object>> responseEntity = null;
        try {
            Integer mvnoId = responseController.getMvnoIdFromCurrentStaff();
    ...
    //@PreAuthorize("@roleAccesses.hasPermission('voucher','createUpdateAccess',#request.getHeader('requestFrom'))")
    public ResponseEntity<Map<String, Object>> changeStatus(@RequestParam(name = "voucherId", required = true) Long voucherId, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        ResponseEntity<Map<String, Object>> responseEntity = null;
        try {
            Integer mvnoId = responseController.getMvnoIdFromCurrentStaff();
