package com.savbill.cpm.modules.MtnPayment
...
class request {
    ...
    public static String requestToMTN(String amount , String transactionId , String currency, String fri){
        ...
        Integer exitCode = -1;
        try {
            String url = "curl --tlsv1.2 -H 'Content-Type: application/xml' -v -s -k -u wifi.admin:Wifiadmin@12345 --cacert /home/savbillminss/mTLS_Certs/RootCA.cer --cert /home/savbillminss/mTLS_Certs/mtnsshotspot.cer  --key /home/savbillminss/mTLS_Certs/savbill_server.key -H 'X-lwac-execute-as: ID:bill.mtn/USER' -d";
    ...
    public static String requestToGetBalance(String fri , String transactionId , String currency , String test){
        ...
        try {
            String url = "curl --tlsv1.2 -H 'Content-Type: application/xml' -v -s -k -u wifi.admin:Wifiadmin@12345 -H --cacert /home/savbillminss/mTLS_Certs/RootCA.cer --cert /home/savbillminss/mTLS_Certs/mtnsshotspot.cer  --key /home/savbillminss/mTLS_Certs/savbill_server.key -d '";
