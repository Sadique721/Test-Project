...
public class CustChargeDetailsRevenue {
    ...
    public CustChargeDetailsRevenue(CustChargeDetails custChargeDetails) {
        ...
        if (custChargeDetails.getInstallmentStartDate()!=null) {
            this.installmentStartDate = custChargeDetails.getInstallmentStartDate().toString();
        }
        if (custChargeDetails.getNextInstallmentDate()!=null) {
            this.nextInstallmentDate = custChargeDetails.getNextInstallmentDate().toString();
        }
        if (custChargeDetails.getLastInstallmentDate()!=null) {
            this.lastInstallmentDate = custChargeDetails.getLastInstallmentDate().toString();
        }
