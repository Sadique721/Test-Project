...
public class DownloadBulkPlanServiceImpl implements DownloadBulkPlanService {
    ...
    public Resource writePostpaidPlansToExcel(Integer mvno) throws Exception {
        ...
        addValidationToWorkBook(masterSheet, lastRow, qosPolicyNames);
    ...
    public void addValidationToWorkBook(Sheet masterSheet, int lastRow, List<String> qosPolicyNames) throws Exception {
        Map<String, List<CommonListDTO>> commonList = getCommonList();
...
//        disableColumnEditing(masterSheet, new int[]{0,4}, lastIndex);
    ...
    public Map<String, List<CommonListDTO>> getCommonList() throws Exception {
        Map<String, List<CommonListDTO>> allData = new HashMap<>();
        commonListService.getAllEntities();
