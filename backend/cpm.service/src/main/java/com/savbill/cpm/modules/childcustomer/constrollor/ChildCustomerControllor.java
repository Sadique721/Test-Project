package com.savbill.cpm.modules.childcustomer.constrollor;
...
import com.savbill.cpm.modules.childcustomer.dto.*;
import com.savbill.cpm.modules.childcustomer.dto.ChangePasswordPojo;
import com.savbill.cpm.modules.childcustomer.dto.ChildByParentDTO;
import com.savbill.cpm.modules.childcustomer.dto.ChildCustPojo;
import com.savbill.cpm.modules.childcustomer.dto.CustomPageResponse;
...
public class ChildCustomerControllor {
    ...
    public GenericDataDTO getAll(@RequestParam Integer page,@RequestParam("pagesize") Integer pagesize, HttpServletRequest req) {
        ...
        try {
            Page<ChildCustomer> childCustomers = childCustomerService.getAllChildCustomer(page, pagesize);
...
//        GenericDataDTO response = ne/w GenericDataDTO();
    ...
    public ResponseEntity<?> updateChildPassword(@RequestBody ChangePasswordPojo pojo,
        ...
        try {
            return childCustomerService.updateChildPassword(pojo);
        } catch (Exception e) {
    ...
    public GenericDataDTO getChildByMobileNumber(@RequestParam String mobileNumber,Integer parentId, HttpServletRequest request) {
        ...
        try {
            ...
            List<ChildCustomer> childCustomer = childCustomerService.getchildCustByMobileNumber(mobileNumber,parentId, Long.valueOf(childCustomerSerImpl.getMvnoIdFromCurrentStaff()));
