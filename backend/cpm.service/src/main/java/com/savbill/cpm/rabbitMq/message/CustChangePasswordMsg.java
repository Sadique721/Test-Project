...
@AllArgsConstructor
@NoArgsConstructor
public class CustChangePasswordMsg {
    ...
    public CustChangePasswordMsg(String username, String  mobileNumber, String emailId, String status, Integer mvnoId, String message, TemplateNotification template, String sourceName,Long buId,String password){
