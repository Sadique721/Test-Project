...
import com.savbill.cpm.modules.InventoryManagement.outward.OutwardMapper;
...
public class InOutWardMACMappingController extends ExBaseAbstractController<InOutWardMACMapingDTO> {
    ...
    @Override
    @PostMapping("/save")
    public GenericDataDTO save(@RequestBody InOutWardMACMapingDTO dto, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
