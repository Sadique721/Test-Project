...
import com.savbill.cpm.model.postpaid.QPartnerDebitDocument;
import com.savbill.cpm.pojo.SearchPartnerCreditDocs;
import com.savbill.cpm.pojo.api.PartnerDebitDocumentPojo;
import com.savbill.cpm.pojo.api.SearchPartnerCreditDocsPojo;
import com.savbill.cpm.repository.postpaid.PartnerCreditDocRepository;
...
//    }
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.PartnerCreditDocument', '1')")
...
//    	PageRequest pageRequest = PageRequest.of(pageNumber - 1, pageSize);
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.PartnerCreditDocument', '2')")
