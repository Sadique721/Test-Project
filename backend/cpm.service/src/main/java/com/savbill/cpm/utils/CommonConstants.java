...
public class CommonConstants {
    ...
    public static final String PLAN_GROUP_REGISTRATION_AND_RENEWAL = "Registration and Renewal";
    public static final String PLAN_GROUP_REGISTRATION = "Registration";
    ...
    public static final String CUSTOMER_STATUS_SERVICE_ACTIVATION = "ServiceActivation";
    ...
    public interface CAF_ACTION {
        ...
        String Service_Activation = "Service Activation";
        String Document_Upload_Digital = "Document Upload - Digital";
    }
...
//    }
    ...
    public static String CAF_VISIBILITY_RISTRICT = "CAF_VISIBILITY_RISTRICT";
