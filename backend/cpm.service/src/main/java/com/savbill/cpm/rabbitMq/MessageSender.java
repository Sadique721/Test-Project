...
//import com.savbill.cpm.modules.InventoryManagement.productCategory.ProductCategoryDto;
//import com.savbill.cpm.modules.InventoryManagement.warehouse.WareHouseDto;
//import com.savbill.cpm.pojo.api.CustomerDiscountPojo;
//import com.savbill.cpm.rabbitMq.message.*;
//import com.savbill.cpm.rabbitMq.message.ServiceTerminationMessage;
//import com.savbill.cpm.utils.NMSServiceActivationDTO;
...
//        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, creditNoteMessageIntegrationSystem);
////        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, otherQueueName, message);
...
////        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName,quickInvoicePojoMessage);
...
//        rabbitTemplate.convertAndSend(RabbitMqConstants.SAVBILL_EXCHANGE, queueName, uuid);
