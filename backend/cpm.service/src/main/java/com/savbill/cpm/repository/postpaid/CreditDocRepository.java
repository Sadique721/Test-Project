...
import com.savbill.cpm.core.dto.CreditDocRepositoryCustom;
import com.savbill.cpm.model.common.Customers;
import com.savbill.cpm.model.postpaid.CreditDocument;
import com.savbill.cpm.pojo.NewCustPojos.NewCreditDocPojo;
...
@Repository
public interface CreditDocRepository extends JpaRepository<CreditDocument, Integer>, QuerydslPredicateExecutor<CreditDocument>, CreditDocRepositoryCustom {
...
List<CreditDocument> findAllByCreditdocumentnoIn(List<String> creditDocumentNos);
    ...
    @Query(value = "select * from tbltcreditdoc t where t.CUSTID =:id", nativeQuery = true)
    ...
    @Query("SELECT new com.savbill.cpm.pojo.NewCustPojos.NewCreditDocPojo("+
    ...
    @Query(value = "SELECT CUSTID FROM TBLTCREDITDOC WHERE CREDITDOCID = :creditDocId", nativeQuery = true)
    Optional<Integer> findCustomerIdByCreditDocId(@Param("creditDocId") Integer creditDocId);
