package com.savbill.cpm.modules.VoucherConfiguration.controller;
...
import com.savbill.cpm.modules.VoucherConfiguration.service.VoucherConfigurationService;
...
@RestController
@RequestMapping("/api/v1/cpm/voucherManagement")
public class BSSVoucherConfigurationController {
   ...
   // @PreAuthorize("validatePermission(\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ALL +"\",\"" + AclConstants.OPERATION_VOUCHER_CONFIG_VIEW +"\")")
    ...
    public ResponseEntity<Map<String, Object>> getAll(PaginationDTO paginationDTO, @RequestParam(name = "name", required = false) String name, @RequestParam(name = "locationId", required = false) Long locationId, HttpServletRequest request) {
        ...
        try {
            Integer mvnoId =  apiResponseController.getMvnoIdFromCurrentStaff();
...
//    @PreAuthorize("validatePermission(\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ALL +"\",\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ADD +"\")")
    ...
    public ResponseEntity<Map<String, Object>> create(@RequestBody VoucherConfigDto voucherConfigDto, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Create");
        MDC.put("userName", getLoggedInUser().getUsername());
...
//    @PreAuthorize("validatePermission(\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ALL +"\",\"" + AclConstants.OPERATION_VOUCHER_CONFIG_EDIT +"\")")
    ...
    public ResponseEntity<Map<String, Object>> update(@RequestBody UpdateVoucherConfigDto voucherConfigDto, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Update");
        MDC.put("userName", getLoggedInUser().getUsername());
...
//    @PreAuthorize("validatePermission(\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ALL +"\",\"" + AclConstants.OPERATION_VOUCHER_CONFIG_DELETE +"\")")
    ...
    public ResponseEntity<Map<String, Object>> delete(@RequestParam(name = "configId", required = true) Long configId, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Delete");
        MDC.put("userName", getLoggedInUser().getUsername());
    ...
    @GetMapping("/findById")
   // @PreAuthorize("validatePermission(\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ALL +"\",\"" + AclConstants.OPERATION_VOUCHER_CONFIG_VIEW +"\")")
    public ResponseEntity<Map<String, Object>> get(@RequestParam(name = "configId", required = true) Long configId, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
          TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Fetch");
        MDC.put("userName", getLoggedInUser().getUsername());
 ...
 //   @PreAuthorize("validatePermission(\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ALL +"\",\"" + AclConstants.OPERATION_VOUCHER_CONFIG_VIEW +"\")")
    public ResponseEntity<Map<String, Object>> getByName(PaginationDTO paginationDTO, @RequestParam(name = "name", required = false) String name, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Fetch");
        MDC.put("userName", getLoggedInUser().getUsername());
    ...
    public ResponseEntity<Map<String, Object>> updateVoucherConfigStatus(@RequestParam(name = "id", required = true) Long id, @RequestParam(name = "status", required = true) String status, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Update");
        MDC.put("userName", getLoggedInUser().getUsername());
 ...
 //   @PreAuthorize("validatePermission(\"" + AclConstants.OPERATION_VOUCHER_CONFIG_ALL +"\",\"" + AclConstants.OPERATION_VOUCHER_CONFIG_VIEW +"\")")
    public ResponseEntity<Map<String, Object>> findVoucher(@RequestParam(name = "voucherName", required = false) String voucherName, @RequestParam(name = "voucherCodeFormat", required = false) String voucherCodeFormat, HttpServletRequest request) {
        Map<String, Object> response = new HashMap<>();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Fetch");
        MDC.put("userName", getLoggedInUser().getUsername());
