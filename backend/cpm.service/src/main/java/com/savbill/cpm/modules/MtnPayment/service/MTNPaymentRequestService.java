...
public class MTNPaymentRequestService {
    ...
    public String requestToMTN(String amount , String transactionId , String currency){
        ...
        Integer exitCode = -1;
        try {
            String url = "curl --tlsv1.2 -ivk  -H 'Content-Type: application/xml'  -v -s -k -u wifi.admin:Wifiadmin@12345 -H --cacert /home/savbillminss/mTLS_Certs/certificate_chain2.cer --cert /home/savbillminss/mTLS_Certs/mtnsshotspot.cer  --key /home/savbillminss/mTLS_Certs/savbill_server.key -H 'X-lwac-execute-as: ID:490001/ID' -d";
