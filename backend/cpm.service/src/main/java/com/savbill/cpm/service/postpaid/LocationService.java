...
import com.savbill.cpm.pojo.api.LocationPojo;
import com.savbill.cpm.repository.postpaid.LocationRepository;
...
public class LocationService extends AbstractService<Location, LocationPojo, Integer> {
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.Location', '1')")
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.Location', '2')")
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.Location', '4')")
