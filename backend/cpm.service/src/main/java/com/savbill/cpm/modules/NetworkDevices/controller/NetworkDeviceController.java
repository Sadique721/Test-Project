package com.savbill.cpm.modules.NetworkDevices.controller;
...
import com.savbill.cpm.modules.NetworkDevices.domain.Oltslots;
...
//        return super.getAllWithoutPagination();
    ...
    @Override
    public GenericDataDTO update(@Valid @RequestBody NetworkDeviceDTO entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        MDC.put("type", "Update");
    ...
    @Override
    public GenericDataDTO save(@Valid @RequestBody NetworkDeviceDTO entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        MDC.put("type", "Create");
        try{
    ...
    public GenericDataDTO availableParents(@RequestParam Long id) {
        MDC.put("type", "Fetch");
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        try {
