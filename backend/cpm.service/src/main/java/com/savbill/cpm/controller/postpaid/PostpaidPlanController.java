...
public class PostpaidPlanController extends BaseController<PostpaidPlan>{
    ...
    TreeMap<String, String> getStatusMap(){
    	return CommonUtils.getPlanStatusMap();
    }
    
    @ModelAttribute("planGroupMap")
    TreeMap<String, String> gegetPlanGroupOptionMap(){
    	return CommonUtils.getPlanGroupOptionMap();
    }
    ...
    TreeMap<String, String> getPlanCategoryMap(){
    	return CommonUtils.getPlanCategoryMap();
    }
    
    @ModelAttribute("quotaUnitMap")
    TreeMap<String, String> getQuotaUnitMap(){
    	return CommonUtils.getQuotaUnitMap();
    }
    ...
    TreeMap<Integer, String> getBillingCycleMap(){
    	return CommonUtils.getBillingCycleMap();
    }
    ...
    TreeMap<String, String> getPlanTypeMap(){
    	return CommonUtils.getPostpaidPlanTypeMap();
    }
...
//    
    ...
    public String edit(@PathVariable Integer id, Model model) throws Exception{
    	PostpaidPlan entity = entityService.getPostpaidPlanForEdit(id);
    ...
    public String delete(@PathVariable Integer id,final RedirectAttributes ra) throws Exception{
    	entityService.deletePostpaidPlan(id);
