package com.savbill.cpm.modules.ServiceArea.controller;
...
//        + MenuConstants.PostpaidCustomers.POSTPAID_CUSTOMER_SERVICE_MANAGEMENT+ "\")")
    ...
    public GenericDataDTO getAllServicesByServiceAreaId(@RequestBody List<Integer> serviceAreaId, HttpServletRequest req){
        ...
        try {
            genericDataDTO.setResponseCode(HttpStatus.OK.value());
            genericDataDTO.setResponseMessage("Success");
            genericDataDTO.setDataList(serviceAreaService.getAllServicebyServiceAreaId(serviceAreaId,false));
    ...
    public GenericDataDTO getAllServicesByServiceAreaIdForCWSC(@RequestBody List<Integer> serviceAreaId, HttpServletRequest req){
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        TraceContext traceContext = tracer.currentSpan().context();
        MDC.put("type", "Fetch");
        MDC.put("userName", getLoggedInUser().getUsername());
        ...
        try {
            genericDataDTO.setResponseCode(HttpStatus.OK.value());
            genericDataDTO.setResponseMessage("Success");
            genericDataDTO.setDataList(serviceAreaService.getAllServicebyServiceAreaId(serviceAreaId,true));
            RESP_CODE = APIConstants.NOT_FOUND;
            logger.info(LogConstants.REQUEST_FROM + req.getHeader("requestFrom") + LogConstants.REQUEST_FOR +"fetch Service area list" + LogConstants.REQUEST_BY + getLoggedInUser().getUsername()+ LogConstants.LOG_STATUS +LogConstants.LOG_NOT_FOUND + LogConstants.LOG_INFO + LogConstants.LOG_NO_RECORD_FOUND + LogConstants.LOG_STATUS_CODE + RESP_CODE);
        } catch (Exception ex) {
            genericDataDTO = new GenericDataDTO();
