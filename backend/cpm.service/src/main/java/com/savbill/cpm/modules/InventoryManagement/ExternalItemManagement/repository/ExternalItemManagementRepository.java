package com.savbill.cpm.modules.InventoryManagement.ExternalItemManagement.repository;
...
public interface ExternalItemManagementRepository extends JpaRepository<ExternalItemManagement, Long>, QuerydslPredicateExecutor<ExternalItemManagement> {
    @Query(nativeQuery = true, value = "select * from tbltexternalitemmanagement t where t.product_id =:id")
