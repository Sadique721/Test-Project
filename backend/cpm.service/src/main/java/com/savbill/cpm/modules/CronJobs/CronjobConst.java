...
public class CronjobConst {
    ...
    public static final String TIME_FOR_KRA_CUSTOMER_SYNC = "cronJobTimeForKRACustomerSync";
    public static final String TIME_FOR_KRA_PLAN_SYNC = "cronJobTimeForKRAPlanSync";
    ...
    public interface SCHEDULER_AUDIT {
        ...
        public static final String TIME_FOR_KRA_CUSTOMER_SYNC_SCHEDULER = "KRA Customer Sync Scheduler";
        public static final String TIME_FOR_KRA_PLAN_SYNC_SCHEDULER = "KRA Plan Sync Scheduler";
    }
