package com.savbill.cpm.modules.CustomerDBR.domain;
...
@Data
@Entity
@Table(name = "tblcustomerchargedbr")
public class CustomerChargeDBR implements IBaseData2 {
    @Id
    ...
    @Column(name = "cust_inv_mapping_id")
    Long custInvMappingId;
