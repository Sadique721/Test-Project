...
import com.savbill.cpm.pojo.api.LeadReasonMgmtWfDTO;
...
//    }
    ...
    public GenericDataDTO approveLeadQuotation(@RequestBody LeadQuotationWfDTO leadQuotationWfDTO) {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        try {
            genericDataDTO.setResponseCode(APIConstants.SUCCESS);
            genericDataDTO.setResponseMessage("Assigned to next staff");
            ...
            genericDataDTO.setCurrentPageNumber(1);
            genericDataDTO.setTotalPages(1);
            return hierarchyService.approveLeadQuotation(leadQuotationWfDTO, genericDataDTO);
    ...
    public GenericDataDTO assignFromStaffListForLeadQuotation(@RequestParam(name = "nextAssignStaff") Integer nextAssignStaff, @RequestParam(name = "eventName") String eventName, @RequestBody LeadQuotationWfDTO leadQuotationWfDTO) {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        try {
            genericDataDTO.setResponseCode(APIConstants.SUCCESS);
            genericDataDTO.setResponseMessage("Assigned to next staff");
            genericDataDTO.setData(hierarchyService.assignFromStaffListForLeadQuotation(nextAssignStaff, eventName, leadQuotationWfDTO));
            genericDataDTO.setTotalRecords(0);
            genericDataDTO.setPageRecords(0);
            genericDataDTO.setCurrentPageNumber(1);
            genericDataDTO.setTotalPages(1);
