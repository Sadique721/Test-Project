...
@Data
public class MvnoExpiryMessage {
    ...
    public MvnoExpiryMessage(StaffUser staffUser , MvnoDocDetails mvnoDocDetails , String ccEmail , boolean isEmailSend, boolean isSmsSend) {
