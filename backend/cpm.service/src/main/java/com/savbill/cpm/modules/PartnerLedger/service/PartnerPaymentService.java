...
import com.savbill.cpm.MicroSeviceDataShare.SavePartnerPaymentMessage;
...
import com.savbill.cpm.modules.PartnerLedger.model.PartnerLedgerGetDTO;
...
import com.savbill.cpm.pojo.api.CustomerCafAssignmentPojo;
...
import com.savbill.cpm.service.postpaid.PartnerCommissionService;
import com.savbill.cpm.service.postpaid.PartnerService;
import com.savbill.cpm.service.postpaid.TempPartnerLedgerDetailsRepository;
...
public class PartnerPaymentService extends ExBaseAbstractService<PartnerPaymentDTO, PartnerPayment, Long> {
    ...
    public PartnerPaymentDTO addBalance(PartnerLedgerBalanceDTO dto) throws Exception {
        ...
        Partner partner = partnerService.get(dto.getPartner_id());
...
//                messageSender.send(savePartnerPaymentMessage, SharedDataConstants.QUEUE_PARTNER_APPROVE_PAYMENT_SHARE_REVENUE);
    ...
    public GenericDataDTO getAllPartnerPayment(List<GenericSearchModel> filters, Integer page, Integer pageSize, String sortBy, Integer sortOrder,String requestFrom) {
        PageRequest pageRequest = generatePageRequest(page, pageSize, "paymentdate", CommonConstants.SORT_ORDER_DESC);
        QPartnerPayment qPartnerPayment = QPartnerPayment.partnerPayment;
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        ...
        else
        {
            ...
            {
                if (getMvnoIdFromCurrentStaff() != 1 && getBUIdsFromCurrentStaff() != null && getBUIdsFromCurrentStaff().isEmpty())
                    booleanExpression = booleanExpression.and(qPartnerPayment.partner.mvnoId.in(1, getMvnoIdFromCurrentStaff()));
                else if (getMvnoIdFromCurrentStaff() != 1 && getBUIdsFromCurrentStaff() != null && getBUIdsFromCurrentStaff().size() > 0) {
                    booleanExpression = booleanExpression.and(qPartnerPayment.partner.mvnoId.eq(getMvnoIdFromCurrentStaff()).and(qPartnerPayment.partner.buId.in(getBUIdsFromCurrentStaff())));
                }
            }
...
//        }
    ...
    //         creditDocument.setPaytype(com.savbill.cpm.modules.subscriber.model.Constants.ADVANCE);
