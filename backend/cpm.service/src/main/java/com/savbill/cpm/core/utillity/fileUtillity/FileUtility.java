package com.savbill.cpm.core.utillity.fileUtillity;
...
//        path="D:\\";
    ...
    public String saveFileToServerRejectedCafDoc(MultipartFile argFile, String path, Integer mvnoId) throws IOException {
        String SUBMODULE = MODULE + " [saveFileToServer()] ";
        Assert.notNull(path, "Path should not be empty");
        String fileName = "CafImage";
        int allowedFileSizeInKB = clientService.getByNames(DocumentConstants.ALLOWED_REJECTED_CAF_DOCUMENT_SIZE, mvnoId) != null ? Integer.parseInt(clientService.getByNames(DocumentConstants.ALLOWED_REJECTED_CAF_DOCUMENT_SIZE, mvnoId).getValue()) : 500;
