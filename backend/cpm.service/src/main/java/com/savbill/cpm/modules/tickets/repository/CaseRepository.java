...
public interface CaseRepository extends JpaRepository<Case, Long>, QuerydslPredicateExecutor<Case> {
    ...
    @Query(value = "\t\tselect * from   tblcases where case_status !='Resolved' and case_status!='Closed' and case_status!='rejected' and final_resolved_by_id IS null and final_closed_by_id  is null",nativeQuery = true)
