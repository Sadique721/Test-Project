package com.savbill.cpm.modules.Alert.emailSchedular.service;
...
import com.savbill.cpm.modules.Alert.emailSchedular.job.EmailJob;
import com.savbill.cpm.modules.Alert.emailSchedular.mapper.SchedularMapper;
import com.savbill.cpm.modules.Alert.emailSchedular.repository.SchedularRepository;
import com.savbill.cpm.modules.Template.model.TemplateDTO;
import com.savbill.cpm.modules.Template.service.TemplateService;
...
public class SchedulerService extends ExBaseAbstractService<SchedulerDTO, Scheduler, Long> {
    ...
    public void sendEmail(List<Customers> customers,Long template_id,String subejct) throws Exception {
        ...
        if(customers!=null && customers.size()>0) {
            TemplateDTO template = templateService.getEntityById(template_id);
