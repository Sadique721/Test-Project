...
public class TicketAssignMessege {
    ...
    public TicketAssignMessege(String mobileNumber, String emailId, String message, TemplateNotification template, String parentStaffPersonName, String staffPersonName, String assigndatetime, String eventName, Integer mvnoId, TicketTatAudits tatAudits,Long buId) {
        this.setMessage(message);
        this.setSourceName(sourceName);
        this.setEmailTemplate(template.getEmailTemplateData());
        this.setSmsTemplate(template.getSmsTemplateData());
