...
//import com.savbill.cpm.modules.ResolutionReasons.service.ResolutionReasonsService;
...
//import com.savbill.cpm.modules.TicketFollowUp.Service.TicketFollowUpService;
...
//import com.savbill.cpm.modules.tickets.domain.*;
//import com.savbill.cpm.modules.tickets.mapper.CaseMapper;
//import com.savbill.cpm.modules.tickets.mapper.CaseUpdateDetailsMapper;
//import com.savbill.cpm.modules.tickets.mapper.CaseUpdateMapper;
//import com.savbill.cpm.modules.tickets.model.*;
//import com.savbill.cpm.modules.tickets.repository.*;
//import com.savbill.cpm.pojo.TimeUnitWithTotal;
...
//                        buId = getBUIdsFromCurrentStaff().get(0);
//                    }
//                    TicketAssignMessege ticketAssignMessege = new TicketAssignMessege(username, mobileNumber, emailId, mvnoId, RabbitMqConstants.TICKET_ASSIGN_SUCCESS, optionalTemplate.get(), RabbitMqConstants.SOURCE_NAME_SAVBILL_BSS_GATEWAY, caseNumber, name, folleoupdateAndTime, staffusername,altEmail,serialNumber,buId);
//                    Gson gson = new Gson();
...
//            if (optionalTemplate.isPresent()) {
//                if (optionalTemplate.get().isSmsEventConfigured() || optionalTemplate.get().isEmailEventConfigured()) {
//                    TicketAssignMessege ticketAssignMessege = new TicketAssignMessege(username, mobileNumber, emailId, mvnoId, RabbitMqConstants.TICKET_ASSIGN_SUCCESS, optionalTemplate.get(), RabbitMqConstants.SOURCE_NAME_SAVBILL_BSS_GATEWAY, caseNumber, name, folleoupdateAndTime, staffusername);
//                    Gson gson = new Gson();
//                    gson.toJson(ticketAssignMessege);
//                    messageSender.send(ticketAssignMessege, RabbitMqConstants.QUEUE_TICKET_ASSIGN_TEAM_SUCCESS);
//                }
...
//            if (optionalTemplate.isPresent()) {
//                if (optionalTemplate.get().isSmsEventConfigured() || optionalTemplate.get().isEmailEventConfigured()) {
//                    CustTicketCloseMsg custTicketCloseMsg = new CustTicketCloseMsg(username, mobileNumber, emailId, status, mvnoId, caseNumber, RabbitMqConstants.CUSTOMER_TICKET_CLOSE_EVENT, optionalTemplate.get(), RabbitMqConstants.SOURCE_NAME_SAVBILL_BSS_GATEWAY,buId);
//                    Gson gson = new Gson();
