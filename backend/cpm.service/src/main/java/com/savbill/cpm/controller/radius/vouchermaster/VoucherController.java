package com.savbill.cpm.controller.radius.vouchermaster;
...
import com.savbill.cpm.service.radius.VoucherBatchService;
import com.savbill.cpm.service.radius.VoucherMasterService;
...
public class VoucherController  extends BaseController<VoucherMaster> {
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.radius.VoucherMaster', '1')")
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.radius.VoucherMaster', '2')")
    ...
    public String singleFileUpload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                voucherMaster.setPlan (planService.get((Integer.valueOf(customer[1]))));
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.radius.VoucherMaster', '4')")
