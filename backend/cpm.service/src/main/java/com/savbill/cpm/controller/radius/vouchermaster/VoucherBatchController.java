...
import com.savbill.cpm.service.radius.PlanService;
...
public class VoucherBatchController extends BaseController<VoucherBatch> {
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.radius.VoucherBatch', '1')")
...
//        model.addAttribute("VoucherMasterPlanList", planService.getAllPlan());
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.radius.VoucherBatch', '2')")
...
//    }
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.radius.VoucherBatch', '4')")
