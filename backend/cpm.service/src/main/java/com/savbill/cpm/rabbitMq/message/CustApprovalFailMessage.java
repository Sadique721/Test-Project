...
//    }
    ...
    public CustApprovalFailMessage(String username, String countryCode, String mobileNumber, String emailId, Integer mvnoId, String message, TemplateNotification template, String sourceName, String approverTeam, Long buId,Double remainingAmount, String currency){
