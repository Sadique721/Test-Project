...
import com.savbill.cpm.model.postpaid.CustSpecialPlanMappping;
...
public interface CustSpecialPlanMapppingRepository extends JpaRepository<CustSpecialPlanMappping, Integer>, QuerydslPredicateExecutor<CustSpecialPlanMappping>{
	...
	@Query(value = "select t.specialplanid  from tblmcustspecialplanrel t where t.normalplanid in (:planId)",nativeQuery = true)
