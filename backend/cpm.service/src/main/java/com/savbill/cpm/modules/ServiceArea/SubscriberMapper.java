package com.savbill.cpm.modules.ServiceArea;
...
import com.savbill.cpm.utils.StatusMapperUtil;
        ...
        try {
            if (null != customers) {
                ...
                if (null != customers.getSalesrep()) {
                    StaffUser staffUser = staffUserService.get(customers.getSalesrep().getId());
                    if (null != staffUser) {
                ...
                if (null != customers.getPartner()) {
                    Partner partner = partnerService.get(customers.getPartner().getId());
                    if (null != partner) {
...
//                }
                ...
                if (null != customers.getDefaultpoolid()) {
                    try {
                        IPPoolDTO ipPool = ipPoolService.getEntityById(customers.getDefaultpoolid());
                        if (null != ipPool) {
