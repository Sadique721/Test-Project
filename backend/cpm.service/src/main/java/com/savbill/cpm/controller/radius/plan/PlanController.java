package com.savbill.cpm.controller.radius.plan;
...
public class PlanController extends BaseController<Plan> {
    ...
    public String add(Model model) {
        ...
        model.addAttribute("planTypeMap", CommonUtils.getPlanTypeMap());
        model.addAttribute("planStatusMap", CommonUtils.getCGStatusMap());
