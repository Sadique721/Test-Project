...
import com.savbill.cpm.model.postpaid.QTrialDebitDocument;
import com.savbill.cpm.model.postpaid.TrialDebitDocument;
import com.savbill.cpm.pojo.SearchTrialDebitDocs;
import com.savbill.cpm.pojo.api.SearchTrialDebitDocsPojo;
import com.savbill.cpm.pojo.api.TrialDebitDocumentPojo;
import com.savbill.cpm.repository.postpaid.TrialDebitDocRepository;
...
public class TrialDebitDocService extends AbstractService<TrialDebitDocument, TrialDebitDocumentPojo, Integer> {
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.TrialDebitDocument', '1')")
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.postpaid.TrialDebitDocument', '2')")
