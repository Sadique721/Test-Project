...
@AllArgsConstructor
@NoArgsConstructor
public class CustAddressShiftingMsg {
    ...
    public CustAddressShiftingMsg(String username, String  mobileNumber, String emailId, String status, Integer mvnoId, String message, TemplateNotification template, String sourceName,Long buId){
