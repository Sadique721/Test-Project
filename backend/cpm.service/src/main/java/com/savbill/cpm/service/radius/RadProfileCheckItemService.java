...
import com.savbill.cpm.pojo.api.CheckItemReplyItemPojo;
import com.savbill.cpm.pojo.api.RadiusProfileCheckItemPojo;
import com.savbill.cpm.repository.radius.RadProfCheckItemRepository;
...
public class RadProfileCheckItemService extends AbstractService<RadiusProfileCheckItem, RadiusProfileCheckItemPojo, Integer> {
    ...
    @PreAuthorize("hasPermission('com.savbill.cpm.model.radius.RadiusProfile', '2')")
