package com.savbill.cpm.modules.integrations.NexgeVoice.service;
...
import com.savbill.cpm.modules.integrations.NexgeVoice.constants.NexgeVoiceProvisionConstants;
import com.savbill.cpm.modules.integrations.NexgeVoice.model.*;
import com.savbill.cpm.modules.integrations.NexgeVoice.model.*;
import com.savbill.cpm.modules.subscriber.model.CustomerPlansModel;
import com.savbill.cpm.modules.subscriber.model.CustomerVoiceDetailsDTO;
                ...
                if (null != activePLanList && 0 < activePLanList.size()) {
                    ...
                    if (null != dataPlanList && 0 < dataPlanList.size()) {
                        for (CustomerPlansModel plansModel : dataPlanList) {
                            PostpaidPlan plan = planService.get(plansModel.getPlanId());
