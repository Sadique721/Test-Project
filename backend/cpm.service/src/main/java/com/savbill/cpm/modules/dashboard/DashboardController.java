...
//            genericDataDTO.setDataList(dashboardService.wareHouseAndProductWiseInventories(mvnoId));
    ...
    public GenericDataDTO getPlanApprovalsList(@RequestBody PaginationRequestDTO paginationRequestDTO, HttpServletRequest req) {
        ...
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        try {
            return postpaidPlanService.getPlanApprovalsList(paginationRequestDTO.getFilters(), paginationRequestDTO.getPage(), paginationRequestDTO.getPageSize(), paginationRequestDTO.getSortBy(), paginationRequestDTO.getSortOrder());
        } catch (Exception ex) {
            genericDataDTO.setResponseMessage(ex.getMessage());
            genericDataDTO.setResponseCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
            Integer RESP_CODE = APIConstants.INTERNAL_SERVER_ERROR;
    ...
    public GenericDataDTO getPlanGroupApprovalsList(@RequestBody PaginationRequestDTO paginationRequestDTO, HttpServletRequest req) {
        ...
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        try {
            return planGroupService.getPlanGroupApprovalsList(paginationRequestDTO.getFilters(), paginationRequestDTO.getPage(), paginationRequestDTO.getPageSize(), paginationRequestDTO.getSortBy(), paginationRequestDTO.getSortOrder());
        } catch (Exception ex) {
            genericDataDTO.setResponseMessage(ex.getMessage());
            genericDataDTO.setResponseCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
            Integer RESP_CODE = APIConstants.INTERNAL_SERVER_ERROR;
...
//    }
    ...
    @GetMapping("/myTaskCounts")
    public GenericDataDTO getMyTaskCounts(HttpServletRequest req) {
        ...
        try {
            ...
            Map<String, Integer> counts = dashboardService.getAllCounts(auth,getLoggedInUser().getStaffId());
