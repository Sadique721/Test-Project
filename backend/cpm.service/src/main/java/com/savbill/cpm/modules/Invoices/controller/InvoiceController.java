package com.savbill.cpm.modules.Invoices.controller;
...
import com.savbill.cpm.pojo.api.StartDateEndDatePojo;
...
//        HashMap<String, Object> response = new HashMap<>();
    ...
    public GenericDataDTO approveDebitDoc(@RequestParam(name = "invoiceId") Long invoiceId, @RequestParam(name = "isApproveRequest") boolean isApproveRequest, @RequestParam(name = "remark") String remark, HttpServletRequest req) {
        MDC.put("type", "Crete");
        Integer RESP_CODE = APIConstants.FAIL;
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        try {
            genericDataDTO=debitDocService.approveDebitDoc(invoiceId, isApproveRequest, remark);
