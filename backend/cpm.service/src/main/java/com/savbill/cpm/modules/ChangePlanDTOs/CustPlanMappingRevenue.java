...
public class CustPlanMappingRevenue {
    ...
    public CustPlanMappingRevenue(Integer custPlanMappingId,LocalDateTime endDate,LocalDateTime expirydate ,String custPlanStatus){
    ...
    public CustPlanMappingRevenue(Integer custPlanMappingId,LocalDateTime endDate,LocalDateTime expirydate ,String custPlanStatus, LocalDateTime startdate){
