...
@AllArgsConstructor
@NoArgsConstructor
public class CustServiceInActiveMsg {
    ...
    public CustServiceInActiveMsg(String username, String  mobileNumber, String emailId, String status, Integer mvnoId, String message, TemplateNotification template, String sourceName,Long buId){
