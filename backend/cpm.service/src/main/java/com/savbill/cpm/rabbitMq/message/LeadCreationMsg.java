...
public class LeadCreationMsg {
    ...
    public LeadCreationMsg(String firstname, String  mobileNumber, String emailId, String leadNo, Integer mvnoId, String message, TemplateNotification template, String sourceName, Integer buId){
