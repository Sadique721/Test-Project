package com.savbill.cpm.modules.TimeBasePolicy.repository;
...
public interface TimeBasePolicyRepository extends JpaRepository<TimeBasePolicy, Long> , QuerydslPredicateExecutor<TimeBasePolicy> {
    ...
    @Query(value = "select policy_name from tblmpostpaidplan t1 where t1.policy_id =:id", nativeQuery = true)
    String findPolicyName(@Param("id")Integer id);
}
