package com.savbill.cpm.modules.partnerdocDetails.Controller;
...
import com.savbill.cpm.modules.partnerdocDetails.Service.PartnerDocDetailsService;
import com.savbill.cpm.modules.partnerdocDetails.model.PartnerDocDeleteModel;
...
public class PartnerDocDetailsController extends ExBaseAbstractController<PartnerdocDTO> {
    ...
    public GenericDataDTO deletePartnerDoc(@RequestBody PartnerDocDeleteModel partnerDocDeleteModel,HttpServletRequest req) {
        ...
        MDC.put("userName", partnerService.getLoggedInUser().getFirstName());
        MDC.put(LogConstants.TRACE_ID, req.getHeader(LogConstants.TRACE_ID));
        MDC.put("spanId",traceContext.spanIdString());        String name=partnerService.get(partnerDocDeleteModel.getPartnerId()).getName();
