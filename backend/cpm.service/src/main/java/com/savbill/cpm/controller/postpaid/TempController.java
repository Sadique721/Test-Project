...
import com.savbill.cpm.pojo.InternationalizationPojo;
import com.savbill.cpm.pojo.XMLRequest;
...
public class TempController extends BaseController<Tax>{
    ...
    TreeMap<String, String> getTaxTypeMap(){
    	return CommonUtils.getTaxTypeMap();
    }
    
    @ModelAttribute("taxGroupMap")
    TreeMap<String, String> getTaxGroupMap(){
    	return CommonUtils.getTaxGroupMap();
    }
    ...
    TreeMap<String, String> getInternationalizationsMap(){
    	return CommonUtils.getInternationalizationsMap();
    }
...
//    @PreAuthorize("hasPermission('com.savbill.cpm.controller.postpaid.Tax', '2')")
...
//    }
//
//    @PreAuthorize("hasPermission('com.savbill.cpm.controller.postpaid.Tax', '4')")
