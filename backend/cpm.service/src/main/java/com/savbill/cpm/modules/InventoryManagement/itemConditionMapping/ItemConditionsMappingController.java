...
//    }
    ...
    @Override
    public GenericDataDTO save(@Valid @RequestBody ItemConditionsMappingDto entityDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
