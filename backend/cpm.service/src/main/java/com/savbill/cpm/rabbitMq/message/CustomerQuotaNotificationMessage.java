...
public class CustomerQuotaNotificationMessage {
    ...
    public CustomerQuotaNotificationMessage(String customerMobileNumber, String customerEmailId, String message, TemplateNotification template, String customerName, Integer percentage , String planname, String countryCode, Integer mvnoId, Long buId) {
