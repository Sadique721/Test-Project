...
//
    ...
    @Query("select new com.savbill.cpm.pojo.api.ChargePojo(c.id, c.name) from Charge c where c.mvnoId in :mvnoIds")
    ...
    @Query("SELECT DISTINCT new com.savbill.cpm.pojo.api.ChargePojo(" +
