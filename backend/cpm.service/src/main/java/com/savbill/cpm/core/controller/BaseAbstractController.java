...
import com.savbill.cpm.core.service.BaseService;

import java.util.Comparator;
import java.util.List;
import java.util.stream.Collectors;

public abstract class BaseAbstractController<DTO extends IBaseDto> implements IBaseController<DTO> {

    private BaseService<DTO, Long> service;

    public BaseAbstractController(BaseService service) {
