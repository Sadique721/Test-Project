...
//        }
    ...
    public String getConnectionNumberGenerate(Boolean isLCO, Integer partnerId, Integer mvnoId) {
        log.debug("Initializing connection number generation process");
        String currconnectionNo = "";
        try {
            String key = isLCO ? "connectionno_" + mvnoId + "_" + partnerId : "connectionno_" + mvnoId;
            String query = "SELECT nextvalconnection(?)";
