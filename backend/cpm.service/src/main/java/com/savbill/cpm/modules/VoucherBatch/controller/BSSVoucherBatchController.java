package com.savbill.cpm.modules.VoucherBatch.controller;
...
import com.savbill.cpm.controller.radius.plan.PlanController;
...
public class BSSVoucherBatchController {
	...
	public ResponseEntity<Map<String, Object>> getAllVoucherBatch(PaginationDTO paginationDto
			, @RequestParam(name = "resellerId", required = false) Long resellerId, @RequestParam(name = "batchName", required = false) String batchName, HttpServletRequest request) {
