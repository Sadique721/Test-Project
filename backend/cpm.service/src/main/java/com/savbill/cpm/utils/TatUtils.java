...
import com.savbill.cpm.model.common.TicketTatAudits;
...
import com.savbill.cpm.modules.TicketTatMatrix.Domain.TicketTatMatrixMapping;
...
import com.savbill.cpm.rabbitMq.message.TicketAssignMessege;
import com.savbill.cpm.rabbitMq.message.TicketPickMessageToTeam;
...
import com.savbill.cpm.repository.common.TatAuditRepository;
...
//                                    details.setStaffId(staffUser.getId());
                                    ...
                                    hierarchyService.sendWorkflowAssignActionMessage("", userparent.getPhone(), userparent.getEmail(), customersCaf.getMvnoId(), userparent.getUsername(), "Assigned");
                                } else {
                                    details.setIsActive(false);
                                    tatMatrixWorkFlowDetailsRepo.save(details);
                                }
...
//                                    details.setStaffId(staffUser.getId());
                                    ...
                                    //details.setStaffId(details.getParentId());
                                    hierarchyService.sendWorkflowAssignActionMessage("", userparent.getPhone(), userparent.getEmail(), terminationcust.getMvnoId(), userparent.getUsername(), "Assigned");
                                } else {
                                    details.setIsActive(false);
                                    tatMatrixWorkFlowDetailsRepo.save(details);
                                }
...
//                                    details.setStaffId(staffUser.getId());
                                    ...
                                    details.setStaffId(details.getParentId());
                                    leadMasterRepository.save(leadMaster);
                                    hierarchyService.sendWorkflowAssignActionMessage("", userparent.getPhone(), userparent.getEmail(), leadMaster.getMvnoId().intValue(), userparent.getUsername(), "Assigned");
                                } else {
                                    details.setIsActive(false);
                                    tatMatrixWorkFlowDetailsRepo.save(details);
                                }
