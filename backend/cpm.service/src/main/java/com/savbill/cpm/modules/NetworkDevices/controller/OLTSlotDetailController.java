...
public class OLTSlotDetailController extends ExBaseAbstractController<OLTSlotDetailDTO> {
    ...
    @Override
    public GenericDataDTO save(@Valid @RequestBody OLTSlotDetailDTO oltSlotDetailDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        MDC.put("type", "Fetch");
        try {
    ...
    @Override
    public GenericDataDTO update(@Valid @RequestBody OLTSlotDetailDTO oltSlotDetailDTO, BindingResult result, Authentication authentication, HttpServletRequest req) throws Exception {
        GenericDataDTO genericDataDTO = new GenericDataDTO();
        MDC.put("type", "Fetch");
        try{
