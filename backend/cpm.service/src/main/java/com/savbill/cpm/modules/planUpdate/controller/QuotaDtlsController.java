package com.savbill.cpm.modules.planUpdate.controller;

import com.savbill.cpm.modules.otpManagment.OTPManagementController;
...
import com.savbill.cpm.modules.planUpdate.model.ServicePlansDTO;
...
public class QuotaDtlsController extends ExBaseAbstractController<QuotaDtlsDTO> {
    ...
    public GenericDataDTO updateQuota(@Valid @RequestBody QuotaDtlsDTO entityDTO, BindingResult result, Authentication authentication) {
        ...
        try {
            ...
            QuotaDtlsDTO dtoData = quotaDtlsService.getEntityById(entityDTO.getIdentityKey());
