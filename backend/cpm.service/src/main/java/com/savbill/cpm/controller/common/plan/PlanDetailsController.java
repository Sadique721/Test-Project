package com.savbill.cpm.controller.common.plan;
...
import com.savbill.cpm.modules.Customers.ServiceAreaFetchDTO;
...
public class PlanDetailsController extends ApiBaseController {
    ...
    public ResponseEntity<?> GetAllPlansBySAAndType(@RequestBody ServiceAreaFetchDTO serviceAreaFetchDTO,
        ...
        try {
            List<LightPostpaidPlanDTO> postpaidPlanList = postpaidPlanService.getPlanDetailsByServiceAreaSiteNameAndServiceId(serviceAreaFetchDTO.getSa(), serviceAreaFetchDTO.getServiceIds(), serviceAreaFetchDTO.getPlanGroupTypes());
