...
public class Savana_Thread_Customer_Class extends RestExecution {
    ...
    private static final Logger log = LoggerFactory.getLogger(Savana_Thread_Customer_Class.class);
...
//        System.out.println(customerMapList);
    ...
    private String getPrepaidCustomerJson(Map<String, String> customerDetails, Map<String, Integer> serviceAreaDetails) {
        ...
        try {
            ...
            planDetailJsonObject.put("name", plan);
