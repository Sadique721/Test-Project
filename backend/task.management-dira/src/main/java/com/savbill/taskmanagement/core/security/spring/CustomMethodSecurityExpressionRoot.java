package com.savbill.taskmanagement.core.security.spring;
//
...
public class CustomMethodSecurityExpressionRoot
    ...
    public CustomMethodSecurityExpressionRoot(Authentication authentication, CustomACLService customACLService) {
        super(authentication);
