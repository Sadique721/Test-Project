package com.savbill.taskmanagement.core.modules.BusinessUnit.service;


import com.savbill.taskmanagement.core.modules.BusinessUnit.domain.BusinessUnit;
import com.savbill.taskmanagement.core.modules.BusinessUnit.mapper.BusinessUnitMapper;
import com.savbill.taskmanagement.core.modules.BusinessUnit.model.BusinessUnitDTO;
...
import com.savbill.taskmanagement.rabbitmq.messages.DataShareMessage.SaveBusinessUnitSharedDataMessage;
import com.savbill.taskmanagement.rabbitmq.messages.DataShareMessage.UpdateBusinessUnitSharedDataMessage;
...
@Transactional
    ...
    public void saveBusinessUnitData(ConsumerRecord<String, Object> records) {
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonData = (String) records.value();
    try{
        SaveBusinessUnitSharedDataMessage message = objectMapper.readValue(jsonData , SaveBusinessUnitSharedDataMessage.class);
        if(message !=null){
            BusinessUnit businessUnit = new BusinessUnit();
            businessUnit.setId(message.getId());
            businessUnit.setBuname(message.getBuname());
    ...
    public void updateBusinessUnitData(ConsumerRecord<String, Object> records) {
    ObjectMapper objectMapper = new ObjectMapper();
    String jsonData = (String) records.value();
    try{
        UpdateBusinessUnitSharedDataMessage message = objectMapper.readValue(jsonData , UpdateBusinessUnitSharedDataMessage.class);
        if(message!=null){
            BusinessUnit businessUnit = businessUnitRepository.findById(message.getId()).get();
            if(businessUnit!=null){
                businessUnit.setBuname(message.getBuname());
                businessUnit.setBucode(message.getBucode());
                businessUnit.setStatus(message.getStatus());
