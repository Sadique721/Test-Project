...
//        this.updateDetails = updateDetails;
        ...
        this.caseCategoryId =caseUpdateDTO.getCaseCategoryId();
        ...
        //this.staffAdditionalMobileNumber = caseUpdateDTO.getStaffAdditionalMobileNumber();
        //this.staffAdditionalEmail = caseUpdateDTO.getStaffAdditionalEmail();
        ...
        this.teamId = caseUpdateDTO.getTeamId();
        this.finalTaskCompletionRemark = caseUpdateDTO.getFinalTaskCompletionRemark();
        this.startDate = caseUpdateDTO.getStartDate();
        this.endDate = caseUpdateDTO.getEndDate();
    }
