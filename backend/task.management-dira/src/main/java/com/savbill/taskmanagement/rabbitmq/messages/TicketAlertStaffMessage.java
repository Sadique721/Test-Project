...
@AllArgsConstructor
@NoArgsConstructor
public class TicketAlertStaffMessage {
    ...
    public TicketAlertStaffMessage(String staffUserName , String staffMobileNumber, String staffEmail, String countryCode, String parentStaffEmail, List<SendTicketDetailDTO> sendTicketDetailDTOList , Integer mvnoId, Long buId) {

        this.setMessage("Ticket Alert");
