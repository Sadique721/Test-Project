...
public class TicketCreationMessage {
    ...
    public TicketCreationMessage(String staffName,String mobileNumber, String emailId, String message, TemplateNotification template, String caseNumber, Integer mvnoId, String caseStatus, String casePriority, String caseRemark,String startDate,String endDate,String taskFor, String createdByName) {
...
//      this.customerData.put("parentStaffPersonName",parentStaffPersonName);
        ...
        this.customerData.put("createdBy",createdByName);
