...
public class TicketMessageIntegration {
    ...
    public TicketMessageIntegration(Case casedata , List<CaseUpdateDTO> caseUpdateDTOS, List<TicketServicemapping> ticketServicemappingList) {  //ticket_assign_staff_mappings
        ...
        //this.customers   =  casedata.getStaffUser().getId();
        ...
        if( casedata.getPartner() !=null  && casedata.getPartner().getName() != null) {
            this.partner = casedata.getPartner().getName();
        }

        this.firstRemark   =  casedata.getFirstRemark();
        this.mobile   =  casedata.getMobile();
        //this.userName   =  casedata.getStaffUser().getUsername();
        this.mvnoId   =  casedata.getMvnoId();
        //this.customerName   =  casedata.getStaffName();
        ...
        this.caseCategoryId = casedata.getCaseCategoryId();
        this.caseCategoryName = casedata.getCaseCategoryName();
      ...
      //  this.ticketAssignStaffMappings   =  ticketAssignStaffMappings;
        ...
        //this.customerAdditionalMobileNumber   =  casedata.getStaffAdditionalMobileNumber();
        //this.customerAdditionalEmail   =  casedata.getStaffAdditionalEmail();
