...
public class TicketPickMessageToTeam {
    ...
    public TicketPickMessageToTeam(String mobileNumber, String emailId, String message, TemplateNotification template, String parentStaffPersonName, String assigndatetime, String eventName, Integer mvnoId, String teamName, String caseNumber, TicketTatAudits tatAudits, Long buId, String customerName, String caseTitle, String casePriority) {
