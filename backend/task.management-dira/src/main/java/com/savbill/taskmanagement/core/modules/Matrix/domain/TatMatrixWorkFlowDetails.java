...
//    private LocalDateTime levelChangeDateTime;
    ...
    public TatMatrixWorkFlowDetails(Long orderNo, String level, Integer staffId,  Long tatMatrixId, Integer parentId, LocalDateTime startDateTime, String mtime, String munit, String action, Boolean isActive, Integer currentTeamHeirarchyMappingId, Integer entityId, String eventName, Integer eventId, String notificationType, Long teamId, Boolean isOverDueReminder) {
