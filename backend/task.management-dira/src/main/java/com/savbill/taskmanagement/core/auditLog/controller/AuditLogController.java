...
import com.savbill.taskmanagement.core.auditLog.service.AuditLogService;
...
//    private PaymentGatewayService pgService;
    ...
    public GenericDataDTO getAuditForList(@PathVariable String auditFor) {
        ...
        try {
            ...
            if (null != auditFor) {
                if (auditFor.equalsIgnoreCase(AuditLogConstants.AUDIT_FOR_CASE))
                    return GenericDataDTO.getGenericDataDTO(caseService.getCaseListForAuditFor());
