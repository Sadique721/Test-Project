package com.savbill.taskmanagement.core.auditLog.service;


import com.savbill.taskmanagement.core.auditLog.Constants.AuditLogConstants;
import com.savbill.taskmanagement.core.auditLog.domain.AuditLogEntry;
import com.savbill.taskmanagement.core.auditLog.domain.QAuditLogEntry;
import com.savbill.taskmanagement.core.auditLog.mapper.AuditLogMapper;
import com.savbill.taskmanagement.core.auditLog.model.AuditLogEntryDTO;
import com.savbill.taskmanagement.core.auditLog.model.AuditLogSearchRequestDTO;
import com.savbill.taskmanagement.core.auditLog.queryScript.AuditSearchQueryScript;
import com.savbill.taskmanagement.core.auditLog.repository.AuditLogRepository;
...
import com.savbill.taskmanagement.core.dto.GenericIdModel;
...
import com.savbill.taskmanagement.core.modules.constants.PGConstants;
...
import com.savbill.taskmanagement.core.modules.utils.PropertyReaderUtil;
