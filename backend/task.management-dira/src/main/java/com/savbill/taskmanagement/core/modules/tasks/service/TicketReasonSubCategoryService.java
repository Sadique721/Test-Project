...
//            if(!ticketReasonSubCategoryDTO.getCaseSubCategoryCategoryMappingList().isEmpty() &&
...
//
//
////    public Iterable<CaseCategoryTatMapping> updateStatus(TicketReasonSubCategoryDTO entityDTO) {
...
////        BooleanExpression booleanExpression=
////                ticketSubCategoryTatMapping.ticketReasonSubCategoryId.isNull();
