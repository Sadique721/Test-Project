...
//    @Column(name = "staff_additional_mobile_number")
//    private String staffAdditionalMobileNumber;

//    @Column(name = "staff_additional_email")
//    private String staffAdditionalEmail;
    ...
    @Column(name="final_task_completion_remark")
    ...
    @Column(name="is_from_calender", nullable = false)
...
//    @JoinColumn(name = "ticketid")
    ...
    @Column(name= "is_processed", columnDefinition = "Boolean default false", nullable = false)
    private Boolean is_processed= false;

    public Case() {
    }

    public Case(String caseNumber, String priority, String caseStatus, String staffName, String caseType, LocalDate nextFollowupDate, String assigneeName) {
