package com.savbill.taskmanagement.core.modules.TicketTatMatrix.Domain;
...
public class TicketTatMatrix extends Auditable implements IBaseData<Long> {
    ...
    @Column(name = "is_default_tat",columnDefinition = "Boolean default false", nullable = false)
