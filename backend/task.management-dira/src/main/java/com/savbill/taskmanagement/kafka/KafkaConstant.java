...
public class KafkaConstant {
    ...
    // KAFKA TOPICS
    public static final String COMBINED_GROUP="combined_group_task_management";
    ...
    //KAFKA-GROUP-ID'S
    public static  final String KAFKA_COMMON_GROUP_ID="task-common-group";


    public static  final String KAFKA_TICKET_GROUP_ID="task-ticket-group";
    public static  final String KAFKA_CMS_GROUP_ID="task-cms-group";

    public static  final String KAFKA_PMS_GROUP_ID="task-pms-group";

    public static  final String KAFKA_INVENTORY_GROUP_ID="task-inventory-group";

    public static  final String KAFKA_REVENUE_GROUP_ID="task-revenue-group";

    public static  final String KAFKA_NOTIFICATION_GROUP_ID="task-notification-group";

    public static  final String KAFKA_RADIUS_GROUP_ID="task-radius-group";
    ...
    public static final String TROUBLE_TASK_FOLLOW_UP_REMINDER_STAFF="TROUBLE_TASK_FOLLOW_UP_REMINDER_STAFF";

    public  static final String TROUBLE_TASK_FOLLOW_UP_REMINDER_CUSTOMER="TROUBLE_TASK_FOLLOW_UP_REMINDER_CUSTOMER";

    public static final String TROUBLE_TASK_FOLLOW_UP_OVER_DUE_STAFF="TROUBLE_TASK_FOLLOW_UP_OVER_DUE_STAFF";

    public static final String TROUBLE_TASK_FOLLOW_UP_OVER_DUE_PARENT_STAFF = "TROUBLE_TASK_FOLLOW_UP_OVER_DUE_PARENT_STAFF";
