package com.savbill.taskmanagement.rabbitmq;
...
//    public static final String QUEUE_SEND_SERIAL_NUMBER = "bss.apigateway.send.serialnumber";
	...
	/**RabbitMq for Ticket FollowUp for customer start**/
	public static final String TICKET_FOLLOWUP_REMARK_CUSTOMER_TEMPLATE = "Ticket Followup Remark For Customer";
	public static final String TICKET_FOLLOWUP_REMARK_CUSTOMER_TEMPLATE_HEADER = "Ticket Remark Message";
	public static final String QUEUE_TICKET_FOLLOWUP_REMARK_CUSTOMER = "send.ticket_followup_remark_for_customer";
	/**RabbitMq for Ticket FollowUp for customer end**/

	public static final String BU_ID = "buId";

	/**RabbitMq for Recieve email config from notification start**/
	public static final String QUEUE_SEND_EMAIL_CONFIG_TO_APIGW = "send.email.config.apigw";
	/**RabbitMq for Recieve email config from notification end**/
	public static final String QUEUE_SEND_CREATE_SYSTEM_CONFIGURATION_COMMON_APIGW_TO_TICKET = "queue.create.systemconfiguration.common.apigw.to.ticket";
	public static final String QUEUE_SEND_UPDATE_SYSTEM_CONFIGURATION_COMMON_APIGW_TO_TICKET = "queues.update.systemconfiguration.common.apigw.to.ticket";


	public static final String QUEUE_SEND_CREATE_DATA_ROLE_TICKET = "queue.send.create.data.role.to.ticket";
	public static final String QUEUE_SEND_DELETE_DATA_ROLE_TICKET = "queue.send.delete.data.role.to.ticket";

	/**RabbitMq for sending external remark to customer**/
	public static final String EXTERNAL_TICKET_REMARK_TO_CUSTOMER_TEMPLATE = "Ticket External Remark For Customer";
	...
	/**RabbitMq for sending ticket alert to staff started**/
	public static final String TICKET_ALERT_TO_STAFF_TEMPLATE = "Ticket External Remark For Customer";
	public static final String QUEUE_TICKET_ALERT_TO_STAFF = "send.ticket_alert_staff";
	/**RabbitMq for sending ticket alert to staff ended**/
