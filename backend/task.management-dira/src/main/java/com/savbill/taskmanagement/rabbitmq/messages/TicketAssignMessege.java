...
public class TicketAssignMessege {
    ...
    public TicketAssignMessege(String username, String mobileNumber, String emailId, Integer mvnoId, String message, TemplateNotification template, String sourceName, String caseNumber, String name , String nextFollowupDate, String custusername){

        this.setMessage(message+"   :"+caseNumber);
        ...
        this.customerData.put("nextFollowupDate",nextFollowupDate);
        this.customerData.put("username",custusername);
    ...
    public TicketAssignMessege(String mobileNumber, String emailId, String message, TemplateNotification template, String parentStaffPersonName, String staffPersonName, String assigndatetime, String eventName, Integer mvnoId, TicketTatAudits tatAudits,Long buId, String caseNumber, String caseTitle, String priority, String team, String customerName, List<String> ccEmailList) {
        ...
        this.customerData.put("caseNumber",caseNumber);
        this.customerData.put("caseTitle",caseTitle);
        this.customerData.put("teamName",team);
        this.customerData.put("casePriority",priority);
//        this.customerData.put("altEmail",staffEmail);
        if(!ccEmailList.isEmpty()) {
            this.customerData.put("altEmailList", ccEmailList);
        }
        this.isEmailConfigured = template.isEmailEventConfigured();
        this.isSmsConfigured = template.isSmsEventConfigured();
    }

    public TicketAssignMessege(String username, String mobileNumber, String emailId, Integer mvnoId, String message, TemplateNotification template, String sourceName, String caseNumber, String name , String nextFollowupDate, String custusername, String altEmail, String serialNumber,Long buId) {
        this.setMessage(message+"   :"+caseNumber);
        this.setSourceName(sourceName);
        this.setEmailTemplate(template.getEmailTemplateData());
        this.setSmsTemplate(template.getSmsTemplateData());
        ...
        this.customerData.put("serialNumber",serialNumber);
