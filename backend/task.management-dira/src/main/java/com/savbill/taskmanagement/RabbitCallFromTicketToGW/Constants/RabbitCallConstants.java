package com.savbill.taskmanagement.RabbitCallFromTicketToGW.Constants;

public class RabbitCallConstants {
    ...
    public static final String QUEUE_SEND_UPDATE_MVNO_COMMON_APIGW_TO_TICKET_ISP = "queue.create.mvno.common.apigw.to.ticket.isp";
