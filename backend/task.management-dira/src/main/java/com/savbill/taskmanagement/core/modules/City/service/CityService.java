package com.savbill.taskmanagement.core.modules.City.service;


import com.savbill.taskmanagement.core.modules.City.domain.City;
import com.savbill.taskmanagement.core.modules.City.dto.CityPojo;
import com.savbill.taskmanagement.core.modules.City.repository.CityRepository;
import com.savbill.taskmanagement.core.service.AbstractService;
import com.savbill.taskmanagement.rabbitmq.messages.DataShareMessage.SaveCitySharedDataMessage;
import com.savbill.taskmanagement.rabbitmq.messages.DataShareMessage.UpdateCitySharedDataMessage;
...
@Transactional
    ...
    public void saveCity(ConsumerRecord<String, Object> records) {
        try{
            ObjectMapper mapper = new ObjectMapper();
            String jsonData = (String) records.value();
            SaveCitySharedDataMessage message = mapper.readValue(jsonData, SaveCitySharedDataMessage.class);
            City city = new City();
            city.setId(message.getId());
            city.setCountryId(message.getCountryId());
            city.setState(message.getState());
    ...
    public void updateCity(ConsumerRecord<String, Object> records) {
        try{
            ObjectMapper mapper = new ObjectMapper();
            String jsonData = (String) records.value();
            UpdateCitySharedDataMessage  message = mapper.readValue(jsonData, UpdateCitySharedDataMessage.class);
            if(message.getId() != null) {
                City city = cityRepository.findById(message.getId()).orElse(null);
