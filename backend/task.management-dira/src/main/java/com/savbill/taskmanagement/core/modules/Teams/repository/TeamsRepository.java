...
public interface TeamsRepository extends JpaRepository<Teams, Long>, QuerydslPredicateExecutor<Teams> {
    ...
    Teams findAllByMvnoIdAndName(Integer mvnoId, String name);
    ...
    Teams findByNameAndMvnoIdAndIsDeletedFalse(String name , Integer mvnoId);

    List<Teams> findAllByIsDeletedFalse();

    List<Teams> findAllByIsDeletedFalseAndMvnoId(Integer mvnoid);
