...
//
//import com.savbill.ticketmanagement.core.modules.tickets.repository.CaseSubCategoryCategoryMappingRepository;
...
//
//    @Autowired
//    CaseSubCategoryCategoryMappingRepository ticketSubCategoryReasonCategoryMappingRepository;
//
//
//    @Override
...
//        List<CaseSubCategoryCategoryMapping> ticketReasonCategoryDTOS=IterableUtils.toList(ticketSubCategoryReasonCategoryMappingRepository.findByTicketReasonCategoryId(reasoneCatId));
