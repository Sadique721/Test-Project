package com.savbill.taskmanagement.core.utillity.fileUtillity;


import com.savbill.taskmanagement.core.constants.DocumentConstants;
import com.savbill.taskmanagement.core.exceptions.CustomValidationException;
import com.savbill.taskmanagement.core.exceptions.FileNotCreatedException;
...
//        int allowedFileSize = clientService.getByName(DocumentConstants.ALLOWED_DOCUMENT_SIZE) != null ? Integer.parseInt(clientService.getByName(DocumentConstants.ALLOWED_DOCUMENT_SIZE).getValue()) : 2;
        if (argFile.getSize() > ((long) 0 * 1024 * 1024))
...
//        path="D:\\";
    ...
    public String saveFileToServerForTicket(MultipartFile argFile, String path) throws IOException {
        ...
        int allowedFileSize = clientService.getByName(DocumentConstants.ALLOWED_TASK_DOCUMENT_SIZE) != null ? Integer.parseInt(clientService.getByName(DocumentConstants.ALLOWED_TASK_DOCUMENT_SIZE).getValue()) : 500;
