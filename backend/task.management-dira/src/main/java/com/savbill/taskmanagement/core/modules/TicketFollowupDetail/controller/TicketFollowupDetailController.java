package com.savbill.taskmanagement.core.modules.TicketFollowupDetail.controller;
...
//                AclConstants.OPERATION_TICKET_FOLLOWUP_DEATAILS_VIEW, req.getRemoteAddr(), null, dto.getId(), dto.getRemark());
    ...
    @PreAuthorize("validatePermission(\"" + MenuConstants.TaskConversation.TASK_CONVERSATION + "\",\"" + MenuConstants.TicketFollowUp.TICKET_FOLLOWUP_CREATE + "\",\"" + MenuConstants.Task.TASK_REMARKS + "\")")
    @Override
