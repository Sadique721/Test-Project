...
public class CommonConstants {
    ...
    public static final String TASK_COUNT_SAME_CATEGORY = "TASK_COUNT_SAME_CATEGORY";
    public static final String TASK_COUNT_IN_LAST_DAYS = "TASK_COUNT_IN_LAST_DAYS";
    public static final String TASK_COUNT_SAME_CATEGORY_DAYS = "TASK_COUNT_SAME_CATEGORY_DAYS";
...
//    }
    ...
    public interface TICKET_SEARCH_OPTION {
        ...
        String IS_CALANDER_FALSE = "ISCALANDERFALSE";
        String IS_FROM_CALENDER_FALSE = "IS_FROM_CALENDER_FALSE";
    ...
    public interface MODULE{
        String MODULE_TICKET = "Ticket Management";
    }
