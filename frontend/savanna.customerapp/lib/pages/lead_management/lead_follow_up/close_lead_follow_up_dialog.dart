...
class CloseLeadRemarkFollowUpDialog extends StatefulWidget {
  final CloseFollowUpRemarkBtnAction? closeFollowUpRemarkBtnAction;
  String? pageName;
  FollowUpList itemList;

  CloseLeadRemarkFollowUpDialog(
      {super.key,
        this.pageName,
  ...
  @override
  _CloseLeadFollowUpState createState() => _CloseLeadFollowUpState();
}

class _CloseLeadFollowUpState extends State<CloseLeadRemarkFollowUpDialog> {
