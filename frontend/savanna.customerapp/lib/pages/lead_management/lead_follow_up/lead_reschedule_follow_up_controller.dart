...
class LeadRescheduleFollowUpController extends GetxController {
          ...
          if (responseModel.result != null) {
            try {
              ...
              if ((response.responseCode != null &&
                ...
                followupNameController.text = response.generatedNameOfTheFollowUp ?? "";
              } else {
