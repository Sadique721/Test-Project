              ...
              children: [
                ...
                Expanded(
                  child: SimpleButton(
                    onTap: () {
                      // validateForm();
                      if (addLeadController.activeStep == 4) {
                    ...
                    child: CustomText(
                      title: addLeadController.activeStep == 4
                          ? Strings.submit
                          : Strings.next,
                      fontSize: AppTheme.medium,
                      fontWeight: FontWeight.w400,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Flexible(
                flex: 1,
                child: titleWithRequireWidget(Strings.primary_email, true),
              ),
              const SizedBox(
                width: Constant.SMALL_PADDING,
              ),
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          //           hintColor: AppTheme.colorIconGrey,
          //           textEditingController:
          //               addLeadController.renewPlanLimitController,
          //           borderEnableColors: AppTheme.colorIconGrey,
          //           borderFocusColors: AppTheme.colorIconGrey,
          //           textColor: AppTheme.colorBlack,
          //           keyboardType: TextInputType.number,
