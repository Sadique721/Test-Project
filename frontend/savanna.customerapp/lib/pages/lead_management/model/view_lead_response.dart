...
class ViewLeadRes extends BaseResponse {
  ...
  ViewLeadRes(
      {this.pageDetails, this.leadMasterList, this.timestamp, this.status});

  ViewLeadRes.fromJson(Map<String, dynamic> json) {
    pageDetails = json['pageDetails'] != null
        ? new PageDetails.fromJson(json['pageDetails'])
        : null;
    if (json['leadMasterList'] != null) {
      leadMasterList = <LeadMasterListData>[];
      json['leadMasterList'].forEach((v) {
        leadMasterList!.add(new LeadMasterListData.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.leadMasterList != null) {
      data['leadMasterList'] =
          this.leadMasterList!.map((v) => v.toJson()).toList();
    }
...
class LeadMasterListData {
  ...
  LeadMasterListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class PlanMappingList {
  ...
  PlanMappingList.fromJson(Map<String, dynamic> json) {
    ...
    //     quotaList!.add(new Null.fromJson(v));
    //   });
    // }
