...
class LeadApproveRejectStaffRes extends BaseResponse {
  // int? responseCode;
  String? responseMessage;
  dynamic data;
  List<ApproveRejectStaffLeadList>? dataList;
  ...
  LeadApproveRejectStaffRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ApproveRejectStaffLeadList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new ApproveRejectStaffLeadList.fromJson(v));
      });
    }
...
class ApproveRejectStaffLeadList {
  int? id;
  String? createdate;
  String? updatedate;
  ...
  ApproveRejectStaffLeadList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
