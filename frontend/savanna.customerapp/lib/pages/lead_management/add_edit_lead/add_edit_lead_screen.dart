                  ...
                  child: SimpleButton(
                    ...
                    child: CustomText(
                      title: addLeadController.activeStep == 1
                          ?addLeadController.from.equalsIgnoreCase(Strings.edit)? Strings.update : Strings.submit
                          : Strings.next,
                      fontSize: AppTheme.medium,
                      fontWeight: FontWeight.w400,
                    ),
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          addLeadController.selectedLeadFeasibility != null && addLeadController.selectedLeadFeasibility!.equalsIgnoreCase("N/A") ?
          Row(
            crossAxisAlignment: CrossAxisAlignment.center,
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Flexible(
                flex: 1,
                child:
                    InputTitleRequire(title: Strings.feasibilityRemark, require: true),
              ),
              const SizedBox(
                width: Constant.SMALL_PADDING,
              ),
            ...
            children: [
              ...
              Flexible(
                ...
                child: CoustomTextField(
                    ...
                    textEditingController:
                    addLeadController.mobileController,
                    maxLength: 9,
                    prefixIcon: InkWell(
                      onTap: _showCountryCodeDialog,
                      child: Container(
