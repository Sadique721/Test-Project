...
class PendingApprovalPlanGroupItem extends StatelessWidget {
  ApprovalPendingPlanGroup item;
  final Function()? onTapApprove;
  final Function()? onTapReject;

  PendingApprovalPlanGroupItem({
    Key? key,
    required this.item,
    this.onTapApprove,
    this.onTapReject,
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: basicDetailItem(
                Strings.name,
                (item.planGroupName != null && item.planGroupName!.isNotEmpty)
                    ? item.planGroupName
                    : "-",
                Strings.type,
                (item.planGroupType != null && item.planGroupType!.isNotEmpty)
                    ? item.planGroupType
                    : "-"),
          ),
          const SizedBox(
          ...
          Padding(
            ...
            child: basicDetailItem(
                Strings.plan_type,
                (item.plantype != null && item.plantype!.isNotEmpty)
                    ? item.plantype
                    : "-",
                Strings.create_by,
