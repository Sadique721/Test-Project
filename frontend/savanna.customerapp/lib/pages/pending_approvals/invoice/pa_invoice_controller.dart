...
class PAInvoiceController extends GetxController {
  ...
  getPAInvoiceList() {
    ...
    PendingApprovalsProvider().getInvoicePendingApprovals(
      request: request,
        ...
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            try {
              ...
              PAInvoiceRes responseData = PAInvoiceRes.fromJson(map);
