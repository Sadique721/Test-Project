...
class PendingApprovalPartnerItem extends StatelessWidget {
  APPartner item;

  final Function()? onTapApprove;
  final Function()? onTapReject;

  PendingApprovalPartnerItem({
    Key? key,
    required this.item,
    this.onTapApprove,
    this.onTapReject,
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: basicDetailItem(
                Strings.partner_name,
                (item.partnerName != null && item.partnerName!.isNotEmpty)
                    ? item.partnerName
                    : "-",
                Strings.transaction_category,
                (item.transcategory != null && item.transcategory!.isNotEmpty)
                    ? item.transcategory
                    : "-"),
          ),
          const SizedBox(
          ...
          Padding(
            ...
            child: basicDetailItem(
                ...
                (item.paymentmode != null && item.paymentmode!.isNotEmpty)
                    ? item.paymentmode
                    : "-",
                Strings.amount,
