...
class PAPartnerStatusDialog extends StatefulWidget {
  final PAPartnerStatusBtnAction paPartnerStatusBtnAction;
  final PartnerApproveRejectReq partnerApproveRejectReq;
  final String from;


  const PAPartnerStatusDialog(
      {Key? key,
      required this.paPartnerStatusBtnAction,
      required this.partnerApproveRejectReq,
      required this.from})
      : super(key: key);

  @override
  _PAPartnerStatusDialogtate createState() => _PAPartnerStatusDialogtate();
}

class _PAPartnerStatusDialogtate extends State<PAPartnerStatusDialog> {
  ...
  contentBox(BuildContext context) {
    ...
    if (widget.from.equalsIgnoreCase(Strings.approve)) {
      title = "${Strings.approve} ${Strings.partner}";
    } else if (widget.from.equalsIgnoreCase(Strings.reject)) {
      title = "${Strings.reject} ${Strings.partner}";
    }
                      ...
                      Expanded(
                        child: InkWell(
                          onTap: () {
                            ...
                            widget.partnerApproveRejectReq.remark =
                                remarkController.text;

                            widget.paPartnerStatusBtnAction
                                .paPartnerStatusBtnAction(
                              identifier: Strings.submit,
                              request: widget.partnerApproveRejectReq,
                            );
                          },
                          child: Container(
...
abstract class PAPartnerStatusBtnAction {
