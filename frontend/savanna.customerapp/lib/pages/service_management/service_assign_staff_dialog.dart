...
class ServiceAssignStaffDialog extends StatefulWidget {
  final ServiceAssignStaffAction serviceAssignAction;
  final List<ApproveRejectServiceDataList> itemsOrgLst;
  final String? staffStatus;
  final int? entityId;

  const ServiceAssignStaffDialog({
    Key? key,
    required this.serviceAssignAction,
  ...
  @override
  _ServiceAssignState createState() => _ServiceAssignState();
}

class _ServiceAssignState extends State<ServiceAssignStaffDialog> {
  List<ApproveRejectServiceDataList> itemsLst = [];
                    ...
                    Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ApproveRejectServiceDataList item = itemsLst[index];
  ...
  validateSelection() {
    ApproveRejectServiceDataList? selectedItem;
    ...
    if (selectedItem!.selected == true) {
      if (widget.staffStatus!.equalsIgnoreCase(Strings.approve)) {
        ...
        widget.serviceAssignAction.serviceAssignStaffBtnAction(
...
abstract class ServiceAssignStaffAction {
  void serviceAssignStaffBtnAction(
      {ApproveRejectServiceDataList selectedItem,
