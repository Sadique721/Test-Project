...
class ApproveRejectServiceRes  extends BaseResponse{
  // int? responseCode;
  String? responseMessage;
  dynamic data;
  List<ApproveRejectServiceDataList>? dataList;
  ...
  ApproveRejectServiceRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ApproveRejectServiceDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(ApproveRejectServiceDataList.fromJson(v));
      });
    }
...
class ApproveRejectServiceDataList {
  int? id;
  String? createdate;
  String? updatedate;
  ...
  ApproveRejectServiceDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
