...
import 'package:savbill/pages/task_management/task_mgmt/task_remark/task_remark_controller.dart';
...
class TaskRemarkScreen extends StatefulWidget {
  @override
  _TaskRemarkScreenState createState() => _TaskRemarkScreenState();
}

class _TaskRemarkScreenState extends State<TaskRemarkScreen>
    with WidgetsBindingObserver {
  final taskRemarkController = Get.put(TaskRemarkController());

  final taskRemarkFormKey = GlobalKey<FormState>();
  ...
  // _backScreen() {
  //   Get.back(result: taskRemarkController.isChangeData);
  // }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<TaskRemarkController>(builder: (controller) {
        return Stack(children: [
          ...
          ProgressBar(isLoader: taskRemarkController.isLoading),
        ]);
      }),
    );
  }

  _body(TaskRemarkController controller) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            controller:
                            taskRemarkController.remarksController,
                            maxLines: 3,
                            maxLength: 250,
  ...
  _appBar() {
    return DynamicAppBar(Strings.task_remark, '', AppTheme.colorPrimary,
        false, _backScreen, [], AppBar().preferredSize.height);
  }

  validateForm() {
    if (taskRemarkFormKey.currentState!.validate()) {
      taskRemarkController.saveTaskFollowupCall();
    } else {
      setState(() {
