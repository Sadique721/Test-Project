...
class ChangeTaskPriorityDialog extends StatefulWidget {
  final TaskDetail? taskDetail;
  final List<TicketPriority> priorityList;
  final TaskPriorityBtnAction ticketPriorityBtnAction;


  const ChangeTaskPriorityDialog({
    Key? key,
  ...
  @override
  State<ChangeTaskPriorityDialog> createState() => _ChangeTaskPriorityDialogState();
}

class _ChangeTaskPriorityDialogState extends State<ChangeTaskPriorityDialog> {
  ...
  contentBox(BuildContext context) {
    String title =
        "${widget.taskDetail?.caseTitle!} ${Strings.change_priority}";
...
abstract class TaskPriorityBtnAction {
