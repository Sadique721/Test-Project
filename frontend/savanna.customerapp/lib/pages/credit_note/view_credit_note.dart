              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                   ...
                   Row(children: [
                     PermissionService().hasAclPermission([AclCreditNotes.GENERATE_CREDIT_NOTE]) == true ? Material(
                            ...
                            return CreditViewListItem(
                              ...
                              onDownloadTap: () {
                                creditNoteController.entityId =
                                    creditNoteController
                                        .creditNoteList![index].id;
                                creditNoteController.fileDownloading(Strings.credit_note,
                                    "${UrlConstants.payment_receipt_url}${creditNoteController.entityId}",creditNoteController
