...
class _CreditApproveRejectState extends State<CreditApproveRejectDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.pageName!.equalsIgnoreCase(Strings.approve)) {
      title = Strings.approve_credit;
    } else if (widget.pageName!.equalsIgnoreCase(Strings.reject)) {
      title = Strings.reject_credit;
    }
                                ...
                                widget.creditApproveRejectBtnAction!
                                    .creditApproveRejectStatus(
                                        ...
                                        paymentApproveRejectReq:
                                            widget.paymentApproveRejectReq);
                              }
                            },
                            child: Container(
...
class CreditApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final CreditApproveRejectBtnAction? creditApproveRejectBtnAction;
  final PaymentApproveRejectReq? paymentApproveRejectReq;

  CreditApproveRejectDialog(
      {Key? key,
      this.pageName,
      this.creditApproveRejectBtnAction,
      this.paymentApproveRejectReq})
      : super(key: key);

  @override
  _CreditApproveRejectState createState() => _CreditApproveRejectState();
}

abstract class CreditApproveRejectBtnAction {
