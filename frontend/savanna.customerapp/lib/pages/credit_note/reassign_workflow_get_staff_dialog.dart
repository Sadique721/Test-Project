...
class CreditReAssignWorkFlowDialog extends StatefulWidget {
  final CreditReAssignWorkFlowAction creditReassignWorkflowAction;
  final List<ReassignWorkflowList> itemsOrgLst;

  const CreditReAssignWorkFlowDialog({
    Key? key,
    required this.creditReassignWorkflowAction,
    required this.itemsOrgLst,
  }) : super(key: key);

  @override
  _CreditReAssignWorkFlowState createState() => _CreditReAssignWorkFlowState();
}

class _CreditReAssignWorkFlowState extends State<CreditReAssignWorkFlowDialog> {
  ...
  Widget build(BuildContext context) {
    String title = Strings.approve_plan;
  ...
  validateSelection() {
    ...
    if (selectedItem != null) {
      widget.creditReassignWorkflowAction.creditReAssignWorkFlowBtnAction(
...
abstract class CreditReAssignWorkFlowAction {
