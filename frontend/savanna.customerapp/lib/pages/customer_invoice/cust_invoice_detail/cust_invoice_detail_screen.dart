import 'package:savbill/pages/customer_invoice/cust_invoice_detail/cust_invoice_detail_controller.dart';
...
class _CustomerInvoiceDetailState extends State<CustomerInvoiceDetailScreen> {
  final custInvoiceDetailController =
      Get.put(CustomerInvoiceDetailController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CustomerInvoiceDetailController>(builder: (controller) {
      return Stack(children: [
        ...
        ProgressBar(isLoader: custInvoiceDetailController.isLoading),
      ]);
    });
  }
  ...
  _body() {
    return Container(
      ...
      child: custInvoiceDetailController.customerDetail != null
                ...
                child: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        basicDetailItem(
                            Strings.name,
                            "${custInvoiceDetailController.custInvoiceDetails != null ? custInvoiceDetailController.custInvoiceDetails!.customerName.toString().capitalizeFirst : ""}",
                            Strings.document_no,
                            custInvoiceDetailController
                  ...
                  child: Column(
                      ...
                      children: [
                        basicDetailItem(
                            ...
                            custInvoiceDetailController.custInvoiceDetails !=
                                    null
                                ? custInvoiceDetailController
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(
                                      height: Constant.VERY_SMALL_PADDING - 1),
                                  CustomText(
                                    title: custInvoiceDetailController
                                                .custInvoiceDetails !=
                                            null
                                        ? custInvoiceDetailController
              ...
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      // const SizedBox(height: Constant.SMALL_PADDING),
                      custInvoiceDetailController.debitDocDetails != null &&
                              custInvoiceDetailController
                                  .debitDocDetails!.isNotEmpty
                          ? Card(
                              color: AppTheme.colorWhite,
                              child: (custInvoiceDetailController
                                      .debitDocDetails!.isNotEmpty)
                                  ? ListView.builder(
                                      physics:
                                      ...
                                      shrinkWrap: true,
                                      itemCount: custInvoiceDetailController
