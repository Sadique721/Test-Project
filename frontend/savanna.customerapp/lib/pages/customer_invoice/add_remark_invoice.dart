...
class AddRemarkInvoiceDialog extends StatefulWidget {
  String? pageName;
  final InvoiceAddRemarkBtnAction? invoiceAddRemarkBtnAction;

  AddRemarkInvoiceDialog(
      {Key? key, this.pageName, this.invoiceAddRemarkBtnAction})
      : super(key: key);
...
class _AddRemarkInvoiceState extends State<AddRemarkInvoiceDialog> {
  ...
  Widget build(BuildContext context) {
    String title = Strings.add_remarks;
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.invoiceAddRemarkBtnAction!
