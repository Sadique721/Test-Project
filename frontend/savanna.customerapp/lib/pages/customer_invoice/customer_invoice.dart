                        ...
                        if (index == customerInvoiceController.invoiceList?.length) {
                          ...
                          return CustomerInvoiceViewItem(
                            ...
                            onTapDownload: () {
                              ...
                              //     "${UrlConstants.invoiceDownloadUrl}${customerInvoiceController.documentId}",item.customerName,true);
                            ...
                            onTapPrintInvoice: () async {
                              ...
                              openPdfViewScreen(
                                  ...
                                  "${UrlConstants.invoice_receipt_url}${customerInvoiceController.documentId}",item.customerName);
                            },
