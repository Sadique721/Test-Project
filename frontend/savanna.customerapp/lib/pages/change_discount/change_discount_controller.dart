...
class CustomerDiscountController extends GetxController
  ...
  getCustomerDiscountDetail() {
    ...
    discountList!.clear();
    update();
    ChangeDiscountProvider().getCustomerDiscountList(
      id: customerId,
            ...
            try {
              ...
              if (responseData.discountDetails != null &&
                ...
                if (discountList != null && discountList!.isNotEmpty) {
                  ...
                  DateTime newCurrentDate = DateFormat(Constant.API_DATE_FORMAT)
                  ...
                  newCurrentDateTime = apiDateTimeFormat.format(newCurrentDate);
                }
              }
  ...
  pickUpCustomerDiscount(int? entityId) {
    String apiUrl =
        "${UrlConstants.creditNote_pick_up_flow}?entityId=$entityId&eventName=CUSTOMER_DISCOUNT";
    isLoading = true;
    update();
