...
class GetIpManagementListRes  extends BaseResponse{
  // int? responseCode;
  String? responseMessage;
  IpManagementData? data;
  Null? dataList;
  Null? excelDataList;
  int? totalRecords;
  int? pageRecords;
  ...
  GetIpManagementListRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'] != null ? new IpManagementData.fromJson(json['data']) : null;
...
class IpManagementData {
  ...
  IpManagementData.fromJson(Map<String, dynamic> json) {
