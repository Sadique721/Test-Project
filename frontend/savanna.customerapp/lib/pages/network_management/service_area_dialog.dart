...
class ServiceAreaDialog extends StatefulWidget {
  final ServiceAreaAction serviceAreaAction;
  final List<ServicesAreaDetail> itemsOrgLst;
...
class _ServiceAreaState extends State<ServiceAreaDialog> {
  List<ServicesAreaDetail> itemsLst = [];
                  ...
                  children: [
                    ...
                    Flexible(
                      ...
                      itemBuilder: (context, index) {
                        ServicesAreaDetail item = itemsLst[index];
                        return Column(
                          children: [
                            InkWell(
                              onTap: () {
  ...
  validateSelection() {
    List<ServicesAreaDetail> selectedItem = [];
...
abstract class ServiceAreaAction {
