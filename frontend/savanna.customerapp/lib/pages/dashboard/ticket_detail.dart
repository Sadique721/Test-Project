...
class _TicketDetailState extends State<TicketDetailScreen>
  ...
  actionButtonView(TicketDetailController ticketDetailController) {
    ...
    if (ticketDetailController != null) {
      if (ticketDetailController.ticketDetail!.caseStatus!
              .equalsIgnoreCase("Closed") ||
          ticketDetailController.ticketDetail!.teamHierarchyMappingId == null ||
          ticketDetailController.ticketDetail!.caseStatus!
              .equalsIgnoreCase("Raise and Close") ||
          ticketDetailController.ticketDetail!.caseStatus!
              .equalsIgnoreCase("rejected") ||
                          ...
                          children: [
                            ...
                            showChangeProblemDomain == false
                                ? buttonView(
                                    ...
                                    viewTicketController.checkTicketReAssign(
                                        ticketDetailController.ticketDetail);
                                  })
                                : buttonView(
                                    linkSvg,
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(
                                    height: Constant.VERY_SMALL_PADDING - 1),
                                ticketDetailController.showTATDetailsData != null && ticketDetailController.showTATDetailsData!.name!.isNotEmpty ? InkWell(
                                  onTap: (){

                                    log("showTATDetailsData===>${jsonEncode(ticketDetailController.showTATDetailsData)}");

                                    openTatNameWithMappingDetail(ticketDetailController.showTATDetailsData);
                                  },
                                  child: CustomText(
                                    title: (ticketDetailController.showTATDetailsData?.name ?? "-"),
  ...
  openTicketChangeStatusScreen(
      TicketDetail? ticketDetail, String? tickT) async {
  ...
  onTicketETRScreen(TicketDetail? ticketDetail) async {
    ...
    if (result != null && result == true) {
      ...
      ticketDetailController.getTicketListData();
    }
  }
  ...
  openDocumentViewTicketScreen(TicketDetail? ticketDetail) async {
    var result = Get.to(TicketViewDocumentScreen(), arguments: {
  ...
  openTatNameWithMappingDetail(ShowTATDetailsData? item) {
    Get.to(()=>TatNameTicketMapDetail(), arguments: {Constant.TAT_NAME_DETAIL: item});
  }
