...
class RecordPaymentController extends GetxController {
  ...
  getArgumentData() {
    ...
    if (form!.equalsIgnoreCase("Customer Payment")) {
      ...
      createCustomerController.text = "${selectedCustomer?.title} ${selectedCustomer?.firstname} ${selectedCustomer?.lastname}";
      update();
    }
    getCustomerListData();
    // getPaymentMode();
...
// get invoice list by customer
              ...
              if (responseData.status != null && responseData.status == 200) {
                ...
                invoiceList?.forEach((element) {
                  ...
                  if (element.adjustedAmount != null) {
                    element.testamount = (element.totalamount! - element.adjustedAmount!);
                  } else {
  ...
  getCustomerListData() {
    isLoading = true;
    update();
    GetAllCaseRequest getAllCaseRequest = GetAllCaseRequest(page: 1, pageSize: 10);
...
String? onlineMode;
    ...
    if(selectPaymentModeSource !=null && selectPaymentModeSource!.value != null){
    ...
    RecordPaymentReq recordPaymentReq = RecordPaymentReq(
        ...
        customerid: newSelectedCustomer != null ? newSelectedCustomer!.id : selectedCustomer!.id,
