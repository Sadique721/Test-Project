...
import 'package:savbill/pages/ticket_system/tat_ticket/tat_mapping_detail_controller.dart';
...
class TatNameTicketMapDetail extends StatefulWidget {
  @override
  _TatNameTicketDetailState createState() => _TatNameTicketDetailState();
}

class _TatNameTicketDetailState extends State<TatNameTicketMapDetail> {
  final tatMappingController = Get.put(TatMappingController());
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<TatMappingController>(builder: (controller) {
                                  ...
                                  children: [
                                          ...
                                          Expanded(
                                              child: CustomText(
                                                  title: (tatMappingController
                                                      .tatDetailsData != null && tatMappingController
                                                      .tatDetailsData!
                                    ...
                                    Padding(
                                      ...
                                      child: basicDetailItem(
                                        Strings.sla_time_p1,
                                        (tatMappingController.tatDetailsData != null && tatMappingController.tatDetailsData!
                                            .slaTimep1 !=
                                            null)
                                            ? "${tatMappingController.tatDetailsData!.slaTimep1} ${tatMappingController.tatDetailsData!.sunitp1!}"
                                            : "-",
                                        Strings.sla_time_p2,
                                        (tatMappingController.tatDetailsData != null && tatMappingController.tatDetailsData!
                                            .slaTimep2 !=
                                            null)
                                            ? "${tatMappingController.tatDetailsData!.slaTimep2} ${tatMappingController.tatDetailsData!.sunitp2!}"
                                            : "-",
                                      ),
                                    ),
                                    const SizedBox(
                                    ...
                                    Padding(
                                      ...
                                      child: basicDetailItem(
                                        ...
                                        (tatMappingController.tatDetailsData != null && tatMappingController.tatDetailsData!
                                            .slaTime3 !=
                                            null)
                                            ? "${tatMappingController.tatDetailsData!.slaTime3} ${tatMappingController.tatDetailsData!.sunitp3!}"
                                            : "-",
                                        Strings.response_time,
                                        (tatMappingController
                                            .tatDetailsData != null && tatMappingController
                                            .tatDetailsData!.rtime !=
                                            null)
                                            ? "${tatMappingController.tatDetailsData!.rtime} ${tatMappingController.tatDetailsData!.runit!}"
                                            : "-",
                                      ),
                                    ),
                                    const SizedBox(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          (tatMappingController.tatMatrixMappings != null &&
                              tatMappingController.tatMatrixMappings!.isNotEmpty)
                              ? Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: Constant.SMALL_PADDING),
  ...
  _appBar() {
    return DynamicAppBar(
        "${ tatMappingController.tatDetailsData?.name.toString().capitalizeFirst} ${Strings.tat_detail}",
        '',
