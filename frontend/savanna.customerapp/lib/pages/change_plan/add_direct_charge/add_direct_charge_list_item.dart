...
class AddDirectChargeListItem extends StatelessWidget {
  // ChargeData item;
  CustChargeDetailsPojoList item;
  int index;
  final Function()? onDeleteTap;

  AddDirectChargeListItem(
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          cardItem(
              Strings.charge_amount, item.actualprice.toString(),"${Strings.plan} ${Strings.validity}:","${item.validity} ${item.unitsOfValidity}"),
          const SizedBox(
            height: Constant.SMALL_PADDING,
          ),
          cardItem(
