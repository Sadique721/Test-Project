import 'package:savbill/pages/customer_caf/reSchedule_followup/re_schedule_follow_up_controller.dart';
...
class ReScheduleFollowUpScreen extends StatefulWidget {
  @override
  _ReScheduleFollowUpState createState() => _ReScheduleFollowUpState();
}

class _ReScheduleFollowUpState extends State<ReScheduleFollowUpScreen> {
  final scheduleFollowUpController = Get.put(ReScheduleFollowUpController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ReScheduleFollowUpController>(builder: (controller) {
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InputTitleRequire(
                              title: Strings.currentFollowUpCloseRemark,
                              require: true),
                          const SizedBox(
                          ...
                          InputTitleRequire(
                              title: Strings.followup_name, require: false),
                          const SizedBox(
                            height: Constant.VERY_SMALL_PADDING,
                          ),
                          CoustomTextField(
                          ...
                          InputTitleRequire(
                              title: Strings.rescheduleRemarks, require: false),
                          const SizedBox(
                            height: Constant.VERY_SMALL_PADDING,
                          ),
                          DropdownButtonHideUnderline(
                            child: DropdownButtonFormField(
                              ...
                              hint: Align(
                                ...
                                child: Text(
                                  Strings.please_select_reschedule_remark,
                                  style: TextStyle(
                              ...
                              isExpanded: false,
                              isDense: true,
                              value: scheduleFollowUpController
                                  .selectedRescheduleRemark,
                              items: scheduleFollowUpController
                                  .rescheduleRemarkList
  ...
  validateForm() {
    if (scheduleFollowUpFormKey.currentState!.validate()) {
      scheduleFollowUpController.rescheduleFollowUpCreate();
    } else {
      setState(() {
