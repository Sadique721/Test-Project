...
import 'package:savbill/pages/customer_caf/followup/remark_follow_up/caf_remark_follow_up_controller.dart';
...
class CafRemarkFollowUp extends StatefulWidget {
  @override
  _CafRemarkFollowUpState createState() => _CafRemarkFollowUpState();
}

class _CafRemarkFollowUpState extends State<CafRemarkFollowUp> {
  final remarkFollowUpController = Get.put(RemarkFollowUpController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RemarkFollowUpController>(builder: (controller) {
  ...
  _appBar() {
    return DynamicAppBar(
        "${Strings.followup} ${Strings.remarks}",
        '',
  ...
  followUpItem({required RemarkFollowUpDataList item}) {
    String actionDate = "";
