...
class LeadWorkFlowApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final LeadWorkFlowApproveRejectBtnAction? leadWorkFlowApproveRejectBtnAction;
  LAAssignContent? item;
  PAAssignLeadController? controller;
  PATeamApprovalLeadController? teamController;

  LeadWorkFlowApproveRejectDialog(
      {Key? key,
        this.pageName,
        this.leadWorkFlowApproveRejectBtnAction,
        this.item,
        this.controller,
      this.teamController})
      : super(key: key);
...
class _LeadApproveRejectState extends State<LeadWorkFlowApproveRejectDialog> {
                          ...
                          child: InkWell(
                            onTap: () {
                              if (remarkController.text.isNullOrEmpty()) {
                                ...
                                widget.leadWorkFlowApproveRejectBtnAction!
                                    .leadWorkFlowApproveRejectStatus(
...
abstract class LeadWorkFlowApproveRejectBtnAction {
  void leadWorkFlowApproveRejectStatus(
      {String identifier, TextEditingController remarkController, int? caseId,BuildContext context,LAAssignContent? item});
}
