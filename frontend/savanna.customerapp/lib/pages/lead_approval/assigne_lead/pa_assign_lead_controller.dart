...
class PAAssignLeadController extends GetxController
  ...
  getPAAssignLeadList() {
    ...
    LeadApprovalsProvider().getLAAssignLeadList(
      request: request,
      onSuccess: (ResponseModel responseModel) {
        isShowLoadMore = false;
        isLoading = false;
        update();
        print("ResponseModel Data ==> ${responseModel.result}");
        print("ResponseModel statusCode ==> ${responseModel.statusCode}");
