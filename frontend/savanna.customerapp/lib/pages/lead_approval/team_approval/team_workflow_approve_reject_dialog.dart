...
class TeamWorkFlowApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final TeamWorkFlowApproveRejectBtnAction? teamWorkFlowApproveRejectBtnAction;
  LAAssignContent? item;
  PATeamApprovalLeadController? controller;

  TeamWorkFlowApproveRejectDialog(
      {Key? key,
        this.pageName,
        this.teamWorkFlowApproveRejectBtnAction,
        this.item,
        this.controller})
      : super(key: key);
...
class _LeadApproveRejectState extends State<TeamWorkFlowApproveRejectDialog> {
                          ...
                          child: InkWell(
                            onTap: () {
                              if (remarkController.text.isNullOrEmpty()) {
                                ...
                                widget.teamWorkFlowApproveRejectBtnAction!
                                    .teamWorkFlowApproveRejectStatus(
...
abstract class TeamWorkFlowApproveRejectBtnAction {
  void teamWorkFlowApproveRejectStatus(
