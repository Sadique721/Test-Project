...
class ApproveRejectTicketRes extends BaseResponse{
  String? responseMessage;
  Null? data;
  List<ApproveRejectTicketList>? dataList;
  Null? excelDataList;
  int? totalRecords;
  int? pageRecords;
  ...
  ApproveRejectTicketRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ApproveRejectTicketList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new ApproveRejectTicketList.fromJson(v));
      });
    }
...
class ApproveRejectTicketList {
  ...
  ApproveRejectTicketList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
