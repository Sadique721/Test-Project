import 'package:savbill/pages/ticket_system/ticket_management/document_upload_ticket/ticket_view_document_controller.dart';
...
class TicketViewDocumentScreen extends StatefulWidget {
  @override
  _TicketViewDocumentState createState() => _TicketViewDocumentState();
}

class _TicketViewDocumentState extends State<TicketViewDocumentScreen>
    with WidgetsBindingObserver, TickerProviderStateMixin {
  final viewDocumentController = Get.put(TicketViewDocumentController());
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<TicketViewDocumentController>(builder: (controller) {
                                                              ...
                                                              AppTheme
                                                                ...
                                                                if(file.uniqueName != null && section.sectionName != null) {
                                                                  viewDocumentController
                                                                      .downloadFile(
                                                                      "${UrlConstants
                                                                          .ticket_download_document}/${viewDocumentController
                                                                          .ticketId}/${file
                                                                          .uniqueName}/${section
                                                                          .sectionName}/",
                                                                      file);
