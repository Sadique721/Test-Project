...
class ViewTicketController extends GetxController implements TicketAssignAction{
  ...
  getStaffListData(int? itemCaseId, TicketDetail? ticketDetail) {
    isLoading = true;
    staffList!.clear();
    update();
            ...
            try {
              ...
              if (responseData.responseCode != null &&
                ...
                if (responseData.dataList != null &&
                  ...
                  openCaseAssignScreen(ticketDetail, staffList);
                } else {
                  Utils.showSnackbar(
                      Strings.INFO,
  ...
  openCaseAssignScreen(
      TicketDetail? ticketDetail, List<CaseStaffDetail>? staffDetail) async {
