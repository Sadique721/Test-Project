...
class TicketChangeStatusScreen extends StatefulWidget {
  @override
  _TicketChangeStatusState createState() => _TicketChangeStatusState();
}

class _TicketChangeStatusState extends State<TicketChangeStatusScreen> {
  final ticketChangeController = Get.put(TicketChangeStatusController());
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<TicketChangeStatusController>(builder: (controller) {
        return Stack(children: [
          ...
          ProgressBar(isLoader: ticketChangeController.isLoading),
        ]);
      }), /**/
    );
  }

  _body(TicketChangeStatusController controller) {
                      ...
                      children: [
                        ...
                        CoustomTextField(
                            ...
                            textEditingController:
                                ticketChangeController.caseStatusController,
                          ...
                          child: DropdownButtonFormField(
                            ...
                            onChanged: (value) {
                              ...
                              controller.getResolutionReasonsChangeStatus(
                                  value!.value);
                              // if(value.value!.equalsIgnoreCase("Resolved")){
                              //   openCustInventoryDocumentUploadScreen("",controller.userDetail!.userId!,);
                              // }
                              controller.update();
                            },
                            validator: (value) {
                        ...
                        /*__________________ Ticket Close status ____________________*/
                        ...
                        (ticketChangeController.selectedCaseStatus != null &&
                                ticketChangeController
                        ...
                        controller.serviceAreaFlag == true
                            ? CoustomTextField(
                                ...
                                textEditingController: ticketChangeController
                        ...
                        ((ticketChangeController.selectedCaseStatus != null &&
                                    ticketChangeController
                                        .selectedCaseStatus!.value!
                                        .equalsIgnoreCase("Resolved")) ||
                                (ticketChangeController.selectedCaseStatus !=
                                        null &&
                                    ticketChangeController
                                        .selectedCaseStatus!.value!
                                ...
                                children: [
                                  ...
                                  /*DropdownButtonHideUnderline(
                                    child: DropdownButtonFormField(
                                      ...
                                      isDense: true,
                                      value: controller
                                          .selectedActiveStaffUserData,
                                      items: controller.activeStaffUserList
                                          ?.map((ActiveStaffUserList value) {
                                        return DropdownMenuItem<
                                            ActiveStaffUserList>(
                                          value: value,
                                      ...
                                      onChanged: (value) {
                                        controller.selectedActiveStaffUserData =
                                            value as ActiveStaffUserList?;
                                        controller.update();
                                      },
                                      validator: (value) {
                                        // if (value == null ||
                                  ...
                                  DropdownSearch<ActiveStaffUserList>(
                                    key: controller.helperNameDropDownKey,
                                    mode: Mode.form,
                                    selectedItem: controller.selectedActiveStaffUserData,
                                    items: (filter, infiniteScrollProps) =>
                                    controller.activeStaffUserList!,
                                    ...
                                    decoratorProps: DropDownDecoratorProps(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: Strings.select_helper_name,
                        ...
                        InputTitleRequire(
                            title: ticketChangeController.selectedCaseStatus !=
                                        null &&
                                    ticketChangeController
                                        .selectedCaseStatus!.value!
                                        .equalsIgnoreCase("Resolved")
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            controller:
                                ticketChangeController.remarksController,
                            maxLines: 3,
                            maxLength: 250,
  ...
  validateForm() {
    if (ticketChangeFormKey.currentState!.validate()) {
      if (ticketChangeController.selectedCaseStatus!.value!
          .equalsIgnoreCase("Closed")) {
        ticketChangeController.caseAssignCloseRequest();
      } else if (ticketChangeController.selectedCaseStatus!.value!
          .equalsIgnoreCase("Follow Up")) {
        ticketChangeController.caseAssignCloseRequest();
      } else {
        // ticketChangeController.caseAssignRequest();
        ticketChangeController.uploadDocuments();
      }
    } else {
      setState(() {
  ...
  Future<void> selectDate(
    ...
    if (identity == Strings.followup_date_time) {
      if (ticketChangeController.selectedFollowUpDate != null) {
        selectedDate = ticketChangeController.selectedFollowUpDate;
      } else {
    ...
    if (picked != null) {
      if (identity == Strings.followup_date_time) {
        ticketChangeController.selectedFollowUpDate = picked;
        ticketChangeController.nextFollowupDate =
            ticketChangeController.dateOnlyFormat.format(picked).toString();
        ticketChangeController.update();
        _selectDateTime();
      }
    }
  }
  ...
  Future<void> _selectDateTime() async {
    ...
    if (picked != null) {
      DateTime dt = DateTime(
        ticketChangeController.selectedFollowUpDate!.year,
        ticketChangeController.selectedFollowUpDate!.month,
        ticketChangeController.selectedFollowUpDate!.day,
        picked.hour,
        picked.minute,
      );
      ticketChangeController.followupDateTimeController.text =
          ticketChangeController.dateFormat.format(dt);
      ticketChangeController.nextFollowupTime =
          "${picked.hour}:${picked.minute}";
      ticketChangeController.followUpScheduleDateTime =
          ticketChangeController.apiDateTimeFormat.format(dt);
      ticketChangeController.update();
    }
  }


  openCustInventoryDocumentUploadScreen(String? from, int? customerId) async {
    ...
    if (result != null) {
      ...
      ticketChangeController.allFilesSectionData = result;
    }
  }
}
