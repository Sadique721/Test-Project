...
class TatTicketMapDetail extends StatefulWidget {
  @override
  _TatTicketDetailState createState() => _TatTicketDetailState();
}

class _TatTicketDetailState extends State<TatTicketMapDetail> {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: basicDetailItem(
                                        Strings.sla_time_p1,
                                        (tatMappingController.tatTicketDetail!
                                                    .slaTimep1 !=
                                                null)
                                            ? "${tatMappingController.tatTicketDetail!.slaTimep1} ${tatMappingController.tatTicketDetail!.sunitp1!}"
                                            : "-",
                                        Strings.sla_time_p2,
                                        (tatMappingController.tatTicketDetail!
                                                    .slaTimep2 !=
                                                null)
                                            ? "${tatMappingController.tatTicketDetail!.slaTimep2} ${tatMappingController.tatTicketDetail!.sunitp2!}"
                                            : "-",
                                      ),
                                    ),
                                    const SizedBox(
                                    ...
                                    Padding(
                                      ...
                                      child: basicDetailItem(
                                        ...
                                        (tatMappingController.tatTicketDetail!
                                                    .slaTime3 !=
                                                null)
                                            ? "${tatMappingController.tatTicketDetail!.slaTime3} ${tatMappingController.tatTicketDetail!.sunitp3!}"
                                            : "-",
                                        Strings.response_time,
                                        (tatMappingController
                                                    .tatTicketDetail!.rtime !=
                                                null)
                                            ? "${tatMappingController.tatTicketDetail!.rtime} ${tatMappingController.tatTicketDetail!.runit!}"
                                            : "-",
                                      ),
                                    ),
                                    const SizedBox(
  ...
  _appBar() {
    return DynamicAppBar(
        "${tatMappingController.tatTicketDetail!.name!} ${Strings.tat_detail}",
        '',
