class ShiftLocationApproveRejectRes {
  Result? result;
  String? message;
  String? timestamp;
  int? status;

  ShiftLocationApproveRejectRes(
      {this.result, this.message, this.timestamp, this.status});

  ShiftLocationApproveRejectRes.fromJson(Map<String, dynamic> json) {
    result =
...
class Result {
  ...
  List<ShiftLocationApproveDataList>? dataList;
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    if (json['dataList'] != null) {
      dataList = <ShiftLocationApproveDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(ShiftLocationApproveDataList.fromJson(v));
      });
    }
...
class ShiftLocationApproveDataList {
  int? id;
  String? createdate;
  String? updatedate;
  ...
  ShiftLocationApproveDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
