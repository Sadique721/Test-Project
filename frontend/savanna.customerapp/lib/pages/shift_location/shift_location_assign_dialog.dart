...
class ShiftLocationAssignDialog extends StatefulWidget {
  final ShiftLocationAssignAction shiftLocationAssignAction;
  final List<ShiftLocationApproveDataList> itemsOrgLst;
  final String? staffStatus;

  const ShiftLocationAssignDialog({
    Key? key,
    required this.shiftLocationAssignAction,
    required this.itemsOrgLst,
    required this.staffStatus,
  }) : super(key: key);

  @override
  _ShiftLocationAssignState createState() => _ShiftLocationAssignState();
}

class _ShiftLocationAssignState extends State<ShiftLocationAssignDialog> {
  List<ShiftLocationApproveDataList> itemsLst = [];
                    ...
                    Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ShiftLocationApproveDataList item = itemsLst[index];
  ...
  validateSelection() {
    ShiftLocationApproveDataList? selectedItem;
    ...
    if (selectedItem!.selected == true) {
      if (widget.staffStatus!.equalsIgnoreCase(Strings.approve)) {
        ...
        widget.shiftLocationAssignAction.shiftLocationAssignBtnAction(
...
abstract class ShiftLocationAssignAction {
  void shiftLocationAssignBtnAction(
      {ShiftLocationApproveDataList selectedItem,
