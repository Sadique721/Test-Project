...
class AssignInventoryEndOwnerReq {
  int? id;
  int? qty;
  int? productId;
  int? customerId;
  ...
  List<ProductMacDataList>? outInWardMACMapping;
  String? itemAssemblyStatus;
  String? latitude;
  String? longitude;

  AssignInventoryEndOwnerReq({
    this.id,
    this.qty,
    this.productId,
    this.serviceId,
  ...
  AssignInventoryEndOwnerReq.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    qty = json['qty'];
    ...
    if (json['inOutWardMACMapping'] != null) {
      outInWardMACMapping = <ProductMacDataList>[];
      json['inOutWardMACMapping'].forEach((v) {
        outInWardMACMapping!.add(new ProductMacDataList.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.outInWardMACMapping != null) {
      data['inOutWardMACMapping'] =
          this.outInWardMACMapping!.map((v) => v.toJson()).toList();
    }
