class GetItemBasedOnProductTypeRes {
  int? responseCode;
  String? responseMessage;
  dynamic data;
  List<ProductTypDataList>? dataList;
  ...
  GetItemBasedOnProductTypeRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ProductTypDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new ProductTypDataList.fromJson(v));
      });
    }
...
class ProductTypDataList {
  ...
  ProductTypDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
