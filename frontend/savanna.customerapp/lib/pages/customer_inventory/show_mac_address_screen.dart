...
class _SelectMacAddressState extends State<ShowMacAddressScreen> {
  // final otherInventoryController = Get.put(OtherInventoryController());
  final controller = Get.find<OtherInventoryController>();
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (index ==
                        ...
                        ProductMacDataList item = widget.macAddressLst[index];
  ...
  validateSelection() {
    ...
    if (selectedItem.isNotEmpty) {
      widget.macAddressAction
          .selectMacAddressBtnAction(selectedItem: selectedItem);
    } else {
...
abstract class SelectMacAddressAction {
