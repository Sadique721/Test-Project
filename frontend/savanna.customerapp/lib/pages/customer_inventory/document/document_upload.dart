...
class _UploadDocumentState extends State<DocumentUploadScreen>
  ...
  void uploadAllDocuments() {
    ...
    for (int tabIndex = 0; tabIndex < tabs.length; tabIndex++) {
      ...
      if (requiredTabs.contains(tabName) && !isValid) {
    ...
    if (!allRequiredTabsValid) {
      Utils.showSnackbar(
        Strings.ERROR,
        "Please fill required sections: FAT Optical Power Picture, ONU Optical Power Picture, Optical Power Range.",
        AppTheme.colorWhite,
        AppTheme.colorRed,
      );
      return;
    ...
    if (allSectionsData.isNotEmpty) {
      ...
      Utils.showSnackbar(
        Strings.ERROR,
        "No valid section data. Please complete the required fields.",
        AppTheme.colorWhite,
        AppTheme.colorRed,
      );
    }
                                              ...
                                              Expanded(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    // titleWidget(
                                                    //     Strings.latitude),
                                                    titleWithRequireWidget(Strings.latitude, true),
                                                    const SizedBox(
                                                        height: Constant
                                                            .SMALL_PADDING),
                                                    valueWidget(
                                              ...
                                              Expanded(
                                                ...
                                                child: Column(
                                                  ...
                                                  mainAxisAlignment:
                                                      MainAxisAlignment.start,
                                                  children: [
                                                    titleWithRequireWidget(Strings.longitude, true),
                                                    const SizedBox(
                                                        height: Constant
                                                            .SMALL_PADDING),
                                                    valueWidget(
                                          ...
                                          DropdownButtonHideUnderline(
                                            child: DropdownButtonFormField(
                                              ...
                                              onChanged: (String? value) {
                                                setState(() {
                                                  selectedOpticalRanges[tabIndex] = value;
                                                });
                                              },
                                              validator: (value) {
                                                // if (value == null ||
