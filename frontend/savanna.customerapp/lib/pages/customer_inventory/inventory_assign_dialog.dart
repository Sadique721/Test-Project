...
class InventoryAssignDialog extends StatefulWidget {
  final InventoryAssignAction inventoryAssignAction;
  final List<ApproveRejectInventory> itemsOrgLst;
  final String? staffStatus;
  final int? entityId;

  const InventoryAssignDialog({
    Key? key,
    required this.inventoryAssignAction,
...
class _TicketAssignState extends State<InventoryAssignDialog> {
  List<ApproveRejectInventory> itemsLst = [];
                    ...
                    Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ApproveRejectInventory item = itemsLst[index];
  ...
  validateSelection() {
    ...
    if (selectedItem!.selected == true) {
      if (widget.staffStatus!.equalsIgnoreCase(Strings.approve.toLowerCase())) {
        ...
        widget.inventoryAssignAction.inventoryAssignBtnAction(
...
abstract class InventoryAssignAction {
