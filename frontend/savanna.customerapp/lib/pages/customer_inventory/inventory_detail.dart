...
class _CustomerInventoryState extends State<CustomerInventoryDetail>
                          ...
                          return InventoryViewItem(
                              ...
                              onTapApprove: () {
                                ...
                                //     Constant.PENDING.toUpperCase())) {
                                  ...
                                  inventoryDetailController.getInventoryDocumentList(item.id);
                                  inventoryDetailController.approveIdList!
                                      .add(item.id);
                                  addRemarkApproveRejectDialog(
                                      context, Strings.approve, item,inventoryDetailController);
                                // } else {
                                //
                                // }
                              },
                              ...
                              onTapReject: () {
                                if (item.status!.equalsIgnoreCase(
                                  ...
                                  addRemarkApproveRejectDialog(
                                      context, Strings.reject, item,inventoryDetailController);
                                }
                              },
  ...
  addRemarkApproveRejectDialog(
      BuildContext context, String? pageName, CustomerInventoryDataList item,InventoryDetailController controller) {
    showDialog(
        context: context,
        barrierDismissible: true,
        builder: (BuildContext context) {
  ...
  void customerInventoryApproveRejectStatus(
      {String? identifier, TextEditingController? remarkController,int? itemId}) {
    Get.back();
    if (identifier != null && identifier.equalsIgnoreCase(Strings.approve)) {
      inventoryDetailController.getApproveReqInventoryApi(approveRequest: true,remark: remarkController!.text,status: Strings.approve,context: context,itemId: itemId);
      ...
      inventoryDetailController.getApproveReqInventoryApi(approveRequest: false,remark: remarkController!.text,status: Strings.reject,context: context,itemId:itemId );
