...
class CustomerTeamWorkInventoryController extends GetxController {
  ...
  getArgumentData() {
    ...
    if (arguments != null) {
      if (arguments[Constant.ID] != null) {
        eventId = arguments[Constant.ID];
      }

      if(arguments[Constant.EVENT_TYPE] != null){
        eventName = arguments[Constant.EVENT_TYPE];
      }
  ...
  getTeamHierarchyApprovalFlow(int? eventId) {
    ...
    isLoading = true;
    update();
    InventoryProvider().getCustomerTeamWorkFlowProgress(
      eventId: eventId,
      eventName:eventName,
  ...
  workFlowAuditApi(int? eventId) {
    ...
    update();
    InventoryProvider().customerInventoryWorkFlowAudit(
