...
class DocumentApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final DocumentApproveRejectBtnAction? documentApproveRejectBtnAction;
  // final DocumentApproveRejectReq? documentApproveRejectReq;
  final DocumentDetail? documentDetail;

  DocumentApproveRejectDialog(
      {Key? key,
        this.pageName,
        this.documentApproveRejectBtnAction,
        this.documentDetail,
        // this.documentApproveRejectReq
      })
      : super(key: key);

  @override
  _DocumentApproveRejectState createState() => _DocumentApproveRejectState();
}
class _DocumentApproveRejectState extends State<DocumentApproveRejectDialog> {
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                // widget.documentApproveRejectReq!.remarks = controller.text;
                                widget.documentApproveRejectBtnAction!
                                    .documentApproveRejectStatus(
                                  ...
                                  documentDetail: widget.documentDetail!,
                                  // documentApproveRejectReq: widget.doucmentApproveRejectReq
                                );
                              }
                            },
                            child: Container(
...
abstract class DocumentApproveRejectBtnAction {
  void documentApproveRejectStatus(
      {String identifier,
        TextEditingController remarkController,
        DocumentDetail documentDetail,
        // DocumentApproveRejectReq? documentpproveRejectReq
      });
}