...
class AssignInventoryReq {
  ...
  List<InwardMacMapDetail>? inOutWardMACMapping;
  ...
  AssignInventoryReq.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    qty = json['qty'];
    ...
    if (json['inOutWardMACMapping'] != null) {
      inOutWardMACMapping = <InwardMacMapDetail>[];
      // inOutWardMACMapping = <ProductMacDataList>[];
      json['inOutWardMACMapping'].forEach((v) {
        inOutWardMACMapping!.add(new InwardMacMapDetail.fromJson(v));
