...
class ParentStaffRes extends BaseResponse {
  PageDetails? pageDetails;
  List<ParentStaffUserlist>? staffUserlist;
  String? timestamp;
  int? status;
  ...
  ParentStaffRes.fromJson(Map<String, dynamic> json) {
    pageDetails = json['pageDetails'] != null
        ? new PageDetails.fromJson(json['pageDetails'])
        : null;
    if (json['staffUserlist'] != null) {
      staffUserlist = <ParentStaffUserlist>[];
      json['staffUserlist'].forEach((v) {
        staffUserlist!.add(new ParentStaffUserlist.fromJson(v));
      });
    }
...
class ParentStaffUserlist {
  ...
  ParentStaffUserlist.fromJson(Map<String, dynamic> json) {
    id = json['id'];
