...
class PlansByPlanGroupIdRes extends BaseResponse{
  List<PlansByPlanGroupIdPlanList>? planList;
  String? timestamp;
  int? status;

  PlansByPlanGroupIdRes({this.planList, this.timestamp, this.status});

  PlansByPlanGroupIdRes.fromJson(Map<String, dynamic> json) {
    if (json['planList'] != null) {
      planList = <PlansByPlanGroupIdPlanList>[];
      json['planList'].forEach((v) {
        planList!.add(new PlansByPlanGroupIdPlanList.fromJson(v));
      });
    }
...
class PlansByPlanGroupIdPlanList {
  String? createdate;
  String? updatedate;
  ...
  PlansByPlanGroupIdPlanList.fromJson(Map<String, dynamic> json) {
