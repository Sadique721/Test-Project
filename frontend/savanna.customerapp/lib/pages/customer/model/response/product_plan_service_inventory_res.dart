class ProductPlanServiceInventoryRes {
  int? responseCode;
  String? responseMessage;
  dynamic data;
  List<ProductInventoryServiceList>? dataList;
  ...
  ProductPlanServiceInventoryRes(
      {this.responseCode,
  ...
  ProductPlanServiceInventoryRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ProductInventoryServiceList>[];
      json['dataList'].forEach((v) {
        dataList!.add(ProductInventoryServiceList.fromJson(v));
      });
    }
...
class ProductInventoryServiceList {
  String? createdate;
  String? updatedate;
  ...
  int? newProductCharge;
  double? newProductAmount;
  ...
  ProductInventoryServiceList.fromJson(Map<String, dynamic> json) {
