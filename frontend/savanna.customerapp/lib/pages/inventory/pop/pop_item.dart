...
class PopItem extends StatelessWidget {
  ...
  final Function()? onTapInventoryMap;
  final Function()? onTapPopDetails;
  ...
  PopItem({
    ...
    this.onTapEdit,
    this.onTapDelete,
    this.onTapInventoryMap,
    this.onTapPopDetails
  }) : super(key: key);
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: basicDetailItem(
                Strings.latitude,
                (item.latitude != null && item.latitude!.isNotEmpty)
                    ? item.latitude
                    : "-",
                Strings.longitude,
                (item.longitude != null && item.longitude!.isNotEmpty)
                    ? item.longitude
                    : "-"),
          ),
          const SizedBox(
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              ...
              buttonView(statusSvg, AppTheme.custUploadFileLight,
                  AppTheme.custUploadFileDark, onTapInventoryMap!),
            ]),
          ),
          const SizedBox(
            height: Constant.SMALL_PADDING,
