class AddEditBulkConsumptionRes {
  int? responseCode;
  Null? responseMessage;
  AddEditBulkConsumpData? data;
  Null? dataList;
  Null? excelDataList;
  int? totalRecords;
  int? pageRecords;
  ...
  AddEditBulkConsumptionRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'] != null ? AddEditBulkConsumpData.fromJson(json['data']) : null;
...
class AddEditBulkConsumpData {
  ...
  int? ownerId;
  String? ownerType;
  List<Null>? itemListLongId;
  List<Null>? inOutWardMACMappings;

  AddEditBulkConsumpData(
      {this.id,
  ...
  AddEditBulkConsumpData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
