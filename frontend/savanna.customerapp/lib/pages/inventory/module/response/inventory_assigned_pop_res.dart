class InventoryAssignedPopRes {
  int? responseCode;
  String? responseMessage;
  dynamic data;
  List<InventoryAssignedPopDataList>? dataList;
  ...
  InventoryAssignedPopRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <InventoryAssignedPopDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new InventoryAssignedPopDataList.fromJson(v));
      });
    }
...
class InventoryAssignedPopDataList {
  int? id;
  int? qty;
  int? productId;
  String? ownerType;
  ...
  InventoryAssignedPopDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    qty = json['qty'];
