...
class GetSerializedProductDataRes {
  int? responseCode;
  String? responseMessage;
  Null? data;
  List<SerializedDataList>? dataList;
  Null? excelDataList;
  int? totalRecords;
  int? pageRecords;
  ...
  GetSerializedProductDataRes.fromJson(Map<String, dynamic> json) {
    ...
    if (json['dataList'] != null) {
      ...
      json['dataList'].forEach((v) {
        dataList!.add(new SerializedDataList.fromJson(v));
      });
    }
...
class SerializedDataList {
  ...
  SerializedDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
