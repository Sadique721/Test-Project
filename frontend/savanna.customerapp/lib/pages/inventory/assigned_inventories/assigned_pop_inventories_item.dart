...
class AssignedPopInventoriesItem extends StatelessWidget {
  InventoryAssignedPopDataList item;

  AssignedPopInventoriesItem({
    Key? key,
    required this.item,
  }) : super(key: key);
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: basicDetailItem(
                ...
                serialNumberAdd,
                Strings.pop_name,
                item.popName != null && item.popName!.isNotEmpty
                    ? item.popName!
                    : "-"),
          ),
          const SizedBox(
          ...
          Padding(
            ...
            child: basicDetailItem(Strings.assign_qty,
                item.qty != null ? item.qty!.toString() : "-", Strings.mac_address, macAddressValue),
          ),
