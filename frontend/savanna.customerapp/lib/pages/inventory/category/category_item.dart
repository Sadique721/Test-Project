...
class CategoryItem extends StatelessWidget {
  ...
  final Function()? onTapCategoryDetails;
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: basicDetailItem(
                Strings.product_id,
                (item.productId!=null && item.productId!.isNotEmpty) ? item.productId : "-",
                Strings.uom,
          ...
          Padding(
            padding:
                const EdgeInsets.symmetric(horizontal: Constant.SMALL_PADDING),
            child: basicDetailItem(
                Strings.type, item.type!.isNotEmpty ? item.type : "-", "", ""),
          ),
          const SizedBox(
            height: Constant.SMALL_PADDING,
          ),
