class UrlConstants {
  ...
  /// PrePod Server
  // static const MAIN_URL = "http://105.28.32.202:30080";
  ...
  static const assignNonSerializedItemToCustomer =
      "${webURL}/v1/inwards/assignNonSerializedItemToCustomer";
  ...
  static const bill_to =
      "${webURL}/v1/SavbillCommonGateway/commonList/billTo";
  ...
  static const get_all_team_list =
      "${webURL}/v1/SavbillCommonGateway/teams/all";
  ...
  static const service_area =
      "${webURL}/v1/SavbillCommonGateway/serviceArea/all";
