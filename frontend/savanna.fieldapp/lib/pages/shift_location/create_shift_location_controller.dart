...
class CreateShiftLocationController extends GetxController {
  ...
  Future<void> initPlatformState() async {
    ...
    if (!strUserData.isNullOrEmpty()) {
      ...
      requesterByController.text = userDetail?.fullName ?? "";
      requesterId = userDetail?.userId ?? 0;
    }
  }
  ...
  updateShiftLocation() {
    ...
    ShiftCustomerLocationReq request = ShiftCustomerLocationReq(
      addressDetails: AddressDetails(
          ...
          building_mgmt_id: selectedBuildingManagementData != null
              ? selectedBuildingManagementData!.buildingMgmtId
              : null,
          buildingNumber:
              selectedBuildingNumber != null ? selectedBuildingNumber : null,
          ...
          subareaId:
              selectedSubAreaData != null ? selectedSubAreaData!.id : null),
  ...
  getBuildingMgmtCall({int? entityId, String? entryName}) {
    ...
    CustomerProvider().getBuildingMgmt(
      entityId: entityId,
      entityName: entryName!.replaceAll(" ", "%20"),
      onSuccess: (ResponseModel responseModel) {
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            try {
  ...
  handleApiError(ResponseModel error) {
    ...
    if (error.statusCode == 500) {
      Utils.showSnackbar(
          Strings.INFO,
          "Invoices must be cleared for location shift",
          AppTheme.colorWhite,
