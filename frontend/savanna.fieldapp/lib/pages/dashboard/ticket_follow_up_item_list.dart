...
class TicketFollowUpItemList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (item!.status!.equalsIgnoreCase("Pending") || item!.status!.equalsIgnoreCase("pending")) {
        ...
        Card(
          ...
          child: Column(
            ...
            children: [
              ...
              line(),
              cardDataRow(Strings.remarks, item!.remarks ?? ""),
              line(),
              Padding(
