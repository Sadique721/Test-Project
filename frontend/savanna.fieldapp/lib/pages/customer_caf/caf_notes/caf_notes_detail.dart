...
class _CafNotesDetailState extends State<CafNotesDetail> {
  ...
  notesDownload({required bool isExcel}) {
    cafNotesDetailController.getCafAllNotes(isExcel: isExcel);
  }
  ...
  _appBar() {
    ...
    bool showDownloadButton = cafNotesDetailController.customerNotesDetails?.isNotEmpty ?? false;
        ...
        if (showDownloadButton)
          ...
          child: Row(
           // mainAxisSize: MainAxisSize.min,
            children: [
              InkWell(
                onTap: () => notesDownload(isExcel: false),
              ...
              InkWell(
                onTap: () => notesDownload(isExcel: true),
                child: SvgPicture.asset(
                  excelDownloadSvg,
                  height: Constant.CAMERA_ICON_SIZE,
                  width: Constant.CAMERA_ICON_SIZE,
