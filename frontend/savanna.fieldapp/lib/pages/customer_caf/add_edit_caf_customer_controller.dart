...
import 'package:savbill/pages/customer_caf/response/pincode_data_res.dart';
...
class AddEditCafCustomerController extends GetxController {
  ...
  List<CustomerFeasibility>? feasibilityList = [];
  CustomerFeasibility? selectedFeasibilityData;
...
//List<>? dataList;
  ...
  List<PinCodeAllDataList>? pincodeList = [];
  PinCodeAllDataList? selPresentPincode;
  ...
  List<PinCodeAllDataList>? paymentPincodeList = [];
  PinCodeAllDataList? selPaymentPincode;
  ...
  List<PinCodeAllDataList>? permanentPincodeList = [];
  PinCodeAllDataList? selPermanentPincode;
  ...
  List<PinCodeAllDataList>? finalPinCodeList = [];
  ...
  bool? isVisibleAAAPassword = false;
  ...
  bool isCredentialMatchWithAccountNo = true;
          ...
          if (responseModel.result != null) {
            try {
              ...
              if ((responseData.responseCode != null &&
                ...
                if(areaDetail!.pincodes!.isNotEmpty) {
                  if (newPinCodeAllList!.isNotEmpty) {
                    for (var element in newPinCodeAllList!) {
                      if (element.pincodeid == areaDetail!.pincodes![0]) {
                ...
                if(responseData.data!.areaId != null) {
                  if(newAreaAllList!.isNotEmpty) {
                    for (var element in newAreaAllList!) {
                      if (element.id == responseData.data!.areaId) {
                        selectedNewAreaAllData = element;
                      }
                    }
                  }
                } else if(newAreaAllList!.isNotEmpty){
                   selectedNewAreaAllData = newAreaAllList?[0];
                }
  ...
  getAreaDetail({int? subAreaId, int? areaId, String? type}) async {
    if (type!.equalsIgnoreCase("Present")) {
      selPresentCity = null;
      selPresentState = null;
      selPresentCountry = null;
          ...
          if (responseModel.result != null) {
            try {
              ...
              if ((responseData.status != null && responseData.status == 200) ||
                ...
                print("selectedMappingFrom $selectedMappingFrom");
                if (selectedMappingFrom!.contains("Pin Code")) {
                  idData = responseData.data!.pincodeId;
                } else if (selectedMappingFrom!.contains("Area")) {
                  idData = areaId;
                } else {
                  idData = subAreaId;
                }
                ...
                if(newPinCodeAllList!.isEmpty) {
                   await getPincodeData();
                }

                await getPinCodeToAreaData(responseData.data?.pincodeId ?? 0, "Present");
                await getServicAreaIdByPincodeCAll(responseData.data!.pincodeId);
                update();
              } else {
                if (responseData.responseMessage != null &&
                    responseData.responseMessage!.isNotEmpty) {
  ...
  getPincodeData() async {
   ...
   // update();
    ...
    //
    // for (var element in finalPinCodeList!) {
            ...
            try {
              ...
              if (responseData.responseCode == 200) {
                if (responseData.dataList != null &&
                  ...
                  //newPinCodeAllList!.clear();
                  //var finalPinCodeList = [...?newPinCodeAllList];
                  newPinCodeAllList!.clear();
            ...
            try {
              ...
              if ((responseData.status != null && responseData.status == 200) ||
                ...
                if (responseData.dataList != null &&
                  ...
                  newPinCodeAllList!.clear();
                  newPinCodeAllList!.addAll(responseData.dataList!);
                  finalPinCodeList = [...?newPinCodeAllList];
                }
              } else {
                Utils.showSnackbar(Strings.INFO, responseData.responseMessage,
                    AppTheme.colorWhite, AppTheme.colorRed);
  ...
  createCustomerApiCall() {
    ...
    AddEditCustomerCafReq request = AddEditCustomerCafReq(
        ...
        email: emailController.text.trim().isNotEmpty
            ...
            : "",
        title: "",
        // selectedBDType != null ? selectedBDType!.value : "",
        ...
        feasibilityRequired: selectedFeasibilityData?.value,
      ...
      onSuccess: (ResponseModel responseModel) {
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            try {
              Map<String, dynamic> map = responseModel.result;
              PincodeDataRes responseData = PincodeDataRes.fromJson(map);
              if ((responseData.status != null && responseData.status == 200) ||
                  (responseData.responseCode != null &&
                      responseData.responseCode == 200)) {
                if (responseData.data != null) {
          ...
          if (responseModel.result != null) {
            try {
              ...
              if (responseData.responseCode != null &&
                  responseData.responseCode == 200) {
                if (responseData.data != null) {
                  serviceAreaId = responseData.data?.serviceAreaId;
                  // if (newPinCodeAllList!.isNotEmpty) {
                  //   for (var element in newPinCodeAllList!) {
  ...
  getBuildingMgmtCall() {
    ...
    CustomerProvider().getBuildingMgmt(
      ...
      entityName: selectedMappingFrom!.replaceAll(" ", "%20"),
      onSuccess: (ResponseModel responseModel) {
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            try {
  ...
  getCustomerFeasibilityType() {
    selectedFeasibilityData = null;
    feasibilityList!.clear();
    // isLoading = true;
    //update();
    CustomerProvider().getCustomerFeasibility(
      onSuccess: (ResponseModel responseModel) {
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            try {
              Map<String, dynamic> map = responseModel.result;
              CustomerFeasibilityRes responseData =
                  CustomerFeasibilityRes.fromJson(map);
              if (responseData.responseCode == 200) {
                if (responseData.dataList != null &&
                    responseData.dataList!.isNotEmpty) {
                  feasibilityList?.addAll(responseData.dataList!);
                }
              } else {
                if (responseData.responseMessage != null &&
                    responseData.responseMessage!.isNotEmpty) {
