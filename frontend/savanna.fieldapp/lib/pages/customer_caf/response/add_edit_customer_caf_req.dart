...
class AddEditCustomerCafReq {
  ...
  bool? isParentLocation;
  String? locations;


  AddEditCustomerCafReq.fromJson(Map<String, dynamic> json) {
    ...
    macProvision = json['mac_provision'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['mac_provision'] = this.macProvision;
