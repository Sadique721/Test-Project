...
import 'package:savbill/pages/customer_caf/sub_area/subarea_list.dart';
...
class _AddEditCafCustomerState extends State<AddEditCafCustomer>
                    ...
                    Flexible(
                      ...
                      child: CoustomTextField(
                          ...
                          suffixIcon: IconButton(
                            onPressed: () {
                              addEditCafCustomerController
                                      .isVisibleAAAPassword =
                                  !addEditCafCustomerController
                                      .isVisibleAAAPassword!;
                              addEditCafCustomerController.update();
                            },
                            icon: Icon(
                              addEditCafCustomerController.isVisibleAAAPassword!
                                  ? Icons.visibility
                          ...
                          onTextFiledOnTap: () {},
                          readOnly: false,
                          obscureText: addEditCafCustomerController
                              .isVisibleAAAPassword!),
                    ),
                  ],
                )
            ...
            children: [
              ...
              Flexible(
                ...
                child: CoustomTextField(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () {
                        addEditCafCustomerController.isVisiblePassword =
                            !addEditCafCustomerController.isVisiblePassword!;
                        addEditCafCustomerController.update();
                      },
                      icon: Icon(
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
              ...
              Flexible(
                ...
                child: DropdownSearch<ServicesAreaDetail>(
                  ...
                  onChanged: (value) {
                    ...
                    // addEditCafCustomerController.getStaffsByServiceAreaAPI(
                    //     value.id, true);
                    addEditCafCustomerController
                        .getAllBranchesByServiceAreaData(serviceAreaId, true);
                  },
                  validator: (value) {
                    if (value == null ||
                        addEditCafCustomerController.selPresentServiceArea ==
          ...
          addEditCafCustomerController.areaDetail != null &&
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                flex: 2,
                child: CoustomTextField(
                  labelText: Strings.select_a_subarea,
                  hintColor: AppTheme.colorIconGrey,
                  textEditingController:
                      addEditCafCustomerController.subareaController,
                  suffixIcon: Padding(
                    padding: const EdgeInsetsDirectional.all(
                        Constant.LARGE_PADDING - 2),
                    child: SvgPicture.asset(
                  ...
                  onTextValidator: (String? value) {
                    if (value!.isEmpty) {
                      return Strings.please_select_subarea;
                    } else {}
                    return null;
                  },
                  onTextFiledOnTap: () {
                    openServiceAreaScreen();
                  },
                ),
              ),
            ],
              ...
              Expanded(
                ...
                child: DropdownSearch<BuildingManagementDataList>(
                  ...
                  onChanged: (BuildingManagementDataList? value) {
                    addEditCafCustomerController
                        .selectedBuildingManagementData = value!;
                    addEditCafCustomerController
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButtonFormField(
                    ...
                    items: addEditCafCustomerController.paymentPincodeList!
                        .map((PinCodeAllDataList value) {
                      return DropdownMenuItem<PinCodeAllDataList>(
                        value: value,
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: CustomText(
  ...
  validateBasicDetail() {
    if (basicDetailFormKey.currentState!.validate()) {
      if (addEditCafCustomerController.isCredentialMatchWithAccountNo ==
          false) {
  ...
  openServiceAreaScreen() async {
    print("service area: ${addEditCafCustomerController.selectedNewAreaAllData?.id}");
    var result = await Get.to(SubareaList(), arguments: {
      Constant.SERVICE_AREA:
          addEditCafCustomerController.selectedNewAreaAllData?.id
    });
    if (result != null) {
      SubAreaDataList data = result;
      addEditCafCustomerController.selectedSubAreaData = data;
      addEditCafCustomerController.subareaController.text = data.name!;
      ...
      addEditCafCustomerController.buildingNumberList!.clear();
      addEditCafCustomerController.selectedBuildingNumber = null;
      addEditCafCustomerController.idData = data.id;
      addEditCafCustomerController.getAreaIdFromSubAreaIdCall(
          data.id, "Present");
      addEditCafCustomerController.getBuildingReferenceAllCall();
      addEditCafCustomerController.update();
    }
  }
