...
class ApproveRejectServiceDialog extends StatefulWidget {
  String? pageName;
  final ApproveRejectServiceBtnAction? approveRejectServiceBtnAction;
  CustomerPlanServiceDetail? item;

  ApproveRejectServiceDialog(
      {Key? key,
        this.pageName,
        this.approveRejectServiceBtnAction,
        this.item})
      : super(key: key);

  @override
  _ApproveRejectServiceState createState() => _ApproveRejectServiceState();
}

class _ApproveRejectServiceState extends State<ApproveRejectServiceDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.pageName!.equalsIgnoreCase(Strings.approve)) {
      title = Strings.approve_service;
    } else if (widget.pageName!.equalsIgnoreCase(Strings.reject)) {
      title = Strings.reject_service;
    }
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.approveRejectServiceBtnAction!
                                    .approveRejectServiceStatus(
                                    ...
                                    caseId:widget.item!.customerServiceMappingId);
                              }
                            },
                            child: Container(
...
abstract class ApproveRejectServiceBtnAction {
  void approveRejectServiceStatus(
      {String identifier,
