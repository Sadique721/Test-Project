...
class _ServiceManagementViewState extends State<ServiceManagementView> {
  final serviceManagementController = Get.put(ServiceManagementController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ServiceManagementController>(builder: (controller) {
      return Stack(children: <Widget>[
        ...
        ProgressBar(isLoader: serviceManagementController.isLoading),
      ]);
    });
  }
  ...
  _body() {
    ...
    log("customerDetails==>>${jsonEncode(serviceManagementController.customerDetail)}");



    if (serviceManagementController.customerDetail != null) {
      currentCustomerName =
          "${serviceManagementController.customerDetail!.title.toString().capitalizeFirst} ${serviceManagementController.customerDetail!.custname} ${Strings.service_detail}";
    }
    return Container(
  ...
  addServiceScreen() async {
    bool chkRefresh = await Get.to(AddServiceManagement(), arguments: {
      ...
      Constant.CUSTOMER_DETAIL: serviceManagementController.customerDetail,
      Constant.CUSTOMER_TYPE: serviceManagementController.customerType,
    });
    if (chkRefresh) {
      serviceManagementController
          .getPlanServiceData(serviceManagementController.customerDetail!.id!);
    }
  }
}
