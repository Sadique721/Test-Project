...
import 'package:savbill/pages/service_management/approve_reject_service_dialog.dart';
...
class ItemListServiceManagement extends StatelessWidget implements ApproveRejectServiceBtnAction  {
  CustomerPlanServiceDetail item;
  ServiceManagementController controller;
  int index;
  BuildContext context;

  ItemListServiceManagement(
      {Key? key,
      required this.index,
      required this.item,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: CustomText(
                        title: (item.custPlanStatus != null &&
                                item.custPlanStatus!.isNotEmpty)
                            ? item.custPlanStatus
                            : "",
              ...
              child: Row(
                  ...
                  children: [
                    controller.isServiceTermination == true
                        ? buttonView(
                            serviceTerminateSvg,
                            AppTheme.unUseCardBg.withOpacity(0.85),
                            AppTheme.colorWhite,
                            null)
                        : buttonView(
                            serviceTerminateSvg,
                            ...
                            AppTheme.colorWhite,
                            () {
                              controller.getDeActiveReasonService(
                                  context,
                                  controller,
                                  item,
                                  Strings.cust_service_termination,
                                  "");
                              // controller.showServiceTerminationDialog(
                              //     Strings.cust_service_termination, context,controller);
                              // Utils.showSnackbar(
                              //     Strings.SUCCESS,
                    ...
                    controller.isPickService == true
                        ...
                        : buttonView(
                            ...
                            AppTheme.colorWhite,
                            () {
                              controller.pickUpService(item.customerServiceMappingId);
                            },
                          ),
                    const SizedBox(
                      width: Constant.SMALL_PADDING + 3,
                    ...
                    controller.isApproveRejectService == true
                        ...
                        : buttonView(
                            ...
                            AppTheme.colorWhite,
                            () {
                              addRemarkServiceDialog(context,Strings.approve,item);
                            },
                          ),
                    const SizedBox(
                      width: Constant.SMALL_PADDING + 3,
                    ...
                    controller.isApproveRejectService == true
                        ...
                        : buttonView(
                            ...
                            AppTheme.colorWhite,
                            () {
                              addRemarkServiceDialog(context,Strings.reject,item);
                            },
                          ),
                    const SizedBox(
                      width: Constant.SMALL_PADDING + 3,
                    ...
                    controller.isWorkFlowStatusDetail == true
                        ...
                        : buttonView(
                            ...
                            AppTheme.colorWhite,
                            () {
                              openDiscountStatus(item.custPlanMapppingId);
                            },
                          ),
                    const SizedBox(
                      width: Constant.SMALL_PADDING + 3,
                  ...
                  children: [
                    controller.isServiceAudit == true
                        ...
                        : buttonView(
                            ...
                            AppTheme.colorWhite,
                            () {
                              openServiceAuditStatus(
                                  item.customerServiceMappingId);
                            },
                          ),
                    const SizedBox(
                      width: Constant.SMALL_PADDING + 3,
                    ...
                    controller.isPauseStartService == true
                        ...
                        : buttonView(
                            ...
                            AppTheme.colorWhite,
                            () {
                              if (item.custPlanStatus!
                                      .toLowerCase()
                                      .equalsIgnoreCase(
                                          Strings.active.toLowerCase()) &&
                                  !(item.custPlanStatus!
                                      .toLowerCase()
                                      .equalsIgnoreCase(
                                          Strings.disable.toLowerCase()))) {
                                log("serviceHoldResumeSvg===>Pause");
                                controller.openPauseServiceModel(
                                    item, "Pause", context, controller);
                              } else if (!(item.custPlanStatus!
                                      .toLowerCase()
                                      .equalsIgnoreCase("disable")) &&
                                  item.custPlanStatus!
                                      .toLowerCase()
                                      .equalsIgnoreCase("hold")) {
                                log("serviceHoldResumeSvg===>Start");
                                controller.openPauseServiceModel(
                                    item, "Start", context, controller);
                              }
                            },
                          ),
                    const SizedBox(
  ...
  addRemarkServiceDialog(BuildContext context, String? pageName, CustomerPlanServiceDetail? item) {
    showDialog(
        context: context,
        barrierDismissible: true,
        builder: (BuildContext context) {
          return ApproveRejectServiceDialog(
            pageName: pageName,
            approveRejectServiceBtnAction: this,
            item: item,
          );
        });
  }
  ...
  @override
  void approveRejectServiceStatus({String? identifier, TextEditingController? remarkController, int? caseId}) {
    Get.back();
    if (identifier != null && identifier.equalsIgnoreCase(Strings.approve)) {
      controller.approveRejectService(
          status: Strings.approve,
          remark: remarkController!.text,
          serviceMappingId: caseId,
          context: context);
