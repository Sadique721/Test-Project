...
class CustomerInventoryApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final CustomerInventoryApproveRejectBtnAction? inventoryApproveRejectBtnAction;
  int? itemId;
  CustomerInventoryDataList? item;
  InventoryDetailController? controller;

  CustomerInventoryApproveRejectDialog({Key? key,
    this.pageName,
    this.inventoryApproveRejectBtnAction,
    this.itemId,
    this.item,
  this.controller})
      : super(key: key);
  ...
  @override
  _CustomerInventoryApproveRejectState createState() =>
      _CustomerInventoryApproveRejectState();
}

class _CustomerInventoryApproveRejectState
    extends State<CustomerInventoryApproveRejectDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.pageName!.equalsIgnoreCase(Strings.approve)) {
      title = "${widget.pageName} ${Strings.assign_inventory}";
                          ...
                          child: InkWell(
                            onTap: () {
                              if (remarkController.text.isNullOrEmpty()) {
                                ...
                                if(widget.item?.hasSerial == false || widget.pageName!.equalsIgnoreCase(Strings.reject)) {
                                  widget.inventoryApproveRejectBtnAction!
                                      .customerInventoryApproveRejectStatus(
                                ...
                                if(widget.controller!.documentList!.isNotEmpty) {
                                  // widget.paymentApproveRejectReq!.remarks = controller.text;
                                  widget.inventoryApproveRejectBtnAction!
                                      .customerInventoryApproveRejectStatus(
                                      identifier: widget.pageName!
                                          .equalsIgnoreCase(
                                  ...
                                  Utils.showSnackbar(
                                      Strings.INFO,
                                      "Please upload the document first. Inventory approval will follow.",
                                      AppTheme.colorWhite,
...
abstract class CustomerInventoryApproveRejectBtnAction {
  void customerInventoryApproveRejectStatus({String identifier,
