import 'package:savbill/pages/customer_inventory/customer_inventory_team_work_flow_controller.dart';
...
class CustomerTeamWorkInventoryFlow extends StatefulWidget {
  const CustomerTeamWorkInventoryFlow({super.key});

  @override
  _CustomerTeamWorkInventoryFlowState createState() => _CustomerTeamWorkInventoryFlowState();
}

class _CustomerTeamWorkInventoryFlowState extends State<CustomerTeamWorkInventoryFlow> {
  final customerTeamInventoryController = Get.put(CustomerTeamWorkInventoryController());
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<CustomerTeamWorkInventoryController>(builder: (controller) {
        return Stack(children: [
          ...
          ProgressBar(isLoader: customerTeamInventoryController.isLoading),
        ]);
      }), /**/
    );
  }
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                customerTeamInventoryController
                    .teamHierarchyDataList!.isNotEmpty ? Container(
                  height: 100,
                  padding: const EdgeInsets.all(Constant.MEDIUM_PADDING),
                  child: ListView.builder(
                      shrinkWrap: true,
                      controller: customerTeamInventoryController.controller,
                      scrollDirection: Axis.horizontal,
                      itemCount: customerTeamInventoryController
                      ...
                      itemBuilder: (context, index) {
                        if (index ==
                            customerTeamInventoryController
                                .teamHierarchyDataList?.length) {
                          if (customerTeamInventoryController.isShowLoadMore) {
                            return Padding(
                              padding:
                ...
                customerTeamInventoryController
                    .workFlowAuditDataList!.isNotEmpty ? Container(
                  padding: const EdgeInsets.all(Constant.SMALL_PADDING),
                  child: ListView.builder(
  ...
  validateForm() {
    if (teamWorkInventoryFormKey.currentState!.validate()) {
      // customerTeamInventoryController.assignInventory();
    } else {
      setState(() {
      ...
      children: [
        Row(
          ...
          children: [
            ...
            customerTeamInventoryController.teamHierarchyDataList!.length - 1 ==
                index
                ? const SizedBox.shrink()
                : Container(
              height: 3,
