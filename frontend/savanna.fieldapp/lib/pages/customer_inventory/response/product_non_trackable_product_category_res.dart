class ProductNonTrackableProductCategoryRes {
  int? responseCode;
  String? responseMessage;
  dynamic data;
  List<ProductTrackableDataList>? dataList;
  ...
  ProductNonTrackableProductCategoryRes(
      {this.responseCode,
  ...
  ProductNonTrackableProductCategoryRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ProductTrackableDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(ProductTrackableDataList.fromJson(v));
      });
    }
...
class ProductTrackableDataList {
  dynamic createdate;
  dynamic updatedate;
  ...
  ProductTrackableDataList.fromJson(Map<String, dynamic> json) {
