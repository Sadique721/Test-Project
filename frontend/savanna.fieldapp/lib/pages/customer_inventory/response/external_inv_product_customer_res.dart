class ExternalInvProductsCustomerRes {
  dynamic responseCode;
  String? responseMessage;
  dynamic data;
  List<ExternalInvProductsDataList>? dataList;
  ...
  ExternalInvProductsCustomerRes(
      {this.responseCode,
  ...
  ExternalInvProductsCustomerRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ExternalInvProductsDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(ExternalInvProductsDataList.fromJson(v));
      });
    }
...
class ExternalInvProductsDataList {
  String? createdate;
  String? updatedate;
  ...
  ExternalInvProductsDataList.fromJson(Map<String, dynamic> json) {
