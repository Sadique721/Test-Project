                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                child: DropdownButtonFormField(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    if (value!.text!.equalsIgnoreCase(
                                      ...
                                      controller.selectedProductPlanService = null;
                                      controller.selectedConditionType = null;
                                      controller.oldOfferPriceController.clear();
                                      controller.newOfferPriceController.clear();
                                      controller.assignMacController.text = "";
                                      controller.oldOfferPriceController.text = "0.0";
                                      controller.newOfferPriceController.text = "0.0";
                            ...
                            ? DropdownButtonHideUnderline(
                                child: DropdownButtonFormField(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    controller.productId = value?.id ?? 0;
                                    print("productId ${controller.productId}");
                        ...
                        if(controller.serializedItemVisible == true)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
...
/*____________________ Billable To ____________________*/
                        ...
                        /*__________________ Inventory Type_________________________*/

                        const SizedBox(
                          height: Constant.MEDIUM_PADDING,
                        ),
                        InputTitleRequire(
                            title: Strings.inventory_type, require: true),
                        const SizedBox(
                          height: Constant.SMALL_PADDING,
                        ),
                        DropdownButtonHideUnderline(
                          child: DropdownButtonFormField<InventoryTypeDataList>(
                            icon: SvgPicture.asset(
                              downArrowSvg,
                              height: Constant.DROP_DOWN_ARROW_W_H,
                              width: Constant.DROP_DOWN_ARROW_W_H,
                            ...
                            // selected value
                            value: controller.selectedInventoryType,

                            // items
                            items: controller.inventoryTypeList.map((value) {
                              return DropdownMenuItem<InventoryTypeDataList>(
                                value: value,
                                child: Text(
                                    value.displayName ?? ""), // null-safe text
                              );
                            }).toList(),
                            ...
                            validator: (value) {
                              if (value == null) {
                                return Strings.select_inventory_type;
                              }
                              return null;
                            },
                          ),
                        ...
                        /*__________________ Nature_________________________*/

                        const SizedBox(
                          height: Constant.MEDIUM_PADDING,
                        ),
                        InputTitleRequire(title: Strings.nature, require: true),
                        const SizedBox(
                          height: Constant.SMALL_PADDING,
                        ),
                        DropdownButtonHideUnderline(
                          child: DropdownButtonFormField<NatureDataList>(
                            icon: SvgPicture.asset(
                              downArrowSvg,
                              height: Constant.DROP_DOWN_ARROW_W_H,
                              width: Constant.DROP_DOWN_ARROW_W_H,
                            ...
                            // selected value
                            value: controller.selectedNature,

                            // items
                            items: controller.natureList.map((value) {
                              return DropdownMenuItem<NatureDataList>(
                                value: value,
                                child: Text(
                                    value.displayName ?? ""), // null-safe text
                              );
                            ...
                            // onChange
                            onChanged: (value) {
                              controller.selectedNature = value;
                            },

                            // validator
                            validator: (value) {
                              if (value == null) {
                                return Strings.select_nature;
                              }
                              return null;
                            },
                          ),
  ...
  void selectMacAddressBtnAction({List<ProductMacDataList>? selectedItem}) {
    ...
    if (selectedItem != null) {
      ...
      for (int i = 0; i < selectedItem.length; i++) {
        ...
        otherInventoryController.selectedSerialNumber!
            .add(element.serialNumber!);
      }
      otherInventoryController.getAllInventorySpecByItemIdApiCall(
          otherInventoryController.macItemId);
