...
class CustomerMobileNumberDialog extends StatefulWidget {
  final String title;
  final TextEditingController mobileController;
  InvoiceDetail? plan;
  ActivePaymentConfig? selectedItem;

  CustomerMobileNumberDialog({
    Key? key,
    required this.title,
  ...
  @override
  State<CustomerMobileNumberDialog> createState() => _CustomDialogForInvoicePaymentState();
}

class _CustomDialogForInvoicePaymentState extends State<CustomerMobileNumberDialog> {
  final customerInvoiceController = Get.find<CustomerInvoiceController>();
