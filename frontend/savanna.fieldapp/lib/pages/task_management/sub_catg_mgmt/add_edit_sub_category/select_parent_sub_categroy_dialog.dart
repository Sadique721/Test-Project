...
class SelectParentSubCategoryDialog extends StatefulWidget {
  final SelectParentCategoryAction serviceAreaSelectionAction;
  final List<TaskCategoryMgmtDataList>? parentCategoryList;
  final String fromFor;

  const SelectParentSubCategoryDialog({
    Key? key,
  ...
  @override
  _SelectParentCategoryState createState() => _SelectParentCategoryState();
}

class _SelectParentCategoryState extends State<SelectParentSubCategoryDialog> {
  List<TaskCategoryMgmtDataList>? itemsParentList = [];
  ...
  Widget build(BuildContext context) {
    String title = "";
    if (widget.fromFor.equalsIgnoreCase(Strings.parent_category)) {
                    ...
                    Flexible(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            TaskCategoryMgmtDataList item = itemsParentList![index];
                            return Column(
                              children: [
                                InkWell(
                                  onTap: () {
  ...
  validateSelection() {
    List<TaskCategoryMgmtDataList> selectedItem = [];
