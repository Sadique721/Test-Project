...
class TaskSubCategoryItem extends StatelessWidget {
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(onTap: onTapDetail,child: valueWidget((item.subCategoryName != null && item.subCategoryName!.isNotEmpty)
