...
class TatTaskItem extends StatelessWidget {
  TatTaskListDetails item;
  int index;
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: basicDetailItem(
              Strings.sla_time_p3,
              (item.slaTime3 != null)
                  ? "${item.slaTime3} ${item.sunitp3 ?? "-"}" // Use ?? to provide a fallback if null
                  : "-",
              Strings.response_time,
              (item.rtime != null)
                  ? "${item.rtime} ${item.runit?? ""}" // Use ?? to provide a fallback if null
                  : "-",
            ),
          ),
          const SizedBox(
