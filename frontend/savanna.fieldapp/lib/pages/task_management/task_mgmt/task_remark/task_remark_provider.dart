...
class TaskRemarkProvider {
  //task Followup Details Save
  void saveTaskFollowupDetails({
    TaskRemarkReq? request,
    Function()? beforeSend,
    Function(ResponseModel responseModel)? onSuccess,
    Function(ResponseModel error)? onError,
  }) {
    ApiRequest(url: UrlConstants.task_follow_up_save, data: request)
        .postRequest(
