...
import '../../model/response/view_task_detail_response.dart';
...
class _TaskDetailState extends State<TaskDetailScreen>
  ...
  taskAttachmentView() {
    ...
    //                       .taskDetail!.caseDocDetails?.length,
    //                   itemBuilder: (context, ii) {
    //                     CaseDocDetails? items = taskDetailController
    //                         .taskDetail!.caseDocDetails?[ii];
    //                     int? lstLength = taskDetailController
    //                         .taskDetail!.caseDocDetails!.length;
    //                     return Padding(
    //                       padding: EdgeInsets.only(
    //                           top: (ii == 0)
    ...
    //                                         InkWell(
    //                                             onTap: () {
    //                                               taskDetailController.downloadFile(
  ...
  actionButtonView(TaskDetailController taskDetailController) {
    ...
    if ((taskDetailController.userDetail!.userId ==
    ...
    if (taskDetailController.taskDetail!.caseStatus!.equalsIgnoreCase("Done") ||
        taskDetailController.taskDetail!.caseStatus!
            .equalsIgnoreCase("Discarded") ||
        (taskDetailController.taskDetail!.currentAssigneeId !=
            taskDetailController.userDetail!.userId)) {
    ...
    if (taskDetailController.taskDetail!.currentAssigneeId == null ||
        taskDetailController.taskDetail!.caseStatus!.equalsIgnoreCase("Done") ||
        taskDetailController.taskDetail!.caseStatus!
            .equalsIgnoreCase("Discarded") ||
        taskDetailController.taskDetail!.caseStatus!
            .equalsIgnoreCase("Resolved") ||
              ...
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      basicDetailItem(
                          Strings.category,
                          taskDetailController.taskDetail?.caseCategoryName ??
                              "-",
                          Strings.task_type,
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(
                                    height: Constant.VERY_SMALL_PADDING - 1),
                                taskDetailController.showTATDetailsData !=
                                            null &&
                                        taskDetailController.showTATDetailsData!
                                            .name!.isNotEmpty
                                    ? InkWell(
  ...
  _appBar() {
    return DynamicAppBar(Strings.task_detail, '', AppTheme.colorPrimary, false,
  ...
  openTaskChangeStatusScreen(TaskDetailController taskDetailController, String? tickT) async {
    var result = await Get.to(TaskChangeStatusScreen(), arguments: {
      Constant.TASK_DETAIL: taskDetailController.taskDetail,
  ...
  openLinkTicketScreen(TaskDetail? taskDetail) async {
    var result = await Get.to(LinkTask(), arguments: {
  ...
  onTaskETRScreen(TaskDetail? taskDetail) async {
    var result = await Get.to(TaskETRScreen(), arguments: {
      Constant.TASK_DETAIL: taskDetail,
    });
    if (result != null && result == true) {
  ...
  onTaskDocumentViewScreen(TaskDetail? taskDetail) async {
    var result = await Get.to(TaskViewDocumentScreen(), arguments: {
  ...
  onTaskRemarkScreen(TaskDetailController taskDetailController) async {
    var result = await Get.to(TaskRemarkScreen(), arguments: {
      Constant.TASK_DETAIL: taskDetailController.taskDetail,
    });
    if (result != null && result == true) {
      taskDetailController.getTicketListData();
  ...
  taskHistoryDialog(BuildContext context, List<UpdateDetails>? item) {
    return showDialog(
        barrierDismissible: true,
        context: context,
        builder: (context) {
                              ...
                              children: [
                                ...
                                ListView.builder(
                                    ...
                                    itemBuilder: (BuildContext context, int index) {
                                      UpdateDetails? itemDetail = item?[index];
