...
class LinkTaskViewItem extends StatefulWidget {
  ViewTaskDataList item;
  int userid;
  LinkTaskController? controller;
  ...
  @override
  State<LinkTaskViewItem> createState() => _ViewTicketItemState();
}

class _ViewTicketItemState extends State<LinkTaskViewItem> {
  bool showEdit = false,
      showApprove = false,
      showReject = false,
                  ...
                  children: [
                    ...
                    widget.item.caseStatus!.equalsIgnoreCase("Raise and Close")
                      ...
                      widgetBuilder: (_, CurrentRemainingTime? time) {
                        ...
                        return valueWidget(
                          "${time.days ?? 00}:${time.hours ?? 00}:${time.min ??
                              00}:${time.sec ?? 00}",
                        );
                      },
                    )
