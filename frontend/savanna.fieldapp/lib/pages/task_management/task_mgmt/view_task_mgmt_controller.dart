...
class ViewTaskMgmtController extends GetxController implements TicketAssignAction{
  ...
  getAllTeamList(TaskDetailController taskDetailController, TaskDetail? taskDetail ) {
              ...
              try {
                ...
                if (responseData.responseCode != null &&
                  ...
                  if (responseData.dataList != null &&
                    ...
                    openCaseAssignScreen(taskDetailController:taskDetailController ,teamDetail: allTeamList,assignStaffParentId: assignStaffParentId);
                  } else {
                    Utils.showSnackbar(
                        Strings.INFO,
  ...
  openCaseAssignScreen(
      {required TaskDetailController taskDetailController,
