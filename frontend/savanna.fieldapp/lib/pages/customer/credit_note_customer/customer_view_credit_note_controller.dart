...
import 'package:savbill/pages/credit_note/create_credit_controller.dart';
...
class CustomerCreditNoteController extends GetxController
  ...
  getCreditNoteListData() {
    String apiUrl = "${UrlConstants.customer_credit_note_list}&page=$page&pageSize=$pageSize&customerid=${customerDetail!.id}&paystatus=&paytodate=&payfromdate=";
    if (isFirstTime) {
      isLoading = true;
    } else {
