...
class _CafNotesDetailState extends State<CustomerNotesDetail> {
  ...
  _notesDownload({required bool isExcel}) {
    customerNotesDetailController.getCustomerAllNotes(isExcel: isExcel);
  }
  ...
  _appBar() {
    ...
    bool showDownloadButton = customerNotesDetailController.customerNotesDetails?.isNotEmpty ?? false;
      ...
      [
        ...
        Padding(
         ...
         child: Row(
            ...
            children: [
              InkWell(
                onTap: () => _notesDownload(isExcel: false),
              ...
              SizedBox(width: 5), // no gap
              InkWell(
                onTap: () => _notesDownload(isExcel: true),
                child: SvgPicture.asset(
                  excelDownloadSvg,
                  height: Constant.CAMERA_ICON_SIZE,
                  width: Constant.CAMERA_ICON_SIZE,
