...
class NetworkDevicesByDeviceTypeRes {
  int? responseCode;
  String? responseMessage;
  Null? data;
  List<NetworkDevicesByDeviceDataList>? dataList;
  Null? excelDataList;
  int? totalRecords;
  int? pageRecords;
  ...
  NetworkDevicesByDeviceTypeRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <NetworkDevicesByDeviceDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new NetworkDevicesByDeviceDataList.fromJson(v));
      });
    }
...
class NetworkDevicesByDeviceDataList {
  String? createdate;
  String? updatedate;
  ...
  dynamic longitude;
  bool? isDeleted;
  ServiceAreaNameList? servicearea;
  ...
  NetworkDevicesByDeviceDataList.fromJson(Map<String, dynamic> json) {
    ...
    servicearea = json['servicearea'] != null
        ? new ServiceAreaNameList.fromJson(json['servicearea'])
        : null;
