...
class CustomerStatusRes extends BaseResponse {
  List<CustomerStatusDetail>? dataList;

  CustomerStatusRes({responseCode, responseMessage, this.dataList});

  CustomerStatusRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    if (json['dataList'] != null) {
      dataList = <CustomerStatusDetail>[];
      json['dataList'].forEach((v) {
        dataList!.add(new CustomerStatusDetail.fromJson(v));
      });
    }
  }
