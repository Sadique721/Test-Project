...
import 'package:savbill/pages/customer/doc_create/create_doc_cust_controller.dart';
...
class CreateDocumentCustomer extends StatefulWidget {
  @override
  _CreateDocumentCustomerState createState() => _CreateDocumentCustomerState();
}

class _CreateDocumentCustomerState extends State<CreateDocumentCustomer>
    with WidgetsBindingObserver
    implements ImageOptionBtnAction, PermissionDenyBtnAction {
  late AppLifecycleState appState;
  final createDocCustController = Get.put(CreateDocCustomerController());
  final createDocCustFormKey = GlobalKey<FormState>();
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    switch (state) {
      ...
      case AppLifecycleState.resumed:
        if (createDocCustController.checkBtnClickEvent) {
          createDocCustController.setBtnClickEvent(false);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<CreateDocCustomerController>(builder: (controller) {
        return Stack(children: [
          ...
          ProgressBar(isLoader: createDocCustController.isLoading),
        ]);
      }),
    );
  }
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Padding(
                    ...
                    child: Form(
                      key: createDocCustFormKey,
                      autovalidateMode:
                          createDocCustController.autoValidateMode,
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: IgnorePointer(
                                  ignoring:
                                      createDocCustController.documentDetail !=
                                              null
                                          ? true
                                          : false,
                                  child: DropdownButtonHideUnderline(
                                    child: DropdownButtonFormField(
                                      ...
                                      isExpanded: true,
                                      isDense: true,
                                      value: createDocCustController
                                          .selectDocVerification,
                                      items: createDocCustController
                                          .docVerificationList!
                                      ...
                                      onChanged: (value) {
                                        createDocCustController
                                                .selectDocVerification =
                                            value as VerificationDataList?;
                                        createDocCustController.update();
                                        createDocCustController
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(
                                flex: 1,
                                child: titleWithRequireWidget(
                                    Strings.document_sub_type_new, true),
                              ),
                              const SizedBox(
                                width: Constant.SMALL_PADDING,
                              ),
                          ...
                          const SizedBox(height: Constant.MEDIUM_PADDING),
                          createDocCustController.selectDocVerification !=
                                      null &&
                                  (createDocCustController
                                          .selectDocVerification!.value!
                                          .equalsIgnoreCase("online") &&
                                      createDocCustController.from!
              ...
              children: [
                Expanded(
                  child: SimpleButton(
                    ...
                    child: CustomText(
                      title: createDocCustController.from!
                              .equalsIgnoreCase(Strings.add)
  ...
  Future<void> selectDate(
    ...
    if (identity == Strings.start_date) {
      if (createDocCustController.selectedStartDate != null) {
        selectedDate = createDocCustController.selectedStartDate;
      } else {
        selectedDate = DateTime.now();
      }
    } else if (identity == Strings.end_date) {
      if (createDocCustController.selectedEndDate != null) {
        selectedDate = createDocCustController.selectedEndDate;
      } else {
        selectedDate = DateTime.now();
      }
    }
    ...
    if (picked != null) {
      if (identity == Strings.start_date) {
        createDocCustController.selectedStartDate = picked;
        createDocCustController.startDateController.text =
            createDocCustController.apiDateFormat.format(picked);
      } else if (identity == Strings.end_date) {
        createDocCustController.selectedEndDate = picked;
        createDocCustController.endDateController.text =
            createDocCustController.apiDateFormat.format(picked);
      }
      createDocCustController.update();
    }
  ...
  _appBar() {
    return DynamicAppBar(
        createDocCustController.from!.equalsIgnoreCase(Strings.add)
            ? Strings.create_cust_document
            : Strings.update_cust_document,
        '',
  ...
  validateForm() {
    if (createDocCustFormKey.currentState!.validate()) {
      if(createDocCustController.from!.equalsIgnoreCase(Strings.add) || createDocCustController.documentDetail == null){
        createDocCustController.customerUploadDocument();
      }else if(createDocCustController.from!.equalsIgnoreCase(Strings.edit) || createDocCustController.documentDetail != null){
        createDocCustController.customerUploadDocumentUpdate(createDocCustController.documentDetail);
      }
    } else {
      setState(() {
  ...
  fileViewWidget() {
    return createDocCustController.fileDetail != null
        ? FileGridItem(
            fileDetail: createDocCustController.fileDetail!,
            onTapItem: () {},
  ...
  fileItemAction() {
    return createDocCustController.fileDetail != null &&
            createDocCustController.fileDetail!.isFileLocal == true
        ? Align(
            alignment: Alignment.topRight,
            child: InkWell(
              onTap: () {
                createDocCustController.fileDetail = null;
                createDocCustController.update();
              },
              child: Container(
                height: 22,
  ...
  void btnClickAction({String? btnIdentifier}) {
    ...
    if (btnIdentifier!.equalsIgnoreCase(Strings.app_permission_settings)) {
      createDocCustController.setBtnClickEvent(true);
      openAppSettings();
    }
  }
  ...
  openFilePicker() async {
    ...
    if (result != null && result.files.isNotEmpty) {
      ...
      if (size <= 5000) {
        createDocCustController.fileDetail = FileDetail(
    ...
    try {
      ...
      if (image != null && !image.path.isNullOrEmpty()) {
        ...
        if (size <= 5000) {
          ...
          print("File MIME type: $mimeType"); // e.g., image/jpeg
          print("File extension: $extension"); // e.g., jpg
          ...
          createDocCustController.fileDetail = FileDetail(
              ...
              isFileLocal: true,
              fileType: mimeType ?? Strings.image);
        } else {
          Utils.showSnackbar(
              Strings.ERROR,
              "Your file size is very large, please select up to 5000kb file size.",
  ...
  remarksView() {
    return Container(
      ...
      child: TextFormField(
        controller: createDocCustController.remarkController,
        maxLines: 3,
        maxLength: 250,
