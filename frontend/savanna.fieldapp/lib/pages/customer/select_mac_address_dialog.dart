...
class SelectMacAddressDialog extends StatefulWidget {
...
class _SelectMacAddressState extends State<SelectMacAddressDialog> {
  ...
  void initState() {
    super.initState();
    // macAddController = TextEditingController();
