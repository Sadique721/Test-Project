...
class RemarkDialog extends StatefulWidget {
  final PromisePayRemarkBtnAction? promisePayRemarkBtnAction;
  final InventoryRemarkBtnAction? inventoryRemarkBtnAction;
  final InvoiceAddRemarkBtnAction? invoiceAddRemarkBtnAction;
  String? pageName;
  ...
  RemarkDialog(
      {Key? key,
      this.pageName,
      this.promisePayRemarkBtnAction,
      this.itemList,
      this.inventoryRemarkBtnAction,
      this.invoiceAddRemarkBtnAction,})
      : super(key: key);
...
class _RemarkState extends State<RemarkDialog> {
  ...
  Widget build(BuildContext context) {
    String title = widget.pageName!.equalsIgnoreCase('inventoryDetails')
        ? Strings.change_approve_status_remove_inv
        : Strings.add_remarks;
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.inventoryRemarkBtnAction!
                                    .inventoryRemarkBtnAction(
                                        identifier: widget.pageName!
                                                .equalsIgnoreCase(
                                                    "inventoryDetails")
                                            ? Strings.approve
                                            : Strings.save,
                                        itemId: widget.itemList!.itemId,
                            ...
                            child: Container(
                              ...
                              child: Text(
                                widget.pageName!
                                        .equalsIgnoreCase("inventoryDetails")
                                    ? Strings.approve
                                    : Strings.save,
                                style: TextStyle(
...
abstract class PromisePayRemarkBtnAction {
  void promisePayRemarkBtnAction(
      {String identifier, TextEditingController remarkController});
}
abstract class InvoiceAddRemarkBtnAction {
  void invoicePaymentDetails(
      {String identifier, TextEditingController remarkController});
}

abstract class InventoryRemarkBtnAction {
  void inventoryRemarkBtnAction(
      {String identifier,
