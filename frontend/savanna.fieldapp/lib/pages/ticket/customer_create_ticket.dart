...
class _CreateTicketState extends State<CustomerCreateTicket>
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          customerTicketController.from.equalsIgnoreCase(Strings.edit) ? const SizedBox(height: Constant.MEDIUM_PADDING) : Container(),
                          ...
                          const SizedBox(height: Constant.MEDIUM_PADDING),
                          customerTicketController.selectedCaseStatus != null &&
                              customerTicketController.selectedCaseStatus!.value!
  ...
  Future<void> selectDate(
    ...
    if (identity == Strings.followup_date_time) {
      if (customerTicketController.selectedFollowUpDate != null) {
        selectedDate = customerTicketController.selectedFollowUpDate;
      } else {
    ...
    if (picked != null) {
      if (identity == Strings.followup_date_time) {
        customerTicketController.selectedFollowUpDate = picked;
        customerTicketController.update();
        _selectDateTime();
      }
    }
  ...
  Future<void> _selectDateTime() async {
    ...
    if (picked != null) {
      DateTime dt = DateTime(
        customerTicketController.selectedFollowUpDate!.year,
        customerTicketController.selectedFollowUpDate!.month,
        customerTicketController.selectedFollowUpDate!.day,
        picked.hour,
        picked.minute,
      );
      customerTicketController.followupDateTimeController.text =
          customerTicketController.dateFormat.format(dt);
      customerTicketController.followUpScheduleDate = customerTicketController.apiDateFormat.format(dt);
      customerTicketController.followUpScheduleTime = customerTicketController.apiTimeFormat.format(dt);
      customerTicketController.update();
    }
  }
}
