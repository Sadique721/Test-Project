...
class LoginController extends GetxController {
        ...
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            UserDetail loginResponse =
                UserDetail.fromJson(responseModel.result);
            if (loginResponse.status == 200) {
              if (!loginResponse.accessToken!.isNullOrEmpty()) {
                getStorage.write(
                    Constant.USER_TOKEN, loginResponse.accessToken);
                getStorage.write(
                    Constant.EMAIL_ID,emailController.text.toString().trim());
                getStorage.write(
                    Constant.PASSWORD, passwordController.text.toString().trim());
              }
              if (loginResponse.userId != null) {
                loginResponse.userName = _loginRequest.username;
                getStorage.write(Constant.USER_DATA, jsonEncode(loginResponse));
                getSystemConfigurationData(Strings.country_code);
                getAclEntry();
                // roleOperation();
                // moveToDashboard();
              }
        ...
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            BaseResponse baseResponse =
                BaseResponse.fromJson(responseModel.result);
    ...
    LoginProvider().aclEntry(
      onSuccess: (ResponseModel responseModel) {
        ...
        if (responseModel.statusCode == 200) {
          if (responseModel.result != null) {
            try {
              GetAclEntryRes aclEntryRes =
                  GetAclEntryRes.fromJson(responseModel.result);
              if ((aclEntryRes.responseCode != null &&
                      aclEntryRes.responseCode == 200) ||
                  (aclEntryRes.status != null && aclEntryRes.status == 200)) {
                if (aclEntryRes.dataList != null &&
                    aclEntryRes.dataList!.isNotEmpty) {
                  getStorage.write(
                      Constant.ACL_ENTRIES, jsonEncode(aclEntryRes.dataList));
                  roleOperation();
                  moveToDashboard();
                }
              } else {
                ...
                if ((aclEntryRes.responseMessage != null &&
                        aclEntryRes.responseMessage!.isNotEmpty) ||
                    (aclEntryRes.msg != null && aclEntryRes.msg!.isNotEmpty) ||
                    (aclEntryRes.message != null &&
                        aclEntryRes.message!.isNotEmpty)) {
                  Utils.showSnackbar(Strings.ERROR, aclEntryRes.responseMessage,
                      AppTheme.colorWhite, AppTheme.colorRed);
                }
              }
          ...
          if (responseModel.result != null) {
            try {
              ...
              if ((roleResponse.responseCode != null &&
                      roleResponse.responseCode == 200) ||
                  (roleResponse.status != null && roleResponse.status == 200)) {
                if (roleResponse.dataList != null &&
                  ...
                  getStorage.write(Constant.ROLE_OPRATION,
                      jsonEncode(roleResponse.dataList));
                  // update();
                }
              }
            } on Exception catch (e) {
              ...
              if ((roleResponse.responseCode != null &&
                ...
                if (roleResponse.demographicmappingtable != null &&
                  ...
                  demographicmappingtable =
                      roleResponse.demographicmappingtable!;
                  getStorage.write(Constant.DEMO_GRAPHIC_MAPPING,
                      jsonEncode(roleResponse.demographicmappingtable));
                ...
                if (roleResponse.message != null &&
                  ...
                  isLoading = false;
                  update();
                  Utils.showSnackbar(Strings.ERROR, roleResponse.message,
                      AppTheme.colorWhite, AppTheme.colorRed);
                }
              }
            } on Exception catch (e) {
  ...
  getSystemConfigurationData(String type) {
    // isLoading = true;
    // update();
    LoginProvider().getSystemConfigurationData(
      type: type,
              ...
              if (responseData.responseCode == 200) {
                if (responseData.data != null) {
                  if (responseData.data!.name!.isNotEmpty &&
                      type.equalsIgnoreCase(Strings.country_code)) {
                    //countryCode = responseData.data!.value ?? "+256";
                    print(
                        "Country Code Display:${responseData.data!.value ?? Strings.defaultCountryCode}");
                    saveCountryCode(
                        responseData.data!.value ?? Strings.defaultCountryCode);
