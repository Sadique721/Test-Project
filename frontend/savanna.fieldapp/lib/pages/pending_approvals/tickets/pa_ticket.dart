...
import 'package:savbill/pages/pending_approvals/tickets/ticket_approve_reject_dialog.dart';
...
class _PendingApprovalTicketState extends State<PendingApprovalTicket>
    implements TicketAssignAction, TicketApproveRejectBtnAction {
                            ...
                            itemBuilder: (context, index) {
                              if (index ==
                                ...
                                return PendingApprovalTicketItem(
                                  item: item,
                                  onTapApprove: () {
                                    addRemarkTicketDialog(context, true, item);
                                  },
                                  onTapReject: () {
                                    addRemarkTicketDialog(context, false, item);
                                  },
                                );
                              }
                            }),
  ...
  addRemarkTicketDialog(
      BuildContext context, bool isApproveRequest, ApprovalPendingTicket item) {
    showDialog(
        context: context,
            ...
            try {
              ...
              if ((responseData.status != null && responseData.status == 200) ||
                ...
                if (responseData.dataList != null &&
                  ...
                  paTicketController.update();
                  showAssignStaffDialog(responseData.dataList!,isApproveRequest?Strings.approve:Strings.reject);
                } else {
  ...
  showAssignStaffDialog(List<TicketAssignStaff> item,String status) {
    showDialog(
        context: context,
        barrierDismissible: true,
        builder: (BuildContext context) {
          return TicketAssignDialog(
              ticketAssignAction: this, itemsOrgLst: item,staffStatus:status,);
        });
  }
  ...
  void ticketApproveRejectStatus({
    ...
    Get.back();
    approveRejectTicket(detail!, isApproveRequest, remarkController.text);
  }
}
