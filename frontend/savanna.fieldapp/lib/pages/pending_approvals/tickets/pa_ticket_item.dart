...
class PendingApprovalTicketItem extends StatelessWidget {

  ApprovalPendingTicket item;
  final Function()? onTapApprove;
  final Function()? onTapReject;

  PendingApprovalTicketItem({
    Key? key,
    required this.item,
    this.onTapApprove,
    this.onTapReject,
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: basicDetailItem(
                Strings.type,
                (item.caseType != null && item.caseType!.isNotEmpty)
                    ? item.caseType
                    : "-",
                Strings.number,
          ...
          Padding(
            ...
            child: basicDetailItem(
                ...
                (item.caseReasonCategory != null &&
                        item.caseReasonCategory!.isNotEmpty)
                    ? item.caseReasonCategory
                    : "-"),
          ),
          const SizedBox(
            height: Constant.SMALL_PADDING,
