...
import '../model/response/approval_pending_ticket_res.dart';

class TicketApproveRejectDialog extends StatefulWidget {
  bool isApproveRequest;
  final ApprovalPendingTicket? detail;
  final TicketApproveRejectBtnAction? ticketApproveRejectBtnAction;

  TicketApproveRejectDialog({
    Key? key,
    required this.isApproveRequest,
    this.ticketApproveRejectBtnAction,
    this.detail,
  }) : super(key: key);

  @override
  _TicketApproveRejectState createState() => _TicketApproveRejectState();
}

class _TicketApproveRejectState extends State<TicketApproveRejectDialog> {
  ...
  Widget build(BuildContext context) {
    String title = "";
    if (widget.isApproveRequest) {
      title = Strings.approve_ticket;
    } else {
      title = Strings.reject_ticket;
    }
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.ticketApproveRejectBtnAction!
                                    .ticketApproveRejectStatus(
                                        remarkController: controller,
                                        isApproveRequest:
                                            widget.isApproveRequest,
...
abstract class TicketApproveRejectBtnAction {
  void ticketApproveRejectStatus({
    required ApprovalPendingTicket? detail,
