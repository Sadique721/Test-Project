...
class InventoryApprovalRejectDialog extends StatefulWidget {
  String? pageName;
  final InventoryApproveRejectBtnAction? custDocApproveRejectBtnAction;
  final InventoryApprovalDataList? inventoryApprovalDataList;

  InventoryApprovalRejectDialog(
      {Key? key,
        this.pageName,
        this.custDocApproveRejectBtnAction,
        this.inventoryApprovalDataList,
      })
      : super(key: key);

  @override
  _CustDocApproveRejectState createState() => _CustDocApproveRejectState();
}
class _CustDocApproveRejectState extends State<InventoryApprovalRejectDialog> {
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.custDocApproveRejectBtnAction!
                                    .inventoryApproveRejectStatus(
                                  ...
                                  inventoryApprovalDataList: widget.inventoryApprovalDataList!,
...
abstract class InventoryApproveRejectBtnAction {
