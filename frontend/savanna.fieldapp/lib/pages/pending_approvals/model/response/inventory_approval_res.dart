...
class InventoryApprovalRes extends BaseResponse{
  String? responseMessage;
  dynamic data;
  List<InventoryApprovalDataList>? dataList;
  ...
  InventoryApprovalRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <InventoryApprovalDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new InventoryApprovalDataList.fromJson(v));
      });
    }
...
class InventoryApprovalDataList {
  dynamic id;
  dynamic qty;
  dynamic productId;
  dynamic customerId;
  ...
  dynamic custInvParams;
  dynamic custServiceMapId;
  dynamic filename;
  dynamic uniquename;
  dynamic opticalPowerRange;
  bool? generateRemoveRequest;
  dynamic identityKey;

  InventoryApprovalDataList(
      {this.id,
        this.qty,
        this.productId,
        this.customerId,
  ...
  InventoryApprovalDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    qty = json['qty'];
    ...
    custInvParams = json['custInvParams'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['custInvParams'] = this.custInvParams;
    data['custServiceMapId'] = this.custServiceMapId;
    data['filename'] = this.filename;
    data['uniquename'] = this.uniquename;
    data['opticalPowerRange'] = this.opticalPowerRange;
...
class InOutWardMACMapping {
  ...
  InOutWardMACMapping.fromJson(Map<String, dynamic> json) {
    ...
    inReplacementProcess = json['inReplacementProcess'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['inReplacementProcess'] = this.inReplacementProcess;
