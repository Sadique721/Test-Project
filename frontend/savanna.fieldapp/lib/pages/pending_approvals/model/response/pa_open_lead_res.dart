...
class PAOpenLeadRes extends BaseResponse{
  LeadMasterList? leadMasterList;
  String? timestamp;
  int? status;

  PAOpenLeadRes({this.leadMasterList, this.timestamp, this.status});

  PAOpenLeadRes.fromJson(Map<String, dynamic> json) {
...
class LeadMasterList {
  List<PAOpenLeadContent>? content;
  Pageable? pageable;
  int? totalPages;
  int? totalElements;
  bool? last;
  ...
  LeadMasterList.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      content = <PAOpenLeadContent>[];
      json['content'].forEach((v) {
        content!.add(new PAOpenLeadContent.fromJson(v));
      });
    }
...
class PAOpenLeadContent {
  ...
  // List<Null>? planMappingList;
  // List<Null>? addressList;
  ...
  PAOpenLeadContent.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    //     planMappingList!.add(new Null.fromJson(v));
    //   });
    // }
    // if (json['addressList'] != null) {
    //   addressList = <Null>[];
    //   json['addressList'].forEach((v) {
    //     addressList!.add(new Null.fromJson(v));
    //   });
    // }
