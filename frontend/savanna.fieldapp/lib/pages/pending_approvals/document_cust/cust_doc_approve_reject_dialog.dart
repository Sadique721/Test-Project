...
class CustDocApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final CustDocApproveRejectBtnAction? custDocApproveRejectBtnAction;
  final CustDocApprovalDataList? custDocApprovalDataList;

  CustDocApproveRejectDialog(
      {Key? key,
        this.pageName,
        this.custDocApproveRejectBtnAction,
        this.custDocApprovalDataList,
      })
      : super(key: key);
...
class _CustDocApproveRejectState extends State<CustDocApproveRejectDialog> {
                            ...
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.custDocApproveRejectBtnAction!
                                  ...
                                  custDocApprovalDataList: widget.custDocApprovalDataList!,
...
abstract class CustDocApproveRejectBtnAction {
