...
class ApproveRejectCustomerStatusDialog extends StatefulWidget {
  String? pageName;
  ...
  final ApproveRejectCustomerStatusBtnAction? approveRejectChangeStatusBtnAction;

  ApproveRejectCustomerStatusDialog(
...
class _AddRemarkInvoiceState extends State<ApproveRejectCustomerStatusDialog> {
                            ...
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.approveRejectChangeStatusBtnAction!
                                    .approveRejectCustomerStatusDetails(
...
abstract class ApproveRejectCustomerStatusBtnAction {
  void approveRejectCustomerStatusDetails(
