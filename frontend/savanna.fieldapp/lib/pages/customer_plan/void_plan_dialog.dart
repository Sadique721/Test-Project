...
class VoidPlanDialog extends StatefulWidget {
  CustPlanDataList? item;
  CustomerPlanController? controller;
  final VoidPlanBtnAction? voidPlanBtnAction;

  VoidPlanDialog(
      {Key? key,
        this.voidPlanBtnAction,
        this.item,
        this.controller,
      })
      : super(key: key);
  ...
  @override
  _VoidPlanDialogState createState() => _VoidPlanDialogState();
}

class _VoidPlanDialogState extends State<VoidPlanDialog> {
...
abstract class VoidPlanBtnAction {
  void voidPlanStatus(
      {TextEditingController remarkController,BuildContext context,CustPlanDataList? item});
}
