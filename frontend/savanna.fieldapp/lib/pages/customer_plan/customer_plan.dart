...
import 'package:savbill/pages/customer_plan/void_plan_dialog.dart';
...
import '../lead_approval/assigne_lead/lead_workflow_approve_reject_dialog.dart';
import '../lead_approval/model/la_assign_list_res.dart';
...
class _CustomerPlanDetailState extends State<CustomerPlanDetail>
    ...
    implements ChangeSubScribePlanBtnAction, SubscriberTrialBtnAction,VoidPlanBtnAction {
        ...
        ? ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return ActivePlanItemView(
                ...
                onTapVoidPlan: () {
                  addRemarkPlanDialog(context, customerPlanController.activePlanList![index], customerPlanController);
                },
                onTapExtendTrial: () {
        ...
        ? ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return FuturePlanItemView(
                ...
                onTapNotes: () {},
                onTapVoidPlan: () {
                  addRemarkPlanDialog(context, customerPlanController.futurePlanList![index], customerPlanController);
                },
                onTapExtendTrial: () {
                  openCurrentPlanExtentValidityScreen(
  ...
  addRemarkPlanDialog(BuildContext context,
      CustPlanDataList? item, CustomerPlanController? controller) {
    showDialog(
        context: context,
        barrierDismissible: true,
        builder: (BuildContext context) {
          return VoidPlanDialog(
              voidPlanBtnAction: this,
              item: item,
  ...
  @override
  void voidPlanStatus({TextEditingController? remarkController,BuildContext? context,CustPlanDataList? item}) {
    Get.back();
    if (item != null) {
      customerPlanController.voidPlan(item, remarkController?.text);
    }
  }
