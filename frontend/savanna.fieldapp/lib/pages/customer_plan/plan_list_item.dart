            ...
            children: [
              ...
              cardDataRow(
                  ...
                  (item.customerInventorySerialnumberDtos!.isNotEmpty ||
                      item.customerInventorySerialnumberDtos != null)
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    // hasOperationPermission(Constant.ACL_PROMISE_TO_PAY,
                    //     Constant.OPERATION_PROMISE_TO_ALL,
                    //     Constant.OPERATION_PROMISE_TO_DISPLAY, userData!) &&
                        !item.isVoid! &&
                        ...
                        item.custPlanStatus!.toLowerCase() != "terminate" &&
                        !isPromiseToPayInExpired(
                            item.customerServiceMappingId, expiredPlanList!,
                            currentPlanList!)
                        ?
                    CustomText(
                    ...
                    //         : AppTheme.colorGrayTxtBg,
                    //     AppTheme.colorWhite,
                    //     item.custPlanStatus != "STOP" ? onTapNotes! : () {}),
                  ],
                ),
              )
            ],
