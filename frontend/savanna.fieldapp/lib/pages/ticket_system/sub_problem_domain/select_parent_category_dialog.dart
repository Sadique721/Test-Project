...
class SelectParentCategoryDialog extends StatefulWidget {
...
class _SelectParentCategoryState extends State<SelectParentCategoryDialog> {
                    ...
                    Flexible(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ProblemDomainDetail item = itemsParentList![index];
                            return Column(
                              children: [
                                InkWell(
                                  onTap: () {
  ...
  validateSelection() {
    List<ProblemDomainDetail> selectedItem = [];
