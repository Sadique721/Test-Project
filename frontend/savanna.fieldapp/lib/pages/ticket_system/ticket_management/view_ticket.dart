...
import 'package:savbill/pages/ticket_system/model/response/olt_list_res.dart';
                  ...
                  children: [
                    ...
                    DropdownButtonHideUnderline(
                      child: DropdownButtonFormField(
                        ...
                        isExpanded: true,
                        isDense: true,
                        value: viewTicketController
                            .selectedOLT,
                        items: (viewTicketController.OLTList ?? [])
                            .map((CityDetailList? value) {
                          return DropdownMenuItem<CityDetailList>(
                            value: value,
