...
class CloseTicketRemarkFollowUpDialog extends StatefulWidget {
  final CloseFollowUpRemarkBtnAction? closeFollowUpRemarkBtnAction;
  String? pageName;
  TicketFollowUpFindAllDataList? itemList;

  CloseTicketRemarkFollowUpDialog(
      {super.key,
        this.pageName,
        this.itemList,
  ...
  @override
  _CloseTicketFollowUpState createState() => _CloseTicketFollowUpState();
}

class _CloseTicketFollowUpState extends State<CloseTicketRemarkFollowUpDialog> {
                            ...
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.closeFollowUpRemarkBtnAction!
                                  ...
                                  identifier: "ticketCloseFollowUp",
