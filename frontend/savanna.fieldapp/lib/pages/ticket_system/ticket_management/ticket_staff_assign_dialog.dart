...
class TicketAssignDialog extends StatefulWidget {
  ...
  final List<ApproveRejectTicketList> itemsOrgLst;
...
class _TicketAssignState extends State<TicketAssignDialog> {
  List<ApproveRejectTicketList> itemsLst = [];
  ...
  searchData(String value) {
    ...
    if (value.isEmpty) {
      ...
      for (ApproveRejectTicketList detail in widget.itemsOrgLst) {
                    ...
                    Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ApproveRejectTicketList item = itemsLst[index];
