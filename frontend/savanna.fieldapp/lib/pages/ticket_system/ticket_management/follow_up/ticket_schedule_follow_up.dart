...
import 'package:savbill/pages/ticket_system/ticket_management/follow_up/ticket_schedule_follow_up_controller.dart';
...
class TicketScheduleFollowUpScreen extends StatefulWidget {
  @override
  _ScheduleFollowUpState createState() => _ScheduleFollowUpState();
}

class _ScheduleFollowUpState extends State<TicketScheduleFollowUpScreen> {
  final scheduleFollowUpController = Get.put(TicketScheduleFollowUpController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TicketScheduleFollowUpController>(builder: (controller) {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CoustomTextField(
                              ...
                              borderFocusColors: AppTheme.colorDisableGray,
                          ...
                          InputTitleRequire(
                              ...
                              require: true),
                          const SizedBox(
                            height: Constant.VERY_SMALL_PADDING+3,
                          ),
                          // CoustomTextField(
                          ...
                          Container(
                              ...
                              child: TextFormField(
                                controller: scheduleFollowUpController.remarkController,
                                maxLines: 4,
                                maxLength: 250,
  ...
  validateForm() {
    if (scheduleFollowUpFormKey.currentState!.validate()) {
      scheduleFollowUpController.scheduleFollowUpSave();
    } else {
      setState(() {
