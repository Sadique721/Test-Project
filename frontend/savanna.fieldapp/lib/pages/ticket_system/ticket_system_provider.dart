...
class TicketSystemProvider {
  ...
  // get ticket Source Type
  void getTicketClassification({
    Function()? beforeSend,
    Function(ResponseModel responseModel)? onSuccess,
    Function(ResponseModel error)? onError,
  }) {
    ApiRequest(url: UrlConstants.ticket_classification).getRequest(
      beforeSend: () => {if (beforeSend != null) beforeSend()},
      onSuccess: (data) {
        onSuccess!(data);
      },
  ...
  void getTicketManagementSearchOption({
    ...
    ApiRequest(
      url: "${UrlConstants.generic_request}TICKET_SEARCH_OPTION?from_cache=true",
    ).getRequest(
      beforeSend: () => {if (beforeSend != null) beforeSend()},
      onSuccess: (data) {
        onSuccess!(data);
  ...
  void getCityList({
    ...
    String url = UrlConstants.city_list;
    ApiRequest(url: url, data: {})
        .postRequest(
      beforeSend: () => {if (beforeSend != null) beforeSend()},
      onSuccess: (data) {
        onSuccess!(data);
