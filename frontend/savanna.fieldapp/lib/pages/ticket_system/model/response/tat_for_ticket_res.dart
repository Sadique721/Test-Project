...
class TatForTicketRes extends BaseResponse{
  Null? data;
  ...
  TatForTicketRes.fromJson(Map<String, dynamic> json) {
    ...
    if (json['dataList'] != null) {
      ...
      json['dataList'].forEach((v) {
        dataList!.add(TatTicketDetail.fromJson(v));
      });
    }
...
//         this.primaryKey});
//
//   TatForDataList.fromJson(Map<String, dynamic> json) {
