...
class CloseLeadWorkFlowRemarkFollowUpDialog extends StatefulWidget {
  final CloseFollowUpRemarkBtnAction? closeFollowUpRemarkBtnAction;
  String? pageName;
  FollowUpList? itemList;

  CloseLeadWorkFlowRemarkFollowUpDialog(
      {super.key,
        this.pageName,
        this.itemList,
  ...
  @override
  _CloseLeadWorkFlowFollowUpState createState() => _CloseLeadWorkFlowFollowUpState();
}

class _CloseLeadWorkFlowFollowUpState extends State<CloseLeadWorkFlowRemarkFollowUpDialog> {
