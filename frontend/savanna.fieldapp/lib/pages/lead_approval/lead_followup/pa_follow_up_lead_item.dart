...
class PendingApprovalFollowUpLeadItem extends StatelessWidget {
  FollowUpList? item;
  ...
  PendingApprovalFollowUpLeadItem({
    Key? key,
    required this.item,
    this.onTapRescheduleFollowUp,
    this.onTapCloseFollowUp,
    this.onTapCallFollowUp,
  }) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Color? statusColor;
    bool? isFollowUpLead = true;
    ...
    if(item!.status!.equalsIgnoreCase("Closed") || item!.status!.equalsIgnoreCase("closed")){
      isFollowUpLead = false;
    }else{
      isFollowUpLead = true;
    }
