class DeleteIpManagementRes {
  int? responseCode;
  String? responseMessage;
  DeleteIpManagementData? data;
  dynamic dataList;
  ...
  DeleteIpManagementRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'] != null ? DeleteIpManagementData.fromJson(json['data']) : null;
...
class DeleteIpManagementData {
  ...
  DeleteIpManagementData.fromJson(Map<String, dynamic> json) {
