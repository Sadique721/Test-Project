...
import '../customer_caf/response/get_building_management_res.dart';
import '../lead_approval/assigne_lead/pa_assign_lead_controller.dart';
...
class CreateLeadController extends GetxController {
  ...
  TextEditingController leadSubSourceController = TextEditingController();
  ...
  String? selectedMappingFrom = "Sub Area";
  ...
  void onInit() {
    ...
    //selectCustomerTitleCAF = Utils.getTitle()![1];
            ...
            try {
              ...
              if ((responseData.responseCode != null &&
                ...
                if (responseData.leadCustomerGender!.isNotEmpty) {
                  ...
                  if (selectedLeadCustomerGender != null) {
          ...
          if (responseModel.result != null) {
            try {
              ...
              if ((responseData.responseCode != null &&
                ...
                if (leadMaster != null && leadMaster!.blockNo != null) {
                  for (int element in blockNoOptions) {
                    if (element
                        .toString()
                        .equalsIgnoreCase(leadMaster!.blockNo!)) {
                      selectedBlockNo = element;
                      break;
                    }
                  }
                }
  ...
  //       }
  //       isLoading = false;
  //       // getBuildingMgmtCall(serviceAreaId);
  //       update();
  //     },
  //     onError: (ResponseModel error) {
  //       // getBuildingMgmtCall(serviceAreaId);
  ...
  getNewSubAreaFromAreaCall(int? areaId) {
    isLoading = true;
    subAreaDataList!.clear();
    selectedSubAreaData = null;
    update();
            ...
            try {
              ...
              if ((responseData.status != null && responseData.status == 200) ||
                ...
                if (customerDetail != null) {
                  ...
                  if (customerDetail!.leadStaffName != null) {
                    leadSubSourceController.text =
                        customerDetail!.leadStaffName;
                  }
            ...
            try {
              ...
              if ((responseData.responseCode != null &&
                ...
                if (leadMaster != null) {
                  ...
                  if (leadMaster!.leadStaffName != null) {
                    leadSubSourceController.text = leadMaster!.leadStaffName;
                  }
      ...
      for (var element in individualPlanList!) {
        ...
        leadPlanMappingList.add(LeadSavePlanMappingList(
            ...
            isInvoiceToOrg: selectedInvoiceToOrg != null &&
                ...
                ? true
                : false,
            istrialplan: element.trialPlan ?? false,
  ...
  leadToCAFConvertCustomer() {
    ...
    leadAddressList.add(LeadAddressList(
        ...
        pincodeId: selPresentPincode?.pincodeid!,
        areaId: selPresentArea?.id,
        building_mgmt_id: selectedBuildingManagementData?.buildingMgmtId,
        buildingNumber: selectedBuildingNumber,
        subareaId: selectedSubAreaData?.id,
        cityId: selPresentCity?.id,
        stateId: selPresentState?.id,
        countryId: selPresentCountry?.id,
        streetName: streetNameController.text,
    ...
    LeadSaveReq saveReq = LeadSaveReq(
      ...
      leadSubSourceId: null,
      leadSubSourceName: leadSubSourceController.text,
      ...
      feasibilityRemark:
          leadMaster != null ? leadMaster!.feasibilityRemark : "a",
      custtype: type,
      isInvoiceToOrg: selectedInvoiceToOrg != null &&
              selectedInvoiceToOrg!.text!.equalsIgnoreCase(Strings.yes)
          ? true
      ...
      contactperson: contactPersonPayController.text.isNotEmpty
          ...
          : null,
      cafno: cafNoController.text.isNotEmpty ? cafNoController.text : null,
      calendarType: selectedCalenderType!.text!.toLowerCase(),
      username:
          userNameController.text.isNotEmpty ? userNameController.text : null,
      password:
          passwordController.text.isNotEmpty ? passwordController.text : null,
    ...
    log("saveToCafLead===>>>${jsonEncode(saveReq)}");
    ...
    LeadSystemProvider().leadToCAFConvertCustomer(
          ...
          if (responseModel.result != null) {
            try {
              ...
              if ((responseData.responseCode != null &&
                ...
                Utils.showSnackbar(
                    Strings.SUCCESS,
                    Strings.lead_convert_caf_succesfully,
                    AppTheme.colorWhite,
                    AppTheme.colorGreen);
      ...
      onError: (ResponseModel error) {
        isLoading = false;
        _handleCustomerAddApiError(error);
      },
    );
  }
  ...
  updateLead(int? leadId, int? customerId, bool? isLeadToCAF) {
    ...
    if (isLeadToCAF == true) {
      ...
      saveReq = LeadSaveReq(
        ...
        approveUsername: userNameController.text,
        // approveServiceareaid: selPresentServiceArea?.id,
        approveServiceareaid: serviceAreaId,
        leadStatus: "Converted",
        isCustomerCafeIsUpdated: true,
        customerId: customerId,
        assigneeName: null,
          ...
          if (responseModel.result != null) {
            try {
              ...
              if ((responseData.responseCode != null &&
                ...
                Utils.showSnackbar(Strings.SUCCESS, responseData.message,
                    AppTheme.colorWhite, AppTheme.colorGreen);
                final paAssignLeadController =
                    Get.put(PAAssignLeadController());
                paAssignLeadController.getPAAssignLeadList();
              } else {
                if (responseData.message != null &&
                    responseData.message!.isNotEmpty) {
                  Utils.showSnackbar(Strings.ERROR, responseData.message,
  ...
  _handleCustomerAddApiError(ResponseModel error) {
    isLoading = false;
    if (error.statusCode == Constant.CODE_NO_INTERNET_CONNECTION) {
      Utils.showSnackbar(Strings.ERROR, Strings.no_internet,
          AppTheme.colorWhite, AppTheme.colorRed);
      ...
      Utils.showSnackbar(Strings.INFO, error.message, AppTheme.colorWhite,
          AppTheme.colorBlueRView);
    } else if (error.statusCode == Constant.STATUS_CODE_NOT_RECORD_FOUND) {
      Utils.showSnackbar(Strings.INFO, Strings.no_data_found,
          AppTheme.colorWhite, AppTheme.colorBlueRView);
    } else if (!error.message!.isNullOrEmpty()) {
      Utils.showSnackbar(Strings.INFO, error.message, AppTheme.colorWhite,
