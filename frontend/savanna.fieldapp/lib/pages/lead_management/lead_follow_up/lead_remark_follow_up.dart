import 'package:savbill/pages/lead_management/lead_follow_up/lead_remark_follow_up_controller.dart';
...
class LeadRemarkFollowUp extends StatefulWidget {
  @override
  _LeadRemarkFollowUpState createState() => _LeadRemarkFollowUpState();
}

class _LeadRemarkFollowUpState extends State<LeadRemarkFollowUp> {
  final remarkFollowUpController = Get.put(LeadRemarkFollowUpController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<LeadRemarkFollowUpController>(builder: (controller) {
  ...
  followUpItem({required FollowUpRemarkList item}) {
    String actionDate = "";
