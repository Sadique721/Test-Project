...
class LeadFollowUpItemList extends StatelessWidget {
  FollowUpList? item;
  LeadFollowUpListController? controller;
  ...
  LeadFollowUpItemList(
      {Key? key,
        required this.index,
        required this.item,
        required this.leadMasterId,
