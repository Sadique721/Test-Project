...
class LeadMasterDetailsRes extends BaseResponse {
  LeadMaster? leadMaster;
  String? timestamp;
  int? status;

  LeadMasterDetailsRes({this.leadMaster, this.timestamp, this.status});

  LeadMasterDetailsRes.fromJson(Map<String, dynamic> json) {
...
class LeadMaster {
  ...
  List<LeadPlanMappingList>? planMappingList;
  ...
  LeadMaster.fromJson(Map<String, dynamic> json) {
    ...
    if (json['planMappingList'] != null) {
      ...
      json['planMappingList'].forEach((v) {
        planMappingList!.add(new LeadPlanMappingList.fromJson(v));
      });
    }
...
class LeadPlanMappingList {
  ...
  LeadPlanMappingList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    planId = json['planId'];
    custid = json['custid'];
