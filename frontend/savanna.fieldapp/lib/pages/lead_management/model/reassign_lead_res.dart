...
class ReassignLeadRes extends BaseResponse {
  String? responseMessage;
  dynamic data;
  List<ReassignLeadDataList>? dataList;
  ...
  ReassignLeadRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ReassignLeadDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new ReassignLeadDataList.fromJson(v));
      });
    }
...
class ReassignLeadDataList {
  ...
  ReassignLeadDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
