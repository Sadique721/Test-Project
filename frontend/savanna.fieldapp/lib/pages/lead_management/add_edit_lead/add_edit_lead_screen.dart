...
import 'package:savbill/pages/lead_management/add_edit_lead/add_edit_lead_controller.dart';
...
class _AddEditLeadScreenState extends State<AddEditLeadScreen>
  ...
  final addLeadController = Get.put(AddEditLeadController());
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<AddEditLeadController>(builder: (controller) {
              ...
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      //     : Container(),
                      // addLeadController.activeStep == 5
                      //     ? basicCAFDetailsForm()
                      //     : Container(),
                      // addLeadController.activeStep == 6
              ...
              children: [
                ...
                Expanded(
                  child: SimpleButton(
                    onTap: () {
                      validateForm();
                      // if (addLeadController.activeStep == 1) {
                    ...
                    child: CustomText(
                      title: addLeadController.activeStep == 1
                          ? addLeadController.from
                                  .equalsIgnoreCase(Strings.edit)
                              ? Strings.update
                              : Strings.submit
                          : Strings.next,
  ...
  validateForm() {
    ...
    } else if (addLeadController.activeStep == 5) {
      ...
      if (addLeadController.activeStep < addLeadController.dotCount - 1) {
        ...
        if (addLeadController.activeStep == 1) {
          if (addLeadController.from.equalsIgnoreCase(Strings.add)) {
            ...
            addLeadController.updateLead(
                addLeadController.leadViewContentData!.id!, null, false);
          } else if (addLeadController.from
              .equalsIgnoreCase(Strings.lead_caf)) {
            addLeadController.leadToCAFConvertCustomer();
          }
  ...
  String getTitle() {
    ...
    switch (addLeadController.activeStep) {
      ...
      case 3:
        ...
        break;
      case 4:
        strTitle = Strings.competitor_pack_details;
        break;
      case 5:
          ...
          Row(
            ...
            children: [
              Flexible(
                flex: 1,
                child:
                    titleWithRequireWidget(Strings.customer_sector_new, true),
              ),
              const SizedBox(
                width: Constant.SMALL_PADDING,
              ),
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (String? value) {
                      addLeadController.selectedLeadType = value;
                      addLeadController.update();
                    },
                    validator: (value) {
                      return null;
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                items: addLeadController
                                        .leadSourceCustomerList!.isEmpty
                                    ? [
                                        DropdownMenuItem<CustomersList>(
                                          value: null,
                                          enabled: false,
                                          child: CustomText(
                                    ...
                                    : addLeadController.leadSourceCustomerList!
                                ...
                                onChanged: (value) {
                                  addLeadController.selectedLeadSourceCustomer =
                        ...
                        ? Flexible(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                isDense: true,
                                value:
                                    addLeadController.selectedLeadSourceBranch,
                                items: addLeadController
                                        .leadSourceBranchList!.isEmpty
                                    ? [
                                        DropdownMenuItem<BranchList>(
                                          value: null,
                                          enabled: false,
                                          child: CustomText(
                                            title: Strings.no_data_found,
                                    ...
                                    : addLeadController.leadSourceBranchList!
                        ...
                        ? Flexible(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                isDense: true,
                                value:
                                    addLeadController.selectedLeadSourcePartner,
                                items: addLeadController
                                        .leadSourcePartnerList!.isEmpty
                                    ? [
                                        DropdownMenuItem<PartnerList>(
                                          value: null,
                                          enabled: false,
                                          child: CustomText(
                                            title: Strings.no_data_found,
                                    ...
                                    : addLeadController.leadSourcePartnerList!
                        ...
                        ? Flexible(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                items: addLeadController
                                        .leadSourceStaffUserList!.isEmpty
                                    ? [
                                        DropdownMenuItem<StaffUserList>(
                                          value: null,
                                          enabled: false,
                                          child: CustomText(
                                            title: Strings.no_data_found,
                                    ...
                                    : addLeadController.leadSourceStaffUserList!
                        ...
                        ? Flexible(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                items: addLeadController
                                        .leadSourceServiceAreaList!.isEmpty
                                    ? [
                                        DropdownMenuItem<ServiceAreaList>(
                                          value: null,
                                          enabled: false,
                                          child: CustomText(
                                            title: Strings.no_data_found,
                        ...
                        ? Flexible(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                items: addLeadController.agentArr!.isEmpty
                                    ? [
                        ...
                        ? Flexible(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                isDense: true,
                                value:
                                    addLeadController.selectedLeadSubSourceArr,
                                items: addLeadController
                                        .leadSubSourceArr!.isEmpty
                                    ? [
                                        DropdownMenuItem<LeadSubSourceDtoList>(
                                          value: null,
                                          enabled: false,
                                          child: CustomText(
                                            title: Strings.no_data_found,
                                    ...
                                    : addLeadController.leadSubSourceArr!
                  ...
                  children: [
                    Flexible(
                      ...
                      child: InputTitleRequire(
                          title: Strings.feasibilityRemark, require: true),
                    ),
                    const SizedBox(
                      width: Constant.SMALL_PADDING,
                    ),
                    Flexible(
                      ...
                      child: CoustomTextField(
                        labelText: Strings.enter_feasibility_remark,
                        hintColor: AppTheme.colorIconGrey,
                        textEditingController:
                            addLeadController.remarksController,
                        ...
                        onTextValidator: (String? value) {
                          if (value!.isEmpty) {
                            return Strings.please_select_feasibility_remark;
                          }
                          return null;
                        },
                        onTextFiledOnTap: () {},
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Flexible(
                flex: 1,
                child:
                    InputTitleRequire(title: Strings.lastname, require: false),
              ),
              const SizedBox(
                width: Constant.SMALL_PADDING,
              ),
          ...
          Row(
            ...
            children: [
              ...
              const SizedBox(
                width: Constant.MEDIUM_PADDING + 5,
              ),
              // Flexible(
              //   flex: 2,
              //   child: DropdownButtonHideUnderline(
              ...
              //       isExpanded: true,
              //       isDense: true,
              //       value: addLeadController.selPresentServiceArea,
              //       items: addLeadController.servicesAreaList!
              ...
              //         addLeadController.selPresentServiceArea =
              ...
              //       validator: (value) {
              //         if (value == null ||
              //             addLeadController.selPresentServiceArea == null) {
              ...
              Flexible(
                flex: 2,
                child: DropdownSearch<NewServiceDataList>(
                  key: addLeadController.dropDownKey,
                  mode: Mode.form,
                  selectedItem: addLeadController.selectNewServiceArea,
                  items: (filter, infiniteScrollProps) =>
                      addLeadController.newServicesAreaList!,
                  ...
                  onChanged: (value) {
                    List<int>? serviceAreaId = [];
                    addLeadController.selectNewServiceArea = value;
                    addLeadController.selPresentPincode = null;
                    // addLeadController.pincodeList!.clear();
                    addLeadController.serviceAreaId = value!.id;
                    addLeadController.update();
                    serviceAreaId.add(value.id!);
                    if (addLeadController.leadMaster != null) {
                      addLeadController
                          .getAllServicesByServiceAreaIdData(serviceAreaId);
                    } else {
                      addLeadController
              ...
              InkWell(
                  onTap: () {
                    // addLeadController.getLeadCustomerGenderTypes();
                    addLeadController.getNewServiceArea();
                    addLeadController.branchesByServiceAreaList!.clear();
                    addLeadController.selectBranchesByServiceAreaData = null;
                  },
                  child: Icon(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ...
                      //     addLeadController.selectNewServiceArea!.id);
                      addLeadController.update();
                    },
                    validator: (value) {
                      if (value == null ||
              ...
              Flexible(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (String? value) {
                      addLeadController.selectedLeadCustomerGender = value;
                      addLeadController.update();
                    },
                    validator: (value) {
                      if (value == null) {
          ...
          const SizedBox(height: Constant.MEDIUM_PADDING),
          addLeadController.blockNoOptions.isEmpty
              ? SizedBox.shrink()
              : Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          ...
                          IgnorePointer(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButtonFormField(
                                ...
                                decoration: Utils.ddlDecoration(
                                    fillColor:
                                        // addLeadController.billToReadOnly
                                        addLeadController.businessPromotionFlag
                                            ? Colors.black12
                                            : AppTheme.colorWhite),
                                autofocus: false,
                            ...
                            children: [
                              ...
                              DropdownButtonHideUnderline(
                                child: DropdownButtonFormField(
                                  ...
                                  // value: addLeadController.selPlan,
                                  // items: addLeadController.planList!
                                  items: addLeadController
                                      .selectedServiceAreaPlanList!
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Flexible(
                flex: 1,
                child: titleWithRequireWidget(Strings.customer_feedback, false),
              ),
              const SizedBox(
                width: Constant.SMALL_PADDING,
              ),
            ...
            children: [
              ...
              Flexible(
                ...
                child: CoustomTextField(
                    ...
                    hintColor: AppTheme.colorIconGrey,
                    textEditingController: addLeadController.cafNoController,
                    borderEnableColors: AppTheme.colorIconGrey,
                    borderFocusColors: AppTheme.colorIconGrey,
                    textColor: AppTheme.colorBlack,
                    keyboardType: TextInputType.text,
              ...
              Flexible(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButtonFormField(
                    ...
                    isExpanded: true,
                    isDense: true,
                    value: addLeadController.selectedCalenderType,
                    items: addLeadController.calenderTypeList!
                        .map((DropdownDetail value) {
                      return DropdownMenuItem<DropdownDetail>(
                        value: value,
                        child: Align(
                    ...
                    onChanged: (value) {
                      addLeadController.selectedCalenderType =
                          value as DropdownDetail?;
                      addLeadController.update();
                    },
                    validator: (value) {
