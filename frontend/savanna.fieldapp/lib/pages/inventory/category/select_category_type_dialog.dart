...
class SelectCategoryTypeDialog extends StatefulWidget {
  final SelectCategoryTypeAction selectCategoryTypeAction;
  final List<CategoryType>? itemsOrgLst;
  final String fromFor;

  const SelectCategoryTypeDialog({
    Key? key,
    required this.selectCategoryTypeAction,
    this.itemsOrgLst,
    required this.fromFor,
  }) : super(key: key);

  @override
  _SelectCategoryTypeState createState() => _SelectCategoryTypeState();
}

class _SelectCategoryTypeState extends State<SelectCategoryTypeDialog> {
  List<CategoryType>? itemsLst = [];
  ...
  Widget build(BuildContext context) {
    String title = "";
    if (widget.fromFor.equalsIgnoreCase(Strings.category_type)) {
      title = "${Strings.select} ${Strings.category}";
    }
                    ...
                    Flexible(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            CategoryType item = itemsLst![index];
                            return Column(
                              children: [
                                InkWell(
                                  onTap: () {
  ...
  validateSelection() {
    List<CategoryType> selectedItem = [];
    ...
    if (selectedItem.isNotEmpty) {
      widget.selectCategoryTypeAction.selectCategoryTypeBtnAction(
...
abstract class SelectCategoryTypeAction {
