...
class BulkConsuApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final BulkConsApproveRejectBtnAction? bulkConsApproveRejectBtnAction;
  final BulkConsApproveRejectReq? bulkConsApproveRejectReq;

  BulkConsuApproveRejectDialog(
      {Key? key,
        this.pageName,
        this.bulkConsApproveRejectBtnAction,
        this.bulkConsApproveRejectReq})
      : super(key: key);

  @override
  _BulkConsuApproveRejectState createState() => _BulkConsuApproveRejectState();
}

class _BulkConsuApproveRejectState extends State<BulkConsuApproveRejectDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.pageName!.equalsIgnoreCase(Strings.approve)) {
      title = "${Strings.bulk_consumption} ${Strings.approve}";
    } else if (widget.pageName!.equalsIgnoreCase(Strings.reject)) {
      title = "${Strings.bulk_consumption} ${Strings.reject}";
    }
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.bulkConsApproveRejectReq!.approvalRemark = controller.text;
                                widget.bulkConsApproveRejectBtnAction!
                                    .bulkConsApproveRejectStatus(
                                    ...
                                    bulkConsApproveRejectReq:
                                    widget.bulkConsApproveRejectReq);
                              }
                            },
                            child: Container(
...
abstract class BulkConsApproveRejectBtnAction {
  void bulkConsApproveRejectStatus(
      {String identifier,
