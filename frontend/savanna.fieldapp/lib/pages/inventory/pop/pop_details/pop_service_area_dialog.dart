...
class PopServiceAreaDialog extends StatefulWidget {
  final List<String>? itemList;
  final String fromFor;

  const PopServiceAreaDialog({
    Key? key,
    this.itemList,
  ...
  @override
  _PopServiceAreaState createState() => _PopServiceAreaState();
}

class _PopServiceAreaState extends State<PopServiceAreaDialog> {
  List<String>? itemsLst = [];
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.fromFor.equalsIgnoreCase(Strings.service_area)) {
      title = "${Strings.service_area} List";
    } else{
      title = "${Strings.service_area} List";
    }
