...
class PopApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final PopApproveRejectBtnAction? creditApproveRejectBtnAction;
  int? inventoryMappingId;

  PopApproveRejectDialog(
      {Key? key,
        this.pageName,
        this.creditApproveRejectBtnAction,this.inventoryMappingId})
      : super(key: key);

  @override
  _PopApproveRejectState createState() => _PopApproveRejectState();
}

class _PopApproveRejectState extends State<PopApproveRejectDialog> {
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.creditApproveRejectBtnAction!
                                    .popApproveRejectStatus(
                                    ...
                                    mappingId : widget.inventoryMappingId);
                              }
                            },
                            child: Container(
                              ...
                              child: Text(
                                widget.pageName!.equalsIgnoreCase(Strings.approve) ? Strings.approve : Strings.reject,
                                style: TextStyle(
...
abstract class PopApproveRejectBtnAction {
  void popApproveRejectStatus(
      {String identifier,
        TextEditingController remarkController,int? mappingId});
}
