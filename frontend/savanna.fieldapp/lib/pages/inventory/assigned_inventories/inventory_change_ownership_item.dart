...
class InventoryChangeOwnershipItem extends StatelessWidget {
  InventoryListDetail item;
  int index;
  InventoryChangeOwnershipController inventoryChangeOwnershipController;

  InventoryChangeOwnershipItem(
      {Key? key,
      required this.index,
      required this.item,
      required this.inventoryChangeOwnershipController})
      : super(key: key);
              ...
              children: [
                Flexible(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      titleWidget(Strings.ownership_status),
                      ...
                      SizedBox(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButtonFormField(
                              ...
                              items: inventoryChangeOwnershipController
                                  .ownershipStatusList
                              ...
                              onChanged: (value) {
                                ...
                                inventoryChangeOwnershipController.update();
                              },
                              validator: (value) {
                                return null;
                              },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TextFormField(
                          key: Key(item.id.toString()),
                          initialValue: item.ownerShipRemarks != null &&
                                  item.ownerShipRemarks!.isNotEmpty
                              ? item.remarks
                              : "",
                          ...
                          onChanged: (value) {
                            inventoryChangeOwnershipController
                                .inventoryList![index].ownerShipRemarks = value;
                            inventoryChangeOwnershipController.update();
                          },
                        ),
                      ),
