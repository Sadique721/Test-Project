...
class AssignedInventoryApproveRejectDialog extends StatefulWidget {
  String? pageName;
  final AssignedInventoryApproveRejectBtnAction? assignedInventoryApproveRejectBtnAction;

  AssignedInventoryApproveRejectDialog(
      {Key? key,
        this.pageName,
        this.assignedInventoryApproveRejectBtnAction})
      : super(key: key);

  @override
  _AssignedInventorypproveRejectState createState() => _AssignedInventorypproveRejectState();
}

class _AssignedInventorypproveRejectState extends State<AssignedInventoryApproveRejectDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.pageName!.equalsIgnoreCase(Strings.approve)) {
      title = Strings.change_approval_status;
                          ...
                          child: InkWell(
                            onTap: () {
                              if (controller.text.isNullOrEmpty()) {
                                ...
                                widget.assignedInventoryApproveRejectBtnAction!
                                    .assignedInventoryApproveRejectStatus(
...
abstract class AssignedInventoryApproveRejectBtnAction {
  void assignedInventoryApproveRejectStatus(
      {String identifier,
