...
class InwardsItem extends StatelessWidget {
  InwardsDetail item;
  int index;
  ...
  final Function()? onTapInwardDetail;
  ...
  InwardsItem(
      ...
      this.onTapApprove,
      this.onTapReject,
      this.onTapInwardDetail})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    String pName = "", inwardsDate = "";
    bool showStatusBtn = false, showMacMappingBtn = false;
    bool isShowApproveRejected = true, isEditDelete = true;
    ...
    if (item.inwardDateTime != null && item.inwardDateTime!.isNotEmpty) {
      DateTime date =
          DateFormat(Constant.DATE_TIME_FORMAT_API).parse(item.inwardDateTime!);
      inwardsDate =
          DateFormat("${Constant.DATE_FORMAT} ${Constant.APP_TIME_FORMAT}")
              .format(date);
    }
    if ((item.approvalStatus == 'Pending' && item.status == 'INACTIVE') ||
    ...
    if ((item.approvalStatus!.equalsIgnoreCase(Strings.pending) &&
        ...
        item.approvalStatus!.equalsIgnoreCase(Strings.rejected)) {
      isShowApproveRejected = false;
    }
    if (item.approvalStatus! != Strings.pending || item.outwardId != null) {
      isEditDelete = false;
    }
    return Container(
      ...
      child: Material(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
              ...
              child: basicDetailItem(
                Strings.create_by,
                (item.createdBy != null && item.createdBy!.isNotEmpty)
                    ? item.createdBy!
                    : "-",
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              isEditDelete
                  ...
                  : buttonView(editSvg, AppTheme.colorDisableGray,
              ...
              isEditDelete
                  ...
                  : buttonView(deleteSvg, AppTheme.colorDisableGray,
                      AppTheme.colorWhite, null),
              showMacMappingBtn
                  ? const SizedBox(
                      width: Constant.SMALL_PADDING,
