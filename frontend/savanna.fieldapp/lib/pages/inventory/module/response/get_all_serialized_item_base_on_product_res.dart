class GetAllSerializedItemBaseOnProductRes {
  int? responseCode;
  String? responseMessage;
  dynamic data;
  List<SerializedItemBaseDataList>? dataList;
  Null? excelDataList;
  int? totalRecords;
  int? pageRecords;
  ...
  GetAllSerializedItemBaseOnProductRes(
      {this.responseCode,
  ...
  GetAllSerializedItemBaseOnProductRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <SerializedItemBaseDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(SerializedItemBaseDataList.fromJson(v));
      });
    }
...
class SerializedItemBaseDataList {
  int? id;
  int? inwardId;
  int? outwardId;
  String? status;
  ...
  SerializedItemBaseDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
