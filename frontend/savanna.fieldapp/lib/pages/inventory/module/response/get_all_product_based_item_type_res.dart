class GetAllProductBasedItemTypeRes {
  int? responseCode;
  String? responseMessage;
  Null? data;
  List<ProductBasedItemTypeDataList>? dataList;
  Null? excelDataList;
  int? totalRecords;
  int? pageRecords;
  ...
  GetAllProductBasedItemTypeRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'];
    if (json['dataList'] != null) {
      dataList = <ProductBasedItemTypeDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(new ProductBasedItemTypeDataList.fromJson(v));
      });
    }
...
class ProductBasedItemTypeDataList {
  int? id;
  String? name;
  String? description;
  String? status;
  ...
  ProductBasedItemTypeDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
