...
class ViewProductDetailsRes  extends BaseResponse{
  // int? responseCode;
  String? responseMessage;
  ViewProductDetailsData? data;
  dynamic dataList;
  ...
  ViewProductDetailsRes.fromJson(Map<String, dynamic> json) {
    responseCode = json['responseCode'];
    responseMessage = json['responseMessage'];
    data = json['data'] != null ? new ViewProductDetailsData.fromJson(json['data']) : null;
...
class ViewProductDetailsData {
  ...
  ViewProductDetailsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    ...
    //   specificationParametersDTOList = <Null>[];
    //   json['specificationParametersDTOList'].forEach((v) {
    //     specificationParametersDTOList!.add(new Null.fromJson(v));
    //   });
    // }
  }
