class CustomerTerminateApproveRejectRes {
  Result? result;
  String? message;
  String? timestamp;
  int? status;

  CustomerTerminateApproveRejectRes(
      {this.result, this.message, this.timestamp, this.status});

  CustomerTerminateApproveRejectRes.fromJson(Map<String, dynamic> json) {
    result =
...
class Result {
  ...
  List<CustomerTerminateApproveRejectDataList>? dataList;
  int? totalRecords;
  int? pageRecords;
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    if (json['dataList'] != null) {
      dataList = <CustomerTerminateApproveRejectDataList>[];
      json['dataList'].forEach((v) {
        dataList!.add(CustomerTerminateApproveRejectDataList.fromJson(v));
      });
    }
...
class CustomerTerminateApproveRejectDataList {
  int? id;
  String? createdate;
  String? updatedate;
  ...
  CustomerTerminateApproveRejectDataList(
      {this.id,
        this.createdate,
        this.updatedate,
        this.createdByName,
  ...
  CustomerTerminateApproveRejectDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
