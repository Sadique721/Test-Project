...
export const environment = {
    ...
    BILLINGENGINE_COMMON_IP_PORT: window["env"]["BILLINGENGINE_COMMON_IP_PORT"] || "localhost:40080",
    OTP_GENERATE_USERNAME: window["env"]["OTP_GENERATE_USERNAME"] || "OTP",
    SAVBILLSALESCRMS_IP_PORT: window["env"]["SAVBILLSALESCRMS_IP_PORT"] || "localhost:60080",
    SAVBILLINVENTORYMANAGEMENT_IP_PORT:
        window["env"]["SAVBILLINVENTORYMANAGEMENT_IP_PORT"] || "localhost:30083",
    SAVBILL_TICKET_IP_PORT: window["env"]["SAVBILL_TICKET_IP_PORT"] || "localhost:30084",
