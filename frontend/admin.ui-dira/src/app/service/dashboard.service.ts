...
export class DashboardService {
  baseUrl = RadiusConstants.SAVBILL_PRODUCT_MANAGEMENT_BASE_URL + "/dashboard";
  inventoryBaseUrl = RadiusConstants.SAVBILL_INVENTORY_MANAGEMENT_BASE_URL + "/dashboard";
