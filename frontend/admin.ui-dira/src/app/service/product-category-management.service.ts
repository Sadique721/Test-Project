...
export class ProductCategoryManagementService {
    baseUrl = SAVBILL_INVENTORY_MANAGEMENT_BASE_URL + "/productCategory";
    ...
    deleteMethod(url) {
        return this.http.delete(RadiusConstants.SAVBILL_INVENTORY_MANAGEMENT_BASE_URL + url);
    }
    ...
    downloadFile(productId): Observable<any> {
        const get_url = RadiusConstants.SAVBILL_INVENTORY_MANAGEMENT_BASE_URL + "/product/document/download/" + productId;
