...
export class MigrationService {
  ...
  integrationUrl = RadiusConstants.SAVBILL_INTEGRATION_SYSTEM_BASE_URL;
  cpmUrl = RadiusConstants.SAVBILL_PRODUCT_MANAGEMENT_BASE_URL;
  ...
  uploadBulkPlanUpdateSheetCMS(data) {
    return this.http.post(`${this.cpmUrl}/uploadPlanUpdatebulk`, data);
  }
}
