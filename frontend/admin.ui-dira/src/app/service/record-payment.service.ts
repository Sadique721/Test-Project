...
export class RecordPaymentService {
    ...
    postMethodForRevenue(url, data) {
        return this.http.post(RadiusConstants.SAVBILL_PAYMENT_RECEIPT_BASE_URL + url, data);
    }
    ...
    getDataTOExport(obj) {
        return this.http.post(
            `${RadiusConstants.SAVBILL_INTEGRATION_SYSTEM_BASE_URL}/onlinePayAudit/exportTransactionsToCSV`, obj
        );
    }
}
