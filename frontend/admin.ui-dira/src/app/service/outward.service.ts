...
import {
    ...
    SAVBILL_INVENTORY_MANAGEMENT_BASE_URL,
...
export class OutwardService {
    ...
    baseCommonUrl = SAVBILL_API_GATEWAY_COMMON_MANAGEMENT;
    ...
    saveBulk(data) {
        return this.http.post(this.baseUrl + "/outwards/saveBulkOutward", data);
    }
