...
export class WarhouseManagementService {
  ...
  baseCommonUrl = RadiusConstants.SAVBILL_API_GATEWAY_COMMON_MANAGEMENT;
  ...
  getPincode(id) {
    return this.http.get(RadiusConstants.SAVBILL_INVENTORY_MANAGEMENT_BASE_URL + "/pincode/" + id);
  }
