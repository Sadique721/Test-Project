...
export class TaskManagementService {
    ...
    assignMethod(url, formData) {
        return this.http.post(RadiusConstants.SAVBILL_TASK_MANAGEMENT + url, formData);
    }
    ...
    downloadResolveFile(ticketId, uniquename, section): Observable<any> {
        const get_url = RadiusConstants.SAVBILL_TASK_MANAGEMENT + "/case/document/download/" + ticketId + "/" + uniquename + "/" + section + "/";
