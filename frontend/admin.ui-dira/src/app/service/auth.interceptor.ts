...
export class AuthInterceptor implements HttpInterceptor {
    COUNT: number = 0;
    secretKey = "howtotrainyourdragon";
    constructor(
    ...
    intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        if (token != null) {
            ...
            if (
                req.urlWithParams.includes("http://137.184.153.97:40080/SavbillBillingEngine/postpaidbillingprocess") ||
                req.urlWithParams.includes("http://137.184.153.97:40080/SavbillBillingEngine/trialbillingprocess")
            ) {
                ...
                let header = {};
                if (!req.url.includes("gateway/getGatewayFromPrefix")) {
                    header = {
                        Authorization: `${token}`,
                        requestFrom: `gui`,
    ...
    private handleTokenExpiration(): void {
        // this.COUNT = 0;
        this.loginService.logout(); // Clear token from storage (you should implement this method)
