...
export class CustomermanagementService {
    ...
    private customerDetailSubject = new BehaviorSubject<any>(null);
    customerDetail$ = this.customerDetailSubject.asObservable();
    customerPrepaidSerachData;
    ...
    setCustomerDetailData(data: any) {
    ...
    getMethodForRadius(url) {
        return this.http.get(RadiusConstants.SAVBILL_RADIUS_BASE_URL + url);
    }

    getByIdMethodForNetConf(url) {
        return this.http.get(RadiusConstants.SAVBILL_API_GATEWAY_NETCONF_CUSTOMER + url);
    }
    ...
    getMethodImagesFile(uniqueName: any, customerCafImageMappingId: any): Observable<any> {
        const get_url =
            RadiusConstants.SAVBILL_PRODUCT_MANAGEMENT_BASE_URL +
            "/customer-caf-image/download/" +
            customerCafImageMappingId +
            "/" +
            uniqueName;
    ...
    postMethodRadius(url, data) {
        return this.http.post(RadiusConstants.SAVBILL_RADIUS_BASE_URL + url, data);
    }

    postMethodForNetConf(url, data) {
        return this.http.post(RadiusConstants.SAVBILL_API_GATEWAY_NETCONF_CUSTOMER + url, data);
    }
    ...
    updateRadiusMethod(url, data) {
        return this.http.put(RadiusConstants.SAVBILL_RADIUS_BASE_URL + url, data);
    }
    updateNetConf(url, data) {
        return this.http.put(RadiusConstants.SAVBILL_API_GATEWAY_NETCONF_CUSTOMER + url, data);
    }
    ...
    getCustQuotaList(custid: any) {
        return this.http.get(RadiusConstants.SAVBILL_COMMON_BASE_URL + "/customer/custQuota/" + custid);
    }
    ...
    addNewReceipt(data) {
        return this.http.post(`${RadiusConstants.SAVBILL_COMMON_BASE_URL}/staff/Reciept`, data);
    }
    getStaffReceiptDataByStaffId(id) {
        return this.http.get(`${RadiusConstants.SAVBILL_COMMON_BASE_URL}/staffReceipt/` + id);
    }

    getCustQuotaListFromRadius(custid: any) {
        return this.http.get(RadiusConstants.SAVBILL_RADIUS_BASE_URL + "/customer/custQuota/" + custid);
    }

    resetQuota(custid: any, cprid: any) {
        return this.http.get(
            RadiusConstants.SAVBILL_RADIUS_BASE_URL +
    ...
    getDownloadMethod(url) {
        return this.http
            .get(RadiusConstants.SAVBILL_PRODUCT_MANAGEMENT_BASE_URL + url, { responseType: "blob" })
            .pipe(
                map((res: any) => {
                    return new Blob([res], { type: "application/pdf" });
                })
    ...
    getDownloadServiceArea(url) {
        return this.http
            .get(RadiusConstants.SAVBILL_API_GATEWAY_COMMON_MANAGEMENT + url, { responseType: "blob" })
            .pipe(
                map((res: any) => {
                    return new Blob([res], { type: "application/pdf" });
                })
    ...
    getMethodForCustomerNotesPdf(url) {
        return this.http.get(RadiusConstants.SAVBILL_COMMON_BASE_URL + url);
    }

    getMethodForCustomerInvoice(url) {
        return this.http.get(RadiusConstants.SAVBILL_COMMON_BASE_URL + url);
    }
    ...
    setCustomerPrepaidSearchData(data) {
        this.customerPrepaidSerachData = data;
    }

    getCustomerPrepaidSearchData() {
        return this.customerPrepaidSerachData;
    }
}
