...
export class StatusCheckService {
  ...
  getSaleCrmServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_LEAD_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getCMSServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_PRODUCT_MANAGEMENT_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getTicketServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_TICKET_MANAGEMENT}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getInventoryServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_INVENTORY_MANAGEMENT_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getRevenueServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_REVENUE_MANAGEMENT_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getRadiusServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_RADIUS_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getNotificationServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_NOTIFICATION_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getTaskManagementServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_TASK_MANAGEMENT}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getKPIServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_KPI_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getIntegrationServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_INTEGRATION_SYSTEM_BASE_URL}/serviceStatus`).subscribe(
      (response: any) => {
  ...
  getTacacsStatus() {
    // this.http
    //   .get(`${RadiusConstants.SAVBILL_TACACS_MANAGEMENT_SYSTEM_BASE_URL}/tacacs-service/health`)
    //   .subscribe(
    //     (response: any) => {
  ...
  getNetConfServiceStatus() {
    this.http.get(`${RadiusConstants.SAVBILL_API_GATEWAY_NETCONF_CUSTOMER}/serviceStatus`).subscribe(
      (response: any) => {
