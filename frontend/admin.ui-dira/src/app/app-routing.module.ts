    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        "./components/tacacs-authentication-audit/tacacs-authentication-audit.module"
                    ).then(m => m.TacacsAuthenticationAuditModule)
            },
            {
...

            {
                ...
                loadChildren: () =>
                    import(
                        "./components/product-category-management/product-category-management.module"
                    ).then(m => m.ProductCategoryManagementModule),
            ...
            // },
            {
                ...
                loadChildren: () =>
                    import(
                        "./components/prepaid-rejected-reason-master/prepaid-rejected-reason-master.module"
                    ).then(res => res.PrepaidRejectedReasonMasterModule)
            },
            {
                path: "dbr-problem",
                loadChildren: () =>
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        "./components/radius-access-response-managemnt/radius-access-response-managemnt.module"
                    ).then(m => m.RadiusAccessResponseManagementModule)
            },
            {
            ...
            },
            {
                ...
                path: "diameter-peerConfig",
                loadChildren: () =>
                    import("./components/daimeter/PeerConfig/peerConfig.module").then(
                        m => m.PeerConfigModule
                    )
            }, {
                path: "diameter-attribute",
                loadChildren: () =>
                    import("./components/daimeter/attribute/attribute.module").then(
                        m => m.AttributeModule
                    )
            }, {
                path: "diameter-vendor",
                loadChildren: () =>
                    import("./components/daimeter/vendor/vendor.module").then(
                        m => m.VendorModule
                    )
            },
            {
                path: "diameter-packet",
                loadChildren: () =>
                    import("./components/daimeter/packetMapping/packetMapping.module").then(
                        m => m.PacketMappingModule
                    )
            }, {
                path: "diameter-policy",
                loadChildren: () =>
                    import("./components/daimeter/policy/policy.module").then(
                        m => m.PolicyModule
                    )
            },
            {
                path: "KRA-integration",
                loadChildren: () =>
                    import(
                        "./components/revenue-authorities-integration/revenue-authorities-integration.module"
                    ).then(m => m.KRAIntegrationModule)
            }
        ]
    }
];
