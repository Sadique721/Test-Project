...
export class AcctProfileCreateComponent implements OnInit {
    ...
    // @Input() editProfileId: any;
    selectedTruststoreFileName: string = '';
    selectedKeystoreFileName: string = '';
    editProfileId: any;
    acctProfileForm: UntypedFormGroup;
    loggedInUser: any;
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<AcctProfileCreateComponent>,
        ...
        this.editProfileId = data.id
        this.selectedMvnoId = data.mvnoId
    }
    ...
    async addAcctProfile() {
        this.submitted = true;
        this.acctProfileForm.markAllAsTouched();
    ...
    validateUserToPerformOperations(selectedMvnoId) {
        ...
        if (this.userId != RadiusConstants.SUPERADMINID && selectedMvnoId != loggedInUserMvnoId) {
            //  this.reset();
            this.toastr.info("You are not authorized to do this operation. Please contact to the administrator", 'Failed!');
