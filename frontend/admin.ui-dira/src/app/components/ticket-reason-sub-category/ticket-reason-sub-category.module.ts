...
const routes = [
    { path: "", component: TicketReasonSubCategoryComponent, canDeactivate: [DeactivateService] },
];

@NgModule({
    declarations: [TicketReasonSubCategoryComponent],
    imports: [CommonModule, RouterModule.forChild(routes), SharedModule, MatPaginator,
        MatCardModule,
        MatCheckbox,
        MatCardContent,
        MatDatepickerModule,
...
export class TicketReasonSubCategoryModule { }
