...
export class NavMasterComponent implements OnInit {
    ...
    navMasterAggregationParamMappingFormgroup: UntypedFormGroup;
    navMasterAggregationParamMappingList: UntypedFormArray;
    ...
    getNavMasterList(list) {
        ...
        this.navMasterService.postMethod(url, plandata).subscribe(
            ...
            (error: any) => {
                ...
                this.toastr.info(`${error.error.msg}`, 'Failed!');
    ...
    onAddParameterMappingList(): void {
        ...
        if (this.navMasterAggregationParamMappingFormgroup.valid) {
            ...
            if (index >= 0) {
                this.toastr.info(`Parameter already added`, 'Information!')
