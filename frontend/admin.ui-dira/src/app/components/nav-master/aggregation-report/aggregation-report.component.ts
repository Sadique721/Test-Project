        ...
        this.navMasterService.postMethod(url, data).subscribe(
            (response: any) => {
                ...
                if (response.responseCode == 200) {
                    ...
                    this.toastr.info(`No asynchronous records found.`, 'Info!');
                    // this.messageService.add({
                    //   severity: "info",
                    //   summary: "Information",
            ...
            this.navMasterService.postMethod(url, this.checkedList).subscribe(
                (response: any) => {
                    if (response.responseCode == 417) {
                        ...
                        this.fetchAggregationReport("");
                        this.fetchAggregationPushedReport("");
                        this.toastr.success(`Pushed into NAV successfully.`, 'Success!');
                        // this.messageService.add({
                        //   severity: "success",
                        //   summary: "Successfully",
        ...
        this.navMasterService.postMethod(url, data).subscribe(
            (response: any) => {
                if (response.responseCode == 200) {
                    ...
                    this.toastr.success(`Push Records fetched successfully.`, 'Success!');
                    // this.messageService.add({
                    //   severity: "success",
                    //   summary: "Successfully",
                ...
                if (response.responseCode == 204) {
                    this.toastr.info(`No pushed records found.`, 'Info!');
                    // this.messageService.add({
                    //   severity: "info",
                    //   summary: "Information",
