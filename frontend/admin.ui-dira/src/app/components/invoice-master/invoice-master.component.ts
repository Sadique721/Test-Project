...
export class InvoiceMasterComponent implements OnInit {
    ...
    openInvoicePaymentModal(id, invoiceId) {
        ...
        // this.dialog.open(InvoicePaymentDetailsModalComponent, {
        //     width: '80%', disableClose: true,
        //     data: {
        //         invoiceId: invoiceId
        //     }
    ...
    addInvoiceRemarks(dialogRef) {
        if (this.invoiceCancelRemarksType === "void") {
            this.voidInvoice(dialogRef);
        } else if (this.invoiceCancelRemarksType === "cancelRegenerate") {
            this.cancelRegenrateInvoice(dialogRef);
        }
    }

    cancelRegenrateInvoice(dialogRef) {
        const data = {};
    ...
    getParentCustomerData() {
        ...
        const url = `/customers/list/` + RadiusConstants.CUSTOMER_TYPE.POSTPAID + "?orgcusttype=false";
    ...
    async saveSelCustomer(dialogRef) {
        ...
        this.modalCloseParentCustomer(dialogRef);
    }
    ...
    searchParentCustomer() {
        ...
        const url = "/customers/search/" + RadiusConstants.CUSTOMER_TYPE.POSTPAID;
