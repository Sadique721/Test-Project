...
export class TaskTicketManagementComponent implements OnInit {
    ...
    @ViewChild('changeStatusDialog1') changeStatusDialog1!: TemplateRef<any>;
    changeStatusDialogRef!: MatDialogRef<any> | null;
    uploadResolveDialogRef!: MatDialogRef<any> | null;
    ...
    currentPageAssignedToMe = 1;
    itemsPerPageAssignedToMe = RadiusConstants.ITEMS_PER_PAGE;
    totalRecordsAssignedToMe: number;
    currentPageUnpicked = 1;
    itemsPerPageUnpicked = RadiusConstants.ITEMS_PER_PAGE;
    itemsPerPageAssignedToTeam = RadiusConstants.ITEMS_PER_PAGE;
    totalRecordsAssignedToTeam: number;
    totalRecordsUnpicked: number;
    currentPageAssignedToTeam = 1;
    workflowID: any;
    priorityTicketData = [];
    selectPriorityValue = "";
    ...
    isLinkTicketDialogOpen: boolean = false;
    ...
    viewTrcData: any;
    linkTicketDialogRef: MatDialogRef<any>
    viewTATMessage: any;
    rating: any = 0;
    ...
    tabs = ['FAT Optical Power Picture', 'FAT Inside Picture', 'FAT Outside Picture', 'ONU Optical Power Picture', 'Optical Power Range', 'Installation Picture', 'Speedtest Picture'];
    ...
    constructor(
        ...
        private ticketManagementService: TicketManagementService, private dialog: MatDialog,
    ) {
        ...
        this.etrExcelDownloadAccess = loginService.hasPermission(
            TASK_SYSTEMS.TASK_ETR_EXCEL_DOWNLOAD
        );
    ...
    addEditTicket(ticketId, dialogRef): void {
        ...
        if (ticketId) {
            ...
            this.updateTicketData.caseSubCategoryId = this.createTicketData.caseSubCategoryId;
        ...
        this.commondropdownService.getMethodWithCache(url).subscribe(
            (response: any) => {
                ...
                if (this.chnageStatusForm.value.oldStatus === "Open") {
                    ...
                    const filteredStatusOList = this.statusData.filter(element => validStatusesForOpen.includes(element.value));
                    this.ChangestatusList.push(...filteredStatusOList);
                } else if (this.chnageStatusForm.value.oldStatus === "In Progress") {
                    const validStatusesForInProgress = ["Resolved", "Rejected", "Done", "On-Hold", "On Hold", "Cancelled"];
                    const filteredStatusIPList = this.statusData.filter(element => validStatusesForInProgress.includes(element.value));
                    this.ChangestatusList.push(...filteredStatusIPList);
                } else if (this.chnageStatusForm.value.oldStatus === "Re-Open" || this.chnageStatusForm.value.oldStatus === "Re Open") {
                    const validStatusesForReOpen = ["In Progress"];
                    const filteredStatusROList = this.statusData.filter(element => validStatusesForReOpen.includes(element.value));
                    ...
                    const filteredStatusRESList = this.statusData.filter(element => validStatusesForResolved.includes(element.value));
                    ...
                    const filteredStatusREList = this.statusData.filter(element => validStatusesForRejected.includes(element.value));
                    this.ChangestatusList.push(...filteredStatusREList);
                } else if (this.chnageStatusForm.value.oldStatus === "On Hold" || this.chnageStatusForm.value.oldStatus === "On-Hold") {
                    const validStatusesForOnHold = ["In Progress", "Cancelled"];
                    const filteredStatusOHList = this.statusData.filter(element => validStatusesForOnHold.includes(element.value));
                    ...
                    const filteredStatusDisList = this.statusData.filter(element => validStatusesForCancelled.includes(element.value));
    ...
    searchTicket(): void {
        ...
        if (this.searchGroupForm.valid) {
            let data: any = [];
            let currentSearchKey = this.searchTicketDetail || this.searchGroupForm.controls.searchValue.value || this.searchGroupForm.controls.searchOption.value || "search_active";
            if (!this.searchkey || this.searchkey !== currentSearchKey) {
                this.currentPageTicketConfig = 1;
            }
            this.searchkey = currentSearchKey;
            if (this.showItemPerPage && this.showItemPerPage !== this.ticketConfigitemsPerPage && this.showItemPerPage !== 0) {
                this.ticketConfigitemsPerPage = this.showItemPerPage;
                this.showItemPerPage = 0;
            }
            this.pageITEM = this.ticketConfigitemsPerPage || this.pageITEM;
            ...
            if (this.searchGroupForm.controls.searchOption.value == "TASK_CATEGORY") {
                data[0].filterColumn = "TICKET_CATEGORY";
            }
            this.searchData = {
                filters: data,
                page: this.currentPageTicketConfig,
    ...
    onSelectTeam(event) {
        if (event.value !== null && event.value !== undefined) {
            ...
            this.ticketGroupForm.controls.caseStatus.setValue("Open");
            this.ticketGroupForm.controls.caseStatus.disable();
            this.ticketGroupForm.controls.currentAssigneeId.setValue(null);
        } else {
    ...
    openStaffDetailModal(staffId) {
        ...
        this.dialog.open(this.staffDetailDialog, {
            width: '80%',
    ...
    assignTicket(ticketId, ticketStatus) {
        ...
        this.dialog.open(this.assignTaskDialog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    ratingTicketModalOpen(id) {
        ...
        this.dialog.open(this.ratingTaskDialog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    followupTicketModalOpen(ticketId, custId, staffId) {
        ...
        this.dialog.open(this.followupPopupOpenDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
        ...
        if (this.followupForm.valid) {
            ...
            this.taskManagementService.postMethod(url, data).subscribe(
                (response: any) => {
                    ...
                    this.getFollowUpDetailById(this.folloupTicketId);
                    this.toastr.success(response.responseMessage || "Remarked Successfully", 'Success!')
                    // this.messageService.add({
                    //     severity: "success",
                    //     summary: "Successfully",
                    //     detail: response.responseMessage,
    ...
    checkChangeProblemDomain(ticket) {
        ...
        this.dialog.open(this.showChangeProblemDomainDialog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    openTicketDetail(ticketId, isDialogOpen?): void {
        if (isDialogOpen) {
    ...
    pageChangedTicketConfig(event: PageEvent): void {
        this.currentPageTicketConfig = event.pageIndex + 1;
        this.ticketConfigitemsPerPage = event.pageSize;
        if (!this.searchkey) {
    ...
    pageChangedLinkTicket(pageEvent): void {
        this.currentPageTicketConfig = pageEvent.pageIndex + 1;
        this.linkTicketItemsPerPage = pageEvent.pageSize;
        // if (!this.searchkey) {
        this.getLinkableTickets(this.ticketDeatailData, null);
        // } else {
        //   this.searchTicket();
        // }
    }
    ...
    viewProgressDetails(caseUpdate): void {
        ...
        this.dialog.open(this.caseUpdateDetailsDialog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    changeStatusModalOpen(data, tickT): void {
        if (tickT == "pTicket") {
            ...
            if (data.caseStatus === "Closed") {
                ...
                this.chnageStatusForm.get('oldStatus').disable();

                // open the template as a MatDialog
                this.changeStatusDialogRef = this.dialog.open(this.changeStatusDialog, {
                    width: '70%',
                    disableClose: true,
    ...
    closeStatus(dialogRef: MatDialogRef<any>): void {
        if (dialogRef) {
            dialogRef.close();
        }
    }
    ...
    closeTicketApproveRejectModal(dialogRef) {
    ...
    getworkflowAuditDetails(size, id, name) {
        ...
        this.taskManagementService.postMethod(url, data).subscribe(
            (response: any) => {
                ...
                this.MastertotalRecords1 = response.totalRecords || this.workflowAuditData1.length;
            },
            (error: any) => {
                if (error.status == 200) {
    ...
    pageChangedMasterList(event: PageEvent) {
        this.currentPageMasterSlab1 = event.pageIndex + 1;
        this.MasteritemsPerPage1 = event.pageSize;
        this.getworkflowAuditDetails(this.MasteritemsPerPage1, this.viewTicketId, "CASE");
    }
    ...
    opechangePriorityMadel(data) {
        ...
        this.dialog.open(this.idChangePriorityDialog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    SavechangePriority(dialogRef: any) {
        let ticketdata: any = {};
    ...
    closeTicketPickModal(dialogRef) {
        ...
        if (data.ticketAssignStaffMappings.length > 0) {
            ...
            data.ticketAssignStaffMappings.forEach(element => {
                if (element.staffId == this.currentLoginUserId) {
                    ...
                    this.dialog.open(this.ticketPickDialog, {
                        width: '80%',
                        disableClose: true // same as data-backdrop="static" data-keyboard="false"
                    });
                }
            ...
            if (!show) {
                this.toastr.info(`YOU ARE NOT AUTOSISED TO PICK THIS TICKET..`, 'Info!')
                // this.messageService.add({
                //     severity: "info",
                //     summary: "Info",
    ...
    pickstaff(dialogRef) {
        ...
        this.taskManagementService.getMethod(url).subscribe(
            () => {
                this.toastr.success(`Pickup Successfully`, 'Success!')
                // this.messageService.add({
                //     severity: "success",
                //     summary: "Successfully",
                //     detail: "Pickup Successfully",
                //     icon: "far fa-check-circle"
                // });
                dialogRef.close()
                if (!this.searchkey) {
    ...
    openLinkTicketDialog(ticket, dialogRef) {
        this.showLinktickets = true;
        this.getLinkableTickets(ticket, dialogRef);
    }

    getLinkableTickets(ticket, dialogRef) {
        ...
        this.ticketManagementService.postMethod(url, this.searchData).subscribe(
            (response: any) => {
                if (response.responseCode == 404) {
                    ...
                    this.showLinktickets = true;
                    let filteredCases = response.dataList.filter(caseItem => caseItem.caseStatus !== 'Closed');
                    this.ticketDataForLink = filteredCases;
                    this.ticketConfigtotalRecords = response.totalRecords;
                    this.linkedTicketId = null;
                    this.selectLinkTicket = true;

                    if (!this.isLinkTicketDialogOpen) {
                        this.linkTicketDialogRef = this.dialog.open(this.selectLinkTicketDialog, {
                            width: '80%',
                            disableClose: true
                        });
                        this.isLinkTicketDialogOpen = true;
                    }
    ...
    closeLinkTicketDialog() {
        if (this.linkTicketDialogRef) {
            this.linkTicketDialogRef.close();
        }
        this.isLinkTicketDialogOpen = false;
        this.linkTicketDialogRef = null;
    }
            ...
            this.customerService.getMethod(url).subscribe(
                (response: any) => {
                    if (response.status == 200) {
                        ...
                        this.dialog.open(this.customerDetailsDialog, {
                            width: '80%',
                            disableClose: true // same as data-backdrop="static" data-keyboard="false"
                        });
                    }
    ...
    uploadDocument(ticket) {
        ...
        this.dialog.open(this.uploadDocumentIdDialog, {
            width: '450px',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }

    closeUploadDocumentId(dialogRef) {
    ...
    async modalOpenParentCustomer() {
        ...
        this.dialog.open(this.displaySelectCustomerDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    async saveSelCustomer(isOpenModal, dialogRef) {
        this.parentCustList = [
            {
        ...
        if (isOpenModal) this.modalCloseParentCustomer(dialogRef);
        dialogRef.close()
    }
    ...
    openETRModal(data) {
        ...
        this.dialog.open(this.ticketETRModalDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    openTeamDetailModel(data) {
        ...
        this.dialog.open(this.ticketStaffTeamdetailsDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    showTATDetails(data) {
        ...
        this.dialog.open(this.displayTATDetailsDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
        this.ticketReasonSubCategoryData.forEach(element => {
    ...
    showticketDocData(data: any) {
        ...
        this.taskManagementService.downloadFile(url).subscribe(data => {
            ...
            if (fileType[fileType?.length - 1] == "pdf") {
                ...
                this.dialog.open(this.documentPreviewDailog, {
                    width: '80%',
                    disableClose: true // same as data-backdrop="static" data-keyboard="false"
                });
            }
    ...
    generatedNameOfTheFollowUp(ticketId) {
        ...
        this.taskManagementService.getMethod(url).subscribe(
            ...
            async (error: any) => {
                ...
                this.toastr.error(`Something went wrong with 'followup name.`, 'Failed!')
                // this.messageService.add({
                //     severity: "error",
                //     summary: "Error",
    ...
    openRawDataModal(finalData: any) {
        ...
        this.dialog.open(this.tatDetailsShowDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    openTATMessageDataModal(Data: any) {
        ...
        this.dialog.open(this.tatDetailsMessageShowDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    openTATModel() {
        ...
        this.dialog.open(this.tatDetailsShowModelDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    openHelperModel() {
        ...
        this.dialog.open(this.helperDetailsShowDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    SlaCounterModelOpen(ticketdata) {
        ...
        this.dialog.open(this.counterDetaildailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    onClickServiceArea() {
        ...
        this.dialog.open(this.serviceAreaDetaildailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    getbulkChange() {
        ...
        this.taskManagementService.postMethod(url, data1).subscribe((response: any) => {
            ...
            this.dialog.open(this.reassignTicketDailog, {
                width: '80%',
                disableClose: true // same as data-backdrop="static" data-keyboard="false"
            });
            if (response.responseCode == 406) {
    ...
    openParentTicketModel(ticketId) {
        ...
        this.dialog.open(this.parentTaskDetailsDialog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
        const url = "/case/" + ticketId;
    ...
    openChildTicketModel(ticketId) {
        ...
        this.dialog.open(this.childDetailsShowDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    ticketRemarkModalOpen(ticket, ticketId, custId, staffId) {
        ...
        this.followUpModal = true;
        this.dialog.open(this.followUpDialog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
        this.followupForm.reset();
    ...
    pageChanged(pageEvent): void {
        this.currentPageAssignedToMe = pageEvent.pageIndex + 1;
        this.itemsPerPageAssignedToMe = pageEvent.pageSize;
        if (!this.searchkey) {
            this.getAssignToMeTicketDetails(this.itemsPerPageAssignedToMe);
        } else {
            this.searchTicket();
        }
    }
    ...
    getAssignToMeTicketDetails(size) {
        ...
        if (size) {
            page_list = size;
            this.itemsPerPageAssignedToMe = size;
        } else {
            if (this.showItemPerPage == 0) {
                this.itemsPerPageAssignedToMe = this.pageITEM;
            } else {
                this.itemsPerPageAssignedToMe = this.showItemPerPage;
            }
        }

        const ticketPagination = {
            page: this.currentPageAssignedToMe,
            pageSize: this.itemsPerPageAssignedToMe
        };
        const url = "/case/filter?filter=Assigned_to_me";
        this.taskManagementService.postMethod(url, ticketPagination).subscribe(
            (response: any) => {
                this.AssignToMeTicketDetails = response.dataList;
                this.totalRecordsAssignedToMe = response.totalRecords;
    ...
    pageChangedUnpicked(pageEvent): void {
        this.currentPageUnpicked = pageEvent.pageIndex + 1;
        this.itemsPerPageUnpicked = pageEvent.pageSize;
        if (!this.searchkey) {
            this.getUnpickTicketDetails(this.itemsPerPageUnpicked);
        } else {
            this.searchTicket();
        }
    }
    ...
    getUnpickTicketDetails(size) {
        ...
        if (size) {
            page_list = size;
            this.itemsPerPageUnpicked = size;
        } else {
            if (this.showItemPerPage == 0) {
                this.itemsPerPageUnpicked = this.pageITEM;
            } else {
                this.itemsPerPageUnpicked = this.showItemPerPage;
            }
        }

        const ticketPagination = {
            page: this.currentPageUnpicked,
            pageSize: this.itemsPerPageUnpicked
        };
        this.ticketConfigtotalRecords = 0;
        ...
        this.taskManagementService.postMethod(url, ticketPagination).subscribe(
            (response: any) => {
                ...
                this.totalRecordsUnpicked = response.totalRecords;
    ...
    pageChangedAssignToTeam(pageEvent): void {
        this.currentPageAssignedToTeam = pageEvent.pageIndex + 1;
        this.itemsPerPageAssignedToTeam = pageEvent.pageSize;
        if (!this.searchkey) {
            this.getAssignToTeamTicketDetails(this.itemsPerPageAssignedToTeam, this.currentPageAssignedToTeam);
        } else {
            this.searchTicket();
        }
    }
    ...
    getAssignToTeamTicketDetails(size, currentPageAssignedToTeam: number = 1) {
        let page_list;
        this.searchkey = "";
        if (size) {
            page_list = size;
            this.itemsPerPageAssignedToTeam = size;
        } else {
            if (this.showItemPerPage == 0) {
                this.itemsPerPageAssignedToTeam = this.pageITEM;
            } else {
                this.itemsPerPageAssignedToTeam = this.showItemPerPage;
            }
        }

        this.totalRecordsAssignedToTeam = 0;
        const ticketPagination = {
            page: currentPageAssignedToTeam,
            pageSize: this.itemsPerPageAssignedToTeam
        };
        const url = "/case/filter?filter=Assigned_to_my_team";
        this.taskManagementService.postMethod(url, ticketPagination).subscribe(
            (response: any) => {
                this.AssignToTeamDetails = response.dataList;
                this.totalRecordsAssignedToTeam = response.totalRecords;
    ...
    onCallDisconnected(event) {
        if (event == "false") {
            ...
            this.dialog.open(this.feedbackFormDailog, {
                width: '80%',
                disableClose: true // same as data-backdrop="static" data-keyboard="false"
            });
    ...
    ticketConversationModalOpen(ticketId) {
        ...
        this.dialog.open(this.conversationDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    }
    ...
    closeAssignStaffModel(dialogRef) {
        this.assignCustomerCAFModal = false;
        dialogRef.close()
    }
        ...
        this.taskManagementService.getMethod(url).subscribe(
            (response: any) => {
                if (response.data && response.data.length > 0) {
                    ...
                    this.dialog.open(this.showTatDetailsDailog, {
                        width: '80%',
                        disableClose: true // same as data-backdrop="static" data-keyboard="false"
                    });
                }
    ...
    @ViewChild('uploadResolveDialogs') uploadResolveDialog!: TemplateRef<any>;
    ...
    uploadResolveDocument() {
        ...
        // this.dialog.open(this.uploadResolvedocumentIdDailog, {
        //     width: '80%',
        //     disableClose: true // same as data-backdrop="static" data-keyboard="false"
        // });
        this.uploadResolveDialogRef = this.dialog.open(this.uploadResolveDialog, {
            width: '90%',
            disableClose: false
        });
    }
    onCloseUploadResolveDialogRef() {
        if (this.uploadResolveDialogRef) {
            this.uploadResolveDialogRef.close();
        }
        this.uploadResolveDialogRef = null;
    }
    ...
    downloadResolveDocument(ticketDeatailData) {
        ...
        this.taskManagementService.getMethod(url)
            .subscribe(
                (response: any) => {
                    ...
                    if (response.responseCode == 200) {
                        ...
                        this.dialog.open(this.downloadResolveDocumentIdDailog, {
                            width: '80%',
                            disableClose: true // same as data-backdrop="static" data-keyboard="false"
                        });
    ...
    deleteResolveDoc(fileName, section, sectionName) {
        ...
        let uniqueName = section.uniqueName;
        let urldoc =
            "/case/document/delete/" + ticketId + "/" + fileName + "/" + uniqueName
            + "/" + sectionName + "/";
            ...
            data => {
                if (data.status == 200) {
                    ...
                    if (fileType[fileType?.length - 1] === "pdf") {
                        ...
                        this.dialog.open(this.resolvedocumentPreviewDailog, {
                            width: '80%',
                            disableClose: true // same as data-backdrop="static" data-keyboard="false"
                        });
                    } else {
    ...
    onFileResolveChangeUpload(event: any, tabIndex: number): void {
        ...
        if (inputElement.files && inputElement.files.length > 0) {
            ...
            if (this.selectedResolveFileUploadPreview[tabIndex].length > 0) {
                this.resolveMultiFiles = this.createResolveFileList(this.selectedResolveFileUploadPreview[tabIndex]);
    ...
    deleteResolveUploadedFile(fileName: string, tabIndex: number): void {
        const temp: File[] = this.selectedResolveFileUploadPreview[tabIndex]?.filter((item: File) => item?.name !== fileName);
    ...
    collectResolveSectionData(formGroup: UntypedFormGroup, tabIndex: number): { section: any, files: File[] } | null {
        const section = {
    ...
    getResolutionRootCause(value: string): void {
        ...
        this.dialog.open(this.uploadDocumentRootDailog, {
            width: '80%',
            disableClose: true // same as data-backdrop="static" data-keyboard="false"
        });
    ...
    displayedColumnsTicketData = ['createdByName',
        'createdate',
        'updatedate',
        'lastModifiedByName',
        'viewProgress']
    interrnaldisplayedColumns: string[] = [
        'caseTitle',
        'staffUserName',
        'remarkDate',
        'remark'
    ...
    displayedColumnstaskAssign: string[] = [
        'taskNumber',
        'action',
        'actionByName',
        'remark',
    ...
    displayedColumnsticketETRDetailData = [
        'staffPersonName',
        'caseNumber',
        'messageMode',
        'notificationMode',
    ...
    displayedColumnslinkTicketData = ['caseNumber', 'caseStatus', 'customerDetails'];
    displayedColumns: string[] = ['select', 'issue', 'number', 'type', 'assignee', 'status', 'created', 'updated', 'remain', 'isp', 'action'];

    caseUpdateDetailsDisplay = ['entitytype', 'operation', 'oldvalue', 'newvalue']
    approveCafDisplay = ['select', 'fullName', 'username']

    ticketCongigDisplay = ['select', 'name', 'number', 'type', 'assignee', 'status']
    partnerDisplay = ['select', 'username']
    followUpremarkDisplay = ['remark', 'createdOn']
    childTicketDisplay = ['caseTitle', 'caseNumber', 'caseType', 'assignee', 'status']
    fileDetialDisplay = ['fileName', 'latitude', 'longitude', 'actions']
    displayedColumnsremarkDailog = [
        'orderNo',
        'level',
        'mtime1',
        'mtime2',
    ...
    @ViewChild('customerDetailsDialog') customerDetailsDialog!: TemplateRef<any>;
    @ViewChild('assignTaskDialog') assignTaskDialog!: TemplateRef<any>;
    @ViewChild('ratingTaskDialog') ratingTaskDialog!: TemplateRef<any>;
    @ViewChild('followUpDialog') followUpDialog!: TemplateRef<any>;
    @ViewChild('staffDetailDialog') staffDetailDialog!: TemplateRef<any>;

    @ViewChild('caseUpdateDetailsDialog') caseUpdateDetailsDialog!: TemplateRef<any>;
    ...
    @ViewChild('idChangePriorityDialog') idChangePriorityDialog!: TemplateRef<any>;

    @ViewChild('uploadDocumentIdDialog') uploadDocumentIdDialog!: TemplateRef<any>;
    @ViewChild('selectLinkTicketDialog') selectLinkTicketDialog!: TemplateRef<any>;
    @ViewChild('ticketPickDialog') ticketPickDialog!: TemplateRef<any>;
    @ViewChild('showChangeProblemDomainDialog') showChangeProblemDomainDialog!: TemplateRef<any>;
    @ViewChild('ticketApproveRejectDialog') ticketApproveRejectDialog!: TemplateRef<any>;

    @ViewChild('displaySelectCustomerDailog') displaySelectCustomerDailog!: TemplateRef<any>;
    @ViewChild('ticketETRModalDailog') ticketETRModalDailog!: TemplateRef<any>;
    @ViewChild('displayTATDetailsDailog') displayTATDetailsDailog!: TemplateRef<any>;
    @ViewChild('documentPreviewDailog') documentPreviewDailog!: TemplateRef<any>;
    @ViewChild('ticketStaffTeamdetailsDailog') ticketStaffTeamdetailsDailog!: TemplateRef<any>;

    @ViewChild('followupPopupOpenDailog') followupPopupOpenDailog!: TemplateRef<any>;
    @ViewChild('closeFollowupDailog') closeFollowupDailog!: TemplateRef<any>;
    @ViewChild('reScheduleFollowupDailog') reScheduleFollowupDailog!: TemplateRef<any>;
    @ViewChild('remarkScheduleFollowupDailog') remarkScheduleFollowupDailog!: TemplateRef<any>;
    @ViewChild('tatDetailsShowDailog') tatDetailsShowDailog!: TemplateRef<any>;
    @ViewChild('tatDetailsMessageShowDailog') tatDetailsMessageShowDailog!: TemplateRef<any>;

    @ViewChild('tatDetailsShowModelDailog') tatDetailsShowModelDailog!: TemplateRef<any>;
    @ViewChild('helperDetailsShowDailog') helperDetailsShowDailog!: TemplateRef<any>;
    @ViewChild('parentTaskDetailsDialog') parentTaskDetailsDialog!: TemplateRef<any>;
    @ViewChild('childDetailsShowDailog') childDetailsShowDailog!: TemplateRef<any>;
    @ViewChild('counterDetaildailog') counterDetaildailog!: TemplateRef<any>;
    @ViewChild('serviceAreaDetaildailog') serviceAreaDetaildailog!: TemplateRef<any>;

    @ViewChild('feedbackFormDailog') feedbackFormDailog!: TemplateRef<any>;
    @ViewChild('conversationDailog') conversationDailog!: TemplateRef<any>;
    @ViewChild('reassignTicketDailog') reassignTicketDailog!: TemplateRef<any>;
    @ViewChild('showTatDetailsDailog') showTatDetailsDailog!: TemplateRef<any>;
    @ViewChild('uploadResolvedocumentIdDailog') uploadResolvedocumentIdDailog!: TemplateRef<any>;

    @ViewChild('downloadResolveDocumentIdDailog') downloadResolveDocumentIdDailog!: TemplateRef<any>;
    @ViewChild('resolvedocumentPreviewDailog') resolvedocumentPreviewDailog!: TemplateRef<any>;
    @ViewChild('uploadDocumentRootDailog') uploadDocumentRootDailog!: TemplateRef<any>;
}
