...
export class RadiusCustomerListComponent implements OnInit {
    ...
    radiusCustomerDisplayedColumns: string[] = [
        'fullName',
        'username',
        'mobile',
        'email',
        ...
        'acctno',
        'status',
        ...(this.independentAAA ? ['action'] : [])
    ];

    radiusCustomerDataSource = new MatTableDataSource<any>([]);
    ...
    ngAfterViewInit(): void {
        this.radiusCustomerDataSource.paginator = this.paginator;
        this.radiusCustomerDataSource.sort = this.sort;
    }
    ...
    async getAll(list) {
        ...
        this.customerService.getAll(page, size).subscribe(
            (response: any) => {
                ...
                this.radiusCustomerDataSource = new MatTableDataSource<any>(this.customerSearchData);
            },
            (error: any) => {
