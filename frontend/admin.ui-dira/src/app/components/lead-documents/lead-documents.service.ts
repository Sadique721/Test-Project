...
const BASE_API_URL = SAVBILL_COMMON_BASE_URL + '/'

const SAVBILL_LEAD_BASE_URL  = RadiusConstants.SAVBILL_LEAD_BASE_URL+'/';
...
export class LeadDocumentService {
  ...
  downloadFile(docId, leadId): Observable<any> {
    const get_url =
    SAVBILL_LEAD_BASE_URL + 'leadDoc/document/download/' + docId + '/' + leadId
  ...
  insertLeadDocument(data: any): Observable<any> {
    const post_url = SAVBILL_LEAD_BASE_URL + 'leadDoc/save'
  ...
  updateLeadDocument(data: any): Observable<any> {
    const post_url = SAVBILL_LEAD_BASE_URL + 'leadDoc/update'
    return this.http.post<any>(post_url, data).pipe(
      map((res: any) => {
        return res
      }),
  ...
  deleteLeadDocument(data: any): Observable<any> {
    const post_url = SAVBILL_LEAD_BASE_URL + 'leadDoc/delete/'+data.docId;
  ...
  isCustDocPending(leadId: any): Observable<any> {
    const get_url = SAVBILL_LEAD_BASE_URL + 'leadDoc/isCustDocPending/' + leadId
    return this.http.get<any>(get_url, { headers: httpOptions.headers })
  }

  approvedCustDoc(docId: any, status: any): Observable<any> {
    const get_url =
    SAVBILL_LEAD_BASE_URL + 'leadDoc/approveDoc/' + docId + '/' + status
    return this.http.get<any>(get_url, { headers: httpOptions.headers })
  }
  ...
  DocumentVerify(data) {
    return this.http.post(SAVBILL_LEAD_BASE_URL + 'leadDoc/verifyDocument', data)
  }

  saveLeadOnlineDocument(data) {
    return this.http.post(
      SAVBILL_LEAD_BASE_URL + 'leadDoc/uploadDocOnline?isUpdate=false ',
      data,
    )
  }
  updateLeadOnlineDocument(data) {
    return this.http.post(
      SAVBILL_LEAD_BASE_URL + 'leadDoc/uploadDocOnline?isUpdate=true ',
      data,
    )
  }
}
