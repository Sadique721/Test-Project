...
@Component({
    selector: "app-task-ticket-reason-sub-category",
    templateUrl: "./task-ticket-reason-sub-category.component.html",
    styleUrls: ["./task-ticket-reason-sub-category.component.css"],
    standalone: false
})
export class TaskTicketReasonSubCategoryComponent implements OnInit {
    ...
    addEditTicketReasonSubCat(id) {
        ...
        if (this.ticketReasonSubCatFormGroup.valid) {
            if (this.TatMappingArray.value.length > 0) {
                ...
                this.toastr.info(`You have rejected the request`, 'Required!');
