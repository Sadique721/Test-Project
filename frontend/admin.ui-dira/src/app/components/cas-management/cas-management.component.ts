...
export class CASManagementComponent implements OnInit, IDeactivateGuard {
    title = "CAS";
    casFormGroup: UntypedFormGroup;
    casePackageMappings: UntypedFormArray;
    casParameterMappingsfromgroup: UntypedFormGroup;
    casParameterMappingsFromArray: UntypedFormArray;
