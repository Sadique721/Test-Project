...
export class TacacsCommandsetComponent implements OnInit {
    ...
    get tacacsCommands(): UntypedFormArray {
        return this.deviceFormGroup.get("tacacsCommands") as UntypedFormArray;
    }
    ...
    clearCommandArray() {
        const tacacsCommands = this.deviceFormGroup.get("tacacsCommands") as UntypedFormArray;
    ...
    approveCommand(index: number) {
        ...
        if (command.command === "" || command.grant === "") {
            this.toastr.error(`Some fields are empty. Please fill in all required values.`, 'Failed!')
            //   this.messageService.add({
            //     severity: "error",
            //     summary: "Error",
        ...
        if (hasDuplicate) {
            this.toastr.error(`Duplicate Command found. Please enter a unique value`, 'Failed!')
            //   this.messageService.add({
            //     severity: "error",
            //     summary: "Error",
