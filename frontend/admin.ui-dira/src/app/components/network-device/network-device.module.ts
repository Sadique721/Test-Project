...
import { SelectDeviceComponent } from "../common/select-device/select-device.component";
...
@NgModule({
    declarations: [NetworkDeviceComponent, SelectDeviceComponent],
    imports: [CommonModule, RouterModule.forChild(routes), SharedModule, DialogModule, MatPaginator,
        MatCardModule,
        MatCheckbox,
        MatCardContent,
        MatDatepickerModule,
