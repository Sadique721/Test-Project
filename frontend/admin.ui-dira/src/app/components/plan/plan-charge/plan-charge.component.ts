...
export class PlanChargeComponent implements OnInit {
    ...
    @ViewChild('planCharge') planChargeDetails
    ...
    ngOnInit(): void {
        ...
        !this.planCharge && (this.planCharge = {});
        let taxData: any = [];
        let slabList: any = [];
        let tireList: any = [];
        let slabPrice: any = [];
        ...
        this.planCharge["amount"] = 0;

        this.planCharge["chargeList"] = this.planCharge["chargeList"] ?? [];
        this.chargeFromArray = this.fb.array([]);
        this.chargeFormGroup = this.fb.group({
            amount: [{ value: 0.00, disabled: true }],
            newOfferPrice: [{ value: 0.00, disabled: true }],
        });
    ...
    ngAfterViewInit() {
        this.dialogRef = this.dialog.open(this.planChargeDetails, {
            width: '1200px'
        });
    }
    onCancel(): void {
