...
export class MigrationComonent implements OnInit {
    createMigration: UntypedFormGroup;
    updateMigration: UntypedFormGroup;
    selectedFile: any;
    ...
    @ViewChild('fileNameDialog') fileNameDialog!: TemplateRef<any>;
                ...
                this.integrationAuditService
                    ...
                    .subscribe(
                        ...
                        (error: any) => {
                            ...
                            if ((error.status = 417)) {
                                this.toastr.info(error.error || "Unknown error occurred", 'info!');
                                // this.messageService.add({
                                //     severity: "info",
                                //     summary: "Info",
                                ...
                                this.toastr.error(error.error || "Unknown error occurred", 'Failed!');
                                // this.messageService.add({
                                //     severity: "error",
                                //     summary: "Error",
                                //     detail: error.error || "Unknown error occurred",
    ...
    downloadClick() {
        ...
        this.dialogRef = this.dialog.open(this.fileNameDialog, {
            width: '500px',
            disableClose: true,
        });
    }
