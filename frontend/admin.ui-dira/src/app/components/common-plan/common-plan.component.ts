    ...
    savePlanDto() {
        ...
        if (this.planGroupForm.valid) {
            if (this.chargeGroupFormArray.value.length > 0) {
                ...
                error: (error) => {
                    this.toastr.error(`${error.error.ERROR}`, 'Please add atleat one charge details!');
                }

            }
        } else {
            error: (error) => {
                this.toastr.error(`${error.error.ERROR}`, 'Something Wrong!');
            }
        ...
        if (!this.isEditPlan) {
            ...
            this.tempservice
                ...
                .subscribe(
                    ...
                    (error: any) => {
                        this.toastr.error(`${error.errorMessag}`, 'Failed!');
