...
export class LeadBetaComponent implements OnInit {
    ...
    planCreationType() {
        ...
        if (planBindingType === "On-Demand") {
            ...
            this.toastr.error(`Staff with multiple BU cannot create Customer.`, 'Failed!');
            // this.messageService.add({
            //     severity: "error",
            //     summary: "Error",
    ...
    saveLead() {
        ...
        if (this.customerGroupForm.valid) {
            ...
            this.custService.postLeadMethod(url, this.customerGroupForm.value).subscribe(
                (res: any) => {
                    if (res.status == 200) {
                        ...
                        this.toastr.error(`Customer Creation Failed`, 'Failed!');
                        // this.messageService.add({
                        //     severity: "error",
                        //     summary: "Error",
            ...
            this.toastr.error(`Please fill all the required fields.`, 'Failed!');
            // this.messageService.add({
            //     severity: "error",
            //     summary: "Error",
    ...
    getLeadNumber() {
        this.tempservice.getleadMethod("/leadMaster/generateLeadNo").subscribe((reslead: any) => {
