...
@NgModule({
    declarations: [ManageBalanceComponent, WorkflowAuditDetailsModalComponent],
    imports: [CommonModule, DialogModule, RouterModule.forChild(routes), SharedModule, , MatPaginator,
        MatCardModule,
        MatCheckbox,
        MatCardContent,
        MatDatepickerModule,
