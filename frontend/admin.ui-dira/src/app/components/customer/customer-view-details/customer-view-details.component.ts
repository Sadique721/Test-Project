...
export class CustomerViewDetailsComponent implements OnInit {
    @ViewChild("customerView") customerView;
    customerViewDialogRef!: MatDialogRef<any>;
    ...
    onCancel() {
        this.customerViewDialogRef.close()
    ...
    ngAfterViewInit() {
        this.customerViewDialogRef = this.matdialog.open(this.customerView, {
            width: '1200px'
        });
    }
