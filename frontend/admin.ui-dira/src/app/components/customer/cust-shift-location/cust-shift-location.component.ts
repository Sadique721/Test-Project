...
export class CustShiftLocationComponent implements OnInit {
    ...
    @ViewChild('rejectApproveShiftLocationDialog') rejectApproveShiftLocationDialog!: TemplateRef<any>;
    @ViewChild('rejectCustomerInventoryDialog') rejectCustomerInventoryDialog!: TemplateRef<any>;
    @ViewChild('assignShiftLocationDialog') assignShiftLocationDialog!: TemplateRef<any>;
    dialogRef!: MatDialogRef<any>;

    @ViewChild('shiftLocationApproveDialog') shiftLocationApproveDialog!: TemplateRef<any>;
    shiftLocationDialogRef !: MatDialogRef<any>;
    shiftLocationApproveDialogRef !: MatDialogRef<any>;
    displayedColumnsShiftLocation = ['fullAddress', 'requestedByName', 'requestedDate', 'status', 'action']
    ...
    openRejectApproveShiftLocationDialog() {
        this.dialogRef = this.dialog.open(this.rejectApproveShiftLocationDialog, {
            width: '40vw',
            maxWidth: '400px',
        });
    ...
    openRejectCustomerInventoryDialog() {
        this.dialogRef = this.dialog.open(this.rejectCustomerInventoryDialog, {
            width: '700px',
        });
        this.dialogRef.afterClosed().subscribe(result => {
    ...
    openAssignShiftLocationDialog() {
        this.dialogRef = this.dialog.open(this.assignShiftLocationDialog, {
            width: '700px',
        });
        this.dialogRef.afterClosed().subscribe(result => {
    ...
    // Close dialog method
    closeDialog() {
        this.shiftLocationApproveDialogRef.close();
        if (this.dialogRef) {
    ...
    openShiftLocationForm() {
        ...
        this.dialogRef = this.dialog.open(this.shiftLocationDialog, {
            width: '90vw',
            maxWidth: '1100px',
            disableClose: true
        });
        this.dialogRef.afterClosed().subscribe(result => {
            // Reset or cleanup after dialog closes if needed
                            ...
                            (res: any) => {
                                if (res.data != null) {
                                    ...
                                    if (!this.shiftLocationDTO.updateAddressServiceAreaId) {
                                        ...
                                        this.selServiceArea(serviceAreaId, false);
                                        this.shiftLocationDTO.updateAddressServiceAreaId = res.data?.serviceAreaId;
                                    }
                                }
                            },
                            (error: any) => {
    ...
    modalOpenStaff(type) {
        ...
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.selectedStaffChange(result)
            } else {
            }
        });
        this.selectedStaff = [];
    ...
    modalOpenParentCustomer(type) {
        ...
        const dialogRef = this.dialog.open(CustomerSelectComponent, {
            width: '1200px',
            data: {
                selectedParentCust: this.selectedParentCust,
    ...
    saveShiftLocation() {
        ...
        this.shiftLocationChargeGroupForm.markAllAsTouched();
        ...
        if (this.shiftLocationChargeGroupForm.valid) {
            ...
            delete this.shiftLocationDTO.addressDetails.subareaName
                ...
                (response: any) => {
                    ...
                    this.commondropdownService.postMethod(url, this.shiftLocationDTO).subscribe(
                        (response: any) => {
                            ...
                            this.toastr.success(`Shift customer location successfully.`, 'Success!')
                            // this.messageService.add({
                            //     severity: "success",
                            //     summary: "Successfully",
    ...
    shiftLocationRejected(data) {
        ...
        this.assignAppRejectShiftLocationForm.reset();
        this.shiftLocationApproveDialogRef = this.dialog.open(this.shiftLocationApproveDialog, {
            width: '40%',
            disableClose: true
        });
    }
