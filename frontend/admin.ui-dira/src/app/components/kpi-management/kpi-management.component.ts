...
export class KpiManagementComponent implements OnInit {
    KPIGroupForm: UntypedFormGroup;
    KPIMappingFormArray: UntypedFormArray;
    KPIMappingForm: UntypedFormGroup;
    ...
    createKPIMappingFormGroup(areaName): UntypedFormGroup {
    ...
    addEditKPI(kpiId) {
        ...
        if (this.KPIGroupForm.valid && this.KPIMappingFormArray.valid) {
            if (this.totalAmountPer >= 100) {
                ...
                this.toastr.error(`Total Amount % not less than 100`, 'Failed!');
                // this.messageService.add({
                //   severity: "error",
                //   summary: "Error",
