...
export class TacasConfigurationComponent implements OnInit {
    ...
    settingData: any;
    DeamonFormGroup: UntypedFormGroup;
    editing = false;
    status: string;
        ...
        this.TacacsConfigurationService.updateMethod(url, this.customerList).subscribe(
            ...
            error => {
                ...
                if (error.error.message) {
                    ...
                    this.toastr.error(`Service is Down`, 'Failed!')
                    //   this.messageService.add({
                    //     severity: "error",
                    //     summary: "Error",
    ...
    onStartListeningPort() {
        ...
        this.TacacsConfigurationService.postMethodDeamon(url, {}).subscribe(
            response => {
                ...
                this.toastr.success(`Tacacs server start Successfully`, 'Success!')
                // this.messageService.add({
                //   severity: "success",
    ...
    onStopListeningPort() {
        ...
        this.TacacsConfigurationService.postMethodDeamon(url, {}).subscribe(
            response => {
                ...
                this.toastr.success(`Tacacs server stop Successfully`, 'Success!')
                // this.messageService.add({
                //   severity: "success",
