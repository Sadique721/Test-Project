...
export class CommonQuotationManagementComponent implements OnInit {
    ...
    serviceList: any;
    quotatationFormGroup: UntypedFormGroup;
    sendToCustomerForm: UntypedFormGroup;
    ...
    leadApproveRejectQuationForm: UntypedFormGroup;
    ...
    getLeadServiceList() {
        const url =
            "/SavbillSalesCrmsBss/leadMaster/findCircuitDetailsByLeadId?leadId=" + this.LeadCustData.id;
    ...
    quotationAssignWorkflow(id: any) {
        ...
        this.leadManagementService.getMethod(url).subscribe(
            ...
            (error: any) => {
                this.toastr.error(`${error.error.ERROR}`, 'Page Not Found!');
    ...
    assignToStaff(flag) {
        ...
        if (!this.selectStaff && !this.selectStaffReject) {
            url = `/teamHierarchy/assignEveryStaff?entityId=${this.leadApproveRejectQuationDto.quotationId
    ...
    approveOrRejectLeadQuotationPopup(lead, flag) {
                ...
                async (response: any) => {
                    ...
                    if ((await response.dataList) && (await response.dataList.length) > 0) {
                        ...
                        if (this.leadApproveRejectQuationDto.approveRequest) {
                            ...
                            this.toastr.success(`${response.message}`, ' Rejected Success!');
        ...
        this.customerManagementService.getMethod(url).subscribe(
            (response: any) => {
                ...
                if (response.responseCode == 417) {
                    ...
                    this.toastr.success(`${response.responseMessage}`, 'suceess!');
