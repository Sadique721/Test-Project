...
export class PlanMappingComponent implements OnInit {
    // planMappingData: MatTableDataSource<PlanMappingComponent>;
    displayedColumns: string[] = ['name', 'status', 'mvnoName', 'action'];
    displayedColumnsPlan: string[] = ['specialPlanGroup', 'normalPlanGroup', 'delete'];
    displayedColumnsPlans: string[] = ['specialPlan', 'normalPlan', 'delete'];
    displayedColumns1: string[] = ['specialPlan', 'customer', 'delete'];
    displayedColumns2: string[] = ['specialPlanGroup1', 'customer', 'delete'];
    displayedColumns3: string[] = ['specialPlan', 'leadCust', 'delete'];
    displayedColumns4: string[] = ['specialPlanGroup2', 'leadCustc', 'delete'];
    displayedColumnsParent: string[] = ['select', 'name', 'username'];
    displayedColumnslead: string[] = ['select', 'leadname', 'leadusername'];
    @Output() CloseParentCustomer = new EventEmitter();
    @Output() CloseLeadCustomer = new EventEmitter();
    @ViewChild(MatPaginator) paginator: MatPaginator;
    @ViewChild(MatSort) sort: MatSort;
    dialogRef: MatDialogRef<any>;
    parentCustomerDialogRef: MatDialogRef<any>;
    leadListDialogRef: MatDialogRef<any>;
    @ViewChild("ParentCustomerList") ParentCustomerList;
    @ViewChild("LeadList") LeadList;
    ...
    planMappingGroupForm: UntypedFormGroup;
    ...
    customerMapping: UntypedFormArray;
    leadMapping: UntypedFormArray;
    ...
    PlanGroupfromgroup: UntypedFormGroup;
    PlanCustfromgroup: UntypedFormGroup;
    planLeadGroupfromgroup: UntypedFormGroup;
    planGroupFromArray: UntypedFormArray;
    custGroupFromArray: UntypedFormArray;
    leadGroupFromArray: UntypedFormArray;
    ...
    // }
    getSpecialPlan() {
        const specialPlanurl = "/postpaidplan/all?type=SPECIAL";
    ...
    getNormalPlan() {
        const normalPlanurl = "/postpaidplan/all?type=NORMAL";
        ...
        this.specialPlanDD.forEach(element => {
            if (element.id == e.value) {
                element.serviceAreaNameList.forEach(s => {
                    if (s.id) {
                        let url = `/plans/serviceArea?serviceAreaId=${s.id}&planmode=NORMAL`;
    ...
    createplanGroupFormGroup(): UntypedFormGroup {
    ...
    onAddplanGroupField() {
        ...
        this.markControlsTouched(this.PlanGroupfromgroup);
    ...
    createPlanAttributeFormGroup(id: number): UntypedFormGroup {
        return this.fb.group({
            normalPlanId: [id],
    ...
    createCustomerAttributeFormGroup(id): UntypedFormGroup {
        return this.fb.group({
            customerId: [id],
    ...
    createLeadAttributeFormGroup(id): UntypedFormGroup {
        return this.fb.group({
            leadCustId: [id],
    ...
    addEdit(id) {
        ...
        if (
            ...
            this.toastr.error(`Atleast one mapping should be added`, 'Failed!');
            // this.messageService.add({
            //     severity: "error",
            //     summary: "Required ",
    ...
    createCustomerGroupAttributeFormGroup(): UntypedFormGroup {
        return this.fb.group({
    ...
    createLeadGroupAttributeFormGroup(): UntypedFormGroup {
        return this.fb.group({
    ...
    onAddCustomerGroupAttribute() {
        ...
        this.markControlsTouched(this.PlanCustfromgroup);
    ...
    onAddLeadGroupAttribute() {
        ...
        this.markControlsTouched(this.planLeadGroupfromgroup);
    ...
    getParentCustomerData() {
        ...
        const url = "/parentCustomers/list/Both";
    ...
    async modalOpenParentCustomer() {
        this.parentCustomerDialogRef = this.dialog.open(this.ParentCustomerList);
    ...
    async modalOpenLeadCustomer() {
        this.leadListDialogRef = this.dialog.open(this.LeadList);
    ...
    modalCloseLeadCustomer() {
        if (this.leadListDialogRef) {
            this.leadListDialogRef.close();
        }
        this.selectLeadModal = false;
    ...
    paginateLead(event) {
        this.currentPageLeadListdata = event.pageIndex + 1;
        this.parentLeadListdataitemsPerPage = event.pageSize;
        this.getLeadList();
        // this.first = event.first;
    ...
    searchParentCustomer() {
        ...
        const url = "/customers/search/Prepaid";
