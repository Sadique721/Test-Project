...
@Component({
    selector: 'app-add-edit-prepaid-rejected-reason-master',
    templateUrl: './add-edit-prepaid-rejected-reason-master.component.html',
    styleUrls: ['./add-edit-prepaid-rejected-reason-master.component.css'],
    standalone: false
})
export class AddEditPrepaidRejectedReasonMasterComponent {
    ...
    constructor(
        public dialogRef: MatDialogRef<AddEditPrepaidRejectedReasonMasterComponent>,
