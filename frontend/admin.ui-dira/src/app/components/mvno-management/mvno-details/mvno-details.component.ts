...
export class MvnoDetailsComponent implements OnInit {
    ...
    mvnoChagesListFormmArray: UntypedFormArray;
        ...
        this.revenueManagementService.postMethod(url, request).subscribe(
            (response: any) => {
                if (response.debitDocDetails.length > 0) {
                    ...
                    this.toastr.info(`No invoice found for given date`, 'Info!')
                    //   this.messageService.add({
                    //     severity: "info",
                    //     summary: "Info",
    ...
    bindInvoice() {
        ...
        if (this.selectedInvoice.length >= 1) {
            ...
            this.toastr.error(`Please select at least one invoice or advance mode.`, 'Failed!')
            //   this.messageService.add({
            //     severity: "error",
            //     summary: "Error",
        ...
        this.revenueManagementService.postMethod(url, request).subscribe(
            (response: any) => {
                ...
                if (this.viewcustomerInvoiceData.length !== 0) {
                    ...
                    this.toastr.info(`No Customers Found !!`, 'Info!')
                    //   this.messageService.add({
                    //     severity: "info",
                    //     summary: "Info",
