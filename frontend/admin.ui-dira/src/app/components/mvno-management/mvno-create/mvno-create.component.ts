...
export class MvnoCreateComponent implements OnInit {
    ...
    fileToUpload: any;
    mvnoFormGroup: UntypedFormGroup;
    ...
    @Input() editMvnoId: string = '';
    @Output() closeCreateDialog: EventEmitter<boolean> = new EventEmitter<boolean>();
    ...
    constructor(
        ...
        private commonService: SavbillCommonBaseService,
    ...
    ngAfterViewInit() {
        this.dialog.open(this.createDialog, { width: '1200px' });
    }
    ...
    addEditMvno(id) {
        ...
        if (this.mvnoFormGroup.valid) {
            ...
            this.mvnoFormGroup.markAllAsTouched();
    ...
    onCancel() {
        ...
        this.closeCreateDialog.emit(false);
    }
}
