...
export class TargetManagementComponent implements OnInit {
    targetGroupForm: UntypedFormGroup;
    targetMappingFormArray: UntypedFormArray;
    targetMappingForm: UntypedFormGroup;
    targetListData: any;
    ...
    addEditTarget(kpiId) {
        ...
        if (this.targetGroupForm.valid && this.targetMappingFormArray.valid) {
            if (this.totalTargetPer >= 100 || this.totalTargetPer == 0) {
                ...
                this.toastr.error(`Total Target % not less than 100`, 'Failed!')
                // this.messageService.add({
                //   severity: "error",
                //   summary: "Error",
    ...
    createTargetStaffMappingFormGroup(i): UntypedFormGroup {
