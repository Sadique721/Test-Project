...
export class PartnerDocumenetComponent implements OnInit {
    ...
    insertPartnerDocumentForm: UntypedFormGroup;
    parDocId: any;
    partnerID: any;
    BASE_API_URL: any;
    ...
    ngOnInit(): void {
        this.insertPartnerDocumentForm = new UntypedFormGroup({
    ...
    deleteConfirm(custDoc) {
        const dialogRef = this.dialog.open(this.confirmDialog, {
            ...
            data: {
                ...
                description: `Do you want to delete this Partner document?`,
                yesLabel: 'Delete',
                noLabel: 'Cancel'
            }
        });
    ...
    addDocument(dialogRef: any) {
        this.submitted = true;

        //this.insertPartnerDocumentForm.value.docStatus = "pending";
        if (this.insertPartnerDocumentForm.valid) {
            if (this.editMode) {
                this.updatePartnerDocumentOnDb(dialogRef);
            } else {
                this.savePartnerDocumentOnDb(dialogRef);
            }
        }
    }

    savePartnerDocumentOnDb(dialogRef: any) {
        let docData;
    ...
    updatePartnerDocumentOnDb(dialogRef: any) {
        let docData: any = [];
        let newFormData = Object.assign({}, this.insertPartnerDocumentForm.value);
